...
namespace SysML2.NET.Serializer
{
    ...
    /// <summary>
    /// The purpose of the <see cref="PackageSerializer"/> is to provide serialization
    ...
    internal static class PackageSerializer
    {
        ...
        /// </param>
        public static void Serialize(IPackage iPackage, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
