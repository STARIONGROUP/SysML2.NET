...
namespace SysML2.NET.Serializer
{
    ...
    internal static class ConnectorAsUsageSerializer
    {
        ...
        /// </param>
        public static void Serialize(IConnectorAsUsage iConnectorAsUsage, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
