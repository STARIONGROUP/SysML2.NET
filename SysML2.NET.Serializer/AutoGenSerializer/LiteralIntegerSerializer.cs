...
namespace SysML2.NET.Serializer
{
    ...
    internal static class LiteralIntegerSerializer
    {
        ...
        /// </param>
        public static void Serialize(ILiteralInteger iLiteralInteger, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
