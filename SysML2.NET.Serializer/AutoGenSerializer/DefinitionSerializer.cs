...
namespace SysML2.NET.Serializer
{
    ...
    /// <summary>
    /// The purpose of the <see cref="DefinitionSerializer"/> is to provide serialization
    ...
    internal static class DefinitionSerializer
    {
        ...
        /// </param>
        public static void Serialize(IDefinition iDefinition, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
