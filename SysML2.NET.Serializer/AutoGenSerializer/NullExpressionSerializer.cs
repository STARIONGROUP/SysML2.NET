...
namespace SysML2.NET.Serializer
{
    ...
    internal static class NullExpressionSerializer
    {
        ...
        /// </param>
        public static void Serialize(INullExpression iNullExpression, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
