...
namespace SysML2.NET.Serializer
{
    ...
    internal static class AssertConstraintUsageSerializer
    {
        ...
        /// </param>
        public static void Serialize(IAssertConstraintUsage iAssertConstraintUsage, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
            ...
            {
                writer.WriteStringValue(iAssertConstraintUsage.Direction.Value.ToString().ToUpper());
            }
            else
            {
                writer.WriteNullValue();
