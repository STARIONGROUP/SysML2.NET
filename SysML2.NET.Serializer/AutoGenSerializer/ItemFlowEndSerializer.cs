...
namespace SysML2.NET.Serializer
{
    ...
    internal static class ItemFlowEndSerializer
    {
        ...
        /// </param>
        public static void Serialize(IItemFlowEnd iItemFlowEnd, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
            ...
            {
                writer.WriteStringValue(iItemFlowEnd.Direction.Value.ToString().ToUpper());
            }
            else
            {
