// -------------------------------------------------------------------------------------------------
// <copyright file="ForLoopActionUsageSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer
{
    ...
    internal static class ForLoopActionUsageSerializer
    {
        ...
        /// </param>
        public static void Serialize(IForLoopActionUsage iForLoopActionUsage, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
            ...
            {
                writer.WriteStringValue(iForLoopActionUsage.PortionKind.Value.ToString().ToUpper());
            }
            else
            {
            ...
            {
                writer.WriteStringValue(iForLoopActionUsage.Direction.Value.ToString().ToUpper());
            }
            else
            {
                writer.WriteNullValue();
