...
namespace SysML2.NET.Serializer
{
    ...
    internal static class FeatureReferenceExpressionSerializer
    {
        ...
        /// </param>
        public static void Serialize(IFeatureReferenceExpression iFeatureReferenceExpression, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
