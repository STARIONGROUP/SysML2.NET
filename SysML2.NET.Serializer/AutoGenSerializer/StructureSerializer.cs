// -------------------------------------------------------------------------------------------------
// <copyright file="StructureSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer
{
    ...
    /// <summary>
    /// The purpose of the <see cref="StructureSerializer"/> is to provide serialization
    ...
    internal static class StructureSerializer
    {
        ...
        /// </param>
        public static void Serialize(IStructure iStructure, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
            ...
            writer.WriteStringValue("Structure");
