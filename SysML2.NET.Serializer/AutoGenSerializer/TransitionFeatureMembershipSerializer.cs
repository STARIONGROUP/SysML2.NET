...
namespace SysML2.NET.Serializer
{
    ...
    internal static class TransitionFeatureMembershipSerializer
    {
        ...
        /// </param>
        public static void Serialize(ITransitionFeatureMembership iTransitionFeatureMembership, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
