...
namespace SysML2.NET.Serializer
{
    ...
    internal static class VerificationCaseUsageSerializer
    {
        ...
        /// </param>
        public static void Serialize(IVerificationCaseUsage iVerificationCaseUsage, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
            ...
            {
                writer.WriteStringValue(iVerificationCaseUsage.Direction.Value.ToString().ToUpper());
            }
            else
            {
                writer.WriteNullValue();
