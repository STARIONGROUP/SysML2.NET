...
namespace SysML2.NET.Serializer
{
    ...
    internal static class SuccessionFlowConnectionUsageSerializer
    {
        ...
        /// </summary>
        /// <param name="successionFlowConnectionUsage">
        ...
        /// </param>
        public static void Serialize(ISuccessionFlowConnectionUsage iSuccessionFlowConnectionUsage, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
