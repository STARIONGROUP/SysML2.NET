...
namespace SysML2.NET.Serializer
{
    ...
    internal static class RenderingUsageSerializer
    {
        ...
        /// </param>
        public static void Serialize(IRenderingUsage iRenderingUsage, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
            ...
            {
                writer.WriteStringValue(iRenderingUsage.PortionKind.Value.ToString().ToUpper());
            }
            else
            {
            ...
            {
                writer.WriteStringValue(iRenderingUsage.Direction.Value.ToString().ToUpper());
            }
            else
            {
                writer.WriteNullValue();
