...
namespace SysML2.NET.Serializer
{
    ...
    /// <summary>
    /// The purpose of the <see cref="MetadataFeatureSerializer"/> is to provide serialization
    ...
    internal static class MetadataFeatureSerializer
    {
        ...
        /// </param>
        public static void Serialize(IMetadataFeature iMetadataFeature, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
