...
namespace SysML2.NET.Serializer
{
    ...
    /// <summary>
    /// The purpose of the <see cref="UseCaseUsageSerializer"/> is to provide serialization
    ...
    internal static class UseCaseUsageSerializer
    {
        ...
        /// </param>
        public static void Serialize(IUseCaseUsage iUseCaseUsage, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
            ...
            writer.WriteStringValue("UseCaseUsage");
            ...
            {
                writer.WriteStringValue(iUseCaseUsage.PortionKind.Value.ToString().ToUpper());
            }
            else
            {
            ...
            {
                writer.WriteStringValue(iUseCaseUsage.Direction.Value.ToString().ToUpper());
            }
            else
            {
                writer.WriteNullValue();
