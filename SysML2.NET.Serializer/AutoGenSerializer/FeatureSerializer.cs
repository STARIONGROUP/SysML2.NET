...
namespace SysML2.NET.Serializer
{
    ...
    internal static class FeatureSerializer
    {
        ...
        /// </param>
        public static void Serialize(IFeature iFeature, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
            ...
            {
                writer.WriteStringValue(iFeature.Direction.Value.ToString().ToUpper());
            }
            else
            {
