...
namespace SysML2.NET.Serializer
{
    ...
    internal static class LiteralBooleanSerializer
    {
        ...
        /// </param>
        public static void Serialize(ILiteralBoolean iLiteralBoolean, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
            ...
            {
                writer.WriteStringValue(iLiteralBoolean.Direction.Value.ToString().ToUpper());
            }
            else
            {
