...
namespace SysML2.NET.Serializer
{
    ...
    internal static class LiteralStringSerializer
    {
        ...
        /// </param>
        public static void Serialize(ILiteralString iLiteralString, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
            ...
            {
                writer.WriteStringValue(iLiteralString.Direction.Value.ToString().ToUpper());
            }
            else
            {
