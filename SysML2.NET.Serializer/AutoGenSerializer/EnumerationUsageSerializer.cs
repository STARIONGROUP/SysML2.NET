...
namespace SysML2.NET.Serializer
{
    ...
    internal static class EnumerationUsageSerializer
    {
        ...
        /// </param>
        public static void Serialize(IEnumerationUsage iEnumerationUsage, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
            ...
            {
                writer.WriteStringValue(iEnumerationUsage.Direction.Value.ToString().ToUpper());
            }
            else
            {
