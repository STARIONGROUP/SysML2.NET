...
namespace SysML2.NET.Serializer
{
    ...
    internal static class AcceptActionUsageSerializer
    {
        ...
        /// </param>
        public static void Serialize(IAcceptActionUsage iAcceptActionUsage, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
            ...
            {
                writer.WriteStringValue(iAcceptActionUsage.Direction.Value.ToString().ToUpper());
            }
            else
            {
                writer.WriteNullValue();
