...
namespace SysML2.NET.Serializer
{
    ...
    internal static class AssignmentActionUsageSerializer
    {
        ...
        /// </param>
        public static void Serialize(IAssignmentActionUsage iAssignmentActionUsage, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
            ...
            {
                writer.WriteStringValue(iAssignmentActionUsage.PortionKind.Value.ToString().ToUpper());
            }
            else
            {
            ...
            {
                writer.WriteStringValue(iAssignmentActionUsage.Direction.Value.ToString().ToUpper());
            }
            else
            {
                writer.WriteNullValue();
