...
namespace SysML2.NET.Serializer
{
    ...
    internal static class MetadataDefinitionSerializer
    {
        ...
        /// </param>
        public static void Serialize(IMetadataDefinition iMetadataDefinition, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
