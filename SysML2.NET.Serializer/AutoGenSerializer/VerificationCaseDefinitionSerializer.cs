...
namespace SysML2.NET.Serializer
{
    ...
    internal static class VerificationCaseDefinitionSerializer
    {
        ...
        /// </param>
        public static void Serialize(IVerificationCaseDefinition iVerificationCaseDefinition, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
