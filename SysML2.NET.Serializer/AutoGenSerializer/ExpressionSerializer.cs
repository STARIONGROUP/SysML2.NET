...
namespace SysML2.NET.Serializer
{
    ...
    internal static class ExpressionSerializer
    {
        ...
        /// </param>
        public static void Serialize(IExpression iExpression, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
            ...
            {
                writer.WriteStringValue(iExpression.Direction.Value.ToString().ToUpper());
            }
            else
            {
