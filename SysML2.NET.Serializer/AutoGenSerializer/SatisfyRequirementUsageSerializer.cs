...
namespace SysML2.NET.Serializer
{
    ...
    internal static class SatisfyRequirementUsageSerializer
    {
        ...
        /// </param>
        public static void Serialize(ISatisfyRequirementUsage iSatisfyRequirementUsage, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
            ...
            {
                writer.WriteStringValue(iSatisfyRequirementUsage.Direction.Value.ToString().ToUpper());
            }
            else
            {
                writer.WriteNullValue();
