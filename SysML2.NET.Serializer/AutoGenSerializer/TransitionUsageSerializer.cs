...
namespace SysML2.NET.Serializer
{
    ...
    internal static class TransitionUsageSerializer
    {
        ...
        /// </param>
        public static void Serialize(ITransitionUsage iTransitionUsage, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
            ...
            {
                writer.WriteStringValue(iTransitionUsage.PortionKind.Value.ToString().ToUpper());
            }
            else
            {
            ...
            {
                writer.WriteStringValue(iTransitionUsage.Direction.Value.ToString().ToUpper());
            }
            else
            {
                writer.WriteNullValue();
