...
namespace SysML2.NET.Serializer
{
    ...
    internal static class ResultExpressionMembershipSerializer
    {
        ...
        /// </param>
        public static void Serialize(IResultExpressionMembership iResultExpressionMembership, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
