...
namespace SysML2.NET.Serializer
{
    ...
    internal static class CollectExpressionSerializer
    {
        ...
        /// </param>
        public static void Serialize(ICollectExpression iCollectExpression, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
