...
namespace SysML2.NET.Serializer
{
    ...
    /// <summary>
    /// The purpose of the <see cref="ConcernDefinitionSerializer"/> is to provide serialization
    ...
    internal static class ConcernDefinitionSerializer
    {
        ...
        /// </param>
        public static void Serialize(IConcernDefinition iConcernDefinition, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
