...
namespace SysML2.NET.Serializer
{
    ...
    /// <summary>
    /// The purpose of the <see cref="ConnectionDefinitionSerializer"/> is to provide serialization
    ...
    internal static class ConnectionDefinitionSerializer
    {
        ...
        /// </param>
        public static void Serialize(IConnectionDefinition iConnectionDefinition, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
