...
namespace SysML2.NET.Serializer
{
    ...
    internal static class BindingConnectorSerializer
    {
        ...
        /// </param>
        public static void Serialize(IBindingConnector iBindingConnector, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
            ...
            {
                writer.WriteStringValue(iBindingConnector.Direction.Value.ToString().ToUpper());
            }
            else
            {
