...
namespace SysML2.NET.Serializer
{
    ...
    internal static class EventOccurrenceUsageSerializer
    {
        ...
        /// </param>
        public static void Serialize(IEventOccurrenceUsage iEventOccurrenceUsage, Utf8JsonWriter writer, SerializationModeKind serializationModeKind)
        {
            ...
            {
                writer.WriteStringValue(iEventOccurrenceUsage.PortionKind.Value.ToString().ToUpper());
            }
            else
            {
            ...
            {
                writer.WriteStringValue(iEventOccurrenceUsage.Direction.Value.ToString().ToUpper());
            }
            else
            {
                writer.WriteNullValue();
