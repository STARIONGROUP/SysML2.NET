// -------------------------------------------------------------------------------------------------
// <copyright file="ExternalDataRequest.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.PSM.DTO
{
    ...
    public partial class ExternalDataRequest : IDataRequest, IRequest
    {
        ...
        /// <summary>
        /// Gets or sets the unique identifier of the ExternalDataRequest
        /// </summary>
        public Guid? Id { get; set; }

        /// <summary>
        /// Gets or sets the resourceIdentifier of the ExternalDataRequest
        /// </summary>
