...
namespace SysML2.NET.PSM.DTO
{
    ...
    /// <summary>
    /// Data transfer object that represents the Query schema of the Systems Modeling API and Services
    /// </summary>
    [GeneratedCode("SysML2.NET", "latest")]
    public partial class Query : IResponse, SysML2.NET.Common.IIdentified
    {
        /// <summary>
        /// The value of the type discriminator of the Query schema
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the alias of the Query
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the select of the Query
        /// </summary>
        public List<string> Select { get; set; } = [];

        /// <summary>
        /// Gets or sets the where of the Query
        /// </summary>
