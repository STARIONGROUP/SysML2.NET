...
namespace SysML2.NET.PSM.DTO
{
    ...
    /// <summary>
    /// Data transfer object that represents the Tag schema of the Systems Modeling API and Services
    /// </summary>
    [GeneratedCode("SysML2.NET", "latest")]
    public partial class Tag : IResponse, SysML2.NET.Common.IIdentified
    {
        /// <summary>
        /// The value of the type discriminator of the Tag schema
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the alias of the Tag
        /// </summary>
        public List<string> Alias { get; set; } = [];

        /// <summary>
        /// Gets or sets the created of the Tag
        /// </summary>
        public DateTime Created { get; set; }

        /// <summary>
        /// Gets or sets the deleted of the Tag
        /// </summary>
