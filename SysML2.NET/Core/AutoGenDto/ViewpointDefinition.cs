...
namespace SysML2.NET.Core.DTO.Systems.Views
{
    ...
    public partial class ViewpointDefinition : IViewpointDefinition
    {
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IRequirementDefinition.ReqId");
            set => throw new InvalidOperationException("Redefined by property IRequirementDefinition.ReqId");
        }
