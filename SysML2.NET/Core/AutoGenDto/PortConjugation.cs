...
namespace SysML2.NET.Core.DTO.Systems.Ports
{
    ...
    public partial class PortConjugation : IPortConjugation
    {
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IPortConjugation.OriginalPortDefinition");
            set => throw new InvalidOperationException("Redefined by property IPortConjugation.OriginalPortDefinition");
        }
        ...
        Guid? Core.Types.IConjugation.owningType => throw new InvalidOperationException("Redefined by property IPortConjugation.ConjugatedPortDefinition");
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IConjugation.ConjugatedType");
            set => throw new InvalidOperationException("Redefined by property IConjugation.ConjugatedType");
        }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IConjugation.OriginalType");
            set => throw new InvalidOperationException("Redefined by property IConjugation.OriginalType");
        }
