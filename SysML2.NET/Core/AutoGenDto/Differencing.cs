...
namespace SysML2.NET.Core.DTO.Core.Types
{
    ...
    public partial class Differencing : IDifferencing
    {
        ...
        public Guid DifferencingType { get; set; }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IDifferencing.TypeDifferenced");
            set => throw new InvalidOperationException("Redefined by property IDifferencing.TypeDifferenced");
        }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IDifferencing.DifferencingType");
            set => throw new InvalidOperationException("Redefined by property IDifferencing.DifferencingType");
        }
        ...
        public Guid typeDifferenced { get; internal set; }
