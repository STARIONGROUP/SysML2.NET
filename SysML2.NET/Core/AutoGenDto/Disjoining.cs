...
namespace SysML2.NET.Core.DTO.Core.Types
{
    ...
    public partial class Disjoining : IDisjoining
    {
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IDisjoining.TypeDisjoined");
            set => throw new InvalidOperationException("Redefined by property IDisjoining.TypeDisjoined");
        }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IDisjoining.DisjoiningType");
            set => throw new InvalidOperationException("Redefined by property IDisjoining.DisjoiningType");
        }
