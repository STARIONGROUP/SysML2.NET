...
namespace SysML2.NET.Core.DTO.Systems.Metadata
{
    ...
    public partial class MetadataUsage : IMetadataUsage
    {
        ...
        List<Guid> Systems.Items.IItemUsage.itemDefinition => throw new InvalidOperationException("Redefined by property IMetadataUsage.MetadataDefinition");
        ...
        Guid? Kernel.Metadata.IMetadataFeature.metaclass => throw new InvalidOperationException("Redefined by property IMetadataUsage.MetadataDefinition");
        ...
        public Guid? metadataDefinition { get; internal set; }
