// -------------------------------------------------------------------------------------------------
// <copyright file="PayloadFeature.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.DTO
{
    ...
    /// transfers that are instances of the Flow.redefinesFromLibrary('Transfers::Transfer::payload')
    /// </summary>
    public partial class PayloadFeature : IPayloadFeature
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayloadFeature"/> class.
        /// </summary>
