...
namespace SysML2.NET.Core.DTO.Systems.Views
{
    ...
    public partial class ViewRenderingMembership : IViewRenderingMembership
    {
        ...
        Guid Core.Types.IFeatureMembership.ownedMemberFeature => throw new InvalidOperationException("Redefined by property IViewRenderingMembership.OwnedRendering");
        ...
        public Guid ownedRendering { get; internal set; }
        ...
        public Guid referencedRendering { get; internal set; }
