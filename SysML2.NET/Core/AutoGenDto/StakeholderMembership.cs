// -------------------------------------------------------------------------------------------------
// <copyright file="StakeholderMembership.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.DTO.Systems.Requirements
{
    ...
    public partial class StakeholderMembership : IStakeholderMembership
    {
        ...
        [RedefinedByProperty("IStakeholderMembership.OwnedStakeholderParameter")]
        [Implements(implementation: "IParameterMembership.OwnedMemberParameter")]
        Guid Kernel.Behaviors.IParameterMembership.ownedMemberParameter => throw new InvalidOperationException("Redefined by property IStakeholderMembership.OwnedStakeholderParameter");
        ...
        [Implements(implementation: "IStakeholderMembership.OwnedStakeholderParameter")]
        public Guid ownedStakeholderParameter { get; internal set; }
