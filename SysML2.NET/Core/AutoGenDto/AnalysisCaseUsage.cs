...
namespace SysML2.NET.Core.DTO.Systems.AnalysisCases
{
    ...
    public partial class AnalysisCaseUsage : IAnalysisCaseUsage
    {
        ...
        public Guid? analysisCaseDefinition { get; internal set; }
        ...
        Guid? Systems.Cases.ICaseUsage.caseDefinition => throw new InvalidOperationException("Redefined by property IAnalysisCaseUsage.AnalysisCaseDefinition");
