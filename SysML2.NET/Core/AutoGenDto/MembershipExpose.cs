...
namespace SysML2.NET.Core.DTO.Systems.Views
{
    ...
    public partial class MembershipExpose : IMembershipExpose
    {
        ...
        public Guid importOwningNamespace { get; internal set; }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IExpose.IsImportAll");
            set => throw new InvalidOperationException("Redefined by property IExpose.IsImportAll");
        }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IImport.ImportOwningNamespace");
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IMembershipImport.ImportedMembership");
            set => throw new InvalidOperationException("Redefined by property IMembershipImport.ImportedMembership");
        }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IExpose.Visibility");
            set => throw new InvalidOperationException("Redefined by property IExpose.Visibility");
        }
