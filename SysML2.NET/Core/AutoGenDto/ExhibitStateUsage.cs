...
namespace SysML2.NET.Core.DTO.Systems.States
{
    ...
    public partial class ExhibitStateUsage : IExhibitStateUsage
    {
        ...
        List<Guid> Systems.Actions.IActionUsage.actionDefinition => [.. this.stateDefinition];
        ...
        List<Guid> Kernel.Behaviors.IStep.behavior => [.. ((SysML2.NET.Core.DTO.Systems.Actions.IActionUsage)this).actionDefinition];
        ...
        Guid Systems.Occurrences.IEventOccurrenceUsage.eventOccurrence => ((SysML2.NET.Core.DTO.Systems.Actions.IPerformActionUsage)this).performedAction;
        ...
        public bool isReference { get; internal set; } = true;
        ...
        Guid Systems.Actions.IPerformActionUsage.performedAction => this.exhibitedState;
