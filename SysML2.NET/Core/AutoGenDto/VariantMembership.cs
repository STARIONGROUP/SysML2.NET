...
namespace SysML2.NET.Core.DTO.Systems.DefinitionAndUsage
{
    ...
    public partial class VariantMembership : IVariantMembership
    {
        ...
        Guid Root.Namespaces.IOwningMembership.ownedMemberElement => throw new InvalidOperationException("Redefined by property IVariantMembership.OwnedVariantUsage");
        ...
        public Guid ownedVariantUsage { get; internal set; }
