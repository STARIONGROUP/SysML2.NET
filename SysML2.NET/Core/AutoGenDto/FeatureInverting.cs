...
namespace SysML2.NET.Core.DTO.Core.Features
{
    ...
    public partial class FeatureInverting : IFeatureInverting
    {
        ...
        public Guid FeatureInverted { get; set; }
        ...
        public Guid InvertingFeature { get; set; }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IFeatureInverting.FeatureInverted");
            set => throw new InvalidOperationException("Redefined by property IFeatureInverting.FeatureInverted");
        }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IFeatureInverting.InvertingFeature");
            set => throw new InvalidOperationException("Redefined by property IFeatureInverting.InvertingFeature");
        }
