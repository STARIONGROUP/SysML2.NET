// -------------------------------------------------------------------------------------------------
// <copyright file="RequirementVerificationMembership.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.DTO.Systems.VerificationCases
{
    ...
    public partial class RequirementVerificationMembership : IRequirementVerificationMembership
    {
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IRequirementVerificationMembership.Kind");
            set => throw new InvalidOperationException("Redefined by property IRequirementVerificationMembership.Kind");
        }
        ...
        Guid Systems.Requirements.IRequirementConstraintMembership.ownedConstraint => throw new InvalidOperationException("Redefined by property IRequirementVerificationMembership.OwnedRequirement");
        ...
        Guid Core.Types.IFeatureMembership.ownedMemberFeature => throw new InvalidOperationException("Redefined by property IRequirementConstraintMembership.OwnedConstraint");
        ...
        Guid Systems.Requirements.IRequirementConstraintMembership.referencedConstraint => throw new InvalidOperationException("Redefined by property IRequirementVerificationMembership.VerifiedRequirement");
