...
namespace SysML2.NET.Core.DTO.Systems.Cases
{
    ...
    public partial class ObjectiveMembership : IObjectiveMembership
    {
        ...
        Guid Core.Types.IFeatureMembership.ownedMemberFeature => throw new InvalidOperationException("Redefined by property IObjectiveMembership.OwnedObjectiveRequirement");
        ...
        public Guid ownedObjectiveRequirement { get; internal set; }
