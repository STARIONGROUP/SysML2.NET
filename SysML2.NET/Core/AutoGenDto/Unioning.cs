...
namespace SysML2.NET.Core.DTO.Core.Types
{
    ...
    public partial class Unioning : IUnioning
    {
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IUnioning.TypeUnioned");
            set => throw new InvalidOperationException("Redefined by property IUnioning.TypeUnioned");
        }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IUnioning.UnioningType");
        ...
        public Guid typeUnioned { get; internal set; }
        ...
        public Guid UnioningType { get; set; }
