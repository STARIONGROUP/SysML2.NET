...
namespace SysML2.NET.Core.DTO.Kernel.Expressions
{
    ...
    public partial class IndexExpression : IIndexExpression
    {
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IIndexExpression.Operator");
            set => throw new InvalidOperationException("Redefined by property IIndexExpression.Operator");
        }
