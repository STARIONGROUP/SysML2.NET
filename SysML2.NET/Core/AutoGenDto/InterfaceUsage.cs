...
namespace SysML2.NET.Core.DTO.Systems.Interfaces
{
    ...
    public partial class InterfaceUsage : IInterfaceUsage
    {
        ...
        List<Guid> Systems.Connections.IConnectionUsage.connectionDefinition => throw new InvalidOperationException("Redefined by property IInterfaceUsage.InterfaceDefinition");
        ...
        public List<Guid> interfaceDefinition { get; internal set; }
