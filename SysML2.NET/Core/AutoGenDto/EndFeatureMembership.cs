...
namespace SysML2.NET.Core.DTO.Core.Features
{
    ...
    public partial class EndFeatureMembership : IEndFeatureMembership
    {
        ...
        Guid Core.Types.IFeatureMembership.ownedMemberFeature => throw new InvalidOperationException("Redefined by property IEndFeatureMembership.OwnedMemberFeature");
