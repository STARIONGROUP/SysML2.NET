...
namespace SysML2.NET.Core.DTO.Core.Features
{
    ...
    public partial class Redefinition : IRedefinition
    {
        ...
        public Guid? owningFeature { get; internal set; }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IRedefinition.RedefinedFeature");
            set => throw new InvalidOperationException("Redefined by property IRedefinition.RedefinedFeature");
        }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IRedefinition.RedefiningFeature");
            set => throw new InvalidOperationException("Redefined by property IRedefinition.RedefiningFeature");
        }
