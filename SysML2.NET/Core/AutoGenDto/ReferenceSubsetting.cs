...
namespace SysML2.NET.Core.DTO.Core.Features
{
    ...
    public partial class ReferenceSubsetting : IReferenceSubsetting
    {
        ...
        {
            get => throw new InvalidOperationException("Redefined by property ISubsetting.SubsettedFeature");
            set => throw new InvalidOperationException("Redefined by property ISubsetting.SubsettedFeature");
        }
        ...
        Guid? ISubsetting.owningFeature => throw new InvalidOperationException("Redefined by property IReferenceSubsetting.ReferencingFeature");
        ...
        Guid? Core.Types.ISpecialization.owningType => throw new InvalidOperationException("Redefined by property ISubsetting.OwningFeature");
        ...
        public Guid referencingFeature { get; internal set; }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property ISpecialization.Specific");
            set => throw new InvalidOperationException("Redefined by property ISpecialization.Specific");
        }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property ISubsetting.SubsettingFeature");
            set => throw new InvalidOperationException("Redefined by property ISubsetting.SubsettingFeature");
        }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IReferenceSubsetting.ReferencedFeature");
            set => throw new InvalidOperationException("Redefined by property IReferenceSubsetting.ReferencedFeature");
        }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IReferenceSubsetting.ReferencingFeature");
            set => throw new InvalidOperationException("Redefined by property IReferenceSubsetting.ReferencingFeature");
        }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property ISpecialization.General");
            set => throw new InvalidOperationException("Redefined by property ISpecialization.General");
        }
