...
namespace SysML2.NET.Core.DTO.Systems.Enumerations
{
    ...
    public partial class EnumerationUsage : IEnumerationUsage
    {
        ...
        List<Guid> Systems.Attributes.IAttributeUsage.attributeDefinition => throw new InvalidOperationException("Redefined by property IEnumerationUsage.EnumerationDefinition");
        ...
        List<Guid> Systems.DefinitionAndUsage.IUsage.definition => throw new InvalidOperationException("Redefined by property IAttributeUsage.AttributeDefinition");
        ...
        public Guid enumerationDefinition { get; internal set; }
