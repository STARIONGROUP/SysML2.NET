...
namespace SysML2.NET.Core.DTO.Core.Features
{
    ...
    public partial class FeatureChaining : IFeatureChaining
    {
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IFeatureChaining.FeatureChained");
            set => throw new InvalidOperationException("Redefined by property IFeatureChaining.FeatureChained");
        }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IFeatureChaining.ChainingFeature");
            set => throw new InvalidOperationException("Redefined by property IFeatureChaining.ChainingFeature");
        }
