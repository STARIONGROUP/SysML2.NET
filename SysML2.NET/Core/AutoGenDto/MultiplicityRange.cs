...
namespace SysML2.NET.Core.DTO.Kernel.Multiplicities
{
    using System;
    ...
    public partial class MultiplicityRange : IMultiplicityRange
    {
        ...
        public List<Guid> bound { get; internal set; } = [];
        ...
        public Guid? lowerBound { get; internal set; }
        ...
        public Guid upperBound { get; internal set; }
