...
namespace SysML2.NET.Core.DTO.Kernel.Packages
{
    ...
    public partial class ElementFilterMembership : IElementFilterMembership
    {
        ...
        Guid Root.Namespaces.IOwningMembership.ownedMemberElement => throw new InvalidOperationException("Redefined by property IElementFilterMembership.Condition");
