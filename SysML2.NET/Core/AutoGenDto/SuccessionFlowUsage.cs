// -------------------------------------------------------------------------------------------------
// <copyright file="SuccessionFlowUsage.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.DTO.Systems.Flows
{
    ...
    public partial class SuccessionFlowUsage : ISuccessionFlowUsage
    {
        /// <summary>
        ...
        List<Guid> Systems.Actions.IActionUsage.actionDefinition => throw new InvalidOperationException("Redefined by property IFlowUsage.FlowDefinition");
        ...
        List<Guid> Kernel.Connectors.IConnector.association => throw new InvalidOperationException("Redefined by property IFlow.Interaction");
        ...
        List<Guid> Kernel.Behaviors.IStep.behavior => throw new InvalidOperationException("Redefined by property IFlow.Interaction");
        ...
        public List<Guid> connectorEnd { get; internal set; }
        ...
        public Guid? defaultFeaturingType { get; internal set; }
        ...
        List<Guid> Core.Types.IType.directedFeature => throw new InvalidOperationException("Redefined by property IStep.Parameter");
        ...
        List<Guid> Core.Types.IType.endFeature => throw new InvalidOperationException("Redefined by property IConnector.ConnectorEnd");
        ...
        [Implements(implementation: "IFlowUsage.FlowDefinition")]
        public List<Guid> flowDefinition { get; internal set; }
        ...
        public List<Guid> flowEnd { get; internal set; }
        ...
        List<Guid> Kernel.Interactions.IFlow.interaction => throw new InvalidOperationException("Redefined by property IFlowUsage.FlowDefinition");
        ...
        List<Guid> Systems.Occurrences.IOccurrenceUsage.occurrenceDefinition => throw new InvalidOperationException("Redefined by property IActionUsage.ActionDefinition");
        ...
        public Guid? payloadFeature { get; internal set; }
        ...
        public List<Guid> payloadType { get; internal set; }
        ...
        List<Guid> Root.Elements.IRelationship.relatedElement => throw new InvalidOperationException("Redefined by property IConnector.RelatedFeature");
        ...
        public List<Guid> relatedFeature { get; internal set; }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IConnector.SourceFeature");
            set => throw new InvalidOperationException("Redefined by property IConnector.SourceFeature");
        }
        ...
        public Guid? sourceFeature { get; internal set; }
        ...
        public Guid? sourceOutputFeature { get; internal set; }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IConnector.TargetFeature");
            set => throw new InvalidOperationException("Redefined by property IConnector.TargetFeature");
        }
        ...
        public List<Guid> targetFeature { get; internal set; }
        ...
        public Guid? targetInputFeature { get; internal set; }
        ...
        List<Guid> Core.Features.IFeature.type => throw new InvalidOperationException("Redefined by property IConnector.Association");
