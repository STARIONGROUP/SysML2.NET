...
namespace SysML2.NET.Core.DTO.Systems.Allocations
{
    ...
    public partial class AllocationUsage : IAllocationUsage
    {
        ...
        public List<Guid> allocationDefinition { get; internal set; }
        ...
        List<Guid> Kernel.Connectors.IConnector.association => throw new InvalidOperationException("Redefined by property IConnectionUsage.ConnectionDefinition");
        ...
        List<Guid> Systems.Connections.IConnectionUsage.connectionDefinition => throw new InvalidOperationException("Redefined by property IAllocationUsage.AllocationDefinition");
