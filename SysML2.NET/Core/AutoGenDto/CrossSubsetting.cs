...
namespace SysML2.NET.Core.DTO.Core.Features
{
    ...
    public partial class CrossSubsetting : ICrossSubsetting
    {
        ...
        Guid? ISubsetting.owningFeature => throw new InvalidOperationException("Redefined by property ICrossSubsetting.CrossingFeature");
        ...
        {
            get => throw new InvalidOperationException("Redefined by property ICrossSubsetting.CrossedFeature");
            set => throw new InvalidOperationException("Redefined by property ICrossSubsetting.CrossedFeature");
        }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property ICrossSubsetting.CrossingFeature");
            set => throw new InvalidOperationException("Redefined by property ICrossSubsetting.CrossingFeature");
        }
