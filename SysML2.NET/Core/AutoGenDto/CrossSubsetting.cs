...
namespace SysML2.NET.Core.DTO.Core.Features
{
    ...
    /// Features are required for any of them to have a CrossSubsetting).                        The
    /// crossedFeature of a CrossSubsetting must have a feature chain of exactly two Features. The second
    /// Feature in the chain is the crossFeature of the crossingFeature (end Feature), which has the same
    /// type as the crossingFeature. When the owningType of the crossingFeature has exactly two end
    /// Features, the first Feature in the chain of the crossedFeature is the other end Feature. The
    /// crossFeature’s featuringType in this case is the other end Feature. When the owningType has more
    /// than two end Features, the first Feature in the chain is a Feature that CrossMultiplies all the
    /// other end Features, which is also the featuringType of the crossFeature.                        A
    /// crossFeature must be owned by its featureCrossing (end Feature) when the featureCrossing owningType
    /// has more than two end Features. Otherwise, for exactly two end Features, the crossFeatures of each
    /// the ends can instead optionally be inherited by the other end from one of its types or a subsetted
    /// Feature.
    /// </summary>
    ...
    public partial class CrossSubsetting : ICrossSubsetting
    {
        ...
        public Guid CrossedFeature { get; set; }
        ...
        public Guid crossingFeature { get; internal set; }
        ...
        Guid Core.Types.ISpecialization.General
        {
            get => ((SysML2.NET.Core.DTO.Core.Features.ISubsetting)this).SubsettedFeature;
            set
            {
                ((SysML2.NET.Core.DTO.Core.Features.ISubsetting)this).SubsettedFeature = value;
            }
        }
        ...
        Guid? ISubsetting.owningFeature => this.crossingFeature;
        ...
        Guid? Core.Types.ISpecialization.owningType => ((SysML2.NET.Core.DTO.Core.Features.ISubsetting)this).owningFeature.HasValue ? ((SysML2.NET.Core.DTO.Core.Features.ISubsetting)this).owningFeature.Value : Guid.Empty;
        ...
        {
            get => [((SysML2.NET.Core.DTO.Core.Types.ISpecialization)this).Specific];
            set
            {
                if (value.Count != 0)
                {
                    ((SysML2.NET.Core.DTO.Core.Types.ISpecialization)this).Specific = value[0];
                }
        ...
        Guid Core.Types.ISpecialization.Specific
        {
            get => ((SysML2.NET.Core.DTO.Core.Features.ISubsetting)this).SubsettingFeature;
            set
            {
                ((SysML2.NET.Core.DTO.Core.Features.ISubsetting)this).SubsettingFeature = value;
            }
        }
        ...
        Guid ISubsetting.SubsettedFeature
        {
            get => this.CrossedFeature;
            set
            {
        ...
        Guid ISubsetting.SubsettingFeature
        {
            get => this.crossingFeature;
            set { }
        }
        ...
        {
            get => [((SysML2.NET.Core.DTO.Core.Types.ISpecialization)this).General];
            set
            {
                if (value.Count != 0)
                {
                    ((SysML2.NET.Core.DTO.Core.Types.ISpecialization)this).General = value[0];
                }
