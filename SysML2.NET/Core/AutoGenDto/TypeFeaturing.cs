...
namespace SysML2.NET.Core.DTO.Core.Features
{
    ...
    public partial class TypeFeaturing : ITypeFeaturing
    {
        ...
        public Guid? owningFeatureOfType { get; internal set; }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property ITypeFeaturing.FeatureOfType");
            set => throw new InvalidOperationException("Redefined by property ITypeFeaturing.FeatureOfType");
        }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property ITypeFeaturing.FeaturingType");
            set => throw new InvalidOperationException("Redefined by property ITypeFeaturing.FeaturingType");
        }
