...
namespace SysML2.NET.Core.DTO.Core.Types
{
    ...
    /// typeIntersected.
    /// </summary>
    [Class(xmiId: "_19_0_4_b9102da_1623187351831_706169_90", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    ...
    public partial class Intersecting : IIntersecting
    {
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IIntersecting.TypeIntersected");
            set => throw new InvalidOperationException("Redefined by property IIntersecting.TypeIntersected");
        }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IIntersecting.IntersectingType");
            set => throw new InvalidOperationException("Redefined by property IIntersecting.IntersectingType");
        }
        ...
        public Guid typeIntersected { get; internal set; }
