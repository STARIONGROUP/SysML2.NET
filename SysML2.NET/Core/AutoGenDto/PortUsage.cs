...
namespace SysML2.NET.Core.DTO.Systems.Ports
{
    ...
    public partial class PortUsage : IPortUsage
    {
        ...
        List<Guid> Systems.Occurrences.IOccurrenceUsage.occurrenceDefinition => throw new InvalidOperationException("Redefined by property IPortUsage.PortDefinition");
        ...
        public List<Guid> portDefinition { get; internal set; }
