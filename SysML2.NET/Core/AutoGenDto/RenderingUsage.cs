...
namespace SysML2.NET.Core.DTO.Systems.Views
{
    ...
    public partial class RenderingUsage : IRenderingUsage
    {
        ...
        List<Guid> Systems.Parts.IPartUsage.partDefinition => this.renderingDefinition.HasValue ? [this.renderingDefinition.Value] : [];
        ...
        public Guid? renderingDefinition { get; internal set; }
