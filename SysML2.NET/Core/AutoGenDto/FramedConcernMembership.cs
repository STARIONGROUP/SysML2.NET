...
namespace SysML2.NET.Core.DTO.Systems.Requirements
{
    ...
    public partial class FramedConcernMembership : IFramedConcernMembership
    {
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IFramedConcernMembership.Kind");
            set => throw new InvalidOperationException("Redefined by property IFramedConcernMembership.Kind");
        }
        ...
        Guid IRequirementConstraintMembership.ownedConstraint => throw new InvalidOperationException("Redefined by property IFramedConcernMembership.OwnedConcern");
        ...
        Guid IRequirementConstraintMembership.referencedConstraint => throw new InvalidOperationException("Redefined by property IFramedConcernMembership.ReferencedConcern");
