// -------------------------------------------------------------------------------------------------
// <copyright file="TransitionFeatureMembership.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.DTO.Systems.States
{
    ...
    public partial class TransitionFeatureMembership : ITransitionFeatureMembership
    {
        ...
        [Implements(implementation: "ITransitionFeatureMembership.Kind")]
        ...
        Guid Core.Types.IFeatureMembership.ownedMemberFeature => throw new InvalidOperationException("Redefined by property ITransitionFeatureMembership.TransitionFeature");
        ...
        [Implements(implementation: "ITransitionFeatureMembership.TransitionFeature")]
        public Guid transitionFeature { get; internal set; }
