...
namespace SysML2.NET.Core.DTO.Systems.Requirements
{
    ...
    public partial class ConcernUsage : IConcernUsage
    {
        ...
        public Guid? concernDefinition { get; internal set; }
        ...
        Guid? IRequirementUsage.requirementDefinition => throw new InvalidOperationException("Redefined by property IConcernUsage.ConcernDefinition");
