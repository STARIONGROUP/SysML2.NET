// -------------------------------------------------------------------------------------------------
// <copyright file="SubjectMembership.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.DTO.Systems.Requirements
{
    ...
    public partial class SubjectMembership : ISubjectMembership
    {
        ...
        [RedefinedByProperty("ISubjectMembership.OwnedSubjectParameter")]
        [Implements(implementation: "IParameterMembership.OwnedMemberParameter")]
        Guid Kernel.Behaviors.IParameterMembership.ownedMemberParameter => throw new InvalidOperationException("Redefined by property ISubjectMembership.OwnedSubjectParameter");
        ...
        [Implements(implementation: "ISubjectMembership.OwnedSubjectParameter")]
        public Guid ownedSubjectParameter { get; internal set; }
