...
namespace SysML2.NET.Core.DTO.Systems.Views
{
    ...
    public partial class NamespaceExpose : INamespaceExpose
    {
        ...
        {
            get => throw new InvalidOperationException("Redefined by property INamespaceImport.ImportedNamespace");
            set => throw new InvalidOperationException("Redefined by property INamespaceImport.ImportedNamespace");
        }
