...
namespace SysML2.NET.Core.DTO.Systems.UseCases
{
    ...
    public partial class IncludeUseCaseUsage : IIncludeUseCaseUsage
    {
        ...
        List<Guid> Systems.Actions.IActionUsage.actionDefinition => throw new InvalidOperationException("Redefined by property ICalculationUsage.CalculationDefinition");
        ...
        List<Guid> Kernel.Behaviors.IStep.behavior => throw new InvalidOperationException("Redefined by property IExpression.Function");
        ...
        Guid? Systems.Calculations.ICalculationUsage.calculationDefinition => throw new InvalidOperationException("Redefined by property ICaseUsage.CaseDefinition");
        ...
        Guid? Systems.Cases.ICaseUsage.caseDefinition => throw new InvalidOperationException("Redefined by property IUseCaseUsage.UseCaseDefinition");
        ...
        Guid Systems.Occurrences.IEventOccurrenceUsage.eventOccurrence => throw new InvalidOperationException("Redefined by property IPerformActionUsage.PerformedAction");
        ...
        Guid? Kernel.Functions.IExpression.function => throw new InvalidOperationException("Redefined by property ICalculationUsage.CalculationDefinition");
        ...
        public List<Guid> includedUseCase { get; internal set; }
        ...
        Guid Systems.Actions.IPerformActionUsage.performedAction => throw new InvalidOperationException("Redefined by property IIncludeUseCaseUsage.UseCaseIncluded");
        ...
        public Guid? useCaseDefinition { get; internal set; }
        ...
        public Guid useCaseIncluded { get; internal set; }
