...
namespace SysML2.NET.Core.DTO.Systems.Requirements
{
    ...
    public partial class ActorMembership : IActorMembership
    {
        ...
        Guid Core.Types.IFeatureMembership.ownedMemberFeature => ((SysML2.NET.Core.DTO.Kernel.Behaviors.IParameterMembership)this).ownedMemberParameter;
        ...
        Guid Kernel.Behaviors.IParameterMembership.ownedMemberParameter => this.ownedActorParameter;
