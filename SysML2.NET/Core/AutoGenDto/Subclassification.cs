...
namespace SysML2.NET.Core.DTO.Core.Classifiers
{
    using System;
    ...
    public partial class Subclassification : ISubclassification
    {
        ...
        {
            get => throw new InvalidOperationException("Redefined by property ISubclassification.Superclassifier");
            set => throw new InvalidOperationException("Redefined by property ISubclassification.Superclassifier");
        }
        ...
        public Guid? owningClassifier { get; internal set; }
        ...
        Guid? Core.Types.ISpecialization.owningType => throw new InvalidOperationException("Redefined by property ISubclassification.OwningClassifier");
        ...
        {
            get => throw new InvalidOperationException("Redefined by property ISubclassification.Subclassifier");
            set => throw new InvalidOperationException("Redefined by property ISubclassification.Subclassifier");
        }
