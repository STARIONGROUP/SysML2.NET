// -------------------------------------------------------------------------------------------------
// <copyright file="SuccessionFlow.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.DTO.Kernel.Interactions
{
    ...
    public partial class SuccessionFlow : ISuccessionFlow
    {
        /// <summary>
        ...
        public List<Guid> interaction { get; internal set; }
