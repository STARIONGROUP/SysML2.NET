...
namespace SysML2.NET.Core.DTO.Kernel.Functions
{
    ...
    public partial class ResultExpressionMembership : IResultExpressionMembership
    {
        ...
        Guid Core.Types.IFeatureMembership.ownedMemberFeature => throw new InvalidOperationException("Redefined by property IResultExpressionMembership.OwnedResultExpression");
        ...
        public Guid ownedResultExpression { get; internal set; }
