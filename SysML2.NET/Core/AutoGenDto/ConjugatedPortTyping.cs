...
namespace SysML2.NET.Core.DTO.Systems.Ports
{
    ...
    public partial class ConjugatedPortTyping : IConjugatedPortTyping
    {
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IFeatureTyping.Type");
            set => throw new InvalidOperationException("Redefined by property IFeatureTyping.Type");
        }
        ...
        Guid? Core.Types.ISpecialization.owningType => throw new InvalidOperationException("Redefined by property IFeatureTyping.OwningFeature");
        ...
        public Guid portDefinition { get; internal set; }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IFeatureTyping.TypedFeature");
            set => throw new InvalidOperationException("Redefined by property IFeatureTyping.TypedFeature");
        }
        ...
        Guid Core.Features.IFeatureTyping.Type
        {
            get => throw new InvalidOperationException("Redefined by property IConjugatedPortTyping.ConjugatedPortDefinition");
            set => throw new InvalidOperationException("Redefined by property IConjugatedPortTyping.ConjugatedPortDefinition");
        }
