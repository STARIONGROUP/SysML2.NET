...
namespace SysML2.NET.Core.DTO.Kernel.Expressions
{
    ...
    public partial class CollectExpression : ICollectExpression
    {
        ...
        {
            get => throw new InvalidOperationException("Redefined by property ICollectExpression.Operator");
            set => throw new InvalidOperationException("Redefined by property ICollectExpression.Operator");
        }
