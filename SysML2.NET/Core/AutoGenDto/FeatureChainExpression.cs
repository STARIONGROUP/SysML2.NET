...
namespace SysML2.NET.Core.DTO.Kernel.Expressions
{
    ...
    public partial class FeatureChainExpression : IFeatureChainExpression
    {
        ...
        public List<Guid> argument { get; internal set; }
        ...
        public Guid instantiatedType { get; internal set; }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IFeatureChainExpression.Operator");
            set => throw new InvalidOperationException("Redefined by property IFeatureChainExpression.Operator");
        }
        ...
        public Guid targetFeature { get; internal set; }
