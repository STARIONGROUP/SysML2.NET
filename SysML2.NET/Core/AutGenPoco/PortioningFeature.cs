// -------------------------------------------------------------------------------------------------
// <copyright file="PortioningFeature.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Core.POCO
{
    ...
    public partial class PortioningFeature : IPortioningFeature
    {
        ...
        /// <summary>
        /// Queries the derived property PortionKind
        /// </summary>
        public PortionKind QueryPortionKind()
        {
            throw new NotImplementedException("Derived property PortionKind not yet supported");
        }
