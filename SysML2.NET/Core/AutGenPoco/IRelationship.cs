...
namespace SysML2.NET.Core.POCO
{
    ...
    /// <summary>
    /// A Relationship is an Element that relates other Elements. Some of its relatedElements may be owned,
    ...
    /// Elements must be derived from underlying reified Relationships.relatedElement =
    /// source->union(target)
    /// </summary>
    public partial interface IRelationship : IElement
    {
        ...
        /// </summary>
        List<Element> OwnedRelatedElement { get; set; }

        /// <summary>
        /// The relatedElement of this Relationship that owns the Relationship, if any.
        /// </summary>
        Element OwningRelatedElement { get; set; }

        /// <summary>
        /// Queries the derived property RelatedElement
        /// </summary>
        List<Element> QueryRelatedElement();
