...
namespace SysML2.NET.Core.POCO
{
    ...
    /// <summary>
    /// A Relationship is an Element that relates other Element<s code="">. Some of its relatedElements may
    /// be owned, in which case those ownedRelatedElements will be deleted from a model if their
    ...
    /// owningRelatedElement of the Relationship.</s>The relatedElements of a Relationship are divided into
    ...
    /// &quot;relationship Element&quot; in the abstract syntax is generically any Element that is an
    /// instance of either Relationship or a direct or indirect specialization of Relationship. Any other
    /// kind of Element is a &quot;non-relationship Element&quot;. It is a convention of that
    /// non-relationship Elements are only related via reified relationship Elements. Any meta-associations
    /// directly between non-relationship Elements must be derived from underlying reified
    /// Relationship.relatedElement = source->union(target)
    /// </summary>
