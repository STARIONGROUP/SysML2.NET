// -------------------------------------------------------------------------------------------------
// <copyright file="ConjugatedPortDefinition.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Core.POCO
{
    ...
    public partial class ConjugatedPortDefinition : IConjugatedPortDefinition
    {
        ...
        /// </summary>
        public PortDefinition QueryOriginalPortDefinition()
        {
        ...
        /// </summary>
        public PortConjugation QueryOwnedPortConjugator()
        {
