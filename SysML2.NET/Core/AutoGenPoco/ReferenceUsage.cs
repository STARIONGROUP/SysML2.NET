...
namespace SysML2.NET.Core.POCO.Systems.DefinitionAndUsage
{
    ...
    public partial class ReferenceUsage : IReferenceUsage, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="ReferenceUsage" />
        /// </summary>
        ...
        public bool isReference => ((IUsage)this).isReference;
        ...
        bool IUsage.isReference => this.ComputeIsReference();
