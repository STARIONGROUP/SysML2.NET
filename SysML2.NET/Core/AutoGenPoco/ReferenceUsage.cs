// -------------------------------------------------------------------------------------------------
// <copyright file="ReferenceUsage.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.POCO.Systems.DefinitionAndUsage
{
    ...
    public partial class ReferenceUsage : IReferenceUsage
    {
        ...
        [Implements(implementation: "IReferenceUsage.IsReference")]
        bool IReferenceUsage.QueryIsReference()
        {
