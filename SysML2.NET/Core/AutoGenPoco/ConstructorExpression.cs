...
namespace SysML2.NET.Core.POCO.Kernel.Expressions
{
    ...
    public partial class ConstructorExpression : IConstructorExpression, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="ConstructorExpression" />
        /// </summary>
        ...
        public IFunction function => ((SysML2.NET.Core.POCO.Kernel.Behaviors.IStep)this).behavior.OfType<IFunction>().SingleOrDefaultStrict(nameof(ConstructorExpression));
        ...
        /// Type.<b>Note.</b> This operation is overridden in the subclass OperatorExpression.
        /// </summary>
        /// <returns>
