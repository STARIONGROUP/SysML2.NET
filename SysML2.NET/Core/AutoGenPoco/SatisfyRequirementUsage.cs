...
namespace SysML2.NET.Core.POCO.Systems.Requirements
{
    ...
    public partial class SatisfyRequirementUsage : ISatisfyRequirementUsage
    {
        ...
        IConstraintUsage Systems.Constraints.IAssertConstraintUsage.assertedConstraint => throw new InvalidOperationException("Redefined by property ISatisfyRequirementUsage.SatisfiedRequirement");
        ...
        IPredicate Systems.Constraints.IConstraintUsage.constraintDefinition => throw new InvalidOperationException("Redefined by property IRequirementUsage.RequirementDefinition");
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IRequirementUsage.ReqId");
            set => throw new InvalidOperationException("Redefined by property IRequirementUsage.ReqId");
        }
        ...
        IFunction Kernel.Functions.IExpression.function => throw new InvalidOperationException("Redefined by property IBooleanExpression.Predicate");
        ...
        IPredicate Kernel.Functions.IBooleanExpression.predicate => throw new InvalidOperationException("Redefined by property IConstraintUsage.ConstraintDefinition");
        ...
        public IRequirementDefinition requirementDefinition => this.ComputeRequirementDefinition();
        ...
        public IRequirementUsage satisfiedRequirement => this.ComputeSatisfiedRequirement();
        ...
        public IFeature satisfyingFeature => this.ComputeSatisfyingFeature();
