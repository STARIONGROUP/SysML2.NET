...
namespace SysML2.NET.Core.POCO.Kernel.Expressions
{
    ...
    public partial class MetadataAccessExpression : IMetadataAccessExpression, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="MetadataAccessExpression" />
        /// </summary>
        ...
        public IFunction function => ((SysML2.NET.Core.POCO.Kernel.Behaviors.IStep)this).behavior.OfType<IFunction>().SingleOrDefaultStrict(nameof(MetadataAccessExpression));
        ...
        public IElement referencedElement => this.ComputeReferencedElement();
