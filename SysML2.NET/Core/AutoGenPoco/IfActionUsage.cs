// -------------------------------------------------------------------------------------------------
// <copyright file="IfActionUsage.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.POCO.Systems.Actions
{
    ...
    public partial class IfActionUsage : IIfActionUsage
    {
        ...
        [Implements(implementation: "IIfActionUsage.ElseAction")]
        public IActionUsage QueryElseAction()
        {
            return this.ComputeElseAction();
        }
        ...
        [Implements(implementation: "IIfActionUsage.IfArgument")]
        public IExpression QueryIfArgument()
        {
            return this.ComputeIfArgument();
        }
        ...
        [Implements(implementation: "IIfActionUsage.ThenAction")]
        public IActionUsage QueryThenAction()
        {
            return this.ComputeThenAction();
        }
