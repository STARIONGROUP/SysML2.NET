...
namespace SysML2.NET.Core.POCO.Systems.Actions
{
    ...
    public partial class IfActionUsage : IIfActionUsage
    {
        ...
        {
            throw new NotImplementedException("Derived property ElseAction not yet supported");
        }
        ...
        {
            throw new NotImplementedException("Derived property IfArgument not yet supported");
        }
        ...
        {
            throw new NotImplementedException("Derived property ThenAction not yet supported");
        }
