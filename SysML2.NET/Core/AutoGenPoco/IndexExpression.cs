...
namespace SysML2.NET.Core.POCO.Kernel.Expressions
{
    ...
    public partial class IndexExpression : IIndexExpression, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="IndexExpression" />
        /// </summary>
        ...
        public IFunction function => ((SysML2.NET.Core.POCO.Kernel.Behaviors.IStep)this).behavior.OfType<IFunction>().SingleOrDefaultStrict(nameof(IndexExpression));
