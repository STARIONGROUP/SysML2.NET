// -------------------------------------------------------------------------------------------------
// <copyright file="InterfaceDefinition.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.POCO.Systems.Interfaces
{
    ...
    public partial class InterfaceDefinition : IInterfaceDefinition
    {
        ...
        [Implements(implementation: "IInterfaceDefinition.InterfaceEnd")]
        public List<IPortUsage> QueryInterfaceEnd()
        {
            return this.ComputeInterfaceEnd();
        }
