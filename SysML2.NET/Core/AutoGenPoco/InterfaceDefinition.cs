...
namespace SysML2.NET.Core.POCO.Systems.Interfaces
{
    ...
    public partial class InterfaceDefinition : IInterfaceDefinition, IContainedRelationship
    {
        /// <summary>
        /// Initialize a new instance of <see cref="InterfaceDefinition" />
        /// </summary>
        ...
        List<IUsage> Systems.Connections.IConnectionDefinition.connectionEnd => [.. ((SysML2.NET.Core.POCO.Kernel.Associations.IAssociation)this).associationEnd.OfType<IUsage>()];
        ...
        public List<IPortUsage> interfaceEnd => [.. ((SysML2.NET.Core.POCO.Systems.Connections.IConnectionDefinition)this).connectionEnd.OfType<IPortUsage>()];
        ...
        public IType sourceType => ((SysML2.NET.Core.POCO.Root.Elements.IRelationship)this).Source.OfType<IType>().SingleOrDefaultStrict(nameof(InterfaceDefinition));
