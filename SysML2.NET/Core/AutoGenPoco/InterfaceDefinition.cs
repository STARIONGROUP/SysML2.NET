...
namespace SysML2.NET.Core.POCO.Systems.Interfaces
{
    ...
    public partial class InterfaceDefinition : IInterfaceDefinition
    {
        ...
        List<IFeature> Kernel.Associations.IAssociation.associationEnd => throw new InvalidOperationException("Redefined by property IConnectionDefinition.ConnectionEnd");
        ...
        List<IUsage> Systems.Connections.IConnectionDefinition.connectionEnd => throw new InvalidOperationException("Redefined by property IInterfaceDefinition.InterfaceEnd");
        ...
        List<IFeature> Core.Types.IType.endFeature => throw new InvalidOperationException("Redefined by property IAssociation.AssociationEnd");
        ...
        public List<IPortUsage> interfaceEnd => this.ComputeInterfaceEnd();
        ...
        List<IElement> Root.Elements.IRelationship.relatedElement => throw new InvalidOperationException("Redefined by property IAssociation.RelatedType");
