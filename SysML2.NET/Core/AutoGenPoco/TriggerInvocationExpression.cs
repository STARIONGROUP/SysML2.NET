...
namespace SysML2.NET.Core.POCO.Systems.Actions
{
    ...
    public partial class TriggerInvocationExpression : ITriggerInvocationExpression, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="TriggerInvocationExpression" />
        /// </summary>
