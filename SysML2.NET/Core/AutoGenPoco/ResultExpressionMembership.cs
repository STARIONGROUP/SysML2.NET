...
namespace SysML2.NET.Core.POCO.Kernel.Functions
{
    ...
    public partial class ResultExpressionMembership : IResultExpressionMembership
    {
        ...
        IFeature Core.Types.IFeatureMembership.ownedMemberFeature => throw new InvalidOperationException("Redefined by property IResultExpressionMembership.OwnedResultExpression");
        ...
        public IExpression ownedResultExpression => this.ComputeOwnedResultExpression();
