...
namespace SysML2.NET.Core.POCO.Systems.Views
{
    ...
    public partial class ViewpointUsage : IViewpointUsage
    {
        ...
        IRequirementDefinition Systems.Requirements.IRequirementUsage.requirementDefinition => throw new InvalidOperationException("Redefined by property IViewpointUsage.ViewpointDefinition");
