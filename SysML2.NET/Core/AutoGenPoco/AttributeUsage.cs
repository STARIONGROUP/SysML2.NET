...
namespace SysML2.NET.Core.POCO.Systems.Attributes
{
    ...
    public partial class AttributeUsage : IAttributeUsage, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="AttributeUsage" />
        /// </summary>
        ...
        public List<IDataType> attributeDefinition => [.. ((SysML2.NET.Core.POCO.Systems.DefinitionAndUsage.IUsage)this).definition.OfType<IDataType>()];
