// -------------------------------------------------------------------------------------------------
// <copyright file="FlowConnectionUsage.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.POCO
{
    ...
    /// </summary>
    public partial class FlowConnectionUsage : IFlowConnectionUsage
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FlowConnectionUsage"/> class.
        /// </summary>
        ...
        /// </summary>
        [EFeature(isChangeable: true, isVolatile: true, isTransient: true, isUnsettable: false, isDerived: true, isOrdered: true, isUnique: true, lowerBound: 0, upperBound: -1, isMany: false, isRequired: false, isContainment: false)]
        public List<Interaction> QueryFlowConnectionDefinition()
        {
            throw new NotImplementedException("Derived property FlowConnectionDefinition not yet supported");
        }
