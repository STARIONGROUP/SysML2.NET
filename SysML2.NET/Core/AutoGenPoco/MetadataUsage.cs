...
namespace SysML2.NET.Core.POCO.Systems.Metadata
{
    ...
    public partial class MetadataUsage : IMetadataUsage
    {
        ...
        {
            throw new NotImplementedException("Derived property Metaclass not yet supported");
        }
        ...
        public
         IMetaclass QueryMetadataDefinition()
        {
            throw new NotImplementedException("Derived property MetadataDefinition not yet supported");
        }
