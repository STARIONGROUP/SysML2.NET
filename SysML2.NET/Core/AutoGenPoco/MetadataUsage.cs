...
namespace SysML2.NET.Core.POCO.Systems.Metadata
{
    ...
    public partial class MetadataUsage : IMetadataUsage
    {
        ...
        List<IStructure> Systems.Items.IItemUsage.itemDefinition => throw new InvalidOperationException("Redefined by property IMetadataUsage.MetadataDefinition");
        ...
        IMetaclass Kernel.Metadata.IMetadataFeature.metaclass => throw new InvalidOperationException("Redefined by property IMetadataUsage.MetadataDefinition");
