// -------------------------------------------------------------------------------------------------
// <copyright file="MetadataUsage.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.POCO.Systems.Metadata
{
    ...
    public partial class MetadataUsage : IMetadataUsage
    {
        ...
        {
            return this.ComputeAnnotatedElement();
        }
        ...
        public IMetaclass QueryMetaclass()
        {
            return this.ComputeMetaclass();
        }
        ...
        public IMetaclass QueryMetadataDefinition()
        {
            return this.ComputeMetadataDefinition();
        }
        ...
        {
            return this.ComputeOwnedAnnotatingRelationship();
        }
        ...
        {
            return this.ComputeOwningAnnotatingRelationship();
        }
