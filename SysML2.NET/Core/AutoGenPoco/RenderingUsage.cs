// -------------------------------------------------------------------------------------------------
// <copyright file="RenderingUsage.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.POCO.Systems.Views
{
    ...
    public partial class RenderingUsage : IRenderingUsage
    {
        /// <summary>
        ...
        [RedefinedByProperty("IRenderingUsage.RenderingDefinition")]
        ...
        [Implements(implementation: "IRenderingUsage.RenderingDefinition")]
        public IRenderingDefinition QueryRenderingDefinition()
        {
            return this.ComputeRenderingDefinition();
        }
