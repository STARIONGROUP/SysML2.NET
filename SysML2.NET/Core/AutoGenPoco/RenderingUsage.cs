...
namespace SysML2.NET.Core.POCO.Systems.Views
{
    ...
    public partial class RenderingUsage : IRenderingUsage
    {
        ...
        List<IPartDefinition> Systems.Parts.IPartUsage.partDefinition => throw new InvalidOperationException("Redefined by property IRenderingUsage.RenderingDefinition");
