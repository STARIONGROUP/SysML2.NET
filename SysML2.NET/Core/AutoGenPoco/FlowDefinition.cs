...
namespace SysML2.NET.Core.POCO.Systems.Flows
{
    ...
    public partial class FlowDefinition : IFlowDefinition
    {
        ...
        public List<IActionUsage> action => this.ComputeAction();
        ...
        List<IFeature> Kernel.Associations.IAssociation.associationEnd => throw new InvalidOperationException("Redefined by property IFlowDefinition.FlowEnd");
        ...
        List<IFeature> Core.Types.IType.directedFeature => throw new InvalidOperationException("Redefined by property IBehavior.Parameter");
        ...
        public List<IUsage> flowEnd => this.ComputeFlowEnd();
