...
namespace SysML2.NET.Core.POCO.Systems.Cases
{
    ...
    public partial class ObjectiveMembership : IObjectiveMembership
    {
        ...
        IFeature Core.Types.IFeatureMembership.ownedMemberFeature => throw new InvalidOperationException("Redefined by property IObjectiveMembership.OwnedObjectiveRequirement");
