// -------------------------------------------------------------------------------------------------
// <copyright file="ObjectiveMembership.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.POCO.Systems.Cases
{
    ...
    public partial class ObjectiveMembership : IObjectiveMembership
    {
        ...
        public IRequirementUsage QueryOwnedObjectiveRequirement()
        {
            throw new NotImplementedException("Derived property OwnedObjectiveRequirement not yet supported");
        }
