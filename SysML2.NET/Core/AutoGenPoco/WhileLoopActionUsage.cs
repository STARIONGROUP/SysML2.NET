// -------------------------------------------------------------------------------------------------
// <copyright file="WhileLoopActionUsage.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.POCO.Systems.Actions
{
    ...
    public partial class WhileLoopActionUsage : IWhileLoopActionUsage
    {
        ...
        [Implements(implementation: "ILoopActionUsage.BodyAction")]
        public IActionUsage QueryBodyAction()
        {
            return this.ComputeBodyAction();
        }
        ...
        [Implements(implementation: "IWhileLoopActionUsage.UntilArgument")]
        public IExpression QueryUntilArgument()
        {
            return this.ComputeUntilArgument();
        }
        ...
        public IExpression QueryWhileArgument()
        {
            return this.ComputeWhileArgument();
        }
