...
namespace SysML2.NET.Core.POCO.Systems.Actions
{
    ...
    public partial class WhileLoopActionUsage : IWhileLoopActionUsage
    {
        ...
        {
            throw new NotImplementedException("Derived property UntilArgument not yet supported");
        }
        ...
        {
            throw new NotImplementedException("Derived property WhileArgument not yet supported");
        }
