...
namespace SysML2.NET.Core.POCO.Core.Types
{
    ...
    public partial class Specialization : ISpecialization, IContainedRelationship
    {
        /// <summary>
        /// Initialize a new instance of <see cref="Specialization" />
        /// </summary>
        ...
        {
            get => this.Specific != null ? [this.Specific] : [];
            set
            {
                if (value.OfType<IType>().FirstOrDefault() is { } firstValue)
                {
                    this.Specific = firstValue;
                }
            }
        }
        ...
        {
            get => this.General != null ? [this.General] : [];
            set
            {
                if (value.OfType<IType>().FirstOrDefault() is { } firstValue)
                {
                    this.General = firstValue;
                }
            }
        }
