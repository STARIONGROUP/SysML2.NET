...
namespace SysML2.NET.Core.POCO.Systems.Views
{
    ...
    public partial class NamespaceExpose : INamespaceExpose, IContainedRelationship
    {
        /// <summary>
        /// Initialize a new instance of <see cref="NamespaceExpose" />
        /// </summary>
        ...
        public INamespace importOwningNamespace => ((SysML2.NET.Core.POCO.Root.Elements.IRelationship)this).Source.OfType<INamespace>().SingleOrDefaultStrict(nameof(NamespaceExpose));
