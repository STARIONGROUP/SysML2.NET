...
namespace SysML2.NET.Core.POCO.Kernel.DataTypes
{
    using System;
    ...
    public partial class DataType : IDataType, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="DataType" />
        /// </summary>
        public DataType()
        {
