...
namespace SysML2.NET.Core.POCO.Systems.VerificationCases
{
    ...
    public partial class RequirementVerificationMembership : IRequirementVerificationMembership
    {
        ...
        [RedefinedByProperty("IRequirementVerificationMembership.Kind")] RequirementConstraintKind Systems.Requirements.IRequirementConstraintMembership.Kind { get; set; }
        ...
        public IConstraintUsage QueryOwnedConstraint()
        {
        ...
        public IRequirementUsage QueryOwnedRequirement()
        {
        ...
        public IConstraintUsage QueryReferencedConstraint()
        {
        ...
        public IRequirementUsage QueryVerifiedRequirement()
        {
