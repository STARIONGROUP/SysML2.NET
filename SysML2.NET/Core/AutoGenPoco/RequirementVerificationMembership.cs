...
namespace SysML2.NET.Core.POCO.Systems.VerificationCases
{
    ...
    public partial class RequirementVerificationMembership : IRequirementVerificationMembership
    {
        ...
        IConstraintUsage Systems.Requirements.IRequirementConstraintMembership.ownedConstraint => throw new InvalidOperationException("Redefined by property IRequirementVerificationMembership.OwnedRequirement");
        ...
        IFeature Core.Types.IFeatureMembership.ownedMemberFeature => throw new InvalidOperationException("Redefined by property IRequirementConstraintMembership.OwnedConstraint");
        ...
        public IRequirementUsage ownedRequirement => this.ComputeOwnedRequirement();
        ...
        IConstraintUsage Systems.Requirements.IRequirementConstraintMembership.referencedConstraint => throw new InvalidOperationException("Redefined by property IRequirementVerificationMembership.VerifiedRequirement");
        ...
        public IRequirementUsage verifiedRequirement => this.ComputeVerifiedRequirement();
