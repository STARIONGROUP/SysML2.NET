...
namespace SysML2.NET.Core.POCO.Core.Types
{
    ...
    public partial class Unioning : IUnioning, IContainedRelationship
    {
        /// <summary>
        /// Initialize a new instance of <see cref="Unioning" />
        /// </summary>
        public Unioning()
        {
        ...
        {
            get => this.typeUnioned != null ? [this.typeUnioned] : [];
            set { }
        }
        ...
        {
            get => this.UnioningType != null ? [this.UnioningType] : [];
            set
            {
                if (value.OfType<IType>().FirstOrDefault() is { } firstValue)
                {
                    this.UnioningType = firstValue;
                }
            }
        }
