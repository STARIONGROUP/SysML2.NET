...
namespace SysML2.NET.Core.POCO.Kernel.Functions
{
    ...
    public partial class Expression : IExpression, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="Expression" />
        /// </summary>
        public Expression()
        {
        ...
        public IFunction function => ((SysML2.NET.Core.POCO.Kernel.Behaviors.IStep)this).behavior.OfType<IFunction>().SingleOrDefaultStrict(nameof(Expression));
