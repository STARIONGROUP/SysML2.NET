...
namespace SysML2.NET.Core.POCO.Kernel.Associations
{
    ...
    public partial class AssociationStructure : IAssociationStructure, IContainedRelationship
    {
        /// <summary>
        /// Initialize a new instance of <see cref="AssociationStructure" />
        /// </summary>
        ...
        public IType sourceType => ((SysML2.NET.Core.POCO.Root.Elements.IRelationship)this).Source.OfType<IType>().SingleOrDefaultStrict(nameof(AssociationStructure));
