...
namespace SysML2.NET.Core.POCO.Kernel.Interactions
{
    ...
    public partial class Interaction : IInteraction, IContainedRelationship
    {
        /// <summary>
        /// Initialize a new instance of <see cref="Interaction" />
        /// </summary>
        public Interaction()
        {
        ...
        public IType sourceType => ((SysML2.NET.Core.POCO.Root.Elements.IRelationship)this).Source.OfType<IType>().SingleOrDefaultStrict(nameof(Interaction));
