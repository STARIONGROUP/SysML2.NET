...
namespace SysML2.NET.Core.POCO.Kernel.Expressions
{
    ...
    public partial class OperatorExpression : IOperatorExpression, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="OperatorExpression" />
        /// </summary>
        ...
        public IFunction function => ((SysML2.NET.Core.POCO.Kernel.Behaviors.IStep)this).behavior.OfType<IFunction>().SingleOrDefaultStrict(nameof(OperatorExpression));
