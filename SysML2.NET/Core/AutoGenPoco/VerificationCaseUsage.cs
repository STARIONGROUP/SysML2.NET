...
namespace SysML2.NET.Core.POCO.Systems.VerificationCases
{
    ...
    public partial class VerificationCaseUsage : IVerificationCaseUsage, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="VerificationCaseUsage" />
        /// </summary>
        ...
        public ICaseDefinition caseDefinition => ((SysML2.NET.Core.POCO.Systems.Calculations.ICalculationUsage)this).calculationDefinition as ICaseDefinition;
        ...
        IFunction Kernel.Functions.IExpression.function => ((SysML2.NET.Core.POCO.Kernel.Behaviors.IStep)this).behavior.OfType<IFunction>().SingleOrDefaultStrict(nameof(VerificationCaseUsage));
