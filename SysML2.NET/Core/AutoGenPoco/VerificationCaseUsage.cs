...
namespace SysML2.NET.Core.POCO.Systems.VerificationCases
{
    ...
    public partial class VerificationCaseUsage : IVerificationCaseUsage
    {
        ...
        public
         IVerificationCaseDefinition QueryVerificationCaseDefinition()
        {
            throw new NotImplementedException("Derived property VerificationCaseDefinition not yet supported");
        }
        ...
        {
            throw new NotImplementedException("Derived property VerifiedRequirement not yet supported");
        }
