// -------------------------------------------------------------------------------------------------
// <copyright file="VerificationCaseUsage.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.POCO.Systems.VerificationCases
{
    ...
    public partial class VerificationCaseUsage : IVerificationCaseUsage
    {
        ...
        [Implements(implementation: "IVerificationCaseUsage.VerificationCaseDefinition")]
        public IVerificationCaseDefinition QueryVerificationCaseDefinition()
        {
            return this.ComputeVerificationCaseDefinition();
        }
