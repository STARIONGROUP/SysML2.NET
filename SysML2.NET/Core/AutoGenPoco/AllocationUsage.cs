...
namespace SysML2.NET.Core.POCO.Systems.Allocations
{
    ...
    public partial class AllocationUsage : IAllocationUsage
    {
        ...
        public List<IAllocationDefinition> allocationDefinition => this.ComputeAllocationDefinition();
        ...
        List<IAssociation> Kernel.Connectors.IConnector.association => throw new InvalidOperationException("Redefined by property IConnectionUsage.ConnectionDefinition");
        ...
        List<IAssociationStructure> Systems.Connections.IConnectionUsage.connectionDefinition => throw new InvalidOperationException("Redefined by property IAllocationUsage.AllocationDefinition");
        ...
        public List<IPartDefinition> partDefinition => this.ComputePartDefinition();
