// -------------------------------------------------------------------------------------------------
// <copyright file="AllocationUsage.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Core.POCO
{
    ...
    /// AllocatopnUsage allocations from the Systems model
    /// library.specializesFromLibrary("Allocations::allocations")
    /// </summary>
    public partial class AllocationUsage : IAllocationUsage
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllocationUsage"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Queries the derived property AllocationDefinition
        /// </summary>
        [EFeature(isChangeable: true, isVolatile: true, isTransient: true, isUnsettable: false, isDerived: true, isOrdered: true, isUnique: true, lowerBound: 0, upperBound: -1, isMany: false, isRequired: false, isContainment: false)]
        public List<AllocationDefinition> QueryAllocationDefinition()
        {
