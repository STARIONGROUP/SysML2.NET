// -------------------------------------------------------------------------------------------------
// <copyright file="AllocationUsage.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.POCO.Systems.Allocations
{
    ...
    public partial class AllocationUsage : IAllocationUsage
    {
        /// <summary>
        ...
        [Implements(implementation: "IAllocationUsage.AllocationDefinition")]
        public List<IAllocationDefinition> QueryAllocationDefinition()
        {
            return this.ComputeAllocationDefinition();
        }
        ...
        {
            return this.ComputeAssociation();
        }
        ...
        public List<IAssociationStructure> QueryConnectionDefinition()
        {
            return this.ComputeConnectionDefinition();
        }
        ...
        {
            return this.ComputeConnectorEnd();
        }
        ...
        {
            return this.ComputeDefaultFeaturingType();
        }
        ...
        public List<IStructure> QueryItemDefinition()
        {
            return this.ComputeItemDefinition();
        }
        ...
        public List<IPartDefinition> QueryPartDefinition()
        {
            return this.ComputePartDefinition();
        }
        ...
        {
            return this.ComputeRelatedFeature();
        }
        ...
        {
            return this.ComputeTargetFeature();
        }
