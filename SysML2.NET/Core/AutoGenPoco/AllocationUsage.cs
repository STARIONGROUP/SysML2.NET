...
namespace SysML2.NET.Core.POCO.Systems.Allocations
{
    ...
    public partial class AllocationUsage : IAllocationUsage, IContainedRelationship
    {
        /// <summary>
        /// Initialize a new instance of <see cref="AllocationUsage" />
        /// </summary>
        ...
        public List<IAllocationDefinition> allocationDefinition => [.. ((SysML2.NET.Core.POCO.Systems.Connections.IConnectionUsage)this).connectionDefinition.OfType<IAllocationDefinition>()];
        ...
        List<IAssociationStructure> Systems.Connections.IConnectionUsage.connectionDefinition => [.. ((SysML2.NET.Core.POCO.Kernel.Connectors.IConnector)this).association.OfType<IAssociationStructure>()];
        ...
        public IFeature sourceFeature => ((SysML2.NET.Core.POCO.Root.Elements.IRelationship)this).Source.OfType<IFeature>().SingleOrDefaultStrict(nameof(AllocationUsage));
