...
namespace SysML2.NET.Core.POCO.Systems.Views
{
    ...
    /// </summary>
    [Class(xmiId: "Systems-Views-ViewDefinition", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    ...
    public partial class ViewDefinition : IViewDefinition
    {
        ...
        /// </summary>
        [Property(xmiId: "Systems-Views-ViewDefinition-satisfiedViewpoint", aggregation: AggregationKind.None, lowerValue: 0, upperValue: -1, isOrdered: true, isReadOnly: false, isDerived: true, isDerivedUnion: false, isUnique: true, defaultValue: null)]
        [SubsettedProperty(propertyName: "Systems-DefinitionAndUsage-Definition-ownedRequirement")]
        [Implements(implementation: "IViewDefinition.SatisfiedViewpoint")]
        public List<IViewpointUsage> satisfiedViewpoint => this.ComputeSatisfiedViewpoint();
        ...
        /// </summary>
        [Property(xmiId: "Systems-Views-ViewDefinition-view", aggregation: AggregationKind.None, lowerValue: 0, upperValue: -1, isOrdered: true, isReadOnly: false, isDerived: true, isDerivedUnion: false, isUnique: true, defaultValue: null)]
        [SubsettedProperty(propertyName: "Systems-DefinitionAndUsage-Definition-usage")]
        [Implements(implementation: "IViewDefinition.View")]
        public List<IViewUsage> view => this.ComputeView();
        ...
        /// </summary>
        [Property(xmiId: "Systems-Views-ViewDefinition-viewCondition", aggregation: AggregationKind.None, lowerValue: 0, upperValue: -1, isOrdered: true, isReadOnly: false, isDerived: true, isDerivedUnion: false, isUnique: true, defaultValue: null)]
        [SubsettedProperty(propertyName: "Root-Namespaces-Namespace-ownedMember")]
        [Implements(implementation: "IViewDefinition.ViewCondition")]
        public List<IExpression> viewCondition => this.ComputeViewCondition();
        ...
        /// </summary>
        [Property(xmiId: "Systems-Views-ViewDefinition-viewRendering", aggregation: AggregationKind.None, lowerValue: 0, upperValue: 1, isOrdered: false, isReadOnly: false, isDerived: true, isDerivedUnion: false, isUnique: true, defaultValue: null)]
