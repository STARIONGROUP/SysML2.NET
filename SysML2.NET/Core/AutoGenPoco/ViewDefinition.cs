...
namespace SysML2.NET.Core.POCO.Systems.Views
{
    ...
    public partial class ViewDefinition : IViewDefinition
    {
        ...
        {
            throw new NotImplementedException("Derived property SatisfiedViewpoint not yet supported");
        }
        ...
        {
            throw new NotImplementedException("Derived property View not yet supported");
        }
        ...
        {
            throw new NotImplementedException("Derived property ViewCondition not yet supported");
        }
        ...
        {
            throw new NotImplementedException("Derived property ViewRendering not yet supported");
        }
