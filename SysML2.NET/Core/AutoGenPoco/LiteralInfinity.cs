...
namespace SysML2.NET.Core.POCO.Kernel.Expressions
{
    ...
    public partial class LiteralInfinity : ILiteralInfinity, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="LiteralInfinity" />
        /// </summary>
        ...
        public IFunction function => ((SysML2.NET.Core.POCO.Kernel.Behaviors.IStep)this).behavior.OfType<IFunction>().SingleOrDefaultStrict(nameof(LiteralInfinity));
