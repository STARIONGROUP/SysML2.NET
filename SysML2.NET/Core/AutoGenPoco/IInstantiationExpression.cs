...
namespace SysML2.NET.Core.POCO
{
    ...
    /// abstract, with concrete subclasses InvocationExpression and ConstructorExpression.result.owningType
    /// = selfinstantiatedType = instantiatedType()instantiatedType() <> null
    /// </summary>
