...
namespace SysML2.NET.Core.POCO.Systems.UseCases
{
    ...
    public partial class UseCaseDefinition : IUseCaseDefinition
    {
        ...
        public List<ICalculationUsage> QueryCalculation()
        {
        ...
        [Implements(implementation: "IUseCaseDefinition.IncludedUseCase")]
        public List<IUseCaseUsage> QueryIncludedUseCase()
        {
            return this.ComputeIncludedUseCase();
        }
        ...
        public IRequirementUsage QueryObjectiveRequirement()
        {
            return this.ComputeObjectiveRequirement();
        }
