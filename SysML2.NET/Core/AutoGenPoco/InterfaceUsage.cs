// -------------------------------------------------------------------------------------------------
// <copyright file="InterfaceUsage.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.POCO.Systems.Interfaces
{
    ...
    public partial class InterfaceUsage : IInterfaceUsage
    {
        /// <summary>
        ...
        [Implements(implementation: "IInterfaceUsage.InterfaceDefinition")]
        public List<IInterfaceDefinition> QueryInterfaceDefinition()
        {
            return this.ComputeInterfaceDefinition();
        }
