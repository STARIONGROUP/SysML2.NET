...
namespace SysML2.NET.Core.POCO.Systems.Interfaces
{
    ...
    public partial class InterfaceUsage : IInterfaceUsage, IContainedRelationship
    {
        /// <summary>
        /// Initialize a new instance of <see cref="InterfaceUsage" />
        /// </summary>
        ...
        public List<IInterfaceDefinition> interfaceDefinition => [.. ((SysML2.NET.Core.POCO.Systems.Connections.IConnectionUsage)this).connectionDefinition.OfType<IInterfaceDefinition>()];
        ...
        public IFeature sourceFeature => ((SysML2.NET.Core.POCO.Root.Elements.IRelationship)this).Source.OfType<IFeature>().SingleOrDefaultStrict(nameof(InterfaceUsage));
