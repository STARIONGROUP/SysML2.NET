...
namespace SysML2.NET.Core.POCO.Systems.Interfaces
{
    ...
    public partial class InterfaceUsage : IInterfaceUsage
    {
        ...
        List<IAssociationStructure> Systems.Connections.IConnectionUsage.connectionDefinition => throw new InvalidOperationException("Redefined by property IInterfaceUsage.InterfaceDefinition");
        ...
        public List<IInterfaceDefinition> interfaceDefinition => this.ComputeInterfaceDefinition();
