...
namespace SysML2.NET.Core.POCO.Systems.Actions
{
    ...
    public partial class AssignmentActionUsage : IAssignmentActionUsage
    {
        ...
        public IFeature referent => this.ComputeReferent();
        ...
        public IExpression targetArgument => this.ComputeTargetArgument();
        ...
        public IExpression valueExpression => this.ComputeValueExpression();
