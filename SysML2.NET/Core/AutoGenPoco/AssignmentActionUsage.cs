// -------------------------------------------------------------------------------------------------
// <copyright file="AssignmentActionUsage.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.POCO.Systems.Actions
{
    ...
    public partial class AssignmentActionUsage : IAssignmentActionUsage
    {
        ...
        [SubsettedProperty(propertyName: "_18_5_3_12e503d9_1533160674979_644335_43267")]
        [Implements(implementation: "IAssignmentActionUsage.Referent")]
        public IFeature QueryReferent()
        {
            return this.ComputeReferent();
        }
        ...
        [Implements(implementation: "IAssignmentActionUsage.TargetArgument")]
        public IExpression QueryTargetArgument()
        {
            return this.ComputeTargetArgument();
        }
        ...
        [Implements(implementation: "IAssignmentActionUsage.ValueExpression")]
        public IExpression QueryValueExpression()
        {
            return this.ComputeValueExpression();
        }
