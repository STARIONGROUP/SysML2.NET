...
namespace SysML2.NET.Core.POCO.Systems.Connections
{
    ...
    public partial class SuccessionAsUsage : ISuccessionAsUsage, IContainedRelationship
    {
        /// <summary>
        /// Initialize a new instance of <see cref="SuccessionAsUsage" />
        /// </summary>
        ...
        public IFeature sourceFeature => ((SysML2.NET.Core.POCO.Root.Elements.IRelationship)this).Source.OfType<IFeature>().SingleOrDefaultStrict(nameof(SuccessionAsUsage));
