...
namespace SysML2.NET.Core.POCO.Kernel.Expressions
{
    ...
    public partial class NullExpression : INullExpression, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="NullExpression" />
        /// </summary>
        ...
        public IFunction function => ((SysML2.NET.Core.POCO.Kernel.Behaviors.IStep)this).behavior.OfType<IFunction>().SingleOrDefaultStrict(nameof(NullExpression));
