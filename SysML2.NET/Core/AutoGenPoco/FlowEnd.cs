// -------------------------------------------------------------------------------------------------
// <copyright file="FlowEnd.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.POCO.Kernel.Interactions
{
    ...
    public partial class FlowEnd : IFlowEnd, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="FlowEnd" />
        /// </summary>
        public FlowEnd()
        {
