// -------------------------------------------------------------------------------------------------
// <copyright file="IncludeUseCaseUsage.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.POCO.Systems.UseCases
{
    ...
    public partial class IncludeUseCaseUsage : IIncludeUseCaseUsage
    {
        /// <summary>
        ...
        {
            return this.ComputeActionDefinition();
        }
        ...
        public IFunction QueryCalculationDefinition()
        {
            return this.ComputeCalculationDefinition();
        }
        ...
        public ICaseDefinition QueryCaseDefinition()
        {
            return this.ComputeCaseDefinition();
        }
        ...
        public IOccurrenceUsage QueryEventOccurrence()
        {
            return this.ComputeEventOccurrence();
        }
        ...
        [Implements(implementation: "IUseCaseUsage.IncludedUseCase")]
        ...
        bool Systems.DefinitionAndUsage.IUsage.QueryIsReference()
        {
        ...
        bool Systems.Occurrences.IEventOccurrenceUsage.QueryIsReference()
        {
            return this.ComputeIsReference();
        }
        ...
        public IActionUsage QueryPerformedAction()
        {
            return this.ComputePerformedAction();
        }
        ...
        public IUseCaseDefinition QueryUseCaseDefinition()
        {
            return this.ComputeUseCaseDefinition();
        }
        ...
        public IUseCaseUsage QueryUseCaseIncluded()
        {
            return this.ComputeUseCaseIncluded();
        }
