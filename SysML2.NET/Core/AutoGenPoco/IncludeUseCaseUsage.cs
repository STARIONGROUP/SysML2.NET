...
namespace SysML2.NET.Core.POCO
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IncludeUseCaseUsage"/> class.
        /// </summary>
        ...
        public List<Behavior> QueryActionDefinition()
        {
        ...
        /// </summary>
        [EFeature(isChangeable: true, isVolatile: true, isTransient: true, isUnsettable: false, isDerived: true, isOrdered: true, isUnique: true, lowerBound: 0, upperBound: 1, isMany: false, isRequired: false, isContainment: false)]
        public Function QueryCalculationDefinition()
        {
        ...
        public CaseDefinition QueryCaseDefinition()
        {
        ...
        public OccurrenceUsage QueryEventOccurrence()
        {
        ...
        /// <summary>
        /// Queries the derived property PerformedAction
        /// </summary>
        [EFeature(isChangeable: true, isVolatile: true, isTransient: true, isUnsettable: false, isDerived: true, isOrdered: false, isUnique: true, lowerBound: 1, upperBound: 1, isMany: false, isRequired: false, isContainment: false)]
        public ActionUsage QueryPerformedAction()
        {
        ...
        /// </summary>
        [EFeature(isChangeable: true, isVolatile: true, isTransient: true, isUnsettable: false, isDerived: true, isOrdered: false, isUnique: true, lowerBound: 0, upperBound: 1, isMany: false, isRequired: false, isContainment: false)]
        public UseCaseDefinition QueryUseCaseDefinition()
        {
        ...
        /// </summary>
        [EFeature(isChangeable: true, isVolatile: true, isTransient: true, isUnsettable: false, isDerived: true, isOrdered: false, isUnique: true, lowerBound: 1, upperBound: 1, isMany: false, isRequired: false, isContainment: false)]
        public UseCaseUsage QueryUseCaseIncluded()
        {
