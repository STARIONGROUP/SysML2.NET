...
namespace SysML2.NET.Core.POCO.Systems.UseCases
{
    ...
    public partial class IncludeUseCaseUsage : IIncludeUseCaseUsage
    {
        ...
        public
         IFunction QueryCalculationDefinition()
        {
            throw new NotImplementedException("Derived property CalculationDefinition not yet supported");
        }
        ...
        {
            throw new NotImplementedException("Derived property CaseDefinition not yet supported");
        }
        ...
        public
         IOccurrenceUsage QueryEventOccurrence()
        {
            throw new NotImplementedException("Derived property EventOccurrence not yet supported");
        }
        ...
        public
         IActionUsage QueryPerformedAction()
        {
            throw new NotImplementedException("Derived property PerformedAction not yet supported");
        }
        ...
        {
            throw new NotImplementedException("Derived property UseCaseDefinition not yet supported");
        }
        ...
        {
            throw new NotImplementedException("Derived property UseCaseIncluded not yet supported");
        }
