...
namespace SysML2.NET.Core.POCO.Systems.UseCases
{
    ...
    public partial class IncludeUseCaseUsage : IIncludeUseCaseUsage
    {
        ...
        List<IBehavior> Systems.Actions.IActionUsage.actionDefinition => throw new InvalidOperationException("Redefined by property ICalculationUsage.CalculationDefinition");
        ...
        IFunction Systems.Calculations.ICalculationUsage.calculationDefinition => throw new InvalidOperationException("Redefined by property ICaseUsage.CaseDefinition");
        ...
        ICaseDefinition Systems.Cases.ICaseUsage.caseDefinition => throw new InvalidOperationException("Redefined by property IUseCaseUsage.UseCaseDefinition");
        ...
        IOccurrenceUsage Systems.Occurrences.IEventOccurrenceUsage.eventOccurrence => throw new InvalidOperationException("Redefined by property IPerformActionUsage.PerformedAction");
        ...
        IFunction Kernel.Functions.IExpression.function => throw new InvalidOperationException("Redefined by property ICalculationUsage.CalculationDefinition");
        ...
        public List<IUseCaseUsage> includedUseCase => this.ComputeIncludedUseCase();
        ...
        public IRequirementUsage objectiveRequirement => this.ComputeObjectiveRequirement();
        ...
        IActionUsage Systems.Actions.IPerformActionUsage.performedAction => throw new InvalidOperationException("Redefined by property IIncludeUseCaseUsage.UseCaseIncluded");
