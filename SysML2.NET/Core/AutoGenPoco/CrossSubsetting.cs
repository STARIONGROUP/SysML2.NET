...
namespace SysML2.NET.Core.POCO.Core.Features
{
    ...
    public partial class CrossSubsetting : ICrossSubsetting
    {
        ...
        public IFeature CrossedFeature { get; set; }
        ...
        IFeature ISubsetting.owningFeature => throw new InvalidOperationException("Redefined by property ICrossSubsetting.CrossingFeature");
        ...
        IType Core.Types.ISpecialization.owningType => throw new InvalidOperationException("Redefined by property ISubsetting.OwningFeature");
