// -------------------------------------------------------------------------------------------------
// <copyright file="RequirementConstraintMembership.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.POCO.Systems.Requirements
{
    ...
    public partial class RequirementConstraintMembership : IRequirementConstraintMembership, IContainedRelationship
    {
        /// <summary>
        /// Initialize a new instance of <see cref="RequirementConstraintMembership" />
        /// </summary>
        ...
        INamespace Root.Namespaces.IMembership.membershipOwningNamespace => ((SysML2.NET.Core.POCO.Root.Elements.IRelationship)this).Source.OfType<INamespace>().SingleOrDefaultStrict(nameof(RequirementConstraintMembership));
        ...
        public IConstraintUsage ownedConstraint => ((SysML2.NET.Core.POCO.Core.Types.IFeatureMembership)this).ownedMemberFeature as IConstraintUsage;
        ...
        public IConstraintUsage referencedConstraint => this.ComputeReferencedConstraint();
