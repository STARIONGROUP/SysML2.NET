...
namespace SysML2.NET.Core.POCO.Systems.Views
{
    ...
    public partial class ViewUsage : IViewUsage
    {
        ...
        public List<IElement> exposedElement => this.ComputeExposedElement();
        ...
        List<IPartDefinition> Systems.Parts.IPartUsage.partDefinition => throw new InvalidOperationException("Redefined by property IViewUsage.ViewDefinition");
