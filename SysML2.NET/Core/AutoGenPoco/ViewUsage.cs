// -------------------------------------------------------------------------------------------------
// <copyright file="ViewUsage.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.POCO.Systems.Views
{
    ...
    public partial class ViewUsage : IViewUsage
    {
        ...
        public List<IElement> QueryExposedElement()
        {
            return this.ComputeExposedElement();
        }
        ...
        public IViewDefinition QueryViewDefinition()
        {
            return this.ComputeViewDefinition();
        }
