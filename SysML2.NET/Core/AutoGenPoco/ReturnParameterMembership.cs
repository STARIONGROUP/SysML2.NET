...
namespace SysML2.NET.Core.POCO.Kernel.Functions
{
    ...
    public partial class ReturnParameterMembership : IReturnParameterMembership, IContainedRelationship
    {
        /// <summary>
        /// Initialize a new instance of <see cref="ReturnParameterMembership" />
        /// </summary>
        ...
        INamespace Root.Namespaces.IMembership.membershipOwningNamespace => ((SysML2.NET.Core.POCO.Root.Elements.IRelationship)this).Source.OfType<INamespace>().SingleOrDefaultStrict(nameof(ReturnParameterMembership));
        ...
        public IFeature ownedMemberParameter => ((SysML2.NET.Core.POCO.Core.Types.IFeatureMembership)this).ownedMemberFeature;
