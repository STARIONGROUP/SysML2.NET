// -------------------------------------------------------------------------------------------------
// <copyright file="TerminateActionUsage.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.POCO.Systems.Actions
{
    ...
    public partial class TerminateActionUsage : ITerminateActionUsage
    {
        /// <summary>
        ...
        [Implements(implementation: "ITerminateActionUsage.TerminatedOccurrenceArgument")]
        public IExpression QueryTerminatedOccurrenceArgument()
        {
            return this.ComputeTerminatedOccurrenceArgument();
        }
