...
namespace SysML2.NET.Core.POCO.Systems.States
{
    ...
    public partial class TransitionFeatureMembership : ITransitionFeatureMembership, IContainedRelationship
    {
        /// <summary>
        /// Initialize a new instance of <see cref="TransitionFeatureMembership" />
        /// </summary>
        ...
        INamespace Root.Namespaces.IMembership.membershipOwningNamespace => ((SysML2.NET.Core.POCO.Root.Elements.IRelationship)this).Source.OfType<INamespace>().SingleOrDefaultStrict(nameof(TransitionFeatureMembership));
        ...
        public IStep transitionFeature => ((SysML2.NET.Core.POCO.Core.Types.IFeatureMembership)this).ownedMemberFeature as IStep;
