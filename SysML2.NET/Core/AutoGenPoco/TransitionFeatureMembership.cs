...
namespace SysML2.NET.Core.POCO.Systems.States
{
    ...
    public partial class TransitionFeatureMembership : ITransitionFeatureMembership
    {
        ...
        IFeature Core.Types.IFeatureMembership.ownedMemberFeature => throw new InvalidOperationException("Redefined by property ITransitionFeatureMembership.TransitionFeature");
