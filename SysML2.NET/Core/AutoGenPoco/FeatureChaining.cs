...
namespace SysML2.NET.Core.POCO.Core.Features
{
    ...
    /// owning Feature.
    /// </summary>
    [Class(xmiId: "Core-Features-FeatureChaining", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    ...
    public partial class FeatureChaining : IFeatureChaining
    {
        ...
        /// </summary>
        [Property(xmiId: "Core-Features-FeatureChaining-chainingFeature", aggregation: AggregationKind.None, lowerValue: 1, upperValue: 1, isOrdered: false, isReadOnly: false, isDerived: false, isDerivedUnion: false, isUnique: true, defaultValue: null)]
        ...
        public IFeature ChainingFeature { get; set; }
        ...
        /// Feature::chainingFeature.
        /// </summary>
        [Property(xmiId: "Core-Features-FeatureChaining-featureChained", aggregation: AggregationKind.None, lowerValue: 1, upperValue: 1, isOrdered: false, isReadOnly: false, isDerived: true, isDerivedUnion: false, isUnique: true, defaultValue: null)]
        ...
        {
            get => this.featureChained != null ? [this.featureChained] : [];
            set { }
        }
        ...
        {
            get => this.ChainingFeature != null ? [this.ChainingFeature] : [];
            set
            {
                if (value.OfType<IFeature>().FirstOrDefault() is { } firstValue)
                {
                    this.ChainingFeature = firstValue;
                }
            }
        }
