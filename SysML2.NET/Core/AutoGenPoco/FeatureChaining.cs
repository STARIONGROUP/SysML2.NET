...
namespace SysML2.NET.Core.POCO.Core.Features
{
    ...
    public partial class FeatureChaining : IFeatureChaining, IContainedRelationship
    {
        /// <summary>
        /// Initialize a new instance of <see cref="FeatureChaining" />
        /// </summary>
        ...
        public IFeature featureChained => ((SysML2.NET.Core.POCO.Root.Elements.IRelationship)this).Source.OfType<IFeature>().SingleOrDefaultStrict(nameof(FeatureChaining));
