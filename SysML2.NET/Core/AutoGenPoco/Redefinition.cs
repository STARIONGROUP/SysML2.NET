...
namespace SysML2.NET.Core.POCO.Core.Features
{
    ...
    public partial class Redefinition : IRedefinition
    {
        ...
        [RedefinedByProperty("IRedefinition.RedefinedFeature")] public IFeature SubsettedFeature { get; set; }
        ...
        [RedefinedByProperty("IRedefinition.RedefiningFeature")] public IFeature SubsettingFeature { get; set; }
