...
namespace SysML2.NET.Core.POCO.Systems.Enumerations
{
    ...
    public partial class EnumerationDefinition : IEnumerationDefinition
    {
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IEnumerationDefinition.IsVariation");
            set => throw new InvalidOperationException("Redefined by property IEnumerationDefinition.IsVariation");
        }
        ...
        List<IUsage> Systems.DefinitionAndUsage.IDefinition.variant => throw new InvalidOperationException("Redefined by property IEnumerationDefinition.EnumeratedValue");
