...
namespace SysML2.NET.Core.POCO.Core.Features
{
    ...
    public partial class EndFeatureMembership : IEndFeatureMembership, IContainedRelationship
    {
        /// <summary>
        /// Initialize a new instance of <see cref="EndFeatureMembership" />
        /// </summary>
        ...
        INamespace Root.Namespaces.IMembership.membershipOwningNamespace => ((SysML2.NET.Core.POCO.Root.Elements.IRelationship)this).Source.OfType<INamespace>().SingleOrDefaultStrict(nameof(EndFeatureMembership));
        ...
        public IFeature ownedMemberFeature => ((SysML2.NET.Core.POCO.Core.Types.IFeatureMembership)this).ownedMemberFeature;
