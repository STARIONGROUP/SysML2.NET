// -------------------------------------------------------------------------------------------------
// <copyright file="AllocationDefinition.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.POCO.Systems.Allocations
{
    ...
    public partial class AllocationDefinition : IAllocationDefinition
    {
        ...
        [Implements(implementation: "IAllocationDefinition.Allocation")]
        public List<IAllocationUsage> QueryAllocation()
        {
            return this.ComputeAllocation();
        }
        ...
        public List<IFeature> QueryAssociationEnd()
        {
            return this.ComputeAssociationEnd();
        }
        ...
        public List<IUsage> QueryConnectionEnd()
        {
            return this.ComputeConnectionEnd();
        }
        ...
        [Implements(implementation: "IConnectionDefinition.IsSufficient")]
        bool Systems.Connections.IConnectionDefinition.IsSufficient { get; set; }
        ...
        public List<IType> QueryRelatedType()
        {
            return this.ComputeRelatedType();
        }
        ...
        public List<IType> QueryTargetType()
        {
            return this.ComputeTargetType();
        }
