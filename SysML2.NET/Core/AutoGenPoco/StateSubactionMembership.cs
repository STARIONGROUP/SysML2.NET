...
namespace SysML2.NET.Core.POCO.Systems.States
{
    ...
    public partial class StateSubactionMembership : IStateSubactionMembership, IContainedRelationship
    {
        /// <summary>
        /// Initialize a new instance of <see cref="StateSubactionMembership" />
        /// </summary>
        ...
        public IActionUsage action => ((SysML2.NET.Core.POCO.Core.Types.IFeatureMembership)this).ownedMemberFeature as IActionUsage;
        ...
        INamespace Root.Namespaces.IMembership.membershipOwningNamespace => ((SysML2.NET.Core.POCO.Root.Elements.IRelationship)this).Source.OfType<INamespace>().SingleOrDefaultStrict(nameof(StateSubactionMembership));
