...
namespace SysML2.NET.Core.POCO.Kernel.FeatureValues
{
    ...
    public partial class FeatureValue : IFeatureValue, IContainedRelationship
    {
        /// <summary>
        /// Initialize a new instance of <see cref="FeatureValue" />
        /// </summary>
        public FeatureValue()
        {
        ...
        public IFeature featureWithValue => this.ComputeFeatureWithValue();
        ...
        public INamespace membershipOwningNamespace => ((SysML2.NET.Core.POCO.Root.Elements.IRelationship)this).Source.OfType<INamespace>().SingleOrDefaultStrict(nameof(FeatureValue));
        ...
        public IExpression value => ((SysML2.NET.Core.POCO.Root.Namespaces.IOwningMembership)this).ownedMemberElement as IExpression;
