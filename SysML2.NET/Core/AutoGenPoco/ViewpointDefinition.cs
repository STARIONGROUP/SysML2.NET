...
namespace SysML2.NET.Core.POCO.Systems.Views
{
    ...
    public partial class ViewpointDefinition : IViewpointDefinition
    {
        ...
        [RedefinedByProperty("IRequirementDefinition.ReqId")] public string DeclaredShortName { get; set; }
        ...
        {
            throw new NotImplementedException("Derived property ViewpointStakeholder not yet supported");
        }
