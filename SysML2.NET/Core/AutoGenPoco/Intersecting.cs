...
namespace SysML2.NET.Core.POCO.Core.Types
{
    ...
    public partial class Intersecting : IIntersecting, IContainedRelationship
    {
        /// <summary>
        /// Initialize a new instance of <see cref="Intersecting" />
        /// </summary>
        public Intersecting()
        {
        ...
        public IType typeIntersected => ((SysML2.NET.Core.POCO.Root.Elements.IRelationship)this).Source.OfType<IType>().SingleOrDefaultStrict(nameof(Intersecting));
