...
namespace SysML2.NET.Core.POCO.Kernel.Expressions
{
    ...
    public partial class CollectExpression : ICollectExpression, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="CollectExpression" />
        /// </summary>
        ...
        public IFunction function => ((SysML2.NET.Core.POCO.Kernel.Behaviors.IStep)this).behavior.OfType<IFunction>().SingleOrDefaultStrict(nameof(CollectExpression));
