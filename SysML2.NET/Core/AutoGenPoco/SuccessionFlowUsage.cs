...
namespace SysML2.NET.Core.POCO.Systems.Flows
{
    ...
    public partial class SuccessionFlowUsage : ISuccessionFlowUsage
    {
        ...
        List<IBehavior> Systems.Actions.IActionUsage.actionDefinition => throw new InvalidOperationException("Redefined by property IFlowUsage.FlowDefinition");
        ...
        List<IAssociation> Kernel.Connectors.IConnector.association => throw new InvalidOperationException("Redefined by property IFlow.Interaction");
        ...
        List<IBehavior> Kernel.Behaviors.IStep.behavior => throw new InvalidOperationException("Redefined by property IFlow.Interaction");
        ...
        List<IClassifier> Systems.DefinitionAndUsage.IUsage.definition => throw new InvalidOperationException("Redefined by property IOccurrenceUsage.OccurrenceDefinition");
        ...
        List<IFeature> Core.Types.IType.endFeature => throw new InvalidOperationException("Redefined by property IConnector.ConnectorEnd");
        ...
        public List<IInteraction> flowDefinition => this.ComputeFlowDefinition();
        ...
        List<IInteraction> Kernel.Interactions.IFlow.interaction => throw new InvalidOperationException("Redefined by property IFlowUsage.FlowDefinition");
        ...
        List<IClass> Systems.Occurrences.IOccurrenceUsage.occurrenceDefinition => throw new InvalidOperationException("Redefined by property IActionUsage.ActionDefinition");
        ...
        List<IElement> Root.Elements.IRelationship.relatedElement => throw new InvalidOperationException("Redefined by property IConnector.RelatedFeature");
        ...
        List<IType> Core.Features.IFeature.type => throw new InvalidOperationException("Redefined by property IConnector.Association");
