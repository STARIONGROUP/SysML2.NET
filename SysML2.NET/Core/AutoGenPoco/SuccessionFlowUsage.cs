...
namespace SysML2.NET.Core.POCO.Systems.Flows
{
    ...
    public partial class SuccessionFlowUsage : ISuccessionFlowUsage
    {
        ...
        public List<IInteraction> QueryFlowDefinition()
        {
            return this.ComputeFlowDefinition();
        }
        ...
        {
            return this.ComputeInteraction();
        }
        ...
        {
            return this.ComputePayloadFeature();
        }
        ...
        {
            return this.ComputePayloadType();
        }
        ...
        {
            return this.ComputeSourceOutputFeature();
        }
        ...
        {
            return this.ComputeTargetInputFeature();
        }
