...
namespace SysML2.NET.Core.POCO.Systems.Cases
{
    ...
    public partial class CaseUsage : ICaseUsage, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="CaseUsage" />
        /// </summary>
        public CaseUsage()
        {
        ...
        IFunction Kernel.Functions.IExpression.function => ((SysML2.NET.Core.POCO.Kernel.Behaviors.IStep)this).behavior.OfType<IFunction>().SingleOrDefaultStrict(nameof(CaseUsage));
