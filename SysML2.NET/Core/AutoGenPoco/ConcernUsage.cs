...
namespace SysML2.NET.Core.POCO.Systems.Requirements
{
    ...
    public partial class ConcernUsage : IConcernUsage
    {
        ...
        public IConcernDefinition concernDefinition => this.ComputeConcernDefinition();
        ...
        IRequirementDefinition IRequirementUsage.requirementDefinition => throw new InvalidOperationException("Redefined by property IConcernUsage.ConcernDefinition");
