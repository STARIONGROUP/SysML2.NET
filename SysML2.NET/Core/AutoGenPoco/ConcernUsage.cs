...
namespace SysML2.NET.Core.POCO.Systems.Requirements
{
    ...
    public partial class ConcernUsage : IConcernUsage, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="ConcernUsage" />
        /// </summary>
        public ConcernUsage()
        {
        ...
        public IConcernDefinition concernDefinition => ((IRequirementUsage)this).requirementDefinition as IConcernDefinition;
        ...
        IFunction Kernel.Functions.IExpression.function => ((SysML2.NET.Core.POCO.Kernel.Behaviors.IStep)this).behavior.OfType<IFunction>().SingleOrDefaultStrict(nameof(ConcernUsage));
        ...
        IRequirementDefinition IRequirementUsage.requirementDefinition => ((SysML2.NET.Core.POCO.Systems.Constraints.IConstraintUsage)this).constraintDefinition as IRequirementDefinition;
