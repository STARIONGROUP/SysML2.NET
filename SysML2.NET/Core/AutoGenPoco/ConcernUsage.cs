// -------------------------------------------------------------------------------------------------
// <copyright file="ConcernUsage.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.POCO.Systems.Requirements
{
    ...
    public partial class ConcernUsage : IConcernUsage
    {
        ...
        [Implements(implementation: "IConcernUsage.ConcernDefinition")]
        public IConcernDefinition QueryConcernDefinition()
        {
            return this.ComputeConcernDefinition();
        }
        ...
        [RedefinedByProperty("IConcernUsage.ConcernDefinition")]
