...
namespace SysML2.NET.Core.POCO.Systems.Enumerations
{
    ...
    public partial class EnumerationUsage : IEnumerationUsage
    {
        ...
        List<IDataType> Systems.Attributes.IAttributeUsage.attributeDefinition => throw new InvalidOperationException("Redefined by property IEnumerationUsage.EnumerationDefinition");
        ...
        List<IClassifier> Systems.DefinitionAndUsage.IUsage.definition => throw new InvalidOperationException("Redefined by property IAttributeUsage.AttributeDefinition");
        ...
        bool Systems.DefinitionAndUsage.IUsage.isReference => throw new InvalidOperationException("Redefined by property IAttributeUsage.IsReference");
