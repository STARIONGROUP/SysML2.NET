// -------------------------------------------------------------------------------------------------
// <copyright file="SendActionUsage.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.POCO.Systems.Actions
{
    ...
    public partial class SendActionUsage : ISendActionUsage
    {
        ...
        [Implements(implementation: "ISendActionUsage.PayloadArgument")]
        public IExpression QueryPayloadArgument()
        {
            return this.ComputePayloadArgument();
        }
        ...
        [Implements(implementation: "ISendActionUsage.ReceiverArgument")]
        public IExpression QueryReceiverArgument()
        {
            return this.ComputeReceiverArgument();
        }
        ...
        [Implements(implementation: "ISendActionUsage.SenderArgument")]
        public IExpression QuerySenderArgument()
        {
            return this.ComputeSenderArgument();
        }
