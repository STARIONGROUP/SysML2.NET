...
namespace SysML2.NET.Core.POCO.Systems.Actions
{
    ...
    public partial class SendActionUsage : ISendActionUsage
    {
        ...
        public IExpression payloadArgument => this.ComputePayloadArgument();
        ...
        public IExpression receiverArgument => this.ComputeReceiverArgument();
        ...
        public IExpression senderArgument => this.ComputeSenderArgument();
