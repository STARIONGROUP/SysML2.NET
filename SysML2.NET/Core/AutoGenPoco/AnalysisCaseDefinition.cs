...
namespace SysML2.NET.Core.POCO.Systems.AnalysisCases
{
    ...
    public partial class AnalysisCaseDefinition : IAnalysisCaseDefinition, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="AnalysisCaseDefinition" />
        /// </summary>
        ...
        public List<ICalculationUsage> calculation => this.ComputeCalculation();
