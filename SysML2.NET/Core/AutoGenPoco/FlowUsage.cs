...
namespace SysML2.NET.Core.POCO
{
    ...
    /// <summary>
    /// A FlowUsage is an ActionUsage that is also a ConnectorAsUsage and a KerML
    /// Flow.specializesFromLibrary('Flows::messages')ownedEndFeatures->notEmpty() implies   
    /// specializesFromLibrary('Flows::flows')
    /// </summary>
    public partial class FlowUsage : IFlowUsage
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FlowUsage"/> class.
        /// </summary>
        public FlowUsage()
        {
        ...
        /// <summary>
        /// Queries the derived property FlowDefinition
        /// </summary>
        [EFeature(isChangeable: true, isVolatile: true, isTransient: true, isUnsettable: false, isDerived: true, isOrdered: true, isUnique: true, lowerBound: 0, upperBound: -1, isMany: false, isRequired: false, isContainment: false)]
        public List<Interaction> QueryFlowDefinition()
        {
        ...
        public List<FlowEnd> QueryFlowEnd()
        {
        ...
        /// </summary>
        [EFeature(isChangeable: true, isVolatile: true, isTransient: true, isUnsettable: false, isDerived: true, isOrdered: true, isUnique: false, lowerBound: 0, upperBound: -1, isMany: false, isRequired: false, isContainment: false)]
        public List<Classifier> QueryPayloadType()
        {
