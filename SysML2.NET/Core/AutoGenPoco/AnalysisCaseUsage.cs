...
namespace SysML2.NET.Core.POCO.Systems.AnalysisCases
{
    ...
    public partial class AnalysisCaseUsage : IAnalysisCaseUsage
    {
        ...
        public
         IAnalysisCaseDefinition QueryAnalysisCaseDefinition()
        {
            throw new NotImplementedException("Derived property AnalysisCaseDefinition not yet supported");
        }
        ...
        {
            throw new NotImplementedException("Derived property ResultExpression not yet supported");
        }
