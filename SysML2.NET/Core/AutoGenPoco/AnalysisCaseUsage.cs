...
namespace SysML2.NET.Core.POCO.Systems.AnalysisCases
{
    ...
    public partial class AnalysisCaseUsage : IAnalysisCaseUsage, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="AnalysisCaseUsage" />
        /// </summary>
        ...
        public IAnalysisCaseDefinition analysisCaseDefinition => ((SysML2.NET.Core.POCO.Systems.Cases.ICaseUsage)this).caseDefinition as IAnalysisCaseDefinition;
        ...
        IFunction Kernel.Functions.IExpression.function => ((SysML2.NET.Core.POCO.Kernel.Behaviors.IStep)this).behavior.OfType<IFunction>().SingleOrDefaultStrict(nameof(AnalysisCaseUsage));
