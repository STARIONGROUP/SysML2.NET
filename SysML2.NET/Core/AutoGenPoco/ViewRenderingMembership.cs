...
namespace SysML2.NET.Core.POCO.Systems.Views
{
    ...
    public partial class ViewRenderingMembership : IViewRenderingMembership, IContainedRelationship
    {
        /// <summary>
        /// Initialize a new instance of <see cref="ViewRenderingMembership" />
        /// </summary>
        ...
        INamespace Root.Namespaces.IMembership.membershipOwningNamespace => ((SysML2.NET.Core.POCO.Root.Elements.IRelationship)this).Source.OfType<INamespace>().SingleOrDefaultStrict(nameof(ViewRenderingMembership));
        ...
        [RedefinedByProperty("IViewRenderingMembership.OwnedRendering")]
        ...
        [Implements(implementation: "IViewRenderingMembership.OwnedRendering")]
        public IRenderingUsage ownedRendering => ((SysML2.NET.Core.POCO.Core.Types.IFeatureMembership)this).ownedMemberFeature as IRenderingUsage;
        ...
        [Implements(implementation: "IViewRenderingMembership.ReferencedRendering")]
        public IRenderingUsage referencedRendering => this.ComputeReferencedRendering();
