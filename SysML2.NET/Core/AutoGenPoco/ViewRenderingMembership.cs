...
namespace SysML2.NET.Core.POCO.Systems.Views
{
    ...
    public partial class ViewRenderingMembership : IViewRenderingMembership
    {
        ...
        public IRenderingUsage QueryOwnedRendering()
        {
        ...
        public IRenderingUsage QueryReferencedRendering()
        {
            throw new NotImplementedException("Derived property ReferencedRendering not yet supported");
        }
