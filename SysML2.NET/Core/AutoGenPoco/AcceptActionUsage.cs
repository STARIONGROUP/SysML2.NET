// -------------------------------------------------------------------------------------------------
// <copyright file="AcceptActionUsage.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.POCO.Systems.Actions
{
    ...
    public partial class AcceptActionUsage : IAcceptActionUsage
    {
        ...
        [Implements(implementation: "IAcceptActionUsage.PayloadArgument")]
        ...
        public IReferenceUsage QueryPayloadParameter()
        {
            return this.ComputePayloadParameter();
        }
        ...
        [Implements(implementation: "IAcceptActionUsage.ReceiverArgument")]
