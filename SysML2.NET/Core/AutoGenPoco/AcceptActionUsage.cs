...
namespace SysML2.NET.Core.POCO.Systems.Actions
{
    ...
    public partial class AcceptActionUsage : IAcceptActionUsage
    {
        ...
        public
         IExpression QueryPayloadArgument()
        {
            throw new NotImplementedException("Derived property PayloadArgument not yet supported");
        }
        ...
        public
         IReferenceUsage QueryPayloadParameter()
        {
            throw new NotImplementedException("Derived property PayloadParameter not yet supported");
        }
        ...
        public
         IExpression QueryReceiverArgument()
        {
            throw new NotImplementedException("Derived property ReceiverArgument not yet supported");
        }
