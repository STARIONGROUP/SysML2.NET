...
namespace SysML2.NET.Core.POCO.Systems.States
{
    ...
    public partial class TransitionUsage : ITransitionUsage
    {
        ...
        List<IBehavior> Kernel.Behaviors.IStep.behavior => throw new InvalidOperationException("Redefined by property IActionUsage.ActionDefinition");
        ...
        public List<IActionUsage> effectAction => this.ComputeEffectAction();
        ...
        public List<IExpression> guardExpression => this.ComputeGuardExpression();
        ...
        public ISuccession succession => this.ComputeSuccession();
        ...
        public IActionUsage target => this.ComputeTarget();
        ...
        public List<IAcceptActionUsage> triggerAction => this.ComputeTriggerAction();
