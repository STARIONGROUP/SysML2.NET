...
namespace SysML2.NET.Core.POCO.Systems.States
{
    ...
    public partial class TransitionUsage : ITransitionUsage
    {
        ...
        {
            throw new NotImplementedException("Derived property EffectAction not yet supported");
        }
        ...
        {
            throw new NotImplementedException("Derived property Source not yet supported");
        }
        ...
        {
            throw new NotImplementedException("Derived property Succession not yet supported");
        }
        ...
        {
            throw new NotImplementedException("Derived property Target not yet supported");
        }
        ...
        {
            throw new NotImplementedException("Derived property TriggerAction not yet supported");
        }
