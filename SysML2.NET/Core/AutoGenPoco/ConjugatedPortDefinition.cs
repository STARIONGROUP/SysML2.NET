...
namespace SysML2.NET.Core.POCO.Systems.Ports
{
    ...
    public partial class ConjugatedPortDefinition : IConjugatedPortDefinition
    {
        ...
        {
            throw new NotImplementedException("Derived property OriginalPortDefinition not yet supported");
        }
        ...
        {
            throw new NotImplementedException("Derived property OwnedPortConjugator not yet supported");
        }
