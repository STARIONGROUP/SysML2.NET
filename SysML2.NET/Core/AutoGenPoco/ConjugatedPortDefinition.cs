...
namespace SysML2.NET.Core.POCO.Systems.Ports
{
    ...
    public partial class ConjugatedPortDefinition : IConjugatedPortDefinition, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="ConjugatedPortDefinition" />
        /// </summary>
