...
namespace SysML2.NET.Core.POCO.Systems.Ports
{
    ...
    public partial class ConjugatedPortTyping : IConjugatedPortTyping
    {
        ...
        [RedefinedByProperty("IFeatureTyping.Type")] public IType General { get; set; }
        ...
        public IPortDefinition QueryPortDefinition()
        {
        ...
        [RedefinedByProperty("IFeatureTyping.TypedFeature")] public IType Specific { get; set; }
        ...
        [RedefinedByProperty("IConjugatedPortTyping.ConjugatedPortDefinition")] public IType Type { get; set; }
