...
namespace SysML2.NET.Core.POCO.Core.Classifiers
{
    ...
    public partial class Subclassification : ISubclassification
    {
        ...
        IType Core.Types.ISpecialization.owningType => throw new InvalidOperationException("Redefined by property ISubclassification.OwningClassifier");
        ...
        public IClassifier Subclassifier { get; set; }
        ...
        public IClassifier Superclassifier { get; set; }
