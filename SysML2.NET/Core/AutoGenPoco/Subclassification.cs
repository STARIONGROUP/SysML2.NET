...
namespace SysML2.NET.Core.POCO.Core.Classifiers
{
    ...
    public partial class Subclassification : ISubclassification
    {
        ...
        [RedefinedByProperty("ISubclassification.Superclassifier")] public IType General { get; set; }
        ...
        public IClassifier QueryOwningClassifier()
        {
            throw new NotImplementedException("Derived property OwningClassifier not yet supported");
        }
        ...
        [RedefinedByProperty("ISubclassification.Subclassifier")] public IType Specific { get; set; }
