...
namespace SysML2.NET.Core.POCO.Root.Annotations
{
    ...
    public partial class Annotation : IAnnotation
    {
        ...
        public IAnnotatingElement QueryAnnotatingElement()
        {
            return this.ComputeAnnotatingElement();
        }
        ...
        public IAnnotatingElement QueryOwnedAnnotatingElement()
        {
            return this.ComputeOwnedAnnotatingElement();
        }
        ...
        {
            return this.ComputeOwningAnnotatedElement();
        }
        ...
        public IAnnotatingElement QueryOwningAnnotatingElement()
        {
            return this.ComputeOwningAnnotatingElement();
        }
