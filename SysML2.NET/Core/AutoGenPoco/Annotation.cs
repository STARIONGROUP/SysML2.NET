...
namespace SysML2.NET.Core.POCO.Root.Annotations
{
    ...
    public partial class Annotation : IAnnotation
    {
        ...
        public IAnnotatingElement ownedAnnotatingElement => this.ComputeOwnedAnnotatingElement();
        ...
        public IElement owningAnnotatedElement => this.ComputeOwningAnnotatedElement();
        ...
        public IAnnotatingElement owningAnnotatingElement => this.ComputeOwningAnnotatingElement();
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IAnnotation.AnnotatingElement");
            set => throw new InvalidOperationException("Redefined by property IAnnotation.AnnotatingElement");
        }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IAnnotation.AnnotatedElement");
            set => throw new InvalidOperationException("Redefined by property IAnnotation.AnnotatedElement");
        }
