...
namespace SysML2.NET.Core.POCO.Systems.UseCases
{
    ...
    public partial class UseCaseUsage : IUseCaseUsage, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="UseCaseUsage" />
        /// </summary>
        public UseCaseUsage()
        {
        ...
        IFunction Kernel.Functions.IExpression.function => ((SysML2.NET.Core.POCO.Kernel.Behaviors.IStep)this).behavior.OfType<IFunction>().SingleOrDefaultStrict(nameof(UseCaseUsage));
