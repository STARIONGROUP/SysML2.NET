...
namespace SysML2.NET.Core.POCO.Systems.Requirements
{
    ...
    public partial class FramedConcernMembership : IFramedConcernMembership
    {
        ...
        IConstraintUsage IRequirementConstraintMembership.ownedConstraint => throw new InvalidOperationException("Redefined by property IFramedConcernMembership.OwnedConcern");
        ...
        IConstraintUsage IRequirementConstraintMembership.referencedConstraint => throw new InvalidOperationException("Redefined by property IFramedConcernMembership.ReferencedConcern");
