...
namespace SysML2.NET.Core.POCO.Systems.Requirements
{
    ...
    public partial class FramedConcernMembership : IFramedConcernMembership, IContainedRelationship
    {
        ...
        INamespace Root.Namespaces.IMembership.membershipOwningNamespace => ((SysML2.NET.Core.POCO.Root.Elements.IRelationship)this).Source.OfType<INamespace>().SingleOrDefaultStrict(nameof(FramedConcernMembership));
        ...
        public IConcernUsage ownedConcern => ((IRequirementConstraintMembership)this).ownedConstraint as IConcernUsage;
        ...
        IConstraintUsage IRequirementConstraintMembership.ownedConstraint => ((SysML2.NET.Core.POCO.Core.Types.IFeatureMembership)this).ownedMemberFeature as IConstraintUsage;
        ...
        public IConcernUsage referencedConcern => ((IRequirementConstraintMembership)this).referencedConstraint as IConcernUsage;
