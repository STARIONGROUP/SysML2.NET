...
namespace SysML2.NET.Core.POCO.Systems.Requirements
{
    ...
    public partial class SubjectMembership : ISubjectMembership
    {
        ...
        IFeature Kernel.Behaviors.IParameterMembership.ownedMemberParameter => throw new InvalidOperationException("Redefined by property ISubjectMembership.OwnedSubjectParameter");
