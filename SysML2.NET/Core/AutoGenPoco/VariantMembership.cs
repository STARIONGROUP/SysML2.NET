...
namespace SysML2.NET.Core.POCO.Systems.DefinitionAndUsage
{
    ...
    public partial class VariantMembership : IVariantMembership
    {
        ...
        IElement Root.Namespaces.IOwningMembership.ownedMemberElement => throw new InvalidOperationException("Redefined by property IVariantMembership.OwnedVariantUsage");
