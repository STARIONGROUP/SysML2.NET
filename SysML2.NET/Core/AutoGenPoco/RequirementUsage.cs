...
namespace SysML2.NET.Core.POCO.Systems.Requirements
{
    ...
    {
        /// <summary>
        /// Initialize a new instance of <see cref="RequirementUsage" />
        /// </summary>
        ...
        IFunction Kernel.Functions.IExpression.function => ((SysML2.NET.Core.POCO.Kernel.Behaviors.IStep)this).behavior.OfType<IFunction>().SingleOrDefaultStrict(nameof(RequirementUsage));
