...
namespace SysML2.NET.Core.POCO.Kernel.Packages
{
    ...
    public partial class ElementFilterMembership : IElementFilterMembership
    {
        ...
        IElement Root.Namespaces.IOwningMembership.ownedMemberElement => throw new InvalidOperationException("Redefined by property IElementFilterMembership.Condition");
