...
namespace SysML2.NET.Core.POCO.Systems.Constraints
{
    ...
    public partial class ConstraintUsage : IConstraintUsage, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="ConstraintUsage" />
        /// </summary>
        ...
        IFunction Kernel.Functions.IExpression.function => ((SysML2.NET.Core.POCO.Kernel.Behaviors.IStep)this).behavior.OfType<IFunction>().SingleOrDefaultStrict(nameof(ConstraintUsage));
