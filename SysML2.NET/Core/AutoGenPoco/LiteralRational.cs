...
namespace SysML2.NET.Core.POCO.Kernel.Expressions
{
    ...
    /// </summary>
    [Class(xmiId: "Kernel-Expressions-LiteralRational", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    ...
    public partial class LiteralRational : ILiteralRational
    {
        ...
        /// </summary>
        [Property(xmiId: "Kernel-Expressions-LiteralRational-value", aggregation: AggregationKind.None, lowerValue: 1, upperValue: 1, isOrdered: false, isReadOnly: false, isDerived: false, isDerivedUnion: false, isUnique: true, defaultValue: null)]
