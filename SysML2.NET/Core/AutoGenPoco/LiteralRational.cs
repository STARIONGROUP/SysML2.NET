...
namespace SysML2.NET.Core.POCO.Kernel.Expressions
{
    ...
    {
        /// <summary>
        /// Initialize a new instance of <see cref="LiteralRational" />
        /// </summary>
        ...
        public IFunction function => ((SysML2.NET.Core.POCO.Kernel.Behaviors.IStep)this).behavior.OfType<IFunction>().SingleOrDefaultStrict(nameof(LiteralRational));
