...
namespace SysML2.NET.Core.POCO.Kernel.Functions
{
    ...
    public partial class Invariant : IInvariant, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="Invariant" />
        /// </summary>
        public Invariant()
        {
        ...
        IFunction IExpression.function => ((SysML2.NET.Core.POCO.Kernel.Behaviors.IStep)this).behavior.OfType<IFunction>().SingleOrDefaultStrict(nameof(Invariant));
