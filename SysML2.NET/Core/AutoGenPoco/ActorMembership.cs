...
namespace SysML2.NET.Core.POCO.Systems.Requirements
{
    ...
    public partial class ActorMembership : IActorMembership
    {
        ...
        IFeature Core.Types.IFeatureMembership.ownedMemberFeature => throw new InvalidOperationException("Redefined by property IParameterMembership.OwnedMemberParameter");
        ...
        IFeature Kernel.Behaviors.IParameterMembership.ownedMemberParameter => throw new InvalidOperationException("Redefined by property IActorMembership.OwnedActorParameter");
