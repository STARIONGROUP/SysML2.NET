...
namespace SysML2.NET.Core.POCO.Systems.Requirements
{
    ...
    public partial class ActorMembership : IActorMembership, IContainedRelationship
    {
        ...
        public IPartUsage ownedActorParameter => this.ComputeOwnedActorParameter();
        ...
        IFeature Core.Types.IFeatureMembership.ownedMemberFeature => ((SysML2.NET.Core.POCO.Kernel.Behaviors.IParameterMembership)this).ownedMemberParameter;
        ...
        IFeature Kernel.Behaviors.IParameterMembership.ownedMemberParameter => this.ownedActorParameter;
