...
namespace SysML2.NET.Core.POCO.Systems.Requirements
{
    ...
    public partial class ActorMembership : IActorMembership, IContainedRelationship
    {
        /// <summary>
        /// Initialize a new instance of <see cref="ActorMembership" />
        /// </summary>
        ...
        INamespace Root.Namespaces.IMembership.membershipOwningNamespace => ((SysML2.NET.Core.POCO.Root.Elements.IRelationship)this).Source.OfType<INamespace>().SingleOrDefaultStrict(nameof(ActorMembership));
        ...
        public IPartUsage ownedActorParameter => ((SysML2.NET.Core.POCO.Kernel.Behaviors.IParameterMembership)this).ownedMemberParameter as IPartUsage;
        ...
        IFeature Kernel.Behaviors.IParameterMembership.ownedMemberParameter => ((SysML2.NET.Core.POCO.Core.Types.IFeatureMembership)this).ownedMemberFeature;
