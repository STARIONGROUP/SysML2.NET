...
namespace SysML2.NET.Core.POCO.Systems.States
{
    ...
    public partial class ExhibitStateUsage : IExhibitStateUsage
    {
        ...
        {
            throw new NotImplementedException("Derived property DoAction not yet supported");
        }
        ...
        {
            throw new NotImplementedException("Derived property EntryAction not yet supported");
        }
        ...
        public
         IStateUsage QueryExhibitedState()
        {
            throw new NotImplementedException("Derived property ExhibitedState not yet supported");
        }
        ...
        {
            throw new NotImplementedException("Derived property ExitAction not yet supported");
        }
        ...
        {
            throw new NotImplementedException("Derived property StateDefinition not yet supported");
        }
