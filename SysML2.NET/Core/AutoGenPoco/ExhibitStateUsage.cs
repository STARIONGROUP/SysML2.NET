...
namespace SysML2.NET.Core.POCO.Systems.States
{
    ...
    public partial class ExhibitStateUsage : IExhibitStateUsage
    {
        ...
        List<IBehavior> Systems.Actions.IActionUsage.actionDefinition => throw new InvalidOperationException("Redefined by property IStateUsage.StateDefinition");
        ...
        IActionUsage Systems.Actions.IPerformActionUsage.performedAction => throw new InvalidOperationException("Redefined by property IExhibitStateUsage.ExhibitedState");
