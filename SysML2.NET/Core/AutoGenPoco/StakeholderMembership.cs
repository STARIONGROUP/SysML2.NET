...
namespace SysML2.NET.Core.POCO.Systems.Requirements
{
    ...
    public partial class StakeholderMembership : IStakeholderMembership, IContainedRelationship
    {
        /// <summary>
        /// Initialize a new instance of <see cref="StakeholderMembership" />
        /// </summary>
        ...
        INamespace Root.Namespaces.IMembership.membershipOwningNamespace => ((SysML2.NET.Core.POCO.Root.Elements.IRelationship)this).Source.OfType<INamespace>().SingleOrDefaultStrict(nameof(StakeholderMembership));
        ...
        public IPartUsage ownedStakeholderParameter => ((SysML2.NET.Core.POCO.Kernel.Behaviors.IParameterMembership)this).ownedMemberParameter as IPartUsage;
