...
namespace SysML2.NET.Core.POCO.Systems.Requirements
{
    ...
    public partial class StakeholderMembership : IStakeholderMembership
    {
        ...
        IFeature Kernel.Behaviors.IParameterMembership.ownedMemberParameter => throw new InvalidOperationException("Redefined by property IStakeholderMembership.OwnedStakeholderParameter");
