...
namespace SysML2.NET.Core.POCO.Systems.Requirements
{
    ...
    public partial class StakeholderMembership : IStakeholderMembership, IContainedRelationship
    {
        ...
        IFeature Kernel.Behaviors.IParameterMembership.ownedMemberParameter => this.ownedStakeholderParameter;
        ...
        public IPartUsage ownedStakeholderParameter => this.ComputeOwnedStakeholderParameter();
