...
namespace SysML2.NET.Core.POCO.Systems.Ports
{
    ...
    public partial class PortUsage : IPortUsage
    {
        ...
        List<IClass> Systems.Occurrences.IOccurrenceUsage.occurrenceDefinition => throw new InvalidOperationException("Redefined by property IPortUsage.PortDefinition");
        ...
        public List<IPortDefinition> portDefinition => this.ComputePortDefinition();
