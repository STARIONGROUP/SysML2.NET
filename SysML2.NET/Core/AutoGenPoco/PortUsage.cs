// -------------------------------------------------------------------------------------------------
// <copyright file="PortUsage.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.POCO.Systems.Ports
{
    ...
    public partial class PortUsage : IPortUsage
    {
        ...
        [Implements(implementation: "IPortUsage.PortDefinition")]
        public List<IPortDefinition> QueryPortDefinition()
        {
            return this.ComputePortDefinition();
        }
