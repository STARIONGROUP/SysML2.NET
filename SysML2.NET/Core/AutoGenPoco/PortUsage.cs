...
namespace SysML2.NET.Core.POCO.Systems.Ports
{
    ...
    public partial class PortUsage : IPortUsage, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="PortUsage" />
        /// </summary>
        public PortUsage()
        {
        ...
        List<IClass> Systems.Occurrences.IOccurrenceUsage.occurrenceDefinition => [.. this.portDefinition];
