// -------------------------------------------------------------------------------------------------
// <copyright file="StateDefinition.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Core.POCO.Systems.States
{
    ...
    public partial class StateDefinition : IStateDefinition
    {
        ...
        public List<IActionUsage> QueryAction()
        {
            return this.ComputeAction();
        }
        ...
        [Implements(implementation: "IStateDefinition.DoAction")]
        public IActionUsage QueryDoAction()
        {
            return this.ComputeDoAction();
        }
        ...
        [Implements(implementation: "IStateDefinition.EntryAction")]
        public IActionUsage QueryEntryAction()
        {
            return this.ComputeEntryAction();
        }
        ...
        [Implements(implementation: "IStateDefinition.ExitAction")]
        public IActionUsage QueryExitAction()
        {
            return this.ComputeExitAction();
        }
        ...
        [Implements(implementation: "IStateDefinition.IsParallel")]
        ...
        [Implements(implementation: "IStateDefinition.State")]
        public List<IStateUsage> QueryState()
        {
