...
namespace SysML2.NET.Core.POCO.Systems.States
{
    ...
    public partial class StateDefinition : IStateDefinition, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="StateDefinition" />
        /// </summary>
        ...
        public List<IStateUsage> state => this.ComputeState();
