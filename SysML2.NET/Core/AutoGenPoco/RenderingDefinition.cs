...
namespace SysML2.NET.Core.POCO.Systems.Views
{
    ...
    public partial class RenderingDefinition : IRenderingDefinition, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="RenderingDefinition" />
        /// </summary>
        ...
        public List<IRenderingUsage> rendering => this.ComputeRendering();
