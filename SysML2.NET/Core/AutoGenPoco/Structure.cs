...
namespace SysML2.NET.Core.POCO.Kernel.Structures
{
    using System;
    ...
    public partial class Structure : IStructure, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="Structure" />
        /// </summary>
        public Structure()
        {
