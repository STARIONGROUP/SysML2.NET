...
namespace SysML2.NET.Core.POCO.Kernel.Expressions
{
    ...
    public partial class FeatureChainExpression : IFeatureChainExpression, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="FeatureChainExpression" />
        /// </summary>
        ...
        public IFunction function => ((SysML2.NET.Core.POCO.Kernel.Behaviors.IStep)this).behavior.OfType<IFunction>().SingleOrDefaultStrict(nameof(FeatureChainExpression));
        ...
        public IFeature targetFeature => this.ComputeTargetFeature();
