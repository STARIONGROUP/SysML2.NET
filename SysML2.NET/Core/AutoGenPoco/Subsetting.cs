...
namespace SysML2.NET.Core.POCO.Core.Features
{
    ...
    public partial class Subsetting : ISubsetting, IContainedRelationship
    {
        /// <summary>
        /// Initialize a new instance of <see cref="Subsetting" />
        /// </summary>
        public Subsetting()
        {
        ...
        IType Core.Types.ISpecialization.General
        {
            ...
            set
            {
                ...
                {
                    this.SubsettedFeature = castedValue;
                }
            }
        }
        ...
        IType Core.Types.ISpecialization.Specific
        {
            ...
            set
            {
                if (value is IFeature castedValue)
                {
                    this.SubsettingFeature = castedValue;
                }
            }
        }
