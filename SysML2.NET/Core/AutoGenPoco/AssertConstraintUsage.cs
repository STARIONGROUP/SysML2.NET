...
namespace SysML2.NET.Core.POCO.Systems.Constraints
{
    ...
    public partial class AssertConstraintUsage : IAssertConstraintUsage, IContainedElement
    {
        /// <summary>
        /// Initialize a new instance of <see cref="AssertConstraintUsage" />
        /// </summary>
        ...
        public IPredicate constraintDefinition => ((SysML2.NET.Core.POCO.Kernel.Functions.IBooleanExpression)this).predicate;
        ...
        IFunction Kernel.Functions.IExpression.function => ((SysML2.NET.Core.POCO.Kernel.Behaviors.IStep)this).behavior.OfType<IFunction>().SingleOrDefaultStrict(nameof(AssertConstraintUsage));
