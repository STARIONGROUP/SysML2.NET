...
namespace SysML2.NET.Core.POCO.Core.Types
{
    ...
    public partial class Differencing : IDifferencing, IContainedRelationship
    {
        /// <summary>
        /// Initialize a new instance of <see cref="Differencing" />
        /// </summary>
        public Differencing()
        {
        ...
        {
            get => this.typeDifferenced != null ? [this.typeDifferenced] : [];
            set { }
        }
        ...
        {
            get => this.DifferencingType != null ? [this.DifferencingType] : [];
            set
            {
                if (value.OfType<IType>().FirstOrDefault() is { } firstValue)
                {
                    this.DifferencingType = firstValue;
                }
            }
        }
