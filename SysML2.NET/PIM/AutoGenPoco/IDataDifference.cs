// -------------------------------------------------------------------------------------------------
// <copyright file="IDataDifference.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.PIM.POCO.API_Model
{
    ...
    public partial interface IDataDifference
    {
        /// <summary>
        /// </summary>
        ...
        IDataVersion CompareData { get; set; }
