// -------------------------------------------------------------------------------------------------
// <copyright file="DataIdentity.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.PIM.DTO
{
    ...
    /// <summary>
    /// An object representing the entire timeline for a modeled thing. This functions similarly to
    /// "Configuration Item" in PLM.
    /// </summary>
    [Class(xmiId: "_19_0_2_12e503d9_1577820468974_665346_65985", isAbstract: false, isFinalSpecialization: false, isActive: false)]
    [GeneratedCode("sysml2.net", "latest")]
    public partial class DataIdentity : IDataIdentity
    {
        /// <summary>
        ...
        /// <summary>
        /// </summary>
        [Property(xmiId: "_19_0_2_12e503d9_1577820469729_822777_66066", aggregation: AggregationKind.None, lowerValue: 1, upperValue: int.MaxValue, isOrdered: false, isReadOnly: false, isDerived: false, isDerivedUnion: false, isUnique: false, defaultValue: null)]
        [Implements(implementation: "IDataIdentity.Version")]
