...
namespace SysML2.NET.TextualNotation
{
    ...
    /// <summary>
    /// Hand-coded part of the <see cref="CommentTextualNotationBuilder"/>
    /// </summary>
    public static partial class CommentTextualNotationBuilder
    {
        /// <summary>
        /// Builds the conditional part for the Comment rule
        /// </summary>
        /// <param name="poco">The <see cref="IComment"/></param>
