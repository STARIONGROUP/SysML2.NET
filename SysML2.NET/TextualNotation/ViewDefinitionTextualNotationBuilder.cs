...
namespace SysML2.NET.TextualNotation
{
    ...
    /// <summary>
    /// Hand-coded part of the <see cref="ViewDefinitionTextualNotationBuilder" />
    /// </summary>
    public static partial class ViewDefinitionTextualNotationBuilder
    {
        ...
        private static void BuildViewDefinitionBodyHandCoded(IViewDefinition poco, ICursorCache cursorCache, StringBuilder stringBuilder)
        {
            throw new System.NotSupportedException("BuildViewDefinitionBodyHandCoded requires manual implementation");
        }
    }
}
