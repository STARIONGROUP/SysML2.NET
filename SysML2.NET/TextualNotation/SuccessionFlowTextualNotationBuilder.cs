...
namespace SysML2.NET.TextualNotation
{
    ...
    public static partial class SuccessionFlowTextualNotationBuilder
    {
        ...
        private static void BuildFeaturePrefixHandCoded(ISuccessionFlow poco, ICursorCache cursorCache, StringBuilder stringBuilder)
        {
        ...
        {
            throw new System.NotSupportedException("BuildFlowDeclarationHandCoded requires manual implementation");
        }
    }
}
