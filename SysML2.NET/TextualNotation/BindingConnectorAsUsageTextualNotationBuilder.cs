...
namespace SysML2.NET.TextualNotation
{
    ...
    /// <summary>
    /// Hand-coded part of the <see cref="BindingConnectorAsUsageTextualNotationBuilder"/>
    /// </summary>
    public static partial class BindingConnectorAsUsageTextualNotationBuilder
    {
        /// <summary>
        /// Builds the conditional part for the BindingConnectorAsUsage rule
        /// </summary>
        /// <param name="poco">The <see cref="IBindingConnectorAsUsage"/></param>
