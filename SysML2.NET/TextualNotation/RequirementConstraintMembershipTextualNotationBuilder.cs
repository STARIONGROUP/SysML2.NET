...
namespace SysML2.NET.TextualNotation
{
    ...
    /// <summary>
    /// Hand-coded part of the <see cref="RequirementConstraintMembershipTextualNotationBuilder" />
    /// </summary>
    public static partial class RequirementConstraintMembershipTextualNotationBuilder
    {
        ...
        private static void BuildRequirementKindHandCoded(IRequirementConstraintMembership poco, ICursorCache cursorCache, StringBuilder stringBuilder)
        {
            throw new System.NotSupportedException("BuildRequirementKindHandCoded requires manual implementation");
        }
    }
}
