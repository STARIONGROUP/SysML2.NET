...
namespace SysML2.NET.TextualNotation
{
    ...
    /// <summary>
    /// Hand-coded part of the <see cref="InvariantTextualNotationBuilder" />
    /// </summary>
    public static partial class InvariantTextualNotationBuilder
    {
        ...
        private static void BuildFeaturePrefixHandCoded(IInvariant poco, ICursorCache cursorCache, StringBuilder stringBuilder)
        {
