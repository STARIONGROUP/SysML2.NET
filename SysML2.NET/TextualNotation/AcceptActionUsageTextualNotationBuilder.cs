...
namespace SysML2.NET.TextualNotation
{
    ...
    /// <summary>
    /// Hand-coded part of the <see cref="AcceptActionUsageTextualNotationBuilder"/>
    /// </summary>
    public static partial class AcceptActionUsageTextualNotationBuilder
    {
        /// <summary>
        /// Builds the conditional part for the TransitionAcceptActionUsage rule
        /// </summary>
        /// <param name="poco">The <see cref="IAcceptActionUsage"/></param>
