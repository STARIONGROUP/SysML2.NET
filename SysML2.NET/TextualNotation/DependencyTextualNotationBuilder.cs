...
namespace SysML2.NET.TextualNotation
{
    ...
    /// <summary>
    /// Hand-coded part of the <see cref="DependencyTextualNotationBuilder"/>
    /// </summary>
    public static partial class DependencyTextualNotationBuilder
    {
        /// <summary>
        /// Builds the conditional part for the DependencyDeclaration rule
        /// </summary>
        /// <param name="poco">The <see cref="IDependency"/></param>
