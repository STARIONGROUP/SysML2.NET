...
namespace SysML2.NET.TextualNotation
{
    ...
    /// <summary>
    /// Hand-coded part of the <see cref="StepTextualNotationBuilder" />
    /// </summary>
    public static partial class StepTextualNotationBuilder
    {
        ...
        private static void BuildFeaturePrefixHandCoded(IStep poco, ICursorCache cursorCache, StringBuilder stringBuilder)
        {
