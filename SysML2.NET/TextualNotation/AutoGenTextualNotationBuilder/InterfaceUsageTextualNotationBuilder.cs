...
namespace SysML2.NET.TextualNotation
{
    ...
    /// <summary>
    /// The <see cref="InterfaceUsageTextualNotationBuilder" /> provides Textual Notation Builder for the <see cref="SysML2.NET.Core.POCO.Systems.Interfaces.InterfaceUsage" /> element
    /// </summary>
    public class InterfaceUsageTextualNotationBuilder : TextualNotationBuilder<SysML2.NET.Core.POCO.Systems.Interfaces.InterfaceUsage>
    {
        ...
        /// <summary>
        /// Builds the Textual Notation string for the provided <see cref="SysML2.NET.Core.POCO.Systems.Interfaces.InterfaceUsage"/>
        /// </summary>
        /// <param name="poco">The <see cref="SysML2.NET.Core.POCO.Systems.Interfaces.InterfaceUsage"/> from which the textual notation should be build</param>
