...
namespace SysML2.NET.TextualNotation
{
    ...
    /// <summary>
    /// The <see cref="ReferenceUsageTextualNotationBuilder" /> provides Textual Notation Builder for the <see cref="SysML2.NET.Core.POCO.Systems.DefinitionAndUsage.ReferenceUsage" /> element
    /// </summary>
    public class ReferenceUsageTextualNotationBuilder : TextualNotationBuilder<SysML2.NET.Core.POCO.Systems.DefinitionAndUsage.ReferenceUsage>
    {
        ...
        /// <summary>
        /// Builds the Textual Notation string for the provided <see cref="SysML2.NET.Core.POCO.Systems.DefinitionAndUsage.ReferenceUsage"/>
        /// </summary>
        /// <param name="poco">The <see cref="SysML2.NET.Core.POCO.Systems.DefinitionAndUsage.ReferenceUsage"/> from which the textual notation should be build</param>
