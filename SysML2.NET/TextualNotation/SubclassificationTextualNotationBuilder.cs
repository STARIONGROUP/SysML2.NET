...
namespace SysML2.NET.TextualNotation
{
    ...
    /// <summary>
    /// Hand-coded part of the <see cref="SubclassificationTextualNotationBuilder"/>
    /// </summary>
    public static partial class SubclassificationTextualNotationBuilder
    {
        /// <summary>
        /// Builds the conditional part for the Subclassification rule
        /// </summary>
        /// <param name="poco">The <see cref="ISubclassification"/></param>
        /// <returns>The assertion of the condition</returns>
        private static bool BuildGroupConditionForSubclassification(ISubclassification poco)
        {
