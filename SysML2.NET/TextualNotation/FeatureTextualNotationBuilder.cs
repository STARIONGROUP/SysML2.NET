...
namespace SysML2.NET.TextualNotation
{
    ...
    public static partial class FeatureTextualNotationBuilder
    {
        ...
        /// <summary>
        /// Builds the Textual Notation string for the rule DEFINED_BY
        /// </summary>
        /// <param name="poco">The <see cref="SysML2.NET.Core.POCO.Core.Features.IFeature" /> from which the rule should be build</param>
        /// <param name="cursorCache">The <see cref="ICursorCache" /> used to get access to CursorCollection for the current <paramref name="poco"/></param>
        /// <param name="stringBuilder">The <see cref="StringBuilder" /> that contains the entire textual notation</param>
        private static void BuildDEFINED_BYHandCoded(IFeature poco, ICursorCache cursorCache, StringBuilder stringBuilder)
        {
            throw new System.NotSupportedException("BuildDEFINED_BYHandCoded requires manual implementation");
        }
