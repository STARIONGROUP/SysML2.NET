...
namespace SysML2.NET.TextualNotation
{
    ...
    /// <summary>
    /// Hand-coded part of the <see cref="ViewUsageTextualNotationBuilder" />
    /// </summary>
    public static partial class ViewUsageTextualNotationBuilder
    {
        ...
        private static void BuildViewBodyHandCoded(IViewUsage poco, ICursorCache cursorCache, StringBuilder stringBuilder)
        {
            throw new System.NotSupportedException("BuildViewBodyHandCoded requires manual implementation");
        }
    }
}
