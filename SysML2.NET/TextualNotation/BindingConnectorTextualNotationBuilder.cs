...
namespace SysML2.NET.TextualNotation
{
    ...
    public static partial class BindingConnectorTextualNotationBuilder
    {
        ...
        {
            throw new System.NotSupportedException("BuildBindingConnectorDeclarationHandCoded requires manual implementation");
        }
        ...
        /// <param name="cursorCache">The <see cref="ICursorCache" /> used to get access to CursorCollection for the current <paramref name="poco"/></param>
        /// <param name="stringBuilder">The <see cref="StringBuilder" /> that contains the entire textual notation</param>
        private static void BuildFeaturePrefixHandCoded(IBindingConnector poco, ICursorCache cursorCache, StringBuilder stringBuilder)
        {
