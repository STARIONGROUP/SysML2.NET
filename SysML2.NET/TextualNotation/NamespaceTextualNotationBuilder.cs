...
namespace SysML2.NET.TextualNotation
{
    ...
    /// <summary>
    /// Hand-coded part of the <see cref="NamespaceTextualNotationBuilder" />
    /// </summary>
    public static partial class NamespaceTextualNotationBuilder
    {
        ...
        private static void BuildNamespaceBodyHandCoded(INamespace poco, ICursorCache cursorCache, StringBuilder stringBuilder)
        {
            throw new System.NotSupportedException("BuildNamespaceBodyHandCoded requires manual implementation");
        }
    }
}
