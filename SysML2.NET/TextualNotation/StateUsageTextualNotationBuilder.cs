...
namespace SysML2.NET.TextualNotation
{
    ...
    /// <summary>
    /// Hand-coded part of the <see cref="StateUsageTextualNotationBuilder" />
    /// </summary>
    public static partial class StateUsageTextualNotationBuilder
    {
        ...
        private static void BuildStateUsageBodyHandCoded(IStateUsage poco, ICursorCache cursorCache, StringBuilder stringBuilder)
        {
            throw new System.NotSupportedException("BuildStateUsageBodyHandCoded requires manual implementation");
        }
    }
}
