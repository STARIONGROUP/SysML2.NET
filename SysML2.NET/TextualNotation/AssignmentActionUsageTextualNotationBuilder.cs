...
namespace SysML2.NET.TextualNotation
{
    ...
    /// <summary>
    /// Hand-coded part of <see cref="AssignmentActionUsageTextualNotationBuilder"/>
    /// </summary>
    public static partial class AssignmentActionUsageTextualNotationBuilder
    {
        /// <summary>
        /// Builds the conditional part for the TransitionAssignmentActionUsage rule
        /// </summary>
        /// <param name="poco">The <see cref="IAssignmentActionUsage"/></param>
