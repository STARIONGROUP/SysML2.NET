...
namespace SysML2.NET.TextualNotation
{
    ...
    /// <summary>
    /// Hand-coded part of the <see cref="StateDefinitionTextualNotationBuilder" />
    /// </summary>
    public static partial class StateDefinitionTextualNotationBuilder
    {
        ...
        private static void BuildStateDefBodyHandCoded(IStateDefinition poco, ICursorCache cursorCache, StringBuilder stringBuilder)
        {
            throw new System.NotSupportedException("BuildStateDefBodyHandCoded requires manual implementation");
        }
    }
}
