// -------------------------------------------------------------------------------------------------
// <copyright file="BooleanExpressionTextualNotationBuilder.cs" company="Starion Group S.A.">
// 
...
namespace SysML2.NET.TextualNotation
{
    ...
    /// <summary>
    /// Hand-coded part of the <see cref="BooleanExpressionTextualNotationBuilder" />
    /// </summary>
    public static partial class BooleanExpressionTextualNotationBuilder
    {
        ...
        private static void BuildFeaturePrefixHandCoded(IBooleanExpression poco, ICursorCache cursorCache, StringBuilder stringBuilder)
        {
