...
namespace SysML2.NET.TextualNotation
{
    ...
    /// <summary>
    /// Hand-coded part of the <see cref="TypeFeaturingTextualNotationBuilder"/>
    /// </summary>
    public static partial class TypeFeaturingTextualNotationBuilder
    {
        /// <summary>
        /// Builds the conditional part for the TypeFeaturing rule
        /// </summary>
        /// <param name="poco">The <see cref="ITypeFeaturing"/></param>
        /// <returns>The assertion of the condition</returns>
        private static bool BuildGroupConditionForTypeFeaturing(ITypeFeaturing poco)
        {
