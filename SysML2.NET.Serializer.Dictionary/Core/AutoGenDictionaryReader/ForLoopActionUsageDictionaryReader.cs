...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class ForLoopActionUsageDictionaryReader
    {
        ...
        private static IForLoopActionUsage ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The isConstant property is missing from the dictionary, the dictionary cannot be converted into a ForLoopActionUsage");
            }
            ...
            {
                throw new ArgumentException("The isVariable property is missing from the dictionary, the dictionary cannot be converted into a ForLoopActionUsage");
            }
            ...
            forLoopActionUsageInstance.IsVariable = isVariableFeature;
