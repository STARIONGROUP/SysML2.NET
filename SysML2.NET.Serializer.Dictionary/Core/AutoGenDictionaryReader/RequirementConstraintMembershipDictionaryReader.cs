// -------------------------------------------------------------------------------------------------
// <copyright file="RequirementConstraintMembershipDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="RequirementConstraintMembershipDictionaryReader"/> is to read (convert)
    /// a <see cref="Dictionary{String, Object}"/> from an <see cref="IRequirementConstraintMembership"/>
    /// </summary>
    public static class RequirementConstraintMembershipDictionaryReader
    {
        /// <summary>
        /// Reads a <see cref="IRequirementConstraintMembership"/> from a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property.
        /// </summary>
        /// <param name="dictionary">
        /// The subject <see cref="Dictionary{String, Object}"/> that is to be converted into a <see cref="IRequirementConstraintMembership"/>
        /// </param>
        ...
        /// the values are converted from an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static IRequirementConstraintMembership ReadSimplified(Dictionary<string, object> dictionary)
        {
            var requirementConstraintMembershipInstance = DictionaryNullAndTypeCheck(dictionary);
            ...
            {
                throw new ArgumentException("The feature property is missing from the dictionary, the dictionary cannot be converted into a RequirementConstraintMembership");
            }
            ...
            {
                throw new ArgumentException("The isImplied property is missing from the dictionary, the dictionary cannot be converted into a RequirementConstraintMembership");
            }
            ...
            {
                throw new ArgumentException("The isImpliedIncluded property is missing from the dictionary, the dictionary cannot be converted into a RequirementConstraintMembership");
            }
            bool isImpliedIncludedFeature = Convert.ToBoolean(isImpliedIncludedObject);

            if (!dictionary.TryGetValue("kind", out object kindObject))
            {
                throw new ArgumentException("The kind property is missing from the dictionary, the dictionary cannot be converted into a RequirementConstraintMembership");
            }
            ...
            {
                throw new ArgumentException("The memberElement property is missing from the dictionary, the dictionary cannot be converted into a RequirementConstraintMembership");
            }
            ...
            {
                throw new ArgumentException("The memberName property is missing from the dictionary, the dictionary cannot be converted into a RequirementConstraintMembership");
            }
            ...
            {
                throw new ArgumentException("The memberShortName property is missing from the dictionary, the dictionary cannot be converted into a RequirementConstraintMembership");
            }
            ...
            {
                throw new ArgumentException("The ownedRelationship property is missing from the dictionary, the dictionary cannot be converted into a RequirementConstraintMembership");
            }
            ...
            {
                throw new ArgumentException("The source property is missing from the dictionary, the dictionary cannot be converted into a RequirementConstraintMembership");
            }
            ...
            {
                throw new ArgumentException("The target property is missing from the dictionary, the dictionary cannot be converted into a RequirementConstraintMembership");
            }
            List<Guid> targetFeature = (targetObject as List<string>)?.Select(Guid.Parse).ToList();

            if (!dictionary.TryGetValue("type", out object typeObject))
            {
                throw new ArgumentException("The type property is missing from the dictionary, the dictionary cannot be converted into a RequirementConstraintMembership");
            }
            Guid typeFeature = Guid.Parse(Convert.ToString(typeObject));

            if (!dictionary.TryGetValue("visibility", out object visibilityObject))
            {
                throw new ArgumentException("The visibility property is missing from the dictionary, the dictionary cannot be converted into a RequirementConstraintMembership");
            }
            ...
            requirementConstraintMembershipInstance.IsImpliedIncluded = isImpliedIncludedFeature;
            requirementConstraintMembershipInstance.Kind = kindFeature;
            ...
            requirementConstraintMembershipInstance.Visibility = visibilityFeature;

            return requirementConstraintMembershipInstance;
        }
        ...
        /// An instance of <see cref="IRequirementConstraintMembership"/>
        /// </returns>
        private static IRequirementConstraintMembership ReadComplex(Dictionary<string, object> dictionary)
        {
            var requirementConstraintMembershipInstance = DictionaryNullAndTypeCheck(dictionary);
        ...
        /// of type <see cref="RequirementConstraintMembership"/>
        /// </summary>
        /// <param name="dictionary">
        ...
        /// Thrown when <paramref name="dictionary"/> is not of type <see cref="RequirementConstraintMembership"/>
        /// </exception>
        private static IRequirementConstraintMembership DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            if (dictionary == null)
            {
            ...
            if (type != "RequirementConstraintMembership")
            {
                throw new ArgumentException($"The dictionary contains an Object is of type {type} and can therefore not be converted into a RequirementConstraintMembership");
            }

            if (!dictionary.TryGetValue("@id", out object idObject))
            {
                throw new ArgumentException("The id property is missing from the dictionary, the dictionary cannot be converted into a RequirementConstraintMembership");
            }
            var id = Guid.Parse(Convert.ToString(idObject));

            var requirementConstraintMembershipInstance = new SysML2.NET.Core.DTO.RequirementConstraintMembership
            {
                Id = id
            };
