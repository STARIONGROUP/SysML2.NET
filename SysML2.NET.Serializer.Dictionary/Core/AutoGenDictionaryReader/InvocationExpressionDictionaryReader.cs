// -------------------------------------------------------------------------------------------------
// <copyright file="InvocationExpressionDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class InvocationExpressionDictionaryReader
    {
        ...
        private static IInvocationExpression ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The isConstant property is missing from the dictionary, the dictionary cannot be converted into a InvocationExpression");
            }
            ...
            {
                throw new ArgumentException("The isVariable property is missing from the dictionary, the dictionary cannot be converted into a InvocationExpression");
            }
            ...
            invocationExpressionInstance.IsVariable = isVariableFeature;
        ...
        private static IInvocationExpression DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var invocationExpressionInstance = new SysML2.NET.Core.DTO.InvocationExpression
            {
                Id = id
            };
