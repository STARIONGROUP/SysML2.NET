// -------------------------------------------------------------------------------------------------
// <copyright file="CalculationDefinitionDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class CalculationDefinitionDictionaryReader
    {
        ...
        private static ICalculationDefinition DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var calculationDefinitionInstance = new SysML2.NET.Core.DTO.CalculationDefinition
            {
                Id = id
            };
