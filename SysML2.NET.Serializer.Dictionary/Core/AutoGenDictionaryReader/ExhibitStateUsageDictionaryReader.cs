// -------------------------------------------------------------------------------------------------
// <copyright file="ExhibitStateUsageDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class ExhibitStateUsageDictionaryReader
    {
        ...
        private static IExhibitStateUsage ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The isConstant property is missing from the dictionary, the dictionary cannot be converted into a ExhibitStateUsage");
            }
            ...
            {
                throw new ArgumentException("The isVariable property is missing from the dictionary, the dictionary cannot be converted into a ExhibitStateUsage");
            }
            ...
            exhibitStateUsageInstance.IsConstant = isConstantFeature;
            ...
            exhibitStateUsageInstance.IsVariable = isVariableFeature;
