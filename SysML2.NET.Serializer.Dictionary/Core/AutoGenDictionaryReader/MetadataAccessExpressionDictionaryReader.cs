// -------------------------------------------------------------------------------------------------
// <copyright file="MetadataAccessExpressionDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class MetadataAccessExpressionDictionaryReader
    {
        ...
        private static IMetadataAccessExpression ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The declaredName property is missing from the dictionary, the dictionary cannot be converted into a MetadataAccessExpression");
            }
            string declaredNameFeature = declaredNameObject == null ? null : Convert.ToString(declaredNameObject);

            if (!dictionary.TryGetValue("declaredShortName", out object declaredShortNameObject))
            {
                throw new ArgumentException("The declaredShortName property is missing from the dictionary, the dictionary cannot be converted into a MetadataAccessExpression");
            }
            ...
            metadataAccessExpressionInstance.DeclaredShortName = declaredShortNameFeature;
        ...
        private static IMetadataAccessExpression DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var metadataAccessExpressionInstance = new SysML2.NET.Core.DTO.MetadataAccessExpression
            {
                Id = id
            };
