// -------------------------------------------------------------------------------------------------
// <copyright file="FramedConcernMembershipDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="FramedConcernMembershipDictionaryReader"/> is to read (convert)
    /// a <see cref="Dictionary{String, Object}"/> from an <see cref="IFramedConcernMembership"/>
    /// </summary>
    public static class FramedConcernMembershipDictionaryReader
    {
        /// <summary>
        /// Reads a <see cref="IFramedConcernMembership"/> from a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property.
        /// </summary>
        /// <param name="dictionary">
        /// The subject <see cref="Dictionary{String, Object}"/> that is to be converted into a <see cref="IFramedConcernMembership"/>
        /// </param>
        ...
        /// the values are converted from an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static IFramedConcernMembership ReadSimplified(Dictionary<string, object> dictionary)
        {
            var framedConcernMembershipInstance = DictionaryNullAndTypeCheck(dictionary);
            ...
            {
                throw new ArgumentException("The isImpliedIncluded property is missing from the dictionary, the dictionary cannot be converted into a FramedConcernMembership");
            }
            bool isImpliedIncludedFeature = Convert.ToBoolean(isImpliedIncludedObject);

            if (!dictionary.TryGetValue("kind", out object kindObject))
            {
                throw new ArgumentException("The kind property is missing from the dictionary, the dictionary cannot be converted into a FramedConcernMembership");
            }
            ...
            {
                throw new ArgumentException("The memberElement property is missing from the dictionary, the dictionary cannot be converted into a FramedConcernMembership");
            }
            ...
            {
                throw new ArgumentException("The memberName property is missing from the dictionary, the dictionary cannot be converted into a FramedConcernMembership");
            }
            ...
            {
                throw new ArgumentException("The memberShortName property is missing from the dictionary, the dictionary cannot be converted into a FramedConcernMembership");
            }
            ...
            {
                throw new ArgumentException("The ownedRelationship property is missing from the dictionary, the dictionary cannot be converted into a FramedConcernMembership");
            }
            ...
            {
                throw new ArgumentException("The owningRelatedElement property is missing from the dictionary, the dictionary cannot be converted into a FramedConcernMembership");
            }
            ...
            {
                throw new ArgumentException("The source property is missing from the dictionary, the dictionary cannot be converted into a FramedConcernMembership");
            }
            ...
            {
                throw new ArgumentException("The target property is missing from the dictionary, the dictionary cannot be converted into a FramedConcernMembership");
            }
        ...
        /// An instance of <see cref="IFramedConcernMembership"/>
        /// </returns>
        private static IFramedConcernMembership ReadComplex(Dictionary<string, object> dictionary)
        {
            var framedConcernMembershipInstance = DictionaryNullAndTypeCheck(dictionary);
        ...
        /// of type <see cref="FramedConcernMembership"/>
        /// </summary>
        /// <param name="dictionary">
        ...
        /// Thrown when <paramref name="dictionary"/> is not of type <see cref="FramedConcernMembership"/>
        /// </exception>
        private static IFramedConcernMembership DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            if (dictionary == null)
            {
            ...
            if (type != "FramedConcernMembership")
            {
                throw new ArgumentException($"The dictionary contains an Object is of type {type} and can therefore not be converted into a FramedConcernMembership");
            }

            if (!dictionary.TryGetValue("@id", out object idObject))
            {
                throw new ArgumentException("The id property is missing from the dictionary, the dictionary cannot be converted into a FramedConcernMembership");
            }
            var id = Guid.Parse(Convert.ToString(idObject));

            var framedConcernMembershipInstance = new SysML2.NET.Core.DTO.FramedConcernMembership
            {
                Id = id
            };
