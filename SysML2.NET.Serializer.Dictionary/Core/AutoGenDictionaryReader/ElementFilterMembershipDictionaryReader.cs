// -------------------------------------------------------------------------------------------------
// <copyright file="ElementFilterMembershipDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class ElementFilterMembershipDictionaryReader
    {
        ...
        private static IElementFilterMembership DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var elementFilterMembershipInstance = new SysML2.NET.Core.DTO.ElementFilterMembership
            {
                Id = id
            };
