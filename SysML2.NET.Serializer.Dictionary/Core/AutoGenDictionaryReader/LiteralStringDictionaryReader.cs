// -------------------------------------------------------------------------------------------------
// <copyright file="LiteralStringDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class LiteralStringDictionaryReader
    {
        ...
        private static ILiteralString ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The isConstant property is missing from the dictionary, the dictionary cannot be converted into a LiteralString");
            }
            ...
            {
                throw new ArgumentException("The isVariable property is missing from the dictionary, the dictionary cannot be converted into a LiteralString");
            }
            ...
            literalStringInstance.IsVariable = isVariableFeature;
