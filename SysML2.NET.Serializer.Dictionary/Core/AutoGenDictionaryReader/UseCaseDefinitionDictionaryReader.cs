// -------------------------------------------------------------------------------------------------
// <copyright file="UseCaseDefinitionDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class UseCaseDefinitionDictionaryReader
    {
        ...
        private static IUseCaseDefinition ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The declaredName property is missing from the dictionary, the dictionary cannot be converted into a UseCaseDefinition");
            }
            string declaredNameFeature = declaredNameObject == null ? null : Convert.ToString(declaredNameObject);

            if (!dictionary.TryGetValue("declaredShortName", out object declaredShortNameObject))
            {
                throw new ArgumentException("The declaredShortName property is missing from the dictionary, the dictionary cannot be converted into a UseCaseDefinition");
            }
            ...
            useCaseDefinitionInstance.DeclaredName = declaredNameFeature;
            useCaseDefinitionInstance.DeclaredShortName = declaredShortNameFeature;
        ...
        private static IUseCaseDefinition DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var useCaseDefinitionInstance = new SysML2.NET.Core.DTO.UseCaseDefinition
            {
                Id = id
            };
