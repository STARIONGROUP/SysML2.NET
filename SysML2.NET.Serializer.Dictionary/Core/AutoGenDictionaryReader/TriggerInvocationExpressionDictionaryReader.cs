...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class TriggerInvocationExpressionDictionaryReader
    {
        ...
        private static ITriggerInvocationExpression ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The isConstant property is missing from the dictionary, the dictionary cannot be converted into a TriggerInvocationExpression");
            }
            ...
            {
                throw new ArgumentException("The isVariable property is missing from the dictionary, the dictionary cannot be converted into a TriggerInvocationExpression");
            }
            ...
            triggerInvocationExpressionInstance.IsConstant = isConstantFeature;
            ...
            triggerInvocationExpressionInstance.IsVariable = isVariableFeature;
