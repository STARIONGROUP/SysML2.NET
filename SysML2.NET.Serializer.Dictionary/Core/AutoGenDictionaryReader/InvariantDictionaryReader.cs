// -------------------------------------------------------------------------------------------------
// <copyright file="InvariantDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="InvariantDictionaryReader"/> is to read (convert)
    /// a <see cref="Dictionary{String, Object}"/> from an <see cref="IInvariant"/>
    /// </summary>
    public static class InvariantDictionaryReader
    {
        /// <summary>
        /// Reads a <see cref="IInvariant"/> from a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property.
        /// </summary>
        /// <param name="dictionary">
        /// The subject <see cref="Dictionary{String, Object}"/> that is to be converted into a <see cref="IInvariant"/>
        /// </param>
        ...
        /// the values are converted from an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static IInvariant ReadSimplified(Dictionary<string, object> dictionary)
        {
            var invariantInstance = DictionaryNullAndTypeCheck(dictionary);
            ...
            {
                throw new ArgumentException("The elementId property is missing from the dictionary, the dictionary cannot be converted into a Invariant");
            }
            string elementIdFeature = Convert.ToString(elementIdObject);

            if (!dictionary.TryGetValue("isAbstract", out object isAbstractObject))
            {
                throw new ArgumentException("The isAbstract property is missing from the dictionary, the dictionary cannot be converted into a Invariant");
            }
            ...
            {
                throw new ArgumentException("The isComposite property is missing from the dictionary, the dictionary cannot be converted into a Invariant");
            }
            ...
            {
                throw new ArgumentException("The isConstant property is missing from the dictionary, the dictionary cannot be converted into a Invariant");
            }
            bool isConstantFeature = Convert.ToBoolean(isConstantObject);

            if (!dictionary.TryGetValue("isDerived", out object isDerivedObject))
            {
                throw new ArgumentException("The isDerived property is missing from the dictionary, the dictionary cannot be converted into a Invariant");
            }
            bool isDerivedFeature = Convert.ToBoolean(isDerivedObject);

            if (!dictionary.TryGetValue("isEnd", out object isEndObject))
            {
                throw new ArgumentException("The isEnd property is missing from the dictionary, the dictionary cannot be converted into a Invariant");
            }
            ...
            {
                throw new ArgumentException("The isImpliedIncluded property is missing from the dictionary, the dictionary cannot be converted into a Invariant");
            }
            bool isImpliedIncludedFeature = Convert.ToBoolean(isImpliedIncludedObject);

            if (!dictionary.TryGetValue("isNegated", out object isNegatedObject))
            {
                throw new ArgumentException("The isNegated property is missing from the dictionary, the dictionary cannot be converted into a Invariant");
            }
            bool isNegatedFeature = Convert.ToBoolean(isNegatedObject);

            if (!dictionary.TryGetValue("isOrdered", out object isOrderedObject))
            {
                throw new ArgumentException("The isOrdered property is missing from the dictionary, the dictionary cannot be converted into a Invariant");
            }
            bool isOrderedFeature = Convert.ToBoolean(isOrderedObject);

            if (!dictionary.TryGetValue("isPortion", out object isPortionObject))
            {
                throw new ArgumentException("The isPortion property is missing from the dictionary, the dictionary cannot be converted into a Invariant");
            }
            ...
            {
                throw new ArgumentException("The isSufficient property is missing from the dictionary, the dictionary cannot be converted into a Invariant");
            }
            ...
            {
                throw new ArgumentException("The isUnique property is missing from the dictionary, the dictionary cannot be converted into a Invariant");
            }
            bool isUniqueFeature = Convert.ToBoolean(isUniqueObject);

            if (!dictionary.TryGetValue("isVariable", out object isVariableObject))
            {
                throw new ArgumentException("The isVariable property is missing from the dictionary, the dictionary cannot be converted into a Invariant");
            }
            ...
            {
                throw new ArgumentException("The owningRelationship property is missing from the dictionary, the dictionary cannot be converted into a Invariant");
            }
            ...
            invariantInstance.IsComposite = isCompositeFeature;
            invariantInstance.IsConstant = isConstantFeature;
            invariantInstance.IsDerived = isDerivedFeature;
            invariantInstance.IsEnd = isEndFeature;
            invariantInstance.IsImpliedIncluded = isImpliedIncludedFeature;
            invariantInstance.IsNegated = isNegatedFeature;
            invariantInstance.IsOrdered = isOrderedFeature;
            invariantInstance.IsPortion = isPortionFeature;
            invariantInstance.IsSufficient = isSufficientFeature;
            invariantInstance.IsUnique = isUniqueFeature;
            invariantInstance.IsVariable = isVariableFeature;
        ...
        /// An instance of <see cref="IInvariant"/>
        /// </returns>
        private static IInvariant ReadComplex(Dictionary<string, object> dictionary)
        {
            var invariantInstance = DictionaryNullAndTypeCheck(dictionary);
        ...
        /// Thrown when <paramref name="dictionary"/> is not of type <see cref="Invariant"/>
        /// </exception>
        private static IInvariant DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            if (dictionary == null)
            {
            ...
            {
                throw new ArgumentException("The type property is missing from the dictionary, the dictionary cannot be converted into a Invariant");
            }
            ...
            if (type != "Invariant")
            {
                throw new ArgumentException($"The dictionary contains an Object is of type {type} and can therefore not be converted into a Invariant");
            }

            if (!dictionary.TryGetValue("@id", out object idObject))
            {
                throw new ArgumentException("The id property is missing from the dictionary, the dictionary cannot be converted into a Invariant");
            }
            var id = Guid.Parse(Convert.ToString(idObject));

            var invariantInstance = new SysML2.NET.Core.DTO.Invariant
            {
                Id = id
            };
