// -------------------------------------------------------------------------------------------------
// <copyright file="ViewpointDefinitionDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="ViewpointDefinitionDictionaryReader"/> is to read (convert)
    /// a <see cref="Dictionary{String, Object}"/> from an <see cref="IViewpointDefinition"/>
    /// </summary>
    public static class ViewpointDefinitionDictionaryReader
    {
        /// <summary>
        /// Reads a <see cref="IViewpointDefinition"/> from a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property.
        /// </summary>
        /// <param name="dictionary">
        /// The subject <see cref="Dictionary{String, Object}"/> that is to be converted into a <see cref="IViewpointDefinition"/>
        /// </param>
        ...
        /// the values are converted from an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static IViewpointDefinition ReadSimplified(Dictionary<string, object> dictionary)
        {
            var viewpointDefinitionInstance = DictionaryNullAndTypeCheck(dictionary);

            if (!dictionary.TryGetValue("aliasIds", out object aliasIdsObject))
            {
                throw new ArgumentException("The aliasIds property is missing from the dictionary, the dictionary cannot be converted into a ViewpointDefinition");
            }
            ...
            {
                throw new ArgumentException("The isAbstract property is missing from the dictionary, the dictionary cannot be converted into a ViewpointDefinition");
            }
            ...
            {
                throw new ArgumentException("The isImpliedIncluded property is missing from the dictionary, the dictionary cannot be converted into a ViewpointDefinition");
            }
            bool isImpliedIncludedFeature = Convert.ToBoolean(isImpliedIncludedObject);

            if (!dictionary.TryGetValue("isIndividual", out object isIndividualObject))
            {
                throw new ArgumentException("The isIndividual property is missing from the dictionary, the dictionary cannot be converted into a ViewpointDefinition");
            }
            ...
            {
                throw new ArgumentException("The isSufficient property is missing from the dictionary, the dictionary cannot be converted into a ViewpointDefinition");
            }
            ...
            {
                throw new ArgumentException("The isVariation property is missing from the dictionary, the dictionary cannot be converted into a ViewpointDefinition");
            }
            ...
            {
                throw new ArgumentException("The owningRelationship property is missing from the dictionary, the dictionary cannot be converted into a ViewpointDefinition");
            }
            Guid? owningRelationshipFeature = owningRelationshipObject == null ? (Guid?)null : Guid.Parse(Convert.ToString(owningRelationshipObject));

            if (!dictionary.TryGetValue("reqId", out object reqIdObject))
            {
                throw new ArgumentException("The reqId property is missing from the dictionary, the dictionary cannot be converted into a ViewpointDefinition");
            }
        ...
        /// An instance of <see cref="IViewpointDefinition"/>
        /// </returns>
        private static IViewpointDefinition ReadComplex(Dictionary<string, object> dictionary)
        {
            var viewpointDefinitionInstance = DictionaryNullAndTypeCheck(dictionary);
        ...
        /// of type <see cref="ViewpointDefinition"/>
        /// </summary>
        /// <param name="dictionary">
        ...
        /// Thrown when <paramref name="dictionary"/> is not of type <see cref="ViewpointDefinition"/>
        /// </exception>
        private static IViewpointDefinition DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            if (dictionary == null)
            {
            ...
            {
                throw new ArgumentException("The type property is missing from the dictionary, the dictionary cannot be converted into a ViewpointDefinition");
            }

            var type = Convert.ToString(typeObject);

            if (type != "ViewpointDefinition")
            {
                throw new ArgumentException($"The dictionary contains an Object is of type {type} and can therefore not be converted into a ViewpointDefinition");
            }

            if (!dictionary.TryGetValue("@id", out object idObject))
            {
                throw new ArgumentException("The id property is missing from the dictionary, the dictionary cannot be converted into a ViewpointDefinition");
            }
            var id = Guid.Parse(Convert.ToString(idObject));

            var viewpointDefinitionInstance = new SysML2.NET.Core.DTO.ViewpointDefinition
            {
                Id = id
            };
