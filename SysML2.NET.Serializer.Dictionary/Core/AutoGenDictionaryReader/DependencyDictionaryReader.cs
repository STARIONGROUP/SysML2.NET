// -------------------------------------------------------------------------------------------------
// <copyright file="DependencyDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="DependencyDictionaryReader"/> is to read (convert)
    /// a <see cref="Dictionary{String, Object}"/> from an <see cref="IDependency"/>
    /// </summary>
    public static class DependencyDictionaryReader
    {
        /// <summary>
        /// Reads a <see cref="IDependency"/> from a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property.
        /// </summary>
        /// <param name="dictionary">
        /// The subject <see cref="Dictionary{String, Object}"/> that is to be converted into a <see cref="IDependency"/>
        /// </param>
        ...
        /// the values are converted from an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static IDependency ReadSimplified(Dictionary<string, object> dictionary)
        {
            var dependencyInstance = DictionaryNullAndTypeCheck(dictionary);

            if (!dictionary.TryGetValue("aliasIds", out object aliasIdsObject))
            {
                throw new ArgumentException("The aliasIds property is missing from the dictionary, the dictionary cannot be converted into a Dependency");
            }
            List<string> aliasIdsFeature = aliasIdsObject as List<string>;

            if (!dictionary.TryGetValue("client", out object clientObject))
            {
                throw new ArgumentException("The client property is missing from the dictionary, the dictionary cannot be converted into a Dependency");
            }
            ...
            {
                throw new ArgumentException("The isImplied property is missing from the dictionary, the dictionary cannot be converted into a Dependency");
            }
            ...
            {
                throw new ArgumentException("The ownedRelatedElement property is missing from the dictionary, the dictionary cannot be converted into a Dependency");
            }
            List<Guid> ownedRelatedElementFeature = (ownedRelatedElementObject as List<string>)?.Select(Guid.Parse).ToList();

            if (!dictionary.TryGetValue("ownedRelationship", out object ownedRelationshipObject))
            {
                throw new ArgumentException("The ownedRelationship property is missing from the dictionary, the dictionary cannot be converted into a Dependency");
            }
            ...
            {
                throw new ArgumentException("The owningRelatedElement property is missing from the dictionary, the dictionary cannot be converted into a Dependency");
            }
            ...
            {
                throw new ArgumentException("The owningRelationship property is missing from the dictionary, the dictionary cannot be converted into a Dependency");
            }
            ...
            if (!dictionary.TryGetValue("supplier", out object supplierObject))
            {
                throw new ArgumentException("The supplier property is missing from the dictionary, the dictionary cannot be converted into a Dependency");
            }
            List<Guid> supplierFeature = (supplierObject as List<string>)?.Select(Guid.Parse).ToList();

            if (!dictionary.TryGetValue("target", out object targetObject))
            {
                throw new ArgumentException("The target property is missing from the dictionary, the dictionary cannot be converted into a Dependency");
            }
        ...
        /// An instance of <see cref="IDependency"/>
        /// </returns>
        private static IDependency ReadComplex(Dictionary<string, object> dictionary)
        {
            var dependencyInstance = DictionaryNullAndTypeCheck(dictionary);
            ...
            List<Guid> supplierFeature = (supplierObject as List<Guid>);
        ...
        /// Thrown when <paramref name="dictionary"/> is not of type <see cref="Dependency"/>
        /// </exception>
        private static IDependency DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            if (dictionary == null)
            {
            ...
            {
                throw new ArgumentException("The type property is missing from the dictionary, the dictionary cannot be converted into a Dependency");
            }
            ...
            if (type != "Dependency")
            {
                throw new ArgumentException($"The dictionary contains an Object is of type {type} and can therefore not be converted into a Dependency");
            }

            if (!dictionary.TryGetValue("@id", out object idObject))
            {
                throw new ArgumentException("The id property is missing from the dictionary, the dictionary cannot be converted into a Dependency");
            }
