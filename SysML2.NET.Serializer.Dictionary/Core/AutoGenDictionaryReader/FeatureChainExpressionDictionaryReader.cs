// -------------------------------------------------------------------------------------------------
// <copyright file="FeatureChainExpressionDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="FeatureChainExpressionDictionaryReader"/> is to read (convert)
    /// a <see cref="Dictionary{String, Object}"/> from an <see cref="IFeatureChainExpression"/>
    /// </summary>
    public static class FeatureChainExpressionDictionaryReader
    {
        /// <summary>
        /// Reads a <see cref="IFeatureChainExpression"/> from a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property.
        /// </summary>
        /// <param name="dictionary">
        /// The subject <see cref="Dictionary{String, Object}"/> that is to be converted into a <see cref="IFeatureChainExpression"/>
        /// </param>
        ...
        /// the values are converted from an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static IFeatureChainExpression ReadSimplified(Dictionary<string, object> dictionary)
        {
            var featureChainExpressionInstance = DictionaryNullAndTypeCheck(dictionary);
            ...
            {
                throw new ArgumentException("The elementId property is missing from the dictionary, the dictionary cannot be converted into a FeatureChainExpression");
            }
            string elementIdFeature = Convert.ToString(elementIdObject);

            if (!dictionary.TryGetValue("isAbstract", out object isAbstractObject))
            {
                throw new ArgumentException("The isAbstract property is missing from the dictionary, the dictionary cannot be converted into a FeatureChainExpression");
            }
            ...
            {
                throw new ArgumentException("The isComposite property is missing from the dictionary, the dictionary cannot be converted into a FeatureChainExpression");
            }
            ...
            {
                throw new ArgumentException("The isConstant property is missing from the dictionary, the dictionary cannot be converted into a FeatureChainExpression");
            }
            bool isConstantFeature = Convert.ToBoolean(isConstantObject);

            if (!dictionary.TryGetValue("isDerived", out object isDerivedObject))
            {
                throw new ArgumentException("The isDerived property is missing from the dictionary, the dictionary cannot be converted into a FeatureChainExpression");
            }
            bool isDerivedFeature = Convert.ToBoolean(isDerivedObject);

            if (!dictionary.TryGetValue("isEnd", out object isEndObject))
            {
                throw new ArgumentException("The isEnd property is missing from the dictionary, the dictionary cannot be converted into a FeatureChainExpression");
            }
            ...
            {
                throw new ArgumentException("The isImpliedIncluded property is missing from the dictionary, the dictionary cannot be converted into a FeatureChainExpression");
            }
            bool isImpliedIncludedFeature = Convert.ToBoolean(isImpliedIncludedObject);

            if (!dictionary.TryGetValue("isOrdered", out object isOrderedObject))
            {
                throw new ArgumentException("The isOrdered property is missing from the dictionary, the dictionary cannot be converted into a FeatureChainExpression");
            }
            bool isOrderedFeature = Convert.ToBoolean(isOrderedObject);

            if (!dictionary.TryGetValue("isPortion", out object isPortionObject))
            {
                throw new ArgumentException("The isPortion property is missing from the dictionary, the dictionary cannot be converted into a FeatureChainExpression");
            }
            ...
            {
                throw new ArgumentException("The isSufficient property is missing from the dictionary, the dictionary cannot be converted into a FeatureChainExpression");
            }
            ...
            {
                throw new ArgumentException("The isUnique property is missing from the dictionary, the dictionary cannot be converted into a FeatureChainExpression");
            }
            bool isUniqueFeature = Convert.ToBoolean(isUniqueObject);

            if (!dictionary.TryGetValue("isVariable", out object isVariableObject))
            {
                throw new ArgumentException("The isVariable property is missing from the dictionary, the dictionary cannot be converted into a FeatureChainExpression");
            }
            ...
            {
                throw new ArgumentException("The ownedRelationship property is missing from the dictionary, the dictionary cannot be converted into a FeatureChainExpression");
            }
            ...
            {
                throw new ArgumentException("The owningRelationship property is missing from the dictionary, the dictionary cannot be converted into a FeatureChainExpression");
            }
            ...
            featureChainExpressionInstance.IsComposite = isCompositeFeature;
            featureChainExpressionInstance.IsConstant = isConstantFeature;
            featureChainExpressionInstance.IsDerived = isDerivedFeature;
            featureChainExpressionInstance.IsEnd = isEndFeature;
            featureChainExpressionInstance.IsImpliedIncluded = isImpliedIncludedFeature;
            featureChainExpressionInstance.IsOrdered = isOrderedFeature;
            featureChainExpressionInstance.IsPortion = isPortionFeature;
            featureChainExpressionInstance.IsSufficient = isSufficientFeature;
            featureChainExpressionInstance.IsUnique = isUniqueFeature;
            featureChainExpressionInstance.IsVariable = isVariableFeature;
        ...
        /// An instance of <see cref="IFeatureChainExpression"/>
        /// </returns>
        private static IFeatureChainExpression ReadComplex(Dictionary<string, object> dictionary)
        {
            var featureChainExpressionInstance = DictionaryNullAndTypeCheck(dictionary);
        ...
        /// of type <see cref="FeatureChainExpression"/>
        /// </summary>
        /// <param name="dictionary">
        ...
        /// Thrown when <paramref name="dictionary"/> is not of type <see cref="FeatureChainExpression"/>
        /// </exception>
        private static IFeatureChainExpression DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            if (dictionary == null)
            {
            ...
            {
                throw new ArgumentException("The type property is missing from the dictionary, the dictionary cannot be converted into a FeatureChainExpression");
            }

            var type = Convert.ToString(typeObject);

            if (type != "FeatureChainExpression")
            {
                throw new ArgumentException($"The dictionary contains an Object is of type {type} and can therefore not be converted into a FeatureChainExpression");
            }

            if (!dictionary.TryGetValue("@id", out object idObject))
            {
                throw new ArgumentException("The id property is missing from the dictionary, the dictionary cannot be converted into a FeatureChainExpression");
            }
            var id = Guid.Parse(Convert.ToString(idObject));

            var featureChainExpressionInstance = new SysML2.NET.Core.DTO.FeatureChainExpression
            {
                Id = id
            };
