...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class PerformActionUsageDictionaryReader
    {
        ...
        private static IPerformActionUsage ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The isReadOnly property is missing from the dictionary, the dictionary cannot be converted into a PerformActionUsage");
            }
            ...
            performActionUsageInstance.IsReadOnly = isReadOnlyFeature;
