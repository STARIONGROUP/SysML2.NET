// -------------------------------------------------------------------------------------------------
// <copyright file="PerformActionUsageDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="PerformActionUsageDictionaryReader"/> is to read (convert)
    /// a <see cref="Dictionary{String, Object}"/> from an <see cref="IPerformActionUsage"/>
    /// </summary>
    public static class PerformActionUsageDictionaryReader
    {
        /// <summary>
        /// Reads a <see cref="IPerformActionUsage"/> from a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property.
        /// </summary>
        /// <param name="dictionary">
        /// The subject <see cref="Dictionary{String, Object}"/> that is to be converted into a <see cref="IPerformActionUsage"/>
        /// </param>
        ...
        /// the values are converted from an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static IPerformActionUsage ReadSimplified(Dictionary<string, object> dictionary)
        {
            var performActionUsageInstance = DictionaryNullAndTypeCheck(dictionary);
            ...
            {
                throw new ArgumentException("The elementId property is missing from the dictionary, the dictionary cannot be converted into a PerformActionUsage");
            }
            string elementIdFeature = Convert.ToString(elementIdObject);

            if (!dictionary.TryGetValue("isAbstract", out object isAbstractObject))
            {
                throw new ArgumentException("The isAbstract property is missing from the dictionary, the dictionary cannot be converted into a PerformActionUsage");
            }
            ...
            {
                throw new ArgumentException("The isComposite property is missing from the dictionary, the dictionary cannot be converted into a PerformActionUsage");
            }
            ...
            {
                throw new ArgumentException("The isConstant property is missing from the dictionary, the dictionary cannot be converted into a PerformActionUsage");
            }
            bool isConstantFeature = Convert.ToBoolean(isConstantObject);

            if (!dictionary.TryGetValue("isDerived", out object isDerivedObject))
            {
                throw new ArgumentException("The isDerived property is missing from the dictionary, the dictionary cannot be converted into a PerformActionUsage");
            }
            bool isDerivedFeature = Convert.ToBoolean(isDerivedObject);

            if (!dictionary.TryGetValue("isEnd", out object isEndObject))
            {
                throw new ArgumentException("The isEnd property is missing from the dictionary, the dictionary cannot be converted into a PerformActionUsage");
            }
            ...
            {
                throw new ArgumentException("The isImpliedIncluded property is missing from the dictionary, the dictionary cannot be converted into a PerformActionUsage");
            }
            bool isImpliedIncludedFeature = Convert.ToBoolean(isImpliedIncludedObject);

            if (!dictionary.TryGetValue("isIndividual", out object isIndividualObject))
            {
                throw new ArgumentException("The isIndividual property is missing from the dictionary, the dictionary cannot be converted into a PerformActionUsage");
            }
            ...
            {
                throw new ArgumentException("The isOrdered property is missing from the dictionary, the dictionary cannot be converted into a PerformActionUsage");
            }
            bool isOrderedFeature = Convert.ToBoolean(isOrderedObject);

            if (!dictionary.TryGetValue("isPortion", out object isPortionObject))
            {
                throw new ArgumentException("The isPortion property is missing from the dictionary, the dictionary cannot be converted into a PerformActionUsage");
            }
            ...
            {
                throw new ArgumentException("The isSufficient property is missing from the dictionary, the dictionary cannot be converted into a PerformActionUsage");
            }
            ...
            {
                throw new ArgumentException("The isUnique property is missing from the dictionary, the dictionary cannot be converted into a PerformActionUsage");
            }
            bool isUniqueFeature = Convert.ToBoolean(isUniqueObject);

            if (!dictionary.TryGetValue("isVariable", out object isVariableObject))
            {
                throw new ArgumentException("The isVariable property is missing from the dictionary, the dictionary cannot be converted into a PerformActionUsage");
            }
            ...
            {
                throw new ArgumentException("The isVariation property is missing from the dictionary, the dictionary cannot be converted into a PerformActionUsage");
            }
            ...
            {
                throw new ArgumentException("The owningRelationship property is missing from the dictionary, the dictionary cannot be converted into a PerformActionUsage");
            }
            Guid? owningRelationshipFeature = owningRelationshipObject == null ? (Guid?)null : Guid.Parse(Convert.ToString(owningRelationshipObject));

            if (!dictionary.TryGetValue("portionKind", out object portionKindObject))
            {
                throw new ArgumentException("The portionKind property is missing from the dictionary, the dictionary cannot be converted into a PerformActionUsage");
            }
            ...
            performActionUsageInstance.IsComposite = isCompositeFeature;
            performActionUsageInstance.IsConstant = isConstantFeature;
            performActionUsageInstance.IsDerived = isDerivedFeature;
            performActionUsageInstance.IsEnd = isEndFeature;
            performActionUsageInstance.IsImpliedIncluded = isImpliedIncludedFeature;
            performActionUsageInstance.IsIndividual = isIndividualFeature;
            performActionUsageInstance.IsOrdered = isOrderedFeature;
            performActionUsageInstance.IsPortion = isPortionFeature;
            performActionUsageInstance.IsSufficient = isSufficientFeature;
            performActionUsageInstance.IsUnique = isUniqueFeature;
            performActionUsageInstance.IsVariable = isVariableFeature;
        ...
        /// An instance of <see cref="IPerformActionUsage"/>
        /// </returns>
        private static IPerformActionUsage ReadComplex(Dictionary<string, object> dictionary)
        {
            var performActionUsageInstance = DictionaryNullAndTypeCheck(dictionary);
        ...
        /// of type <see cref="PerformActionUsage"/>
        /// </summary>
        /// <param name="dictionary">
        ...
        /// Thrown when <paramref name="dictionary"/> is not of type <see cref="PerformActionUsage"/>
        /// </exception>
        private static IPerformActionUsage DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            if (dictionary == null)
            {
            ...
            {
                throw new ArgumentException("The type property is missing from the dictionary, the dictionary cannot be converted into a PerformActionUsage");
            }

            var type = Convert.ToString(typeObject);

            if (type != "PerformActionUsage")
            {
                throw new ArgumentException($"The dictionary contains an Object is of type {type} and can therefore not be converted into a PerformActionUsage");
            }

            if (!dictionary.TryGetValue("@id", out object idObject))
            {
                throw new ArgumentException("The id property is missing from the dictionary, the dictionary cannot be converted into a PerformActionUsage");
            }
            var id = Guid.Parse(Convert.ToString(idObject));

            var performActionUsageInstance = new SysML2.NET.Core.DTO.PerformActionUsage
            {
                Id = id
            };
