// -------------------------------------------------------------------------------------------------
// <copyright file="RequirementDefinitionDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="RequirementDefinitionDictionaryReader"/> is to read (convert)
    /// a <see cref="Dictionary{String, Object}"/> from an <see cref="IRequirementDefinition"/>
    /// </summary>
    public static class RequirementDefinitionDictionaryReader
    {
        /// <summary>
        /// Reads a <see cref="IRequirementDefinition"/> from a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property.
        /// </summary>
        /// <param name="dictionary">
        /// The subject <see cref="Dictionary{String, Object}"/> that is to be converted into a <see cref="IRequirementDefinition"/>
        /// </param>
        ...
        /// the values are converted from an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static IRequirementDefinition ReadSimplified(Dictionary<string, object> dictionary)
        {
            var requirementDefinitionInstance = DictionaryNullAndTypeCheck(dictionary);

            if (!dictionary.TryGetValue("aliasIds", out object aliasIdsObject))
            {
                throw new ArgumentException("The aliasIds property is missing from the dictionary, the dictionary cannot be converted into a RequirementDefinition");
            }
            ...
            {
                throw new ArgumentException("The isAbstract property is missing from the dictionary, the dictionary cannot be converted into a RequirementDefinition");
            }
            ...
            {
                throw new ArgumentException("The isImpliedIncluded property is missing from the dictionary, the dictionary cannot be converted into a RequirementDefinition");
            }
            bool isImpliedIncludedFeature = Convert.ToBoolean(isImpliedIncludedObject);

            if (!dictionary.TryGetValue("isIndividual", out object isIndividualObject))
            {
                throw new ArgumentException("The isIndividual property is missing from the dictionary, the dictionary cannot be converted into a RequirementDefinition");
            }
            ...
            {
                throw new ArgumentException("The isSufficient property is missing from the dictionary, the dictionary cannot be converted into a RequirementDefinition");
            }
            ...
            {
                throw new ArgumentException("The isVariation property is missing from the dictionary, the dictionary cannot be converted into a RequirementDefinition");
            }
            ...
            {
                throw new ArgumentException("The owningRelationship property is missing from the dictionary, the dictionary cannot be converted into a RequirementDefinition");
            }
            Guid? owningRelationshipFeature = owningRelationshipObject == null ? (Guid?)null : Guid.Parse(Convert.ToString(owningRelationshipObject));

            if (!dictionary.TryGetValue("reqId", out object reqIdObject))
            {
                throw new ArgumentException("The reqId property is missing from the dictionary, the dictionary cannot be converted into a RequirementDefinition");
            }
        ...
        /// An instance of <see cref="IRequirementDefinition"/>
        /// </returns>
        private static IRequirementDefinition ReadComplex(Dictionary<string, object> dictionary)
        {
            var requirementDefinitionInstance = DictionaryNullAndTypeCheck(dictionary);
        ...
        /// of type <see cref="RequirementDefinition"/>
        /// </summary>
        /// <param name="dictionary">
        ...
        /// Thrown when <paramref name="dictionary"/> is not of type <see cref="RequirementDefinition"/>
        /// </exception>
        private static IRequirementDefinition DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            if (dictionary == null)
            {
            ...
            {
                throw new ArgumentException("The type property is missing from the dictionary, the dictionary cannot be converted into a RequirementDefinition");
            }

            var type = Convert.ToString(typeObject);

            if (type != "RequirementDefinition")
            {
                throw new ArgumentException($"The dictionary contains an Object is of type {type} and can therefore not be converted into a RequirementDefinition");
            }

            if (!dictionary.TryGetValue("@id", out object idObject))
            {
                throw new ArgumentException("The id property is missing from the dictionary, the dictionary cannot be converted into a RequirementDefinition");
            }
            var id = Guid.Parse(Convert.ToString(idObject));

            var requirementDefinitionInstance = new SysML2.NET.Core.DTO.RequirementDefinition
            {
                Id = id
            };
