// -------------------------------------------------------------------------------------------------
// <copyright file="CollectExpressionDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="CollectExpressionDictionaryReader"/> is to read (convert)
    /// a <see cref="Dictionary{String, Object}"/> from an <see cref="ICollectExpression"/>
    /// </summary>
    public static class CollectExpressionDictionaryReader
    {
        /// <summary>
        /// Reads a <see cref="ICollectExpression"/> from a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property.
        /// </summary>
        /// <param name="dictionary">
        /// The subject <see cref="Dictionary{String, Object}"/> that is to be converted into a <see cref="ICollectExpression"/>
        /// </param>
        ...
        /// the values are converted from an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static ICollectExpression ReadSimplified(Dictionary<string, object> dictionary)
        {
            var collectExpressionInstance = DictionaryNullAndTypeCheck(dictionary);
            ...
            {
                throw new ArgumentException("The elementId property is missing from the dictionary, the dictionary cannot be converted into a CollectExpression");
            }
            string elementIdFeature = Convert.ToString(elementIdObject);

            if (!dictionary.TryGetValue("isAbstract", out object isAbstractObject))
            {
                throw new ArgumentException("The isAbstract property is missing from the dictionary, the dictionary cannot be converted into a CollectExpression");
            }
            ...
            {
                throw new ArgumentException("The isComposite property is missing from the dictionary, the dictionary cannot be converted into a CollectExpression");
            }
            ...
            {
                throw new ArgumentException("The isConstant property is missing from the dictionary, the dictionary cannot be converted into a CollectExpression");
            }
            bool isConstantFeature = Convert.ToBoolean(isConstantObject);

            if (!dictionary.TryGetValue("isDerived", out object isDerivedObject))
            {
                throw new ArgumentException("The isDerived property is missing from the dictionary, the dictionary cannot be converted into a CollectExpression");
            }
            bool isDerivedFeature = Convert.ToBoolean(isDerivedObject);

            if (!dictionary.TryGetValue("isEnd", out object isEndObject))
            {
                throw new ArgumentException("The isEnd property is missing from the dictionary, the dictionary cannot be converted into a CollectExpression");
            }
            ...
            {
                throw new ArgumentException("The isImpliedIncluded property is missing from the dictionary, the dictionary cannot be converted into a CollectExpression");
            }
            bool isImpliedIncludedFeature = Convert.ToBoolean(isImpliedIncludedObject);

            if (!dictionary.TryGetValue("isOrdered", out object isOrderedObject))
            {
                throw new ArgumentException("The isOrdered property is missing from the dictionary, the dictionary cannot be converted into a CollectExpression");
            }
            bool isOrderedFeature = Convert.ToBoolean(isOrderedObject);

            if (!dictionary.TryGetValue("isPortion", out object isPortionObject))
            {
                throw new ArgumentException("The isPortion property is missing from the dictionary, the dictionary cannot be converted into a CollectExpression");
            }
            ...
            {
                throw new ArgumentException("The isUnique property is missing from the dictionary, the dictionary cannot be converted into a CollectExpression");
            }
            bool isUniqueFeature = Convert.ToBoolean(isUniqueObject);

            if (!dictionary.TryGetValue("isVariable", out object isVariableObject))
            {
                throw new ArgumentException("The isVariable property is missing from the dictionary, the dictionary cannot be converted into a CollectExpression");
            }
            ...
            {
                throw new ArgumentException("The ownedRelationship property is missing from the dictionary, the dictionary cannot be converted into a CollectExpression");
            }
            ...
            {
                throw new ArgumentException("The owningRelationship property is missing from the dictionary, the dictionary cannot be converted into a CollectExpression");
            }
            ...
            collectExpressionInstance.IsComposite = isCompositeFeature;
            collectExpressionInstance.IsConstant = isConstantFeature;
            collectExpressionInstance.IsDerived = isDerivedFeature;
            collectExpressionInstance.IsEnd = isEndFeature;
            collectExpressionInstance.IsImpliedIncluded = isImpliedIncludedFeature;
            collectExpressionInstance.IsOrdered = isOrderedFeature;
            collectExpressionInstance.IsPortion = isPortionFeature;
            collectExpressionInstance.IsSufficient = isSufficientFeature;
            collectExpressionInstance.IsUnique = isUniqueFeature;
            collectExpressionInstance.IsVariable = isVariableFeature;
        ...
        /// An instance of <see cref="ICollectExpression"/>
        /// </returns>
        private static ICollectExpression ReadComplex(Dictionary<string, object> dictionary)
        {
            var collectExpressionInstance = DictionaryNullAndTypeCheck(dictionary);
        ...
        /// of type <see cref="CollectExpression"/>
        /// </summary>
        /// <param name="dictionary">
        ...
        /// Thrown when <paramref name="dictionary"/> is not of type <see cref="CollectExpression"/>
        /// </exception>
        private static ICollectExpression DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            if (dictionary == null)
            {
            ...
            {
                throw new ArgumentException("The type property is missing from the dictionary, the dictionary cannot be converted into a CollectExpression");
            }

            var type = Convert.ToString(typeObject);

            if (type != "CollectExpression")
            {
                throw new ArgumentException($"The dictionary contains an Object is of type {type} and can therefore not be converted into a CollectExpression");
            }

            if (!dictionary.TryGetValue("@id", out object idObject))
            {
                throw new ArgumentException("The id property is missing from the dictionary, the dictionary cannot be converted into a CollectExpression");
            }
            var id = Guid.Parse(Convert.ToString(idObject));

            var collectExpressionInstance = new SysML2.NET.Core.DTO.CollectExpression
            {
                Id = id
            };
