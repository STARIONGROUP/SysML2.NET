// -------------------------------------------------------------------------------------------------
// <copyright file="ReferenceSubsettingDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class ReferenceSubsettingDictionaryReader
    {
        ...
        private static IReferenceSubsetting DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var referenceSubsettingInstance = new SysML2.NET.Core.DTO.ReferenceSubsetting
            {
                Id = id
            };
