...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class RenderingUsageDictionaryReader
    {
        ...
        private static IRenderingUsage ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The isConstant property is missing from the dictionary, the dictionary cannot be converted into a RenderingUsage");
            }
            ...
            {
                throw new ArgumentException("The isVariable property is missing from the dictionary, the dictionary cannot be converted into a RenderingUsage");
            }
            ...
            renderingUsageInstance.IsConstant = isConstantFeature;
            ...
            renderingUsageInstance.IsVariable = isVariableFeature;
