// -------------------------------------------------------------------------------------------------
// <copyright file="UnioningDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="UnioningDictionaryReader"/> is to read (convert)
    /// a <see cref="Dictionary{String, Object}"/> from an <see cref="IUnioning"/>
    /// </summary>
    public static class UnioningDictionaryReader
    {
        /// <summary>
        /// Reads a <see cref="IUnioning"/> from a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property.
        /// </summary>
        /// <param name="dictionary">
        /// The subject <see cref="Dictionary{String, Object}"/> that is to be converted into a <see cref="IUnioning"/>
        /// </param>
        ...
        /// the values are converted from an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static IUnioning ReadSimplified(Dictionary<string, object> dictionary)
        {
            var unioningInstance = DictionaryNullAndTypeCheck(dictionary);

            if (!dictionary.TryGetValue("aliasIds", out object aliasIdsObject))
            {
                throw new ArgumentException("The aliasIds property is missing from the dictionary, the dictionary cannot be converted into a Unioning");
            }
            ...
            {
                throw new ArgumentException("The isImplied property is missing from the dictionary, the dictionary cannot be converted into a Unioning");
            }
            ...
            {
                throw new ArgumentException("The ownedRelatedElement property is missing from the dictionary, the dictionary cannot be converted into a Unioning");
            }
            List<Guid> ownedRelatedElementFeature = (ownedRelatedElementObject as List<string>)?.Select(Guid.Parse).ToList();

            if (!dictionary.TryGetValue("ownedRelationship", out object ownedRelationshipObject))
            {
                throw new ArgumentException("The ownedRelationship property is missing from the dictionary, the dictionary cannot be converted into a Unioning");
            }
            ...
            {
                throw new ArgumentException("The owningRelatedElement property is missing from the dictionary, the dictionary cannot be converted into a Unioning");
            }
            ...
            {
                throw new ArgumentException("The owningRelationship property is missing from the dictionary, the dictionary cannot be converted into a Unioning");
            }
            ...
            {
                throw new ArgumentException("The target property is missing from the dictionary, the dictionary cannot be converted into a Unioning");
            }
            List<Guid> targetFeature = (targetObject as List<string>)?.Select(Guid.Parse).ToList();

            if (!dictionary.TryGetValue("unioningType", out object unioningTypeObject))
            {
                throw new ArgumentException("The unioningType property is missing from the dictionary, the dictionary cannot be converted into a Unioning");
            }
            Guid unioningTypeFeature = Guid.Parse(Convert.ToString(unioningTypeObject));
        ...
        /// An instance of <see cref="IUnioning"/>
        /// </returns>
        private static IUnioning ReadComplex(Dictionary<string, object> dictionary)
        {
            var unioningInstance = DictionaryNullAndTypeCheck(dictionary);
        ...
        /// Thrown when <paramref name="dictionary"/> is not of type <see cref="Unioning"/>
        /// </exception>
        private static IUnioning DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            if (dictionary == null)
            {
            ...
            {
                throw new ArgumentException("The type property is missing from the dictionary, the dictionary cannot be converted into a Unioning");
            }
            ...
            if (type != "Unioning")
            {
                throw new ArgumentException($"The dictionary contains an Object is of type {type} and can therefore not be converted into a Unioning");
            }

            if (!dictionary.TryGetValue("@id", out object idObject))
            {
                throw new ArgumentException("The id property is missing from the dictionary, the dictionary cannot be converted into a Unioning");
            }
            var id = Guid.Parse(Convert.ToString(idObject));

            var unioningInstance = new SysML2.NET.Core.DTO.Unioning
            {
                Id = id
            };
