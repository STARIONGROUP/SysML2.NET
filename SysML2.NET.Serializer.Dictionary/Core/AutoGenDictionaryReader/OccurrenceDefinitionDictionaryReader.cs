// -------------------------------------------------------------------------------------------------
// <copyright file="OccurrenceDefinitionDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="OccurrenceDefinitionDictionaryReader"/> is to read (convert)
    /// a <see cref="Dictionary{String, Object}"/> from an <see cref="IOccurrenceDefinition"/>
    /// </summary>
    public static class OccurrenceDefinitionDictionaryReader
    {
        /// <summary>
        /// Reads a <see cref="IOccurrenceDefinition"/> from a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property.
        /// </summary>
        /// <param name="dictionary">
        /// The subject <see cref="Dictionary{String, Object}"/> that is to be converted into a <see cref="IOccurrenceDefinition"/>
        /// </param>
        ...
        /// the values are converted from an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static IOccurrenceDefinition ReadSimplified(Dictionary<string, object> dictionary)
        {
            var occurrenceDefinitionInstance = DictionaryNullAndTypeCheck(dictionary);

            if (!dictionary.TryGetValue("aliasIds", out object aliasIdsObject))
            {
                throw new ArgumentException("The aliasIds property is missing from the dictionary, the dictionary cannot be converted into a OccurrenceDefinition");
            }
            ...
            {
                throw new ArgumentException("The isAbstract property is missing from the dictionary, the dictionary cannot be converted into a OccurrenceDefinition");
            }
            ...
            {
                throw new ArgumentException("The isImpliedIncluded property is missing from the dictionary, the dictionary cannot be converted into a OccurrenceDefinition");
            }
            bool isImpliedIncludedFeature = Convert.ToBoolean(isImpliedIncludedObject);

            if (!dictionary.TryGetValue("isIndividual", out object isIndividualObject))
            {
                throw new ArgumentException("The isIndividual property is missing from the dictionary, the dictionary cannot be converted into a OccurrenceDefinition");
            }
            ...
            {
                throw new ArgumentException("The isSufficient property is missing from the dictionary, the dictionary cannot be converted into a OccurrenceDefinition");
            }
            ...
            {
                throw new ArgumentException("The isVariation property is missing from the dictionary, the dictionary cannot be converted into a OccurrenceDefinition");
            }
            ...
            {
                throw new ArgumentException("The owningRelationship property is missing from the dictionary, the dictionary cannot be converted into a OccurrenceDefinition");
            }
        ...
        /// An instance of <see cref="IOccurrenceDefinition"/>
        /// </returns>
        private static IOccurrenceDefinition ReadComplex(Dictionary<string, object> dictionary)
        {
            var occurrenceDefinitionInstance = DictionaryNullAndTypeCheck(dictionary);
        ...
        /// of type <see cref="OccurrenceDefinition"/>
        /// </summary>
        /// <param name="dictionary">
        ...
        /// Thrown when <paramref name="dictionary"/> is not of type <see cref="OccurrenceDefinition"/>
        /// </exception>
        private static IOccurrenceDefinition DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            if (dictionary == null)
            {
            ...
            {
                throw new ArgumentException("The type property is missing from the dictionary, the dictionary cannot be converted into a OccurrenceDefinition");
            }

            var type = Convert.ToString(typeObject);

            if (type != "OccurrenceDefinition")
            {
                throw new ArgumentException($"The dictionary contains an Object is of type {type} and can therefore not be converted into a OccurrenceDefinition");
            }

            if (!dictionary.TryGetValue("@id", out object idObject))
            {
                throw new ArgumentException("The id property is missing from the dictionary, the dictionary cannot be converted into a OccurrenceDefinition");
            }
            var id = Guid.Parse(Convert.ToString(idObject));

            var occurrenceDefinitionInstance = new SysML2.NET.Core.DTO.OccurrenceDefinition
            {
                Id = id
            };
