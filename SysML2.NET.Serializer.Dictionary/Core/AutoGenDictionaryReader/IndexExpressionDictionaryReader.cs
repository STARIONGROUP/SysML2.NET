// -------------------------------------------------------------------------------------------------
// <copyright file="IndexExpressionDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="IndexExpressionDictionaryReader"/> is to read (convert)
    /// a <see cref="Dictionary{String, Object}"/> from an <see cref="IIndexExpression"/>
    /// </summary>
    public static class IndexExpressionDictionaryReader
    {
        /// <summary>
        /// Reads a <see cref="IIndexExpression"/> from a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property.
        /// </summary>
        /// <param name="dictionary">
        /// The subject <see cref="Dictionary{String, Object}"/> that is to be converted into a <see cref="IIndexExpression"/>
        /// </param>
        ...
        /// the values are converted from an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static IIndexExpression ReadSimplified(Dictionary<string, object> dictionary)
        {
            var indexExpressionInstance = DictionaryNullAndTypeCheck(dictionary);

            if (!dictionary.TryGetValue("aliasIds", out object aliasIdsObject))
            {
                throw new ArgumentException("The aliasIds property is missing from the dictionary, the dictionary cannot be converted into a IndexExpression");
            }
            List<string> aliasIdsFeature = aliasIdsObject as List<string>;

            if (!dictionary.TryGetValue("declaredName", out object declaredNameObject))
            {
                throw new ArgumentException("The declaredName property is missing from the dictionary, the dictionary cannot be converted into a IndexExpression");
            }
            string declaredNameFeature = declaredNameObject == null ? null : Convert.ToString(declaredNameObject);

            if (!dictionary.TryGetValue("declaredShortName", out object declaredShortNameObject))
            {
                throw new ArgumentException("The declaredShortName property is missing from the dictionary, the dictionary cannot be converted into a IndexExpression");
            }
            string declaredShortNameFeature = declaredShortNameObject == null ? null : Convert.ToString(declaredShortNameObject);

            if (!dictionary.TryGetValue("direction", out object directionObject))
            {
                throw new ArgumentException("The direction property is missing from the dictionary, the dictionary cannot be converted into a IndexExpression");
            }
            ...
            {
                throw new ArgumentException("The elementId property is missing from the dictionary, the dictionary cannot be converted into a IndexExpression");
            }
            string elementIdFeature = Convert.ToString(elementIdObject);

            if (!dictionary.TryGetValue("isAbstract", out object isAbstractObject))
            {
                throw new ArgumentException("The isAbstract property is missing from the dictionary, the dictionary cannot be converted into a IndexExpression");
            }
            ...
            {
                throw new ArgumentException("The isComposite property is missing from the dictionary, the dictionary cannot be converted into a IndexExpression");
            }
            ...
            {
                throw new ArgumentException("The isEnd property is missing from the dictionary, the dictionary cannot be converted into a IndexExpression");
            }
            ...
            {
                throw new ArgumentException("The isImpliedIncluded property is missing from the dictionary, the dictionary cannot be converted into a IndexExpression");
            }
            bool isImpliedIncludedFeature = Convert.ToBoolean(isImpliedIncludedObject);

            if (!dictionary.TryGetValue("isOrdered", out object isOrderedObject))
            {
                throw new ArgumentException("The isOrdered property is missing from the dictionary, the dictionary cannot be converted into a IndexExpression");
            }
            bool isOrderedFeature = Convert.ToBoolean(isOrderedObject);

            if (!dictionary.TryGetValue("isPortion", out object isPortionObject))
            {
                throw new ArgumentException("The isPortion property is missing from the dictionary, the dictionary cannot be converted into a IndexExpression");
            }
            ...
            {
                throw new ArgumentException("The operator property is missing from the dictionary, the dictionary cannot be converted into a IndexExpression");
            }
            string operatorFeature = Convert.ToString(operatorObject);

            if (!dictionary.TryGetValue("ownedRelationship", out object ownedRelationshipObject))
            {
                throw new ArgumentException("The ownedRelationship property is missing from the dictionary, the dictionary cannot be converted into a IndexExpression");
            }
            ...
            {
                throw new ArgumentException("The owningRelationship property is missing from the dictionary, the dictionary cannot be converted into a IndexExpression");
            }
            Guid? owningRelationshipFeature = owningRelationshipObject == null ? (Guid?)null : Guid.Parse(Convert.ToString(owningRelationshipObject));


            indexExpressionInstance.AliasIds = aliasIdsFeature ?? new List<string>();
            indexExpressionInstance.DeclaredName = declaredNameFeature;
            indexExpressionInstance.DeclaredShortName = declaredShortNameFeature;
            indexExpressionInstance.Direction = directionFeature;
            ...
            return indexExpressionInstance;
        }
        ...
        /// An instance of <see cref="IIndexExpression"/>
        /// </returns>
        private static IIndexExpression ReadComplex(Dictionary<string, object> dictionary)
        {
            var indexExpressionInstance = DictionaryNullAndTypeCheck(dictionary);
        ...
        /// of type <see cref="IndexExpression"/>
        /// </summary>
        /// <param name="dictionary">
        ...
        /// Thrown when <paramref name="dictionary"/> is not of type <see cref="IndexExpression"/>
        /// </exception>
        private static IIndexExpression DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            if (dictionary == null)
            {
            ...
            {
                throw new ArgumentException("The type property is missing from the dictionary, the dictionary cannot be converted into a IndexExpression");
            }
            ...
            {
                throw new ArgumentException($"The dictionary contains an Object is of type {type} and can therefore not be converted into a IndexExpression");
            }

            if (!dictionary.TryGetValue("@id", out object idObject))
            {
                throw new ArgumentException("The id property is missing from the dictionary, the dictionary cannot be converted into a IndexExpression");
            }
            var id = Guid.Parse(Convert.ToString(idObject));

            var indexExpressionInstance = new SysML2.NET.Core.DTO.IndexExpression
            {
                Id = id
            };
