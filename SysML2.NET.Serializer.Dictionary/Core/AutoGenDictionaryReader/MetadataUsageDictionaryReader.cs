...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class MetadataUsageDictionaryReader
    {
        ...
        private static IMetadataUsage ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The isConstant property is missing from the dictionary, the dictionary cannot be converted into a MetadataUsage");
            }
            ...
            {
                throw new ArgumentException("The isVariable property is missing from the dictionary, the dictionary cannot be converted into a MetadataUsage");
            }
            ...
            metadataUsageInstance.IsConstant = isConstantFeature;
            ...
            metadataUsageInstance.IsVariable = isVariableFeature;
