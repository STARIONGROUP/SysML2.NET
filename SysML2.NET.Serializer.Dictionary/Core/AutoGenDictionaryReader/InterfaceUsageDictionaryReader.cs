// -------------------------------------------------------------------------------------------------
// <copyright file="InterfaceUsageDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class InterfaceUsageDictionaryReader
    {
        ...
        private static IInterfaceUsage ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The isConstant property is missing from the dictionary, the dictionary cannot be converted into a InterfaceUsage");
            }
            ...
            {
                throw new ArgumentException("The isVariable property is missing from the dictionary, the dictionary cannot be converted into a InterfaceUsage");
            }
            ...
            interfaceUsageInstance.IsConstant = isConstantFeature;
            ...
            interfaceUsageInstance.IsVariable = isVariableFeature;
