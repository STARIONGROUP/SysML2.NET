// -------------------------------------------------------------------------------------------------
// <copyright file="MembershipExposeDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class MembershipExposeDictionaryReader
    {
        ...
        private static IMembershipExpose ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The declaredName property is missing from the dictionary, the dictionary cannot be converted into a MembershipExpose");
            }
            string declaredNameFeature = declaredNameObject == null ? null : Convert.ToString(declaredNameObject);

            if (!dictionary.TryGetValue("declaredShortName", out object declaredShortNameObject))
            {
                throw new ArgumentException("The declaredShortName property is missing from the dictionary, the dictionary cannot be converted into a MembershipExpose");
            }
            ...
            membershipExposeInstance.DeclaredName = declaredNameFeature;
            membershipExposeInstance.DeclaredShortName = declaredShortNameFeature;
        ...
        private static IMembershipExpose DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var membershipExposeInstance = new SysML2.NET.Core.DTO.MembershipExpose
            {
                Id = id
            };
