// -------------------------------------------------------------------------------------------------
// <copyright file="SelectExpressionDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="SelectExpressionDictionaryReader"/> is to read (convert)
    /// a <see cref="Dictionary{String, Object}"/> from an <see cref="ISelectExpression"/>
    /// </summary>
    public static class SelectExpressionDictionaryReader
    {
        /// <summary>
        /// Reads a <see cref="ISelectExpression"/> from a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property.
        /// </summary>
        /// <param name="dictionary">
        /// The subject <see cref="Dictionary{String, Object}"/> that is to be converted into a <see cref="ISelectExpression"/>
        /// </param>
        ...
        /// the values are converted from an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static ISelectExpression ReadSimplified(Dictionary<string, object> dictionary)
        {
            var selectExpressionInstance = DictionaryNullAndTypeCheck(dictionary);
            ...
            {
                throw new ArgumentException("The elementId property is missing from the dictionary, the dictionary cannot be converted into a SelectExpression");
            }
            string elementIdFeature = Convert.ToString(elementIdObject);

            if (!dictionary.TryGetValue("isAbstract", out object isAbstractObject))
            {
                throw new ArgumentException("The isAbstract property is missing from the dictionary, the dictionary cannot be converted into a SelectExpression");
            }
            ...
            {
                throw new ArgumentException("The isComposite property is missing from the dictionary, the dictionary cannot be converted into a SelectExpression");
            }
            ...
            {
                throw new ArgumentException("The isConstant property is missing from the dictionary, the dictionary cannot be converted into a SelectExpression");
            }
            bool isConstantFeature = Convert.ToBoolean(isConstantObject);

            if (!dictionary.TryGetValue("isDerived", out object isDerivedObject))
            {
                throw new ArgumentException("The isDerived property is missing from the dictionary, the dictionary cannot be converted into a SelectExpression");
            }
            bool isDerivedFeature = Convert.ToBoolean(isDerivedObject);

            if (!dictionary.TryGetValue("isEnd", out object isEndObject))
            {
                throw new ArgumentException("The isEnd property is missing from the dictionary, the dictionary cannot be converted into a SelectExpression");
            }
            ...
            {
                throw new ArgumentException("The isImpliedIncluded property is missing from the dictionary, the dictionary cannot be converted into a SelectExpression");
            }
            bool isImpliedIncludedFeature = Convert.ToBoolean(isImpliedIncludedObject);

            if (!dictionary.TryGetValue("isOrdered", out object isOrderedObject))
            {
                throw new ArgumentException("The isOrdered property is missing from the dictionary, the dictionary cannot be converted into a SelectExpression");
            }
            bool isOrderedFeature = Convert.ToBoolean(isOrderedObject);

            if (!dictionary.TryGetValue("isPortion", out object isPortionObject))
            {
                throw new ArgumentException("The isPortion property is missing from the dictionary, the dictionary cannot be converted into a SelectExpression");
            }
            ...
            {
                throw new ArgumentException("The isSufficient property is missing from the dictionary, the dictionary cannot be converted into a SelectExpression");
            }
            ...
            {
                throw new ArgumentException("The isUnique property is missing from the dictionary, the dictionary cannot be converted into a SelectExpression");
            }
            bool isUniqueFeature = Convert.ToBoolean(isUniqueObject);

            if (!dictionary.TryGetValue("isVariable", out object isVariableObject))
            {
                throw new ArgumentException("The isVariable property is missing from the dictionary, the dictionary cannot be converted into a SelectExpression");
            }
            ...
            {
                throw new ArgumentException("The ownedRelationship property is missing from the dictionary, the dictionary cannot be converted into a SelectExpression");
            }
            ...
            {
                throw new ArgumentException("The owningRelationship property is missing from the dictionary, the dictionary cannot be converted into a SelectExpression");
            }
            ...
            selectExpressionInstance.IsComposite = isCompositeFeature;
            selectExpressionInstance.IsConstant = isConstantFeature;
            selectExpressionInstance.IsDerived = isDerivedFeature;
            selectExpressionInstance.IsEnd = isEndFeature;
            selectExpressionInstance.IsImpliedIncluded = isImpliedIncludedFeature;
            selectExpressionInstance.IsOrdered = isOrderedFeature;
            selectExpressionInstance.IsPortion = isPortionFeature;
            selectExpressionInstance.IsSufficient = isSufficientFeature;
            selectExpressionInstance.IsUnique = isUniqueFeature;
            selectExpressionInstance.IsVariable = isVariableFeature;
        ...
        /// An instance of <see cref="ISelectExpression"/>
        /// </returns>
        private static ISelectExpression ReadComplex(Dictionary<string, object> dictionary)
        {
            var selectExpressionInstance = DictionaryNullAndTypeCheck(dictionary);
        ...
        /// of type <see cref="SelectExpression"/>
        /// </summary>
        /// <param name="dictionary">
        ...
        /// Thrown when <paramref name="dictionary"/> is not of type <see cref="SelectExpression"/>
        /// </exception>
        private static ISelectExpression DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            if (dictionary == null)
            {
            ...
            {
                throw new ArgumentException("The type property is missing from the dictionary, the dictionary cannot be converted into a SelectExpression");
            }

            var type = Convert.ToString(typeObject);

            if (type != "SelectExpression")
            {
                throw new ArgumentException($"The dictionary contains an Object is of type {type} and can therefore not be converted into a SelectExpression");
            }

            if (!dictionary.TryGetValue("@id", out object idObject))
            {
                throw new ArgumentException("The id property is missing from the dictionary, the dictionary cannot be converted into a SelectExpression");
            }
            var id = Guid.Parse(Convert.ToString(idObject));

            var selectExpressionInstance = new SysML2.NET.Core.DTO.SelectExpression
            {
                Id = id
            };
