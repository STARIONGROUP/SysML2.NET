// -------------------------------------------------------------------------------------------------
// <copyright file="ForkNodeDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class ForkNodeDictionaryReader
    {
        ...
        private static IForkNode ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The isConstant property is missing from the dictionary, the dictionary cannot be converted into a ForkNode");
            }
            ...
            {
                throw new ArgumentException("The isVariable property is missing from the dictionary, the dictionary cannot be converted into a ForkNode");
            }
            ...
            forkNodeInstance.IsVariable = isVariableFeature;
        ...
        private static IForkNode DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var forkNodeInstance = new SysML2.NET.Core.DTO.ForkNode
            {
                Id = id
            };
