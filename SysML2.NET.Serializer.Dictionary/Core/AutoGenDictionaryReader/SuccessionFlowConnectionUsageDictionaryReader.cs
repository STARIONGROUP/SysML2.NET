// -------------------------------------------------------------------------------------------------
// <copyright file="SuccessionFlowConnectionUsageDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="SuccessionFlowConnectionUsageDictionaryReader"/> is to read (convert)
    /// a <see cref="Dictionary{String, Object}"/> from an <see cref="ISuccessionFlowConnectionUsage"/>
    /// </summary>
    public static class SuccessionFlowConnectionUsageDictionaryReader
    {
        /// <summary>
        /// Reads a <see cref="ISuccessionFlowConnectionUsage"/> from a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property.
        /// </summary>
        /// <param name="dictionary">
        /// The subject <see cref="Dictionary{String, Object}"/> that is to be converted into a <see cref="ISuccessionFlowConnectionUsage"/>
        /// </param>
        /// <param name="dictionaryKind">
        /// The source <see cref="DictionaryKind"/> that is to be read from
        /// </param>
        /// <returns>
        /// An instance of <see cref="ISuccessionFlowConnectionUsage"/>
        /// </returns>
        /// <remarks>
        ...
        /// the values are converted from an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static ISuccessionFlowConnectionUsage ReadSimplified(Dictionary<string, object> dictionary)
        {
            var successionFlowConnectionUsageInstance = DictionaryNullAndTypeCheck(dictionary);
            ...
            {
                throw new ArgumentException("The elementId property is missing from the dictionary, the dictionary cannot be converted into a SuccessionFlowConnectionUsage");
            }
            string elementIdFeature = Convert.ToString(elementIdObject);

            if (!dictionary.TryGetValue("isAbstract", out object isAbstractObject))
            {
                throw new ArgumentException("The isAbstract property is missing from the dictionary, the dictionary cannot be converted into a SuccessionFlowConnectionUsage");
            }
            ...
            {
                throw new ArgumentException("The isComposite property is missing from the dictionary, the dictionary cannot be converted into a SuccessionFlowConnectionUsage");
            }
            ...
            {
                throw new ArgumentException("The isDerived property is missing from the dictionary, the dictionary cannot be converted into a SuccessionFlowConnectionUsage");
            }
            bool isDerivedFeature = Convert.ToBoolean(isDerivedObject);

            if (!dictionary.TryGetValue("isDirected", out object isDirectedObject))
            {
                throw new ArgumentException("The isDirected property is missing from the dictionary, the dictionary cannot be converted into a SuccessionFlowConnectionUsage");
            }
            bool isDirectedFeature = Convert.ToBoolean(isDirectedObject);

            if (!dictionary.TryGetValue("isEnd", out object isEndObject))
            {
                throw new ArgumentException("The isEnd property is missing from the dictionary, the dictionary cannot be converted into a SuccessionFlowConnectionUsage");
            }
            bool isEndFeature = Convert.ToBoolean(isEndObject);

            if (!dictionary.TryGetValue("isImplied", out object isImpliedObject))
            {
                throw new ArgumentException("The isImplied property is missing from the dictionary, the dictionary cannot be converted into a SuccessionFlowConnectionUsage");
            }
            ...
            {
                throw new ArgumentException("The isImpliedIncluded property is missing from the dictionary, the dictionary cannot be converted into a SuccessionFlowConnectionUsage");
            }
            bool isImpliedIncludedFeature = Convert.ToBoolean(isImpliedIncludedObject);

            if (!dictionary.TryGetValue("isIndividual", out object isIndividualObject))
            {
                throw new ArgumentException("The isIndividual property is missing from the dictionary, the dictionary cannot be converted into a SuccessionFlowConnectionUsage");
            }
            ...
            {
                throw new ArgumentException("The isOrdered property is missing from the dictionary, the dictionary cannot be converted into a SuccessionFlowConnectionUsage");
            }
            bool isOrderedFeature = Convert.ToBoolean(isOrderedObject);

            if (!dictionary.TryGetValue("isPortion", out object isPortionObject))
            {
                throw new ArgumentException("The isPortion property is missing from the dictionary, the dictionary cannot be converted into a SuccessionFlowConnectionUsage");
            }
            bool isPortionFeature = Convert.ToBoolean(isPortionObject);

            if (!dictionary.TryGetValue("isReadOnly", out object isReadOnlyObject))
            {
                throw new ArgumentException("The isReadOnly property is missing from the dictionary, the dictionary cannot be converted into a SuccessionFlowConnectionUsage");
            }
            ...
            {
                throw new ArgumentException("The isSufficient property is missing from the dictionary, the dictionary cannot be converted into a SuccessionFlowConnectionUsage");
            }
            ...
            {
                throw new ArgumentException("The isUnique property is missing from the dictionary, the dictionary cannot be converted into a SuccessionFlowConnectionUsage");
            }
            bool isUniqueFeature = Convert.ToBoolean(isUniqueObject);

            if (!dictionary.TryGetValue("isVariation", out object isVariationObject))
            {
                throw new ArgumentException("The isVariation property is missing from the dictionary, the dictionary cannot be converted into a SuccessionFlowConnectionUsage");
            }
            ...
            {
                throw new ArgumentException("The ownedRelationship property is missing from the dictionary, the dictionary cannot be converted into a SuccessionFlowConnectionUsage");
            }
            ...
            {
                throw new ArgumentException("The owningRelatedElement property is missing from the dictionary, the dictionary cannot be converted into a SuccessionFlowConnectionUsage");
            }
            ...
            {
                throw new ArgumentException("The owningRelationship property is missing from the dictionary, the dictionary cannot be converted into a SuccessionFlowConnectionUsage");
            }
            Guid? owningRelationshipFeature = owningRelationshipObject == null ? (Guid?)null : Guid.Parse(Convert.ToString(owningRelationshipObject));

            if (!dictionary.TryGetValue("portionKind", out object portionKindObject))
            {
                throw new ArgumentException("The portionKind property is missing from the dictionary, the dictionary cannot be converted into a SuccessionFlowConnectionUsage");
            }
            ...
            {
                throw new ArgumentException("The target property is missing from the dictionary, the dictionary cannot be converted into a SuccessionFlowConnectionUsage");
            }
            ...
            successionFlowConnectionUsageInstance.IsComposite = isCompositeFeature;
            successionFlowConnectionUsageInstance.IsDerived = isDerivedFeature;
            successionFlowConnectionUsageInstance.IsDirected = isDirectedFeature;
            successionFlowConnectionUsageInstance.IsEnd = isEndFeature;
            successionFlowConnectionUsageInstance.IsImplied = isImpliedFeature;
            successionFlowConnectionUsageInstance.IsImpliedIncluded = isImpliedIncludedFeature;
            successionFlowConnectionUsageInstance.IsIndividual = isIndividualFeature;
            successionFlowConnectionUsageInstance.IsOrdered = isOrderedFeature;
            successionFlowConnectionUsageInstance.IsPortion = isPortionFeature;
            successionFlowConnectionUsageInstance.IsReadOnly = isReadOnlyFeature;
            ...
            return successionFlowConnectionUsageInstance;
        }
        ...
        /// An instance of <see cref="ISuccessionFlowConnectionUsage"/>
        /// </returns>
        private static ISuccessionFlowConnectionUsage ReadComplex(Dictionary<string, object> dictionary)
        {
            var successionFlowConnectionUsageInstance = DictionaryNullAndTypeCheck(dictionary);
        ...
        /// of type <see cref="SuccessionFlowConnectionUsage"/>
        /// </summary>
        /// <param name="dictionary">
        ...
        /// Thrown when <paramref name="dictionary"/> is not of type <see cref="SuccessionFlowConnectionUsage"/>
        /// </exception>
        private static ISuccessionFlowConnectionUsage DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            if (dictionary == null)
            {
            ...
            {
                throw new ArgumentException("The type property is missing from the dictionary, the dictionary cannot be converted into a SuccessionFlowConnectionUsage");
            }

            var type = Convert.ToString(typeObject);

            if (type != "SuccessionFlowConnectionUsage")
            {
                throw new ArgumentException($"The dictionary contains an Object is of type {type} and can therefore not be converted into a SuccessionFlowConnectionUsage");
            }

            if (!dictionary.TryGetValue("@id", out object idObject))
            {
                throw new ArgumentException("The id property is missing from the dictionary, the dictionary cannot be converted into a SuccessionFlowConnectionUsage");
            }
            var id = Guid.Parse(Convert.ToString(idObject));

            var successionFlowConnectionUsageInstance = new SysML2.NET.Core.DTO.SuccessionFlowConnectionUsage
            {
                Id = id
            };
