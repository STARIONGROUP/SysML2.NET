...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    internal static class DictionaryReaderProvider
    {
        private static readonly Dictionary<string, Func<Dictionary<string, object>, DictionaryKind, IData>> DictionaryReaderFuncMap = new Dictionary<string, Func<Dictionary<string, object>, DictionaryKind, IData>>
        {
            ...
            { "ConstructorExpression", ConstructorExpressionDictionaryReader.Read },
            ...
            { "Flow", FlowDictionaryReader.Read },
            { "FlowDefinition", FlowDefinitionDictionaryReader.Read },
            { "FlowEnd", FlowEndDictionaryReader.Read },
            { "FlowUsage", FlowUsageDictionaryReader.Read },
            ...
            { "PayloadFeature", PayloadFeatureDictionaryReader.Read },
            ...
            { "SuccessionFlow", SuccessionFlowDictionaryReader.Read },
            { "SuccessionFlowUsage", SuccessionFlowUsageDictionaryReader.Read },
