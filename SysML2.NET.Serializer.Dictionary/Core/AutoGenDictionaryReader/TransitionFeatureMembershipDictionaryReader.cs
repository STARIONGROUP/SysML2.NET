// -------------------------------------------------------------------------------------------------
// <copyright file="TransitionFeatureMembershipDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="TransitionFeatureMembershipDictionaryReader"/> is to read (convert)
    /// a <see cref="Dictionary{String, Object}"/> from an <see cref="ITransitionFeatureMembership"/>
    /// </summary>
    public static class TransitionFeatureMembershipDictionaryReader
    {
        /// <summary>
        /// Reads a <see cref="ITransitionFeatureMembership"/> from a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property.
        /// </summary>
        /// <param name="dictionary">
        /// The subject <see cref="Dictionary{String, Object}"/> that is to be converted into a <see cref="ITransitionFeatureMembership"/>
        /// </param>
        ...
        /// the values are converted from an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static ITransitionFeatureMembership ReadSimplified(Dictionary<string, object> dictionary)
        {
            var transitionFeatureMembershipInstance = DictionaryNullAndTypeCheck(dictionary);
            ...
            {
                throw new ArgumentException("The feature property is missing from the dictionary, the dictionary cannot be converted into a TransitionFeatureMembership");
            }
            ...
            {
                throw new ArgumentException("The isImplied property is missing from the dictionary, the dictionary cannot be converted into a TransitionFeatureMembership");
            }
            ...
            {
                throw new ArgumentException("The isImpliedIncluded property is missing from the dictionary, the dictionary cannot be converted into a TransitionFeatureMembership");
            }
            bool isImpliedIncludedFeature = Convert.ToBoolean(isImpliedIncludedObject);

            if (!dictionary.TryGetValue("kind", out object kindObject))
            {
                throw new ArgumentException("The kind property is missing from the dictionary, the dictionary cannot be converted into a TransitionFeatureMembership");
            }
            TransitionFeatureKind kindFeature = (TransitionFeatureKind)Enum.Parse(typeof(TransitionFeatureKind), Convert.ToString(kindObject), true);

            if (!dictionary.TryGetValue("memberElement", out object memberElementObject))
            {
                throw new ArgumentException("The memberElement property is missing from the dictionary, the dictionary cannot be converted into a TransitionFeatureMembership");
            }
            ...
            {
                throw new ArgumentException("The memberName property is missing from the dictionary, the dictionary cannot be converted into a TransitionFeatureMembership");
            }
            ...
            {
                throw new ArgumentException("The memberShortName property is missing from the dictionary, the dictionary cannot be converted into a TransitionFeatureMembership");
            }
            ...
            {
                throw new ArgumentException("The ownedRelationship property is missing from the dictionary, the dictionary cannot be converted into a TransitionFeatureMembership");
            }
            ...
            {
                throw new ArgumentException("The owningRelatedElement property is missing from the dictionary, the dictionary cannot be converted into a TransitionFeatureMembership");
            }
            ...
            {
                throw new ArgumentException("The source property is missing from the dictionary, the dictionary cannot be converted into a TransitionFeatureMembership");
            }
            ...
            {
                throw new ArgumentException("The target property is missing from the dictionary, the dictionary cannot be converted into a TransitionFeatureMembership");
            }
            List<Guid> targetFeature = (targetObject as List<string>)?.Select(Guid.Parse).ToList();

            if (!dictionary.TryGetValue("type", out object typeObject))
            {
                throw new ArgumentException("The type property is missing from the dictionary, the dictionary cannot be converted into a TransitionFeatureMembership");
            }
            Guid typeFeature = Guid.Parse(Convert.ToString(typeObject));

            if (!dictionary.TryGetValue("visibility", out object visibilityObject))
            {
                throw new ArgumentException("The visibility property is missing from the dictionary, the dictionary cannot be converted into a TransitionFeatureMembership");
            }
            ...
            transitionFeatureMembershipInstance.IsImpliedIncluded = isImpliedIncludedFeature;
            transitionFeatureMembershipInstance.Kind = kindFeature;
            ...
            transitionFeatureMembershipInstance.Visibility = visibilityFeature;
        ...
        /// An instance of <see cref="ITransitionFeatureMembership"/>
        /// </returns>
        private static ITransitionFeatureMembership ReadComplex(Dictionary<string, object> dictionary)
        {
            var transitionFeatureMembershipInstance = DictionaryNullAndTypeCheck(dictionary);
            ...
            TransitionFeatureKind kindFeature = (TransitionFeatureKind)kindObject;
        ...
        /// of type <see cref="TransitionFeatureMembership"/>
        /// </summary>
        /// <param name="dictionary">
        ...
        /// Thrown when <paramref name="dictionary"/> is not of type <see cref="TransitionFeatureMembership"/>
        /// </exception>
        private static ITransitionFeatureMembership DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            if (dictionary == null)
            {
            ...
            if (type != "TransitionFeatureMembership")
            {
                throw new ArgumentException($"The dictionary contains an Object is of type {type} and can therefore not be converted into a TransitionFeatureMembership");
            }

            if (!dictionary.TryGetValue("@id", out object idObject))
            {
                throw new ArgumentException("The id property is missing from the dictionary, the dictionary cannot be converted into a TransitionFeatureMembership");
            }
            var id = Guid.Parse(Convert.ToString(idObject));

            var transitionFeatureMembershipInstance = new SysML2.NET.Core.DTO.TransitionFeatureMembership
            {
                Id = id
            };
