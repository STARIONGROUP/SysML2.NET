// -------------------------------------------------------------------------------------------------
// <copyright file="ConjugationDictionaryReader.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="ConjugationDictionaryReader"/> is to read (convert)
    /// a <see cref="Dictionary{String, Object}"/> from an <see cref="IConjugation"/>
    /// </summary>
    public static class ConjugationDictionaryReader
    {
        /// <summary>
        /// Reads a <see cref="IConjugation"/> from a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property.
        /// </summary>
        /// <param name="dictionary">
        /// The subject <see cref="Dictionary{String, Object}"/> that is to be converted into a <see cref="IConjugation"/>
        /// </param>
        ...
        /// the values are converted from an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static IConjugation ReadSimplified(Dictionary<string, object> dictionary)
        {
            var conjugationInstance = DictionaryNullAndTypeCheck(dictionary);

            if (!dictionary.TryGetValue("aliasIds", out object aliasIdsObject))
            {
                throw new ArgumentException("The aliasIds property is missing from the dictionary, the dictionary cannot be converted into a Conjugation");
            }
            List<string> aliasIdsFeature = aliasIdsObject as List<string>;

            if (!dictionary.TryGetValue("conjugatedType", out object conjugatedTypeObject))
            {
                throw new ArgumentException("The conjugatedType property is missing from the dictionary, the dictionary cannot be converted into a Conjugation");
            }
            ...
            {
                throw new ArgumentException("The isImplied property is missing from the dictionary, the dictionary cannot be converted into a Conjugation");
            }
            ...
            {
                throw new ArgumentException("The originalType property is missing from the dictionary, the dictionary cannot be converted into a Conjugation");
            }
            ...
            {
                throw new ArgumentException("The ownedRelatedElement property is missing from the dictionary, the dictionary cannot be converted into a Conjugation");
            }
            List<Guid> ownedRelatedElementFeature = (ownedRelatedElementObject as List<string>)?.Select(Guid.Parse).ToList();

            if (!dictionary.TryGetValue("ownedRelationship", out object ownedRelationshipObject))
            {
                throw new ArgumentException("The ownedRelationship property is missing from the dictionary, the dictionary cannot be converted into a Conjugation");
            }
            ...
            {
                throw new ArgumentException("The owningRelatedElement property is missing from the dictionary, the dictionary cannot be converted into a Conjugation");
            }
            ...
            {
                throw new ArgumentException("The owningRelationship property is missing from the dictionary, the dictionary cannot be converted into a Conjugation");
            }
            ...
            {
                throw new ArgumentException("The target property is missing from the dictionary, the dictionary cannot be converted into a Conjugation");
            }
        ...
        /// An instance of <see cref="IConjugation"/>
        /// </returns>
        private static IConjugation ReadComplex(Dictionary<string, object> dictionary)
        {
            var conjugationInstance = DictionaryNullAndTypeCheck(dictionary);
        ...
        /// Thrown when <paramref name="dictionary"/> is not of type <see cref="Conjugation"/>
        /// </exception>
        private static IConjugation DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            if (dictionary == null)
            {
            ...
            {
                throw new ArgumentException("The type property is missing from the dictionary, the dictionary cannot be converted into a Conjugation");
            }
            ...
            if (type != "Conjugation")
            {
                throw new ArgumentException($"The dictionary contains an Object is of type {type} and can therefore not be converted into a Conjugation");
            }

            if (!dictionary.TryGetValue("@id", out object idObject))
            {
                throw new ArgumentException("The id property is missing from the dictionary, the dictionary cannot be converted into a Conjugation");
            }
            var id = Guid.Parse(Convert.ToString(idObject));

            var conjugationInstance = new SysML2.NET.Core.DTO.Conjugation
            {
                Id = id
            };
