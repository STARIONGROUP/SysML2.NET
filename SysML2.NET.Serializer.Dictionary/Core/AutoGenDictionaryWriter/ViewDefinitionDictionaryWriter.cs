// -------------------------------------------------------------------------------------------------
// <copyright file="ViewDefinitionDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class ViewDefinitionDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IViewDefinition viewDefinitionInstance)
        {
            ...
            dictionary.Add("declaredName", viewDefinitionInstance.DeclaredName);
            dictionary.Add("declaredShortName", viewDefinitionInstance.DeclaredShortName);
