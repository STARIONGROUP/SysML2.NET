// -------------------------------------------------------------------------------------------------
// <copyright file="AssignmentActionUsageDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class AssignmentActionUsageDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IAssignmentActionUsage assignmentActionUsageInstance)
        {
            ...
            dictionary.Add("isConstant", assignmentActionUsageInstance.IsConstant);
            ...
            dictionary.Add("isVariable", assignmentActionUsageInstance.IsVariable);
