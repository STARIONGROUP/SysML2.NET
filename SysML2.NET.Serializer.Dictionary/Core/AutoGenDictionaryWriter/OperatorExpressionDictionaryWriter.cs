// -------------------------------------------------------------------------------------------------
// <copyright file="OperatorExpressionDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class OperatorExpressionDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IOperatorExpression operatorExpressionInstance)
        {
            ...
            dictionary.Add("declaredName", operatorExpressionInstance.DeclaredName);
            dictionary.Add("declaredShortName", operatorExpressionInstance.DeclaredShortName);
            ...
            dictionary.Add("isConstant", operatorExpressionInstance.IsConstant);
            ...
            dictionary.Add("isVariable", operatorExpressionInstance.IsVariable);
