// -------------------------------------------------------------------------------------------------
// <copyright file="FlowConnectionUsageDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class FlowConnectionUsageDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IFlowConnectionUsage flowConnectionUsageInstance)
        {
            ...
            dictionary.Add("declaredName", flowConnectionUsageInstance.DeclaredName);
            dictionary.Add("declaredShortName", flowConnectionUsageInstance.DeclaredShortName);
