// -------------------------------------------------------------------------------------------------
// <copyright file="MultiplicityDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class MultiplicityDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IMultiplicity multiplicityInstance)
        {
            ...
            dictionary.Add("declaredName", multiplicityInstance.DeclaredName);
            dictionary.Add("declaredShortName", multiplicityInstance.DeclaredShortName);
