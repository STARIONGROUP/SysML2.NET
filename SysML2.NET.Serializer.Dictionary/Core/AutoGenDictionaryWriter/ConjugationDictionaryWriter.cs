// -------------------------------------------------------------------------------------------------
// <copyright file="ConjugationDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="ConjugationDictionaryWriter"/> is to write (convert) a <see cref="IConjugation"/>
    /// to a <see cref="Dictionary{String, Object}"/>.
    /// </summary>
    public static class ConjugationDictionaryWriter
    {
        /// <summary>
        /// Writes a <see cref="IConjugation"/> to a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property. The type key is used to store type information (name of the Type).
        /// </summary>
        /// <param name="dataItem">
        /// The subject <see cref="IConjugation"/> that is to be written to a <see cref="Dictionary{String, Object}"/>.
        /// </param>
        ...
        {
            var conjugationInstance = ThingNullAndTypeCheck(dataItem);

            switch (dictionaryKind)
            {
                case DictionaryKind.Complex:
                    return WriteComplex(conjugationInstance);
                case DictionaryKind.Simplified:
                    return WriteSimplified(conjugationInstance);
                default:
        ...
        /// for each property. The type key is used to store type information (name of the Type).
        /// </summary>
        /// <param name="conjugationInstance">
        /// The subject <see cref="IConjugation"/> that is to be written to a <see cref="Dictionary{String, Object}"/>.
        /// </param>
        /// <returns>
        /// An instance of <see cref="Dictionary{String, Object}"/> that contains all the properties as key-value-pairs as well
        ...
        /// the values are converted to an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static Dictionary<string, object> WriteSimplified(IConjugation conjugationInstance)
        {
            var dictionary = new Dictionary<string, object>
            {
                { "@type", "Conjugation" },
                { "@id", conjugationInstance.Id.ToString() }
            };
        ...
        /// </remarks>
        private static Dictionary<string, object> WriteComplex(IConjugation conjugationInstance)
        {
            var dictionary = new Dictionary<string, object>
            {
                { "@type", "Conjugation" },
                { "@id", conjugationInstance.Id }
            };
        ...
        /// Thrown when <paramref name="thing"/> is not of type <see cref="IConjugation"/>
        /// </exception>
        private static IConjugation ThingNullAndTypeCheck(IData dataItem)
        {
            if (dataItem == null)
            {
            ...
            if (!(dataItem is IConjugation conjugationInstance))
            {
                throw new ArgumentException("The dataItem must be of Type IConjugation", "dataItem");
            }
