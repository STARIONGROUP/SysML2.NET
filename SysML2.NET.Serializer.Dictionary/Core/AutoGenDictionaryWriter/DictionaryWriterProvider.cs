...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    internal static class DictionaryWriterProvider
    {
        private static readonly Dictionary<System.Type, Func<IData, DictionaryKind, Dictionary<string, object>>> DictionaryWriterFuncMap = new Dictionary<System.Type, Func<IData, DictionaryKind, Dictionary<string, object>>>
        {
            ...
            { typeof(SysML2.NET.Core.DTO.ConstructorExpression), ConstructorExpressionDictionaryWriter.Write },
            ...
            { typeof(SysML2.NET.Core.DTO.Flow), FlowDictionaryWriter.Write },
            { typeof(SysML2.NET.Core.DTO.FlowDefinition), FlowDefinitionDictionaryWriter.Write },
            { typeof(SysML2.NET.Core.DTO.FlowEnd), FlowEndDictionaryWriter.Write },
            { typeof(SysML2.NET.Core.DTO.FlowUsage), FlowUsageDictionaryWriter.Write },
            ...
            { typeof(SysML2.NET.Core.DTO.PayloadFeature), PayloadFeatureDictionaryWriter.Write },
            ...
            { typeof(SysML2.NET.Core.DTO.SuccessionFlow), SuccessionFlowDictionaryWriter.Write },
            { typeof(SysML2.NET.Core.DTO.SuccessionFlowUsage), SuccessionFlowUsageDictionaryWriter.Write },
