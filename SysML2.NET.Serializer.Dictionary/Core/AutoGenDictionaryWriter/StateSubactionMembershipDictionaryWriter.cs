// -------------------------------------------------------------------------------------------------
// <copyright file="StateSubactionMembershipDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="StateSubactionMembershipDictionaryWriter"/> is to write (convert) a <see cref="IStateSubactionMembership"/>
    /// to a <see cref="Dictionary{String, Object}"/>.
    /// </summary>
    public static class StateSubactionMembershipDictionaryWriter
    {
        /// <summary>
        /// Writes a <see cref="IStateSubactionMembership"/> to a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property. The type key is used to store type information (name of the Type).
        /// </summary>
        /// <param name="dataItem">
        /// The subject <see cref="IStateSubactionMembership"/> that is to be written to a <see cref="Dictionary{String, Object}"/>.
        /// </param>
        ...
        {
            var stateSubactionMembershipInstance = ThingNullAndTypeCheck(dataItem);

            switch (dictionaryKind)
            {
                case DictionaryKind.Complex:
                    return WriteComplex(stateSubactionMembershipInstance);
                case DictionaryKind.Simplified:
                    return WriteSimplified(stateSubactionMembershipInstance);
                default:
        ...
        /// for each property. The type key is used to store type information (name of the Type).
        /// </summary>
        /// <param name="stateSubactionMembershipInstance">
        /// The subject <see cref="IStateSubactionMembership"/> that is to be written to a <see cref="Dictionary{String, Object}"/>.
        /// </param>
        /// <returns>
        /// An instance of <see cref="Dictionary{String, Object}"/> that contains all the properties as key-value-pairs as well
        ...
        /// the values are converted to an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static Dictionary<string, object> WriteSimplified(IStateSubactionMembership stateSubactionMembershipInstance)
        {
            var dictionary = new Dictionary<string, object>
            {
                { "@type", "StateSubactionMembership" },
                { "@id", stateSubactionMembershipInstance.Id.ToString() }
            };
        ...
        /// </remarks>
        private static Dictionary<string, object> WriteComplex(IStateSubactionMembership stateSubactionMembershipInstance)
        {
            var dictionary = new Dictionary<string, object>
            {
                { "@type", "StateSubactionMembership" },
                { "@id", stateSubactionMembershipInstance.Id }
            };
        ...
        /// of type <see cref="IStateSubactionMembership"/>
        /// </summary>
        /// <param name="dataItem">
        ...
        /// Thrown when <paramref name="thing"/> is not of type <see cref="IStateSubactionMembership"/>
        /// </exception>
        private static IStateSubactionMembership ThingNullAndTypeCheck(IData dataItem)
        {
            if (dataItem == null)
            {
            ...
            if (!(dataItem is IStateSubactionMembership stateSubactionMembershipInstance))
            {
                throw new ArgumentException("The dataItem must be of Type IStateSubactionMembership", "dataItem");
            }
