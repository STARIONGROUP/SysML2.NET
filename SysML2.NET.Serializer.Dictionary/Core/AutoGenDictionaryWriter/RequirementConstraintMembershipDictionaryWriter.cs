// -------------------------------------------------------------------------------------------------
// <copyright file="RequirementConstraintMembershipDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="RequirementConstraintMembershipDictionaryWriter"/> is to write (convert) a <see cref="IRequirementConstraintMembership"/>
    /// to a <see cref="Dictionary{String, Object}"/>.
    /// </summary>
    public static class RequirementConstraintMembershipDictionaryWriter
    {
        /// <summary>
        /// Writes a <see cref="IRequirementConstraintMembership"/> to a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property. The type key is used to store type information (name of the Type).
        /// </summary>
        /// <param name="dataItem">
        /// The subject <see cref="IRequirementConstraintMembership"/> that is to be written to a <see cref="Dictionary{String, Object}"/>.
        /// </param>
        ...
        {
            var requirementConstraintMembershipInstance = ThingNullAndTypeCheck(dataItem);

            switch (dictionaryKind)
            {
                case DictionaryKind.Complex:
                    return WriteComplex(requirementConstraintMembershipInstance);
                case DictionaryKind.Simplified:
                    return WriteSimplified(requirementConstraintMembershipInstance);
                default:
        ...
        /// for each property. The type key is used to store type information (name of the Type).
        /// </summary>
        /// <param name="requirementConstraintMembershipInstance">
        /// The subject <see cref="IRequirementConstraintMembership"/> that is to be written to a <see cref="Dictionary{String, Object}"/>.
        /// </param>
        /// <returns>
        /// An instance of <see cref="Dictionary{String, Object}"/> that contains all the properties as key-value-pairs as well
        ...
        /// the values are converted to an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static Dictionary<string, object> WriteSimplified(IRequirementConstraintMembership requirementConstraintMembershipInstance)
        {
            var dictionary = new Dictionary<string, object>
            {
                { "@type", "RequirementConstraintMembership" },
                { "@id", requirementConstraintMembershipInstance.Id.ToString() }
            };
        ...
        /// </remarks>
        private static Dictionary<string, object> WriteComplex(IRequirementConstraintMembership requirementConstraintMembershipInstance)
        {
            var dictionary = new Dictionary<string, object>
            {
                { "@type", "RequirementConstraintMembership" },
                { "@id", requirementConstraintMembershipInstance.Id }
            };
        ...
        /// of type <see cref="IRequirementConstraintMembership"/>
        /// </summary>
        /// <param name="dataItem">
        ...
        /// Thrown when <paramref name="thing"/> is not of type <see cref="IRequirementConstraintMembership"/>
        /// </exception>
        private static IRequirementConstraintMembership ThingNullAndTypeCheck(IData dataItem)
        {
            if (dataItem == null)
            {
            ...
            if (!(dataItem is IRequirementConstraintMembership requirementConstraintMembershipInstance))
            {
                throw new ArgumentException("The dataItem must be of Type IRequirementConstraintMembership", "dataItem");
            }
