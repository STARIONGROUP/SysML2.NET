// -------------------------------------------------------------------------------------------------
// <copyright file="BooleanExpressionDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="BooleanExpressionDictionaryWriter"/> is to write (convert) a <see cref="IBooleanExpression"/>
    /// to a <see cref="Dictionary{String, Object}"/>.
    /// </summary>
    public static class BooleanExpressionDictionaryWriter
    {
        /// <summary>
        /// Writes a <see cref="IBooleanExpression"/> to a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property. The type key is used to store type information (name of the Type).
        /// </summary>
        /// <param name="dataItem">
        /// The subject <see cref="IBooleanExpression"/> that is to be written to a <see cref="Dictionary{String, Object}"/>.
        /// </param>
        ...
        {
            var booleanExpressionInstance = ThingNullAndTypeCheck(dataItem);

            switch (dictionaryKind)
            {
                case DictionaryKind.Complex:
                    return WriteComplex(booleanExpressionInstance);
                case DictionaryKind.Simplified:
                    return WriteSimplified(booleanExpressionInstance);
                default:
        ...
        /// for each property. The type key is used to store type information (name of the Type).
        /// </summary>
        /// <param name="booleanExpressionInstance">
        /// The subject <see cref="IBooleanExpression"/> that is to be written to a <see cref="Dictionary{String, Object}"/>.
        /// </param>
        /// <returns>
        /// An instance of <see cref="Dictionary{String, Object}"/> that contains all the properties as key-value-pairs as well
        ...
        /// the values are converted to an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static Dictionary<string, object> WriteSimplified(IBooleanExpression booleanExpressionInstance)
        {
            var dictionary = new Dictionary<string, object>
            {
                { "@type", "BooleanExpression" },
                { "@id", booleanExpressionInstance.Id.ToString() }
            };
        ...
        /// </remarks>
        private static Dictionary<string, object> WriteComplex(IBooleanExpression booleanExpressionInstance)
        {
            var dictionary = new Dictionary<string, object>
            {
                { "@type", "BooleanExpression" },
                { "@id", booleanExpressionInstance.Id }
            };
        ...
        /// of type <see cref="IBooleanExpression"/>
        /// </summary>
        /// <param name="dataItem">
        ...
        /// Thrown when <paramref name="thing"/> is not of type <see cref="IBooleanExpression"/>
        /// </exception>
        private static IBooleanExpression ThingNullAndTypeCheck(IData dataItem)
        {
            if (dataItem == null)
            {
            ...
            if (!(dataItem is IBooleanExpression booleanExpressionInstance))
            {
                throw new ArgumentException("The dataItem must be of Type IBooleanExpression", "dataItem");
            }
