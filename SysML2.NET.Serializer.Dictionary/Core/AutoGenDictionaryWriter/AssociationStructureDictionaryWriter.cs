// -------------------------------------------------------------------------------------------------
// <copyright file="AssociationStructureDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="AssociationStructureDictionaryWriter"/> is to write (convert) a <see cref="IAssociationStructure"/>
    /// to a <see cref="Dictionary{String, Object}"/>.
    /// </summary>
    public static class AssociationStructureDictionaryWriter
    {
        /// <summary>
        /// Writes a <see cref="IAssociationStructure"/> to a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property. The type key is used to store type information (name of the Type).
        /// </summary>
        /// <param name="dataItem">
        /// The subject <see cref="IAssociationStructure"/> that is to be written to a <see cref="Dictionary{String, Object}"/>.
        /// </param>
        ...
        {
            var associationStructureInstance = ThingNullAndTypeCheck(dataItem);

            switch (dictionaryKind)
            {
                case DictionaryKind.Complex:
                    return WriteComplex(associationStructureInstance);
                case DictionaryKind.Simplified:
                    return WriteSimplified(associationStructureInstance);
                default:
        ...
        /// for each property. The type key is used to store type information (name of the Type).
        /// </summary>
        /// <param name="associationStructureInstance">
        /// The subject <see cref="IAssociationStructure"/> that is to be written to a <see cref="Dictionary{String, Object}"/>.
        /// </param>
        /// <returns>
        /// An instance of <see cref="Dictionary{String, Object}"/> that contains all the properties as key-value-pairs as well
        ...
        /// the values are converted to an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static Dictionary<string, object> WriteSimplified(IAssociationStructure associationStructureInstance)
        {
            var dictionary = new Dictionary<string, object>
            {
                { "@type", "AssociationStructure" },
                { "@id", associationStructureInstance.Id.ToString() }
            };
        ...
        /// </remarks>
        private static Dictionary<string, object> WriteComplex(IAssociationStructure associationStructureInstance)
        {
            var dictionary = new Dictionary<string, object>
            {
                { "@type", "AssociationStructure" },
                { "@id", associationStructureInstance.Id }
            };
        ...
        /// of type <see cref="IAssociationStructure"/>
        /// </summary>
        /// <param name="dataItem">
        ...
        /// Thrown when <paramref name="thing"/> is not of type <see cref="IAssociationStructure"/>
        /// </exception>
        private static IAssociationStructure ThingNullAndTypeCheck(IData dataItem)
        {
            if (dataItem == null)
            {
            ...
            if (!(dataItem is IAssociationStructure associationStructureInstance))
            {
                throw new ArgumentException("The dataItem must be of Type IAssociationStructure", "dataItem");
            }
