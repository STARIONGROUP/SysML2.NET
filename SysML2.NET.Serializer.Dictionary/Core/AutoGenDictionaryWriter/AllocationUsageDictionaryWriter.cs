// -------------------------------------------------------------------------------------------------
// <copyright file="AllocationUsageDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class AllocationUsageDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IAllocationUsage allocationUsageInstance)
        {
            ...
            dictionary.Add("isConstant", allocationUsageInstance.IsConstant);
            ...
            dictionary.Add("isVariable", allocationUsageInstance.IsVariable);
