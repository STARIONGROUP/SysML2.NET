// -------------------------------------------------------------------------------------------------
// <copyright file="ResultExpressionMembershipDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="ResultExpressionMembershipDictionaryWriter"/> is to write (convert) a <see cref="IResultExpressionMembership"/>
    /// to a <see cref="Dictionary{String, Object}"/>.
    /// </summary>
    public static class ResultExpressionMembershipDictionaryWriter
    {
        /// <summary>
        /// Writes a <see cref="IResultExpressionMembership"/> to a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property. The type key is used to store type information (name of the Type).
        /// </summary>
        /// <param name="dataItem">
        /// The subject <see cref="IResultExpressionMembership"/> that is to be written to a <see cref="Dictionary{String, Object}"/>.
        /// </param>
        ...
        {
            var resultExpressionMembershipInstance = ThingNullAndTypeCheck(dataItem);

            switch (dictionaryKind)
            {
                case DictionaryKind.Complex:
                    return WriteComplex(resultExpressionMembershipInstance);
                case DictionaryKind.Simplified:
                    return WriteSimplified(resultExpressionMembershipInstance);
                default:
        ...
        /// for each property. The type key is used to store type information (name of the Type).
        /// </summary>
        /// <param name="resultExpressionMembershipInstance">
        /// The subject <see cref="IResultExpressionMembership"/> that is to be written to a <see cref="Dictionary{String, Object}"/>.
        /// </param>
        /// <returns>
        /// An instance of <see cref="Dictionary{String, Object}"/> that contains all the properties as key-value-pairs as well
        ...
        /// the values are converted to an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static Dictionary<string, object> WriteSimplified(IResultExpressionMembership resultExpressionMembershipInstance)
        {
            var dictionary = new Dictionary<string, object>
            {
                { "@type", "ResultExpressionMembership" },
                { "@id", resultExpressionMembershipInstance.Id.ToString() }
            };
            ...
            dictionary.Add("isImpliedIncluded", resultExpressionMembershipInstance.IsImpliedIncluded);
            ...
            dictionary.Add("visibility", resultExpressionMembershipInstance.Visibility);
        ...
        /// </remarks>
        private static Dictionary<string, object> WriteComplex(IResultExpressionMembership resultExpressionMembershipInstance)
        {
            var dictionary = new Dictionary<string, object>
            {
                { "@type", "ResultExpressionMembership" },
                { "@id", resultExpressionMembershipInstance.Id }
            };
        ...
        /// of type <see cref="IResultExpressionMembership"/>
        /// </summary>
        /// <param name="dataItem">
        ...
        /// Thrown when <paramref name="thing"/> is not of type <see cref="IResultExpressionMembership"/>
        /// </exception>
        private static IResultExpressionMembership ThingNullAndTypeCheck(IData dataItem)
        {
            if (dataItem == null)
            {
            ...
            if (!(dataItem is IResultExpressionMembership resultExpressionMembershipInstance))
            {
                throw new ArgumentException("The dataItem must be of Type IResultExpressionMembership", "dataItem");
            }
