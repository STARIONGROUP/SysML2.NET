// -------------------------------------------------------------------------------------------------
// <copyright file="ReferenceUsageDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class ReferenceUsageDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IReferenceUsage referenceUsageInstance)
        {
            ...
            dictionary.Add("isConstant", referenceUsageInstance.IsConstant);
            ...
            dictionary.Add("isVariable", referenceUsageInstance.IsVariable);
