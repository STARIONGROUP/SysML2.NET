// -------------------------------------------------------------------------------------------------
// <copyright file="InterfaceUsageDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="InterfaceUsageDictionaryWriter"/> is to write (convert) a <see cref="IInterfaceUsage"/>
    /// to a <see cref="Dictionary{String, Object}"/>.
    /// </summary>
    public static class InterfaceUsageDictionaryWriter
    {
        /// <summary>
        /// Writes a <see cref="IInterfaceUsage"/> to a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property. The type key is used to store type information (name of the Type).
        /// </summary>
        /// <param name="dataItem">
        /// The subject <see cref="IInterfaceUsage"/> that is to be written to a <see cref="Dictionary{String, Object}"/>.
        /// </param>
        ...
        {
            var interfaceUsageInstance = ThingNullAndTypeCheck(dataItem);

            switch (dictionaryKind)
            {
                case DictionaryKind.Complex:
                    return WriteComplex(interfaceUsageInstance);
                case DictionaryKind.Simplified:
                    return WriteSimplified(interfaceUsageInstance);
                default:
        ...
        /// for each property. The type key is used to store type information (name of the Type).
        /// </summary>
        /// <param name="interfaceUsageInstance">
        /// The subject <see cref="IInterfaceUsage"/> that is to be written to a <see cref="Dictionary{String, Object}"/>.
        /// </param>
        /// <returns>
        /// An instance of <see cref="Dictionary{String, Object}"/> that contains all the properties as key-value-pairs as well
        ...
        /// the values are converted to an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static Dictionary<string, object> WriteSimplified(IInterfaceUsage interfaceUsageInstance)
        {
            var dictionary = new Dictionary<string, object>
            {
                { "@type", "InterfaceUsage" },
                { "@id", interfaceUsageInstance.Id.ToString() }
            };
            ...
            dictionary.Add("isConstant", interfaceUsageInstance.IsConstant);
            ...
            dictionary.Add("isIndividual", interfaceUsageInstance.IsIndividual);
            dictionary.Add("isOrdered", interfaceUsageInstance.IsOrdered);
            dictionary.Add("isPortion", interfaceUsageInstance.IsPortion);
            dictionary.Add("isSufficient", interfaceUsageInstance.IsSufficient);
            dictionary.Add("isUnique", interfaceUsageInstance.IsUnique);
            dictionary.Add("isVariable", interfaceUsageInstance.IsVariable);
        ...
        /// </remarks>
        private static Dictionary<string, object> WriteComplex(IInterfaceUsage interfaceUsageInstance)
        {
            var dictionary = new Dictionary<string, object>
            {
                { "@type", "InterfaceUsage" },
                { "@id", interfaceUsageInstance.Id }
            };
        ...
        /// of type <see cref="IInterfaceUsage"/>
        /// </summary>
        /// <param name="dataItem">
        ...
        /// Thrown when <paramref name="thing"/> is not of type <see cref="IInterfaceUsage"/>
        /// </exception>
        private static IInterfaceUsage ThingNullAndTypeCheck(IData dataItem)
        {
            if (dataItem == null)
            {
            ...
            if (!(dataItem is IInterfaceUsage interfaceUsageInstance))
            {
                throw new ArgumentException("The dataItem must be of Type IInterfaceUsage", "dataItem");
            }
