// -------------------------------------------------------------------------------------------------
// <copyright file="LiteralStringDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class LiteralStringDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(ILiteralString literalStringInstance)
        {
            ...
            dictionary.Add("declaredName", literalStringInstance.DeclaredName);
            dictionary.Add("declaredShortName", literalStringInstance.DeclaredShortName);
            ...
            dictionary.Add("isConstant", literalStringInstance.IsConstant);
            ...
            dictionary.Add("isVariable", literalStringInstance.IsVariable);
