// -------------------------------------------------------------------------------------------------
// <copyright file="ItemUsageDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class ItemUsageDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IItemUsage itemUsageInstance)
        {
            ...
            dictionary.Add("isConstant", itemUsageInstance.IsConstant);
            ...
            dictionary.Add("isVariable", itemUsageInstance.IsVariable);
