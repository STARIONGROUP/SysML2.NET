// -------------------------------------------------------------------------------------------------
// <copyright file="SpecializationDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="SpecializationDictionaryWriter"/> is to write (convert) a <see cref="ISpecialization"/>
    /// to a <see cref="Dictionary{String, Object}"/>.
    /// </summary>
    public static class SpecializationDictionaryWriter
    {
        /// <summary>
        /// Writes a <see cref="ISpecialization"/> to a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property. The type key is used to store type information (name of the Type).
        /// </summary>
        /// <param name="dataItem">
        /// The subject <see cref="ISpecialization"/> that is to be written to a <see cref="Dictionary{String, Object}"/>.
        /// </param>
        ...
        {
            var specializationInstance = ThingNullAndTypeCheck(dataItem);

            switch (dictionaryKind)
            {
                case DictionaryKind.Complex:
                    return WriteComplex(specializationInstance);
                case DictionaryKind.Simplified:
                    return WriteSimplified(specializationInstance);
                default:
        ...
        /// for each property. The type key is used to store type information (name of the Type).
        /// </summary>
        /// <param name="specializationInstance">
        /// The subject <see cref="ISpecialization"/> that is to be written to a <see cref="Dictionary{String, Object}"/>.
        /// </param>
        /// <returns>
        /// An instance of <see cref="Dictionary{String, Object}"/> that contains all the properties as key-value-pairs as well
        ...
        /// the values are converted to an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static Dictionary<string, object> WriteSimplified(ISpecialization specializationInstance)
        {
            var dictionary = new Dictionary<string, object>
            {
                { "@type", "Specialization" },
                { "@id", specializationInstance.Id.ToString() }
            };
        ...
        /// </remarks>
        private static Dictionary<string, object> WriteComplex(ISpecialization specializationInstance)
        {
            var dictionary = new Dictionary<string, object>
            {
                { "@type", "Specialization" },
                { "@id", specializationInstance.Id }
            };
        ...
        /// of type <see cref="ISpecialization"/>
        /// </summary>
        /// <param name="dataItem">
        ...
        /// Thrown when <paramref name="thing"/> is not of type <see cref="ISpecialization"/>
        /// </exception>
        private static ISpecialization ThingNullAndTypeCheck(IData dataItem)
        {
            if (dataItem == null)
            {
            ...
            if (!(dataItem is ISpecialization specializationInstance))
            {
                throw new ArgumentException("The dataItem must be of Type ISpecialization", "dataItem");
            }
