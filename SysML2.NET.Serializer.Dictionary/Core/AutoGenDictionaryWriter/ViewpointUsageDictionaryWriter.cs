// -------------------------------------------------------------------------------------------------
// <copyright file="ViewpointUsageDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class ViewpointUsageDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IViewpointUsage viewpointUsageInstance)
        {
            ...
            dictionary.Add("declaredName", viewpointUsageInstance.DeclaredName);
            dictionary.Add("declaredShortName", viewpointUsageInstance.DeclaredShortName);
            ...
            dictionary.Add("isConstant", viewpointUsageInstance.IsConstant);
            ...
            dictionary.Add("isVariable", viewpointUsageInstance.IsVariable);
