// -------------------------------------------------------------------------------------------------
// <copyright file="ExhibitStateUsageDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class ExhibitStateUsageDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IExhibitStateUsage exhibitStateUsageInstance)
        {
            ...
            dictionary.Add("declaredName", exhibitStateUsageInstance.DeclaredName);
            dictionary.Add("declaredShortName", exhibitStateUsageInstance.DeclaredShortName);
