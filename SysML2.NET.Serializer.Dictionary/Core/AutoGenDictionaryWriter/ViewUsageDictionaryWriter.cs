// -------------------------------------------------------------------------------------------------
// <copyright file="ViewUsageDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class ViewUsageDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IViewUsage viewUsageInstance)
        {
            ...
            dictionary.Add("isConstant", viewUsageInstance.IsConstant);
            ...
            dictionary.Add("isVariable", viewUsageInstance.IsVariable);
