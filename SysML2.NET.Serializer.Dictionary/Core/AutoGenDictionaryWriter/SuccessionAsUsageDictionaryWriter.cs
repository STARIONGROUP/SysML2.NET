// -------------------------------------------------------------------------------------------------
// <copyright file="SuccessionAsUsageDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class SuccessionAsUsageDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(ISuccessionAsUsage successionAsUsageInstance)
        {
            ...
            dictionary.Add("isConstant", successionAsUsageInstance.IsConstant);
            ...
            dictionary.Add("isVariable", successionAsUsageInstance.IsVariable);
