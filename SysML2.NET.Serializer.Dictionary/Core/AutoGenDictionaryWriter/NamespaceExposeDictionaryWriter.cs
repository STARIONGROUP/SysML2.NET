// -------------------------------------------------------------------------------------------------
// <copyright file="NamespaceExposeDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="NamespaceExposeDictionaryWriter"/> is to write (convert) a <see cref="INamespaceExpose"/>
    /// to a <see cref="Dictionary{String, Object}"/>.
    /// </summary>
    public static class NamespaceExposeDictionaryWriter
    {
        /// <summary>
        /// Writes a <see cref="INamespaceExpose"/> to a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property. The type key is used to store type information (name of the Type).
        /// </summary>
        /// <param name="dataItem">
        /// The subject <see cref="INamespaceExpose"/> that is to be written to a <see cref="Dictionary{String, Object}"/>.
        /// </param>
        ...
        {
            var namespaceExposeInstance = ThingNullAndTypeCheck(dataItem);

            switch (dictionaryKind)
            {
                case DictionaryKind.Complex:
                    return WriteComplex(namespaceExposeInstance);
                case DictionaryKind.Simplified:
                    return WriteSimplified(namespaceExposeInstance);
                default:
        ...
        /// for each property. The type key is used to store type information (name of the Type).
        /// </summary>
        /// <param name="namespaceExposeInstance">
        /// The subject <see cref="INamespaceExpose"/> that is to be written to a <see cref="Dictionary{String, Object}"/>.
        /// </param>
        /// <returns>
        /// An instance of <see cref="Dictionary{String, Object}"/> that contains all the properties as key-value-pairs as well
        ...
        /// the values are converted to an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static Dictionary<string, object> WriteSimplified(INamespaceExpose namespaceExposeInstance)
        {
            var dictionary = new Dictionary<string, object>
            {
                { "@type", "NamespaceExpose" },
                { "@id", namespaceExposeInstance.Id.ToString() }
            };
        ...
        /// </remarks>
        private static Dictionary<string, object> WriteComplex(INamespaceExpose namespaceExposeInstance)
        {
            var dictionary = new Dictionary<string, object>
            {
                { "@type", "NamespaceExpose" },
                { "@id", namespaceExposeInstance.Id }
            };
        ...
        /// of type <see cref="INamespaceExpose"/>
        /// </summary>
        /// <param name="dataItem">
        ...
        /// Thrown when <paramref name="thing"/> is not of type <see cref="INamespaceExpose"/>
        /// </exception>
        private static INamespaceExpose ThingNullAndTypeCheck(IData dataItem)
        {
            if (dataItem == null)
            {
            ...
            if (!(dataItem is INamespaceExpose namespaceExposeInstance))
            {
                throw new ArgumentException("The dataItem must be of Type INamespaceExpose", "dataItem");
            }
