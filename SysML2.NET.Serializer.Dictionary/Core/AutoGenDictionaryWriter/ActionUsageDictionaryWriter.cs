// -------------------------------------------------------------------------------------------------
// <copyright file="ActionUsageDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class ActionUsageDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IActionUsage actionUsageInstance)
        {
            ...
            dictionary.Add("isConstant", actionUsageInstance.IsConstant);
            ...
            dictionary.Add("isVariable", actionUsageInstance.IsVariable);
