// -------------------------------------------------------------------------------------------------
// <copyright file="EventOccurrenceUsageDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class EventOccurrenceUsageDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IEventOccurrenceUsage eventOccurrenceUsageInstance)
        {
            ...
            dictionary.Add("isConstant", eventOccurrenceUsageInstance.IsConstant);
            ...
            dictionary.Add("isVariable", eventOccurrenceUsageInstance.IsVariable);
