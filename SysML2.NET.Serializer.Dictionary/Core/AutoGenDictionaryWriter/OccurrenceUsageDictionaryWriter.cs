// -------------------------------------------------------------------------------------------------
// <copyright file="OccurrenceUsageDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class OccurrenceUsageDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IOccurrenceUsage occurrenceUsageInstance)
        {
            ...
            dictionary.Add("isConstant", occurrenceUsageInstance.IsConstant);
            ...
            dictionary.Add("isVariable", occurrenceUsageInstance.IsVariable);
