// -------------------------------------------------------------------------------------------------
// <copyright file="ConcernUsageDictionaryWriter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class ConcernUsageDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IConcernUsage concernUsageInstance)
        {
            ...
            dictionary.Add("isConstant", concernUsageInstance.IsConstant);
            ...
            dictionary.Add("isVariable", concernUsageInstance.IsVariable);
