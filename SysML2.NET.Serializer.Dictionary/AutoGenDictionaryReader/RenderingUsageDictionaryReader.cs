// -------------------------------------------------------------------------------------------------
// <copyright file="RenderingUsageDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class RenderingUsageDictionaryReader
    {
        ...
        private static IRenderingUsage ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a RenderingUsage");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a RenderingUsage");
            }
            ...
            renderingUsageInstance.Name = nameFeature;
            ...
            renderingUsageInstance.ShortName = shortNameFeature;
        ...
        private static IRenderingUsage DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var renderingUsageInstance = new Core.DTO.RenderingUsage
            {
                Id = id
            };
