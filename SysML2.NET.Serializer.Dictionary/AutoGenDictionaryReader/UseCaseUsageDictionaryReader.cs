// -------------------------------------------------------------------------------------------------
// <copyright file="UseCaseUsageDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class UseCaseUsageDictionaryReader
    {
        ...
        private static IUseCaseUsage ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The isReadOnly property is missing from the dictionary, the dictionary cannot be converted into a UseCaseUsage");
            }
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a UseCaseUsage");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a UseCaseUsage");
            }
            ...
            useCaseUsageInstance.IsReadOnly = isReadOnlyFeature;
            ...
            useCaseUsageInstance.Name = nameFeature;
            ...
            useCaseUsageInstance.ShortName = shortNameFeature;
        ...
        private static IUseCaseUsage DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var useCaseUsageInstance = new Core.DTO.UseCaseUsage
            {
                Id = id
            };
