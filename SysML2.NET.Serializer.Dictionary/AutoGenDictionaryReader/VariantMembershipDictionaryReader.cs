// -------------------------------------------------------------------------------------------------
// <copyright file="VariantMembershipDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class VariantMembershipDictionaryReader
    {
        ...
        private static IVariantMembership ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a VariantMembership");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a VariantMembership");
            }
            ...
            variantMembershipInstance.Name = nameFeature;
            ...
            variantMembershipInstance.ShortName = shortNameFeature;
        ...
        private static IVariantMembership DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var variantMembershipInstance = new Core.DTO.VariantMembership
            {
                Id = id
            };
