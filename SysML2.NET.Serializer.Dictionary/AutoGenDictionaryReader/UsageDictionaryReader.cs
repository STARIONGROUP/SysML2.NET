// -------------------------------------------------------------------------------------------------
// <copyright file="UsageDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class UsageDictionaryReader
    {
        ...
        private static IUsage ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a Usage");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a Usage");
            }
            ...
            usageInstance.Name = nameFeature;
            ...
            usageInstance.ShortName = shortNameFeature;
        ...
        private static IUsage DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var usageInstance = new Core.DTO.Usage
            {
                Id = id
            };
