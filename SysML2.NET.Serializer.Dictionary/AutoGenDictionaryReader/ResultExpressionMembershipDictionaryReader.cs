// -------------------------------------------------------------------------------------------------
// <copyright file="ResultExpressionMembershipDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class ResultExpressionMembershipDictionaryReader
    {
        ...
        private static IResultExpressionMembership ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The feature property is missing from the dictionary, the dictionary cannot be converted into a ResultExpressionMembership");
            }
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a ResultExpressionMembership");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a ResultExpressionMembership");
            }
            ...
            resultExpressionMembershipInstance.Feature = featureFeature;
            ...
            resultExpressionMembershipInstance.Name = nameFeature;
            ...
            resultExpressionMembershipInstance.ShortName = shortNameFeature;
            ...
            resultExpressionMembershipInstance.Type = typeFeature;
        ...
        private static IResultExpressionMembership DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var resultExpressionMembershipInstance = new Core.DTO.ResultExpressionMembership
            {
                Id = id
            };
