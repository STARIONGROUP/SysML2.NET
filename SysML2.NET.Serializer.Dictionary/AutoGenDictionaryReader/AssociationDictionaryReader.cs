// -------------------------------------------------------------------------------------------------
// <copyright file="AssociationDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class AssociationDictionaryReader
    {
        ...
        private static IAssociation ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a Association");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a Association");
            }
            ...
            associationInstance.Name = nameFeature;
            ...
            associationInstance.ShortName = shortNameFeature;
        ...
        private static IAssociation DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var associationInstance = new Core.DTO.Association
            {
                Id = id
            };
