// -------------------------------------------------------------------------------------------------
// <copyright file="RequirementVerificationMembershipDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    /// <summary>
    /// The purpose of the <see cref="RequirementVerificationMembershipDictionaryReader"/> is to read (convert)
    /// a <see cref="Dictionary{String, Object}"/> from an <see cref="IRequirementVerificationMembership"/>
    /// </summary>
    public static class RequirementVerificationMembershipDictionaryReader
    {
        /// <summary>
        /// Reads a <see cref="IRequirementVerificationMembership"/> from a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property.
        /// </summary>
        /// <param name="dictionary">
        /// The subject <see cref="Dictionary{String, Object}"/> that is to be converted into a <see cref="IRequirementVerificationMembership"/>
        /// </param>
        ...
        /// the values are converted from an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static IRequirementVerificationMembership ReadSimplified(Dictionary<string, object> dictionary)
        {
            var requirementVerificationMembershipInstance = DictionaryNullAndTypeCheck(dictionary);

            if (!dictionary.TryGetValue("aliasIds", out object aliasIdsObject))
            {
                throw new ArgumentException("The aliasIds property is missing from the dictionary, the dictionary cannot be converted into a RequirementVerificationMembership");
            }
            ...
            {
                throw new ArgumentException("The isImpliedIncluded property is missing from the dictionary, the dictionary cannot be converted into a RequirementVerificationMembership");
            }
            bool isImpliedIncludedFeature = Convert.ToBoolean(isImpliedIncludedObject);

            if (!dictionary.TryGetValue("kind", out object kindObject))
            {
                throw new ArgumentException("The kind property is missing from the dictionary, the dictionary cannot be converted into a RequirementVerificationMembership");
            }
            RequirementConstraintKind kindFeature = (RequirementConstraintKind)Enum.Parse(typeof(RequirementConstraintKind), Convert.ToString(kindObject), true);

            if (!dictionary.TryGetValue("memberElement", out object memberElementObject))
            {
                throw new ArgumentException("The memberElement property is missing from the dictionary, the dictionary cannot be converted into a RequirementVerificationMembership");
            }
            ...
            {
                throw new ArgumentException("The memberName property is missing from the dictionary, the dictionary cannot be converted into a RequirementVerificationMembership");
            }
            ...
            {
                throw new ArgumentException("The memberShortName property is missing from the dictionary, the dictionary cannot be converted into a RequirementVerificationMembership");
            }
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a RequirementVerificationMembership");
            }
            ...
            {
                throw new ArgumentException("The ownedRelatedElement property is missing from the dictionary, the dictionary cannot be converted into a RequirementVerificationMembership");
            }
            List<Guid> ownedRelatedElementFeature = (ownedRelatedElementObject as List<string>)?.Select(Guid.Parse).ToList();

            if (!dictionary.TryGetValue("ownedRelationship", out object ownedRelationshipObject))
            {
                throw new ArgumentException("The ownedRelationship property is missing from the dictionary, the dictionary cannot be converted into a RequirementVerificationMembership");
            }
            ...
            {
                throw new ArgumentException("The owningRelatedElement property is missing from the dictionary, the dictionary cannot be converted into a RequirementVerificationMembership");
            }
            ...
            {
                throw new ArgumentException("The owningRelationship property is missing from the dictionary, the dictionary cannot be converted into a RequirementVerificationMembership");
            }
            Guid? owningRelationshipFeature = owningRelationshipObject == null ? (Guid?)null : Guid.Parse(Convert.ToString(owningRelationshipObject));

            if (!dictionary.TryGetValue("shortName", out object shortNameObject))
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a RequirementVerificationMembership");
            }
            ...
            {
                throw new ArgumentException("The source property is missing from the dictionary, the dictionary cannot be converted into a RequirementVerificationMembership");
            }
            ...
            {
                throw new ArgumentException("The target property is missing from the dictionary, the dictionary cannot be converted into a RequirementVerificationMembership");
            }
            ...
            requirementVerificationMembershipInstance.AliasIds = aliasIdsFeature ?? new List<string>();
            ...
            requirementVerificationMembershipInstance.MemberElement = memberElementFeature;
            requirementVerificationMembershipInstance.MemberName = memberNameFeature;
            requirementVerificationMembershipInstance.MemberShortName = memberShortNameFeature;
            requirementVerificationMembershipInstance.Name = nameFeature;
            requirementVerificationMembershipInstance.OwnedRelatedElement = ownedRelatedElementFeature ?? new List<Guid>();
            requirementVerificationMembershipInstance.OwnedRelationship = ownedRelationshipFeature ?? new List<Guid>();
            requirementVerificationMembershipInstance.OwningRelatedElement = owningRelatedElementFeature;
            requirementVerificationMembershipInstance.OwningRelationship = owningRelationshipFeature;
            requirementVerificationMembershipInstance.ShortName = shortNameFeature;
        ...
        /// An instance of <see cref="IRequirementVerificationMembership"/>
        /// </returns>
        private static IRequirementVerificationMembership ReadComplex(Dictionary<string, object> dictionary)
        {
            var requirementVerificationMembershipInstance = DictionaryNullAndTypeCheck(dictionary);
            ...
            RequirementConstraintKind kindFeature = (RequirementConstraintKind)kindObject;
        ...
        /// of type <see cref="RequirementVerificationMembership"/>
        /// </summary>
        /// <param name="dictionary">
        ...
        /// Thrown when <paramref name="dictionary"/> is not of type <see cref="RequirementVerificationMembership"/>
        /// </exception>
        private static IRequirementVerificationMembership DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            if (dictionary == null)
            {
            ...
            if (type != "RequirementVerificationMembership")
            {
                throw new ArgumentException($"The dictionary contains an Object is of type {type} and can therefore not be converted into a RequirementVerificationMembership");
            }

            if (!dictionary.TryGetValue("@id", out object idObject))
            {
                throw new ArgumentException("The id property is missing from the dictionary, the dictionary cannot be converted into a RequirementVerificationMembership");
            }
            var id = Guid.Parse(Convert.ToString(idObject));

            var requirementVerificationMembershipInstance = new Core.DTO.RequirementVerificationMembership
            {
                Id = id
            };
