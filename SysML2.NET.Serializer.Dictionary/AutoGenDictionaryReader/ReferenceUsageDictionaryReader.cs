// -------------------------------------------------------------------------------------------------
// <copyright file="ReferenceUsageDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class ReferenceUsageDictionaryReader
    {
        ...
        private static IReferenceUsage ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The isReadOnly property is missing from the dictionary, the dictionary cannot be converted into a ReferenceUsage");
            }
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a ReferenceUsage");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a ReferenceUsage");
            }
            ...
            referenceUsageInstance.IsReadOnly = isReadOnlyFeature;
            ...
            referenceUsageInstance.Name = nameFeature;
            ...
            referenceUsageInstance.ShortName = shortNameFeature;
        ...
        private static IReferenceUsage DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var referenceUsageInstance = new Core.DTO.ReferenceUsage
            {
                Id = id
            };
