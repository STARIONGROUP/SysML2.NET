// -------------------------------------------------------------------------------------------------
// <copyright file="MetadataAccessExpressionDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    /// <summary>
    /// The purpose of the <see cref="MetadataAccessExpressionDictionaryReader"/> is to read (convert)
    /// a <see cref="Dictionary{String, Object}"/> from an <see cref="IMetadataAccessExpression"/>
    /// </summary>
    public static class MetadataAccessExpressionDictionaryReader
    {
        /// <summary>
        /// Reads a <see cref="IMetadataAccessExpression"/> from a <see cref="Dictionary{String, Object}"/> that contains a key-value-pair
        /// for each property.
        /// </summary>
        /// <param name="dictionary">
        /// The subject <see cref="Dictionary{String, Object}"/> that is to be converted into a <see cref="IMetadataAccessExpression"/>
        /// </param>
        ...
        /// the values are converted from an Array of String using JSON notation, i.e. [ value_1, ..., value_n ]
        /// </remarks>
        private static IMetadataAccessExpression ReadSimplified(Dictionary<string, object> dictionary)
        {
            var metadataAccessExpressionInstance = DictionaryNullAndTypeCheck(dictionary);

            if (!dictionary.TryGetValue("aliasIds", out object aliasIdsObject))
            {
                throw new ArgumentException("The aliasIds property is missing from the dictionary, the dictionary cannot be converted into a MetadataAccessExpression");
            }
            List<string> aliasIdsFeature = aliasIdsObject as List<string>;

            if (!dictionary.TryGetValue("direction", out object directionObject))
            {
                throw new ArgumentException("The direction property is missing from the dictionary, the dictionary cannot be converted into a MetadataAccessExpression");
            }
            ...
            {
                throw new ArgumentException("The elementId property is missing from the dictionary, the dictionary cannot be converted into a MetadataAccessExpression");
            }
            string elementIdFeature = Convert.ToString(elementIdObject);

            if (!dictionary.TryGetValue("isAbstract", out object isAbstractObject))
            {
                throw new ArgumentException("The isAbstract property is missing from the dictionary, the dictionary cannot be converted into a MetadataAccessExpression");
            }
            ...
            {
                throw new ArgumentException("The isComposite property is missing from the dictionary, the dictionary cannot be converted into a MetadataAccessExpression");
            }
            ...
            {
                throw new ArgumentException("The isEnd property is missing from the dictionary, the dictionary cannot be converted into a MetadataAccessExpression");
            }
            ...
            {
                throw new ArgumentException("The isImpliedIncluded property is missing from the dictionary, the dictionary cannot be converted into a MetadataAccessExpression");
            }
            bool isImpliedIncludedFeature = Convert.ToBoolean(isImpliedIncludedObject);

            if (!dictionary.TryGetValue("isOrdered", out object isOrderedObject))
            {
                throw new ArgumentException("The isOrdered property is missing from the dictionary, the dictionary cannot be converted into a MetadataAccessExpression");
            }
            bool isOrderedFeature = Convert.ToBoolean(isOrderedObject);

            if (!dictionary.TryGetValue("isPortion", out object isPortionObject))
            {
                throw new ArgumentException("The isPortion property is missing from the dictionary, the dictionary cannot be converted into a MetadataAccessExpression");
            }
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a MetadataAccessExpression");
            }
            string nameFeature = nameObject == null ? null : Convert.ToString(nameObject);

            if (!dictionary.TryGetValue("ownedRelationship", out object ownedRelationshipObject))
            {
                throw new ArgumentException("The ownedRelationship property is missing from the dictionary, the dictionary cannot be converted into a MetadataAccessExpression");
            }
            ...
            {
                throw new ArgumentException("The owningRelationship property is missing from the dictionary, the dictionary cannot be converted into a MetadataAccessExpression");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a MetadataAccessExpression");
            }
            ...
            metadataAccessExpressionInstance.Direction = directionFeature;
            ...
            metadataAccessExpressionInstance.Name = nameFeature;
            ...
            metadataAccessExpressionInstance.ShortName = shortNameFeature;
        ...
        /// An instance of <see cref="IMetadataAccessExpression"/>
        /// </returns>
        private static IMetadataAccessExpression ReadComplex(Dictionary<string, object> dictionary)
        {
            var metadataAccessExpressionInstance = DictionaryNullAndTypeCheck(dictionary);
        ...
        /// of type <see cref="MetadataAccessExpression"/>
        /// </summary>
        /// <param name="dictionary">
        ...
        /// Thrown when <paramref name="dictionary"/> is not of type <see cref="MetadataAccessExpression"/>
        /// </exception>
        private static IMetadataAccessExpression DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            if (dictionary == null)
            {
            ...
            {
                throw new ArgumentException("The type property is missing from the dictionary, the dictionary cannot be converted into a MetadataAccessExpression");
            }

            var type = Convert.ToString(typeObject);

            if (type != "MetadataAccessExpression")
            {
                throw new ArgumentException($"The dictionary contains an Object is of type {type} and can therefore not be converted into a MetadataAccessExpression");
            }

            if (!dictionary.TryGetValue("@id", out object idObject))
            {
                throw new ArgumentException("The id property is missing from the dictionary, the dictionary cannot be converted into a MetadataAccessExpression");
            }
            var id = Guid.Parse(Convert.ToString(idObject));

            var metadataAccessExpressionInstance = new Core.DTO.MetadataAccessExpression
            {
                Id = id
            };
