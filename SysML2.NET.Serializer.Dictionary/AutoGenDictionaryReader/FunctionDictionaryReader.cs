// -------------------------------------------------------------------------------------------------
// <copyright file="FunctionDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class FunctionDictionaryReader
    {
        ...
        private static IFunction ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a Function");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a Function");
            }
            ...
            functionInstance.Name = nameFeature;
            ...
            functionInstance.ShortName = shortNameFeature;
        ...
        private static IFunction DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var functionInstance = new Core.DTO.Function
            {
                Id = id
            };
