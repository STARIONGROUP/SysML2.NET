// -------------------------------------------------------------------------------------------------
// <copyright file="TriggerInvocationExpressionDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class TriggerInvocationExpressionDictionaryReader
    {
        ...
        private static ITriggerInvocationExpression DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var triggerInvocationExpressionInstance = new Core.DTO.TriggerInvocationExpression
            {
                Id = id
            };
