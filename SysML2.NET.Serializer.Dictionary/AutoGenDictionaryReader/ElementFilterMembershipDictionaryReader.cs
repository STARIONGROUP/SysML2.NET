...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class ElementFilterMembershipDictionaryReader
    {
        ...
        private static IElementFilterMembership ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a ElementFilterMembership");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a ElementFilterMembership");
            }
            ...
            elementFilterMembershipInstance.Name = nameFeature;
            ...
            elementFilterMembershipInstance.ShortName = shortNameFeature;
