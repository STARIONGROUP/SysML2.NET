// -------------------------------------------------------------------------------------------------
// <copyright file="MultiplicityRangeDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class MultiplicityRangeDictionaryReader
    {
        ...
        private static IMultiplicityRange ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a MultiplicityRange");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a MultiplicityRange");
            }
            ...
            multiplicityRangeInstance.Name = nameFeature;
            ...
            multiplicityRangeInstance.ShortName = shortNameFeature;
        ...
        private static IMultiplicityRange DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var multiplicityRangeInstance = new Core.DTO.MultiplicityRange
            {
                Id = id
            };
