...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class ForkNodeDictionaryReader
    {
        ...
        private static IForkNode ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a ForkNode");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a ForkNode");
            }
            ...
            forkNodeInstance.Name = nameFeature;
            ...
            forkNodeInstance.ShortName = shortNameFeature;
