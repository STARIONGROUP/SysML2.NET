...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class TypeFeaturingDictionaryReader
    {
        ...
        private static ITypeFeaturing ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a TypeFeaturing");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a TypeFeaturing");
            }
            ...
            typeFeaturingInstance.Name = nameFeature;
            ...
            typeFeaturingInstance.ShortName = shortNameFeature;
