...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class LiteralBooleanDictionaryReader
    {
        ...
        private static ILiteralBoolean ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a LiteralBoolean");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a LiteralBoolean");
            }
            ...
            literalBooleanInstance.Name = nameFeature;
            ...
            literalBooleanInstance.ShortName = shortNameFeature;
