...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class LiteralStringDictionaryReader
    {
        ...
        private static ILiteralString ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a LiteralString");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a LiteralString");
            }
            ...
            literalStringInstance.Name = nameFeature;
            ...
            literalStringInstance.ShortName = shortNameFeature;
        ...
        private static ILiteralString DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var literalStringInstance = new Core.DTO.LiteralString
            {
                Id = id
            };
