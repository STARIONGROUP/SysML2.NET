// -------------------------------------------------------------------------------------------------
// <copyright file="MetaclassDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class MetaclassDictionaryReader
    {
        ...
        private static IMetaclass ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a Metaclass");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a Metaclass");
            }
            ...
            metaclassInstance.Name = nameFeature;
            ...
            metaclassInstance.ShortName = shortNameFeature;
        ...
        private static IMetaclass DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var metaclassInstance = new Core.DTO.Metaclass
            {
                Id = id
            };
