// -------------------------------------------------------------------------------------------------
// <copyright file="FeatureInvertingDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class FeatureInvertingDictionaryReader
    {
        ...
        private static IFeatureInverting ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a FeatureInverting");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a FeatureInverting");
            }
            ...
            featureInvertingInstance.Name = nameFeature;
            ...
            featureInvertingInstance.ShortName = shortNameFeature;
        ...
        private static IFeatureInverting DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var featureInvertingInstance = new Core.DTO.FeatureInverting
            {
                Id = id
            };
