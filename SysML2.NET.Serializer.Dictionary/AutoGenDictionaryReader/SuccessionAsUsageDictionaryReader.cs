// -------------------------------------------------------------------------------------------------
// <copyright file="SuccessionAsUsageDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class SuccessionAsUsageDictionaryReader
    {
        ...
        private static ISuccessionAsUsage ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The isDirected property is missing from the dictionary, the dictionary cannot be converted into a SuccessionAsUsage");
            }
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a SuccessionAsUsage");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a SuccessionAsUsage");
            }
            ...
            successionAsUsageInstance.IsDirected = isDirectedFeature;
            ...
            successionAsUsageInstance.Name = nameFeature;
            ...
            successionAsUsageInstance.ShortName = shortNameFeature;
        ...
        private static ISuccessionAsUsage DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var successionAsUsageInstance = new Core.DTO.SuccessionAsUsage
            {
                Id = id
            };
