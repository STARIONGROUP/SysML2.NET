// -------------------------------------------------------------------------------------------------
// <copyright file="IntersectingDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class IntersectingDictionaryReader
    {
        ...
        private static IIntersecting ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a Intersecting");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a Intersecting");
            }
            ...
            intersectingInstance.Name = nameFeature;
            ...
            intersectingInstance.ShortName = shortNameFeature;
        ...
        private static IIntersecting DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var intersectingInstance = new Core.DTO.Intersecting
            {
                Id = id
            };
