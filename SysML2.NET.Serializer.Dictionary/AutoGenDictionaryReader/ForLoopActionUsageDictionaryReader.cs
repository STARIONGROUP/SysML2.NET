// -------------------------------------------------------------------------------------------------
// <copyright file="ForLoopActionUsageDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class ForLoopActionUsageDictionaryReader
    {
        ...
        private static IForLoopActionUsage ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a ForLoopActionUsage");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a ForLoopActionUsage");
            }
            ...
            forLoopActionUsageInstance.Name = nameFeature;
            ...
            forLoopActionUsageInstance.ShortName = shortNameFeature;
        ...
        private static IForLoopActionUsage DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var forLoopActionUsageInstance = new Core.DTO.ForLoopActionUsage
            {
                Id = id
            };
