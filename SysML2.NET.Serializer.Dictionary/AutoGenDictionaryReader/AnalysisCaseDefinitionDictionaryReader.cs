// -------------------------------------------------------------------------------------------------
// <copyright file="AnalysisCaseDefinitionDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class AnalysisCaseDefinitionDictionaryReader
    {
        ...
        private static IAnalysisCaseDefinition DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var analysisCaseDefinitionInstance = new Core.DTO.AnalysisCaseDefinition
            {
                Id = id
            };
