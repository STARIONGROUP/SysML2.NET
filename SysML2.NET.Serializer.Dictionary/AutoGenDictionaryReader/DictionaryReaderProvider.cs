...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    internal static class DictionaryReaderProvider
    {
        private static readonly Dictionary<string, Func<Dictionary<string, object>, DictionaryKind, IData>> DictionaryReaderFuncMap = new Dictionary<string, Func<Dictionary<string, object>, DictionaryKind, IData>>
        {
            ...
            { "Element", ElementDictionaryReader.Read },
            ...
            { "Expose", ExposeDictionaryReader.Read },
            ...
            { "Import", ImportDictionaryReader.Read },
            ...
            { "ItemFlowFeature", ItemFlowFeatureDictionaryReader.Read },
            ...
            { "Relationship", RelationshipDictionaryReader.Read },
            ...
            { "SourceEnd", SourceEndDictionaryReader.Read },
            ...
            { "TargetEnd", TargetEndDictionaryReader.Read },
