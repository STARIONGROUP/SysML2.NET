// -------------------------------------------------------------------------------------------------
// <copyright file="BindingConnectorDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class BindingConnectorDictionaryReader
    {
        ...
        private static IBindingConnector ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The isDirected property is missing from the dictionary, the dictionary cannot be converted into a BindingConnector");
            }
            ...
            bindingConnectorInstance.IsDirected = isDirectedFeature;
        ...
        private static IBindingConnector DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var bindingConnectorInstance = new Core.DTO.BindingConnector
            {
                Id = id
            };
