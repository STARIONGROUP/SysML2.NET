// -------------------------------------------------------------------------------------------------
// <copyright file="RedefinitionDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class RedefinitionDictionaryReader
    {
        ...
        private static IRedefinition ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a Redefinition");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a Redefinition");
            }
            ...
            redefinitionInstance.Name = nameFeature;
            ...
            redefinitionInstance.ShortName = shortNameFeature;
        ...
        private static IRedefinition DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var redefinitionInstance = new Core.DTO.Redefinition
            {
                Id = id
            };
