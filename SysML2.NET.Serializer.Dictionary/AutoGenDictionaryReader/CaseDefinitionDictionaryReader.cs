// -------------------------------------------------------------------------------------------------
// <copyright file="CaseDefinitionDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class CaseDefinitionDictionaryReader
    {
        ...
        private static ICaseDefinition ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a CaseDefinition");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a CaseDefinition");
            }
            ...
            caseDefinitionInstance.Name = nameFeature;
            ...
            caseDefinitionInstance.ShortName = shortNameFeature;
