// -------------------------------------------------------------------------------------------------
// <copyright file="StateSubactionMembershipDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class StateSubactionMembershipDictionaryReader
    {
        ...
        private static IStateSubactionMembership ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a StateSubactionMembership");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a StateSubactionMembership");
            }
            ...
            stateSubactionMembershipInstance.Name = nameFeature;
            ...
            stateSubactionMembershipInstance.ShortName = shortNameFeature;
        ...
        private static IStateSubactionMembership DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var stateSubactionMembershipInstance = new Core.DTO.StateSubactionMembership
            {
                Id = id
            };
