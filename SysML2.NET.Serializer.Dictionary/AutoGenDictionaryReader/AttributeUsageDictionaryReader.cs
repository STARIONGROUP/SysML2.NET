// -------------------------------------------------------------------------------------------------
// <copyright file="AttributeUsageDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class AttributeUsageDictionaryReader
    {
        ...
        private static IAttributeUsage ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a AttributeUsage");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a AttributeUsage");
            }
            ...
            attributeUsageInstance.Name = nameFeature;
            ...
            attributeUsageInstance.ShortName = shortNameFeature;
        ...
        private static IAttributeUsage DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var attributeUsageInstance = new Core.DTO.AttributeUsage
            {
                Id = id
            };
