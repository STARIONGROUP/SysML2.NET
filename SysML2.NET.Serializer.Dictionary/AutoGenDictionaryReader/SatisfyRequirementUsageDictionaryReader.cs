...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class SatisfyRequirementUsageDictionaryReader
    {
        ...
        private static ISatisfyRequirementUsage ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a SatisfyRequirementUsage");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a SatisfyRequirementUsage");
            }
            ...
            satisfyRequirementUsageInstance.Name = nameFeature;
            ...
            satisfyRequirementUsageInstance.ShortName = shortNameFeature;
        ...
        private static ISatisfyRequirementUsage DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var satisfyRequirementUsageInstance = new Core.DTO.SatisfyRequirementUsage
            {
                Id = id
            };
