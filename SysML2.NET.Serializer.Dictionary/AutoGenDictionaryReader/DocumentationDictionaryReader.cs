// -------------------------------------------------------------------------------------------------
// <copyright file="DocumentationDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class DocumentationDictionaryReader
    {
        ...
        private static IDocumentation ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The annotation property is missing from the dictionary, the dictionary cannot be converted into a Documentation");
            }
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a Documentation");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a Documentation");
            }
            ...
            documentationInstance.Annotation = annotationFeature ?? new List<Guid>();
            ...
            documentationInstance.Name = nameFeature;
            ...
            documentationInstance.ShortName = shortNameFeature;
        ...
        private static IDocumentation DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var documentationInstance = new Core.DTO.Documentation
            {
                Id = id
            };
