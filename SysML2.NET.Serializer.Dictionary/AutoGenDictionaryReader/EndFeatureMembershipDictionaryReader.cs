// -------------------------------------------------------------------------------------------------
// <copyright file="EndFeatureMembershipDictionaryReader.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class EndFeatureMembershipDictionaryReader
    {
        ...
        private static IEndFeatureMembership ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The feature property is missing from the dictionary, the dictionary cannot be converted into a EndFeatureMembership");
            }
            ...
            {
                throw new ArgumentException("The name property is missing from the dictionary, the dictionary cannot be converted into a EndFeatureMembership");
            }
            ...
            {
                throw new ArgumentException("The shortName property is missing from the dictionary, the dictionary cannot be converted into a EndFeatureMembership");
            }
            ...
            endFeatureMembershipInstance.Feature = featureFeature;
            ...
            endFeatureMembershipInstance.Name = nameFeature;
            ...
            endFeatureMembershipInstance.ShortName = shortNameFeature;
            ...
            endFeatureMembershipInstance.Type = typeFeature;
        ...
        private static IEndFeatureMembership DictionaryNullAndTypeCheck(Dictionary<string, object> dictionary)
        {
            ...
            var endFeatureMembershipInstance = new Core.DTO.EndFeatureMembership
            {
                Id = id
            };
