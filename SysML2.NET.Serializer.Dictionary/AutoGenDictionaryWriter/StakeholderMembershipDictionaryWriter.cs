// -------------------------------------------------------------------------------------------------
// <copyright file="StakeholderMembershipDictionaryWriter.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class StakeholderMembershipDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IStakeholderMembership stakeholderMembershipInstance)
        {
            ...
            dictionary.Add("name", stakeholderMembershipInstance.Name);
            ...
            dictionary.Add("shortName", stakeholderMembershipInstance.ShortName);
