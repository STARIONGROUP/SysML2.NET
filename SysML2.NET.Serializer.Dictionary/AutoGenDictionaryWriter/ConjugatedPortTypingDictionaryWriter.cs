// -------------------------------------------------------------------------------------------------
// <copyright file="ConjugatedPortTypingDictionaryWriter.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class ConjugatedPortTypingDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IConjugatedPortTyping conjugatedPortTypingInstance)
        {
            ...
            dictionary.Add("name", conjugatedPortTypingInstance.Name);
            ...
            dictionary.Add("shortName", conjugatedPortTypingInstance.ShortName);
