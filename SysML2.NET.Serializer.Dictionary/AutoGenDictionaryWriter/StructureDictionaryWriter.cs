// -------------------------------------------------------------------------------------------------
// <copyright file="StructureDictionaryWriter.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class StructureDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IStructure structureInstance)
        {
            ...
            dictionary.Add("name", structureInstance.Name);
            ...
            dictionary.Add("shortName", structureInstance.ShortName);
