// -------------------------------------------------------------------------------------------------
// <copyright file="ReturnParameterMembershipDictionaryWriter.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class ReturnParameterMembershipDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IReturnParameterMembership returnParameterMembershipInstance)
        {
            ...
            dictionary.Add("name", returnParameterMembershipInstance.Name);
            ...
            dictionary.Add("shortName", returnParameterMembershipInstance.ShortName);
