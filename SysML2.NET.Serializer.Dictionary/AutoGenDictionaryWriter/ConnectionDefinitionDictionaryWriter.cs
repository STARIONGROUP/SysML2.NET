// -------------------------------------------------------------------------------------------------
// <copyright file="ConnectionDefinitionDictionaryWriter.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class ConnectionDefinitionDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IConnectionDefinition connectionDefinitionInstance)
        {
            ...
            dictionary.Add("name", connectionDefinitionInstance.Name);
            ...
            dictionary.Add("shortName", connectionDefinitionInstance.ShortName);
