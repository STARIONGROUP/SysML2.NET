// -------------------------------------------------------------------------------------------------
// <copyright file="AttributeUsageDictionaryWriter.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class AttributeUsageDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IAttributeUsage attributeUsageInstance)
        {
            ...
            dictionary.Add("name", attributeUsageInstance.Name);
            ...
            dictionary.Add("shortName", attributeUsageInstance.ShortName);
