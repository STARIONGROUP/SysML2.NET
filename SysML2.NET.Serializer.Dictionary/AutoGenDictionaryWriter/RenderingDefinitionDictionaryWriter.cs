// -------------------------------------------------------------------------------------------------
// <copyright file="RenderingDefinitionDictionaryWriter.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class RenderingDefinitionDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IRenderingDefinition renderingDefinitionInstance)
        {
            ...
            dictionary.Add("name", renderingDefinitionInstance.Name);
            ...
            dictionary.Add("shortName", renderingDefinitionInstance.ShortName);
