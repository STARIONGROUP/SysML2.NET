// -------------------------------------------------------------------------------------------------
// <copyright file="SelectExpressionDictionaryWriter.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class SelectExpressionDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(ISelectExpression selectExpressionInstance)
        {
            ...
            dictionary.Add("name", selectExpressionInstance.Name);
            ...
            dictionary.Add("shortName", selectExpressionInstance.ShortName);
