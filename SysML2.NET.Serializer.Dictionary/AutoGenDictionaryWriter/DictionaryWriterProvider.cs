...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    internal static class DictionaryWriterProvider
    {
        private static readonly Dictionary<System.Type, Func<IData, DictionaryKind, Dictionary<string, object>>> DictionaryWriterFuncMap = new Dictionary<System.Type, Func<IData, DictionaryKind, Dictionary<string, object>>>
        {
            ...
            { typeof(SysML2.NET.Core.DTO.Element), ElementDictionaryWriter.Write },
            ...
            { typeof(SysML2.NET.Core.DTO.Expose), ExposeDictionaryWriter.Write },
            ...
            { typeof(SysML2.NET.Core.DTO.Import), ImportDictionaryWriter.Write },
            ...
            { typeof(SysML2.NET.Core.DTO.ItemFlowFeature), ItemFlowFeatureDictionaryWriter.Write },
            ...
            { typeof(SysML2.NET.Core.DTO.Relationship), RelationshipDictionaryWriter.Write },
            ...
            { typeof(SysML2.NET.Core.DTO.SourceEnd), SourceEndDictionaryWriter.Write },
            ...
            { typeof(SysML2.NET.Core.DTO.TargetEnd), TargetEndDictionaryWriter.Write },
