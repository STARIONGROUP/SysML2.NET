// -------------------------------------------------------------------------------------------------
// <copyright file="FramedConcernMembershipDictionaryWriter.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class FramedConcernMembershipDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IFramedConcernMembership framedConcernMembershipInstance)
        {
            ...
            dictionary.Add("name", framedConcernMembershipInstance.Name);
            ...
            dictionary.Add("shortName", framedConcernMembershipInstance.ShortName);
