// -------------------------------------------------------------------------------------------------
// <copyright file="IfActionUsageDictionaryWriter.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class IfActionUsageDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IIfActionUsage ifActionUsageInstance)
        {
            ...
            dictionary.Add("isReadOnly", ifActionUsageInstance.IsReadOnly);
            ...
            dictionary.Add("name", ifActionUsageInstance.Name);
            ...
            dictionary.Add("shortName", ifActionUsageInstance.ShortName);
