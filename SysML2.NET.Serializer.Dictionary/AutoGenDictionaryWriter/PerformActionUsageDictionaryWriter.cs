// -------------------------------------------------------------------------------------------------
// <copyright file="PerformActionUsageDictionaryWriter.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class PerformActionUsageDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IPerformActionUsage performActionUsageInstance)
        {
            ...
            dictionary.Add("name", performActionUsageInstance.Name);
            ...
            dictionary.Add("shortName", performActionUsageInstance.ShortName);
