...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class BindingConnectorDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IBindingConnector bindingConnectorInstance)
        {
            ...
            dictionary.Add("isReadOnly", bindingConnectorInstance.IsReadOnly);
            ...
            dictionary.Add("name", bindingConnectorInstance.Name);
            ...
            dictionary.Add("shortName", bindingConnectorInstance.ShortName);
