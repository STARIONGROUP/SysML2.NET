// -------------------------------------------------------------------------------------------------
// <copyright file="InteractionDictionaryWriter.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class InteractionDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IInteraction interactionInstance)
        {
            ...
            dictionary.Add("name", interactionInstance.Name);
            ...
            dictionary.Add("shortName", interactionInstance.ShortName);
