// -------------------------------------------------------------------------------------------------
// <copyright file="UseCaseUsageDictionaryWriter.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class UseCaseUsageDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IUseCaseUsage useCaseUsageInstance)
        {
            ...
            dictionary.Add("name", useCaseUsageInstance.Name);
            ...
            dictionary.Add("shortName", useCaseUsageInstance.ShortName);
