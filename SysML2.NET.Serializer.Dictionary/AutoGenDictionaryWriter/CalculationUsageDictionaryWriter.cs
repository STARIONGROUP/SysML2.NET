// -------------------------------------------------------------------------------------------------
// <copyright file="CalculationUsageDictionaryWriter.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class CalculationUsageDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(ICalculationUsage calculationUsageInstance)
        {
            ...
            dictionary.Add("isReadOnly", calculationUsageInstance.IsReadOnly);
            ...
            dictionary.Add("name", calculationUsageInstance.Name);
            ...
            dictionary.Add("shortName", calculationUsageInstance.ShortName);
