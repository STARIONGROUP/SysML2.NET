// -------------------------------------------------------------------------------------------------
// <copyright file="EndFeatureMembershipDictionaryWriter.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class EndFeatureMembershipDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IEndFeatureMembership endFeatureMembershipInstance)
        {
            ...
            dictionary.Add("name", endFeatureMembershipInstance.Name);
            ...
            dictionary.Add("shortName", endFeatureMembershipInstance.ShortName);
