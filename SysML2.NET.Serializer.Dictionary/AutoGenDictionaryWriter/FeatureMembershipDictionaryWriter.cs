// -------------------------------------------------------------------------------------------------
// <copyright file="FeatureMembershipDictionaryWriter.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Dictionary
{
    ...
    public static class FeatureMembershipDictionaryWriter
    {
        ...
        private static Dictionary<string, object> WriteSimplified(IFeatureMembership featureMembershipInstance)
        {
            ...
            dictionary.Add("name", featureMembershipInstance.Name);
            ...
            dictionary.Add("shortName", featureMembershipInstance.ShortName);
