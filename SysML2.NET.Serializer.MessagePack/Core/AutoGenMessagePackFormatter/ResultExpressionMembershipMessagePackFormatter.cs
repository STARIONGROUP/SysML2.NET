// -------------------------------------------------------------------------------------------------
// <copyright file="ResultExpressionMembershipMessagePackFormatter.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.MessagePack.Core
{
    ...
    /// <summary>
    /// The purpose of the <see cref="ResultExpressionMembershipMessagePackFormatter"/> is to provide
    /// the contract for MessagePack (de)serialization of the <see cref="SysML2.NET.Core.DTO.Kernel.Functions.ResultExpressionMembership"/> type
    /// </summary>
    public class ResultExpressionMembershipMessagePackFormatter : MessagePackFormatterBase, IMessagePackFormatter<SysML2.NET.Core.DTO.Kernel.Functions.ResultExpressionMembership>
    {
        /// <summary>
        /// Serializes an <see cref="SysML2.NET.Core.DTO.Kernel.Functions.ResultExpressionMembership"/> DTO.
        /// </summary>
        /// <param name="writer">
        /// The <see cref="MessagePackWriter"/> to use when serializing the value.
        /// </param>
        /// <param name="dto">
        /// The <see cref="SysML2.NET.Core.DTO.Kernel.Functions.ResultExpressionMembership"/> that is to be serialized.
        /// </param>
        /// <param name="options">
        ...
        /// <summary>
        /// Deserializes an <see cref="SysML2.NET.Core.DTO.Kernel.Functions.ResultExpressionMembership"/> DTO
        /// </summary>
        /// <param name="reader">
        /// The <see cref="MessagePackWriter"/> to deserialize the <see cref="SysML2.NET.Core.DTO.Kernel.Functions.ResultExpressionMembership"/> from.
        /// </param>
        /// <param name="options">
        /// The serialization settings to use.
        /// </param>
        /// <returns>
        /// The deserialized <see cref="SysML2.NET.Core.DTO.Kernel.Functions.ResultExpressionMembership"/>.
        /// </returns>
