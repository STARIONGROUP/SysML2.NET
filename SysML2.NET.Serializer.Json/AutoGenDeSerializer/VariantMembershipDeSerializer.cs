...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class VariantMembershipDeSerializer
    {
        ...
        internal static IVariantMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "VariantMembership")
            {
                throw new InvalidOperationException($"The VariantMembershipDeSerializer can only be used to deserialize objects of type VariantMembership, a {typeProperty.GetString()} was provided");
            }

            var variantMembershipInstance = new DTO.VariantMembership();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    variantMembershipInstance.Id = Guid.Parse(propertyValue);
                }
            }
