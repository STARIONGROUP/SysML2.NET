...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class FeatureMembershipDeSerializer
    {
        ...
        internal static IFeatureMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "FeatureMembership")
            {
                throw new InvalidOperationException($"The FeatureMembershipDeSerializer can only be used to deserialize objects of type FeatureMembership, a {typeProperty.GetString()} was provided");
            }

            var featureMembershipInstance = new DTO.FeatureMembership();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    featureMembershipInstance.Id = Guid.Parse(propertyValue);
                }
            }
