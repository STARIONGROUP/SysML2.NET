...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class PerformActionUsageDeSerializer
    {
        ...
        internal static IPerformActionUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "PerformActionUsage")
            {
                throw new InvalidOperationException($"The PerformActionUsageDeSerializer can only be used to deserialize objects of type PerformActionUsage, a {typeProperty.GetString()} was provided");
            }

            var performActionUsageInstance = new DTO.PerformActionUsage();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    performActionUsageInstance.Id = Guid.Parse(propertyValue);
                }
            }
