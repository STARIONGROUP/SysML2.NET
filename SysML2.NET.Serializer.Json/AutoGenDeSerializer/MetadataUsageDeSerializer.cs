...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class MetadataUsageDeSerializer
    {
        ...
        internal static IMetadataUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new DTO.MetadataUsage();
            ...
            {
                throw new NotImplementedException("MetadataUsage.direction is not yet supported");
            }
            else
            {
            ...
            {
                logger.LogDebug($"the name Json property was not found in the MetadataUsage: {dtoInstance.Id}");
            }
            ...
            {
                throw new NotImplementedException("MetadataUsage.portionKind is not yet supported");
            }
            else
            {
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the MetadataUsage: {dtoInstance.Id}");
            }
