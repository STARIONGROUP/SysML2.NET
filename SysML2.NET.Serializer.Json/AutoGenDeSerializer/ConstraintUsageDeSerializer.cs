...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class ConstraintUsageDeSerializer
    {
        ...
        internal static IConstraintUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new DTO.ConstraintUsage();
            ...
            {
                throw new NotImplementedException("ConstraintUsage.direction is not yet supported");
            }
            else
            {
            ...
            {
                logger.LogDebug($"the name Json property was not found in the ConstraintUsage: {dtoInstance.Id}");
            }
            ...
            {
                throw new NotImplementedException("ConstraintUsage.portionKind is not yet supported");
            }
            else
            {
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the ConstraintUsage: {dtoInstance.Id}");
            }
