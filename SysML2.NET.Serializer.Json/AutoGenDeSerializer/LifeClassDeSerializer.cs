...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class LifeClassDeSerializer
    {
        ...
        internal static ILifeClass DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "LifeClass")
            {
                throw new InvalidOperationException($"The LifeClassDeSerializer can only be used to deserialize objects of type LifeClass, a {typeProperty.GetString()} was provided");
            }

            var lifeClassInstance = new DTO.LifeClass();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    lifeClassInstance.Id = Guid.Parse(propertyValue);
                }
            }
