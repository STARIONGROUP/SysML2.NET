...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class StateSubactionMembershipDeSerializer
    {
        ...
        internal static IStateSubactionMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "StateSubactionMembership")
            {
                throw new InvalidOperationException($"The StateSubactionMembershipDeSerializer can only be used to deserialize objects of type StateSubactionMembership, a {typeProperty.GetString()} was provided");
            }

            var stateSubactionMembershipInstance = new DTO.StateSubactionMembership();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    stateSubactionMembershipInstance.Id = Guid.Parse(propertyValue);
                }
            }
