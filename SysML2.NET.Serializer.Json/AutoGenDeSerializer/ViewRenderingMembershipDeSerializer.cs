...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class ViewRenderingMembershipDeSerializer
    {
        ...
        internal static IViewRenderingMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "ViewRenderingMembership")
            {
                throw new InvalidOperationException($"The ViewRenderingMembershipDeSerializer can only be used to deserialize objects of type ViewRenderingMembership, a {typeProperty.GetString()} was provided");
            }

            var viewRenderingMembershipInstance = new DTO.ViewRenderingMembership();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    viewRenderingMembershipInstance.Id = Guid.Parse(propertyValue);
                }
            }
