// -------------------------------------------------------------------------------------------------
// <copyright file="MergeNodeDeSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class MergeNodeDeSerializer
    {
        ...
        internal static IMergeNode DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new DTO.MergeNode();
            ...
            {
                throw new NotImplementedException("MergeNode.direction is not yet supported");
            }
            else
            {
            ...
            {
                logger.LogDebug($"the isReadOnly Json property was not found in the MergeNode: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the MergeNode: {dtoInstance.Id}");
            }
            ...
            {
                throw new NotImplementedException("MergeNode.portionKind is not yet supported");
            }
            else
            {
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the MergeNode: {dtoInstance.Id}");
            }
