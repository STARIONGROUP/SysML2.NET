...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class AnalysisCaseUsageDeSerializer
    {
        ...
        internal static IAnalysisCaseUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "AnalysisCaseUsage")
            {
                throw new InvalidOperationException($"The AnalysisCaseUsageDeSerializer can only be used to deserialize objects of type AnalysisCaseUsage, a {typeProperty.GetString()} was provided");
            }

            var analysisCaseUsageInstance = new DTO.AnalysisCaseUsage();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    analysisCaseUsageInstance.Id = Guid.Parse(propertyValue);
                }
            }
