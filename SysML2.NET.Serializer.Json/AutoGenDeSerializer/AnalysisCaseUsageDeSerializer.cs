// -------------------------------------------------------------------------------------------------
// <copyright file="AnalysisCaseUsageDeSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class AnalysisCaseUsageDeSerializer
    {
        ...
        internal static IAnalysisCaseUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new DTO.AnalysisCaseUsage();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the AnalysisCaseUsage: {dtoInstance.Id}");
            }

            if (jsonElement.TryGetProperty("direction", out JsonElement directionProperty))
            {
                throw new NotImplementedException("AnalysisCaseUsage.direction is not yet supported");
            }
            else
            {
                logger.LogDebug($"the direction Json property was not found in the AnalysisCaseUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the AnalysisCaseUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isAbstract Json property was not found in the AnalysisCaseUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isComposite Json property was not found in the AnalysisCaseUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isDerived Json property was not found in the AnalysisCaseUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isEnd Json property was not found in the AnalysisCaseUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isIndividual Json property was not found in the AnalysisCaseUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isOrdered Json property was not found in the AnalysisCaseUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isPortion Json property was not found in the AnalysisCaseUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isReadOnly Json property was not found in the AnalysisCaseUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isSufficient Json property was not found in the AnalysisCaseUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isUnique Json property was not found in the AnalysisCaseUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isVariation Json property was not found in the AnalysisCaseUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the AnalysisCaseUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the AnalysisCaseUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the AnalysisCaseUsage: {dtoInstance.Id}");
            }

            if (jsonElement.TryGetProperty("portionKind", out JsonElement portionKindProperty))
            {
                throw new NotImplementedException("AnalysisCaseUsage.portionKind is not yet supported");
            }
            else
            {
                logger.LogDebug($"the portionKind Json property was not found in the AnalysisCaseUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the AnalysisCaseUsage: {dtoInstance.Id}");
            }
