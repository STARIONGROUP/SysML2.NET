// -------------------------------------------------------------------------------------------------
// <copyright file="UnioningDeSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class UnioningDeSerializer
    {
        ...
        internal static IUnioning DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new Core.DTO.Unioning();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the Unioning: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the Unioning: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the Unioning: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the Unioning: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the Unioning: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the Unioning: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the Unioning: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the Unioning: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the Unioning: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the Unioning: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the source Json property was not found in the Unioning: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the target Json property was not found in the Unioning: {dtoInstance.Id}");
            }

            if (jsonElement.TryGetProperty("unioningType", out JsonElement unioningTypeProperty))
            {
                ...
                {
                    if (unioningTypeProperty.TryGetProperty("@id", out JsonElement unioningTypeIdProperty))
                    {
            ...
            {
                logger.LogDebug($"the unioningType Json property was not found in the Unioning: {dtoInstance.Id}");
            }
