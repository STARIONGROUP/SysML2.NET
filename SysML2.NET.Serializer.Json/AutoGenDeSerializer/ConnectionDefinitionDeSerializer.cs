...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class ConnectionDefinitionDeSerializer
    {
        ...
        internal static IConnectionDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug($"the name Json property was not found in the ConnectionDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the ConnectionDefinition: {dtoInstance.Id}");
            }
