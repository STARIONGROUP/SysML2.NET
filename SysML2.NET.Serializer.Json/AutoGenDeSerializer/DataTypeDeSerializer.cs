...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class DataTypeDeSerializer
    {
        ...
        internal static IDataType DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "DataType")
            {
                throw new InvalidOperationException($"The DataTypeDeSerializer can only be used to deserialize objects of type DataType, a {typeProperty.GetString()} was provided");
            }

            var dataTypeInstance = new DTO.DataType();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    dataTypeInstance.Id = Guid.Parse(propertyValue);
                }
            }
