...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class ConjugatedPortDefinitionDeSerializer
    {
        ...
        internal static IConjugatedPortDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "ConjugatedPortDefinition")
            {
                throw new InvalidOperationException($"The ConjugatedPortDefinitionDeSerializer can only be used to deserialize objects of type ConjugatedPortDefinition, a {typeProperty.GetString()} was provided");
            }

            var conjugatedPortDefinitionInstance = new DTO.ConjugatedPortDefinition();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    conjugatedPortDefinitionInstance.Id = Guid.Parse(propertyValue);
                }
            }
