// -------------------------------------------------------------------------------------------------
// <copyright file="AssignmentActionUsageDeSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class AssignmentActionUsageDeSerializer
    {
        ...
        internal static IAssignmentActionUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new DTO.AssignmentActionUsage();
            ...
            {
                throw new NotImplementedException("AssignmentActionUsage.direction is not yet supported");
            }
            else
            {
            ...
            {
                logger.LogDebug($"the isReadOnly Json property was not found in the AssignmentActionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the AssignmentActionUsage: {dtoInstance.Id}");
            }
            ...
            {
                throw new NotImplementedException("AssignmentActionUsage.portionKind is not yet supported");
            }
            else
            {
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the AssignmentActionUsage: {dtoInstance.Id}");
            }
