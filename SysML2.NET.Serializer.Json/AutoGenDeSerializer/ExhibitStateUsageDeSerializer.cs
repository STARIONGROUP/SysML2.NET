...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class ExhibitStateUsageDeSerializer
    {
        ...
        internal static IExhibitStateUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new DTO.ExhibitStateUsage();
            ...
            {
                throw new NotImplementedException("ExhibitStateUsage.direction is not yet supported");
            }
            else
            {
            ...
            {
                logger.LogDebug($"the name Json property was not found in the ExhibitStateUsage: {dtoInstance.Id}");
            }
            ...
            {
                throw new NotImplementedException("ExhibitStateUsage.portionKind is not yet supported");
            }
            else
            {
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the ExhibitStateUsage: {dtoInstance.Id}");
            }
