// -------------------------------------------------------------------------------------------------
// <copyright file="ClassDeSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class ClassDeSerializer
    {
        ...
        internal static IClass DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "Class")
            {
                throw new InvalidOperationException($"The ClassDeSerializer can only be used to deserialize objects of type Class, a {typeProperty.GetString()} was provided");
            }

            var classInstance = new DTO.Class();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    classInstance.Id = Guid.Parse(propertyValue);
                }
            }
