...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class UsageDeSerializer
    {
        ...
        internal static IUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "Usage")
            {
                throw new InvalidOperationException($"The UsageDeSerializer can only be used to deserialize objects of type Usage, a {typeProperty.GetString()} was provided");
            }

            var usageInstance = new DTO.Usage();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    usageInstance.Id = Guid.Parse(propertyValue);
                }
            }
