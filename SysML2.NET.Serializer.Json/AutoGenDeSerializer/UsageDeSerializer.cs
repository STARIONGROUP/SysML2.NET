...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class UsageDeSerializer
    {
        ...
        internal static IUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new NotImplementedException("Usage.direction is not yet supported");
            }
            else
            {
            ...
            {
                logger.LogDebug($"the name Json property was not found in the Usage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the Usage: {dtoInstance.Id}");
            }
