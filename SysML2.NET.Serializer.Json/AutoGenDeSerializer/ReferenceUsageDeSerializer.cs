...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class ReferenceUsageDeSerializer
    {
        ...
        internal static IReferenceUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug($"the name Json property was not found in the ReferenceUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the ReferenceUsage: {dtoInstance.Id}");
            }
