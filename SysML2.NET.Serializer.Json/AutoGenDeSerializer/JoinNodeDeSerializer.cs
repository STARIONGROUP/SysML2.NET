// -------------------------------------------------------------------------------------------------
// <copyright file="JoinNodeDeSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class JoinNodeDeSerializer
    {
        ...
        internal static IJoinNode DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new DTO.JoinNode();
            ...
            {
                throw new NotImplementedException("JoinNode.direction is not yet supported");
            }
            else
            {
            ...
            {
                logger.LogDebug($"the isReadOnly Json property was not found in the JoinNode: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the JoinNode: {dtoInstance.Id}");
            }
            ...
            {
                throw new NotImplementedException("JoinNode.portionKind is not yet supported");
            }
            else
            {
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the JoinNode: {dtoInstance.Id}");
            }
