// -------------------------------------------------------------------------------------------------
// <copyright file="RequirementConstraintMembershipDeSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class RequirementConstraintMembershipDeSerializer
    {
        ...
        internal static IRequirementConstraintMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new Core.DTO.RequirementConstraintMembership();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the RequirementConstraintMembership: {dtoInstance.Id}");
            }
            ...
            if (jsonElement.TryGetProperty("featureOfType", out JsonElement featureOfTypeProperty))
            {
                if (featureOfTypeProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the RequirementConstraintMembership.FeatureOfType property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the featureOfType Json property was not found in the RequirementConstraintMembership: {dtoInstance.Id}");
            }
            ...
            if (jsonElement.TryGetProperty("featuringType", out JsonElement featuringTypeProperty))
            {
                if (featuringTypeProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the RequirementConstraintMembership.FeaturingType property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the featuringType Json property was not found in the RequirementConstraintMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the kind Json property was not found in the RequirementConstraintMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the memberElement Json property was not found in the RequirementConstraintMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the memberName Json property was not found in the RequirementConstraintMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the memberShortName Json property was not found in the RequirementConstraintMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the RequirementConstraintMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the RequirementConstraintMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the RequirementConstraintMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the RequirementConstraintMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the RequirementConstraintMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the RequirementConstraintMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the source Json property was not found in the RequirementConstraintMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the visibility Json property was not found in the RequirementConstraintMembership: {dtoInstance.Id}");
            }
