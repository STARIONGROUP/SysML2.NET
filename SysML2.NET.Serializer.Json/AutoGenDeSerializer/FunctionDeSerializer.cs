...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class FunctionDeSerializer
    {
        ...
        internal static IFunction DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug($"the name Json property was not found in the Function: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the Function: {dtoInstance.Id}");
            }
