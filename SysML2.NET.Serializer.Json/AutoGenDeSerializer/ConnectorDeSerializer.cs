...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class ConnectorDeSerializer
    {
        ...
        internal static IConnector DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "Connector")
            {
                throw new InvalidOperationException($"The ConnectorDeSerializer can only be used to deserialize objects of type Connector, a {typeProperty.GetString()} was provided");
            }

            var connectorInstance = new DTO.Connector();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    connectorInstance.Id = Guid.Parse(propertyValue);
                }
            }
