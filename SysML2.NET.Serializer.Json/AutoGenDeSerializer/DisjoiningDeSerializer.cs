...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class DisjoiningDeSerializer
    {
        ...
        internal static IDisjoining DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "Disjoining")
            {
                throw new InvalidOperationException($"The DisjoiningDeSerializer can only be used to deserialize objects of type Disjoining, a {typeProperty.GetString()} was provided");
            }

            var disjoiningInstance = new DTO.Disjoining();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    disjoiningInstance.Id = Guid.Parse(propertyValue);
                }
            }
