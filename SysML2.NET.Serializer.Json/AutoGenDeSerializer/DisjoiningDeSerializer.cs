...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class DisjoiningDeSerializer
    {
        ...
        internal static IDisjoining DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new DTO.Disjoining();
            ...
            {
                logger.LogDebug($"the name Json property was not found in the Disjoining: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the Disjoining: {dtoInstance.Id}");
            }
