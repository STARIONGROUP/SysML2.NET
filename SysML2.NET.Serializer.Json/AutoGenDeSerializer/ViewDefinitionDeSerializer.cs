...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class ViewDefinitionDeSerializer
    {
        ...
        internal static IViewDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug($"the name Json property was not found in the ViewDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the ViewDefinition: {dtoInstance.Id}");
            }
