// -------------------------------------------------------------------------------------------------
// <copyright file="VerificationCaseUsageDeSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class VerificationCaseUsageDeSerializer
    {
        ...
        internal static IVerificationCaseUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new DTO.VerificationCaseUsage();
            ...
            {
                throw new NotImplementedException("VerificationCaseUsage.direction is not yet supported");
            }
            else
            {
            ...
            {
                logger.LogDebug($"the name Json property was not found in the VerificationCaseUsage: {dtoInstance.Id}");
            }
            ...
            {
                throw new NotImplementedException("VerificationCaseUsage.portionKind is not yet supported");
            }
            else
            {
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the VerificationCaseUsage: {dtoInstance.Id}");
            }
