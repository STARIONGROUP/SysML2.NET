...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class VerificationCaseUsageDeSerializer
    {
        ...
        internal static IVerificationCaseUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "VerificationCaseUsage")
            {
                throw new InvalidOperationException($"The VerificationCaseUsageDeSerializer can only be used to deserialize objects of type VerificationCaseUsage, a {typeProperty.GetString()} was provided");
            }

            var verificationCaseUsageInstance = new DTO.VerificationCaseUsage();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    verificationCaseUsageInstance.Id = Guid.Parse(propertyValue);
                }
            }
