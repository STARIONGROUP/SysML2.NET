// -------------------------------------------------------------------------------------------------
// <copyright file="ForkNodeDeSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class ForkNodeDeSerializer
    {
        ...
        internal static IForkNode DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new DTO.ForkNode();
            ...
            {
                throw new NotImplementedException("ForkNode.direction is not yet supported");
            }
            else
            {
            ...
            {
                logger.LogDebug($"the isReadOnly Json property was not found in the ForkNode: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the ForkNode: {dtoInstance.Id}");
            }
            ...
            {
                throw new NotImplementedException("ForkNode.portionKind is not yet supported");
            }
            else
            {
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the ForkNode: {dtoInstance.Id}");
            }
