...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class CommentDeSerializer
    {
        ...
        internal static IComment DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "Comment")
            {
                throw new InvalidOperationException($"The CommentDeSerializer can only be used to deserialize objects of type Comment, a {typeProperty.GetString()} was provided");
            }

            var commentInstance = new DTO.Comment();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    commentInstance.Id = Guid.Parse(propertyValue);
                }
            }
