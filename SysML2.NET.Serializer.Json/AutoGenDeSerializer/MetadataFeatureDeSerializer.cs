...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class MetadataFeatureDeSerializer
    {
        ...
        internal static IMetadataFeature DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "MetadataFeature")
            {
                throw new InvalidOperationException($"The MetadataFeatureDeSerializer can only be used to deserialize objects of type MetadataFeature, a {typeProperty.GetString()} was provided");
            }

            var metadataFeatureInstance = new DTO.MetadataFeature();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    metadataFeatureInstance.Id = Guid.Parse(propertyValue);
                }
            }
