// -------------------------------------------------------------------------------------------------
// <copyright file="InterfaceUsageDeSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class InterfaceUsageDeSerializer
    {
        ...
        internal static IInterfaceUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new DTO.InterfaceUsage();
            ...
            {
                throw new NotImplementedException("InterfaceUsage.direction is not yet supported");
            }
            else
            {
            ...
            {
                logger.LogDebug($"the isDirected Json property was not found in the InterfaceUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the InterfaceUsage: {dtoInstance.Id}");
            }
            ...
            {
                throw new NotImplementedException("InterfaceUsage.portionKind is not yet supported");
            }
            else
            {
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the InterfaceUsage: {dtoInstance.Id}");
            }
