...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class InterfaceUsageDeSerializer
    {
        ...
        internal static IInterfaceUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "InterfaceUsage")
            {
                throw new InvalidOperationException($"The InterfaceUsageDeSerializer can only be used to deserialize objects of type InterfaceUsage, a {typeProperty.GetString()} was provided");
            }

            var interfaceUsageInstance = new DTO.InterfaceUsage();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    interfaceUsageInstance.Id = Guid.Parse(propertyValue);
                }
            }
