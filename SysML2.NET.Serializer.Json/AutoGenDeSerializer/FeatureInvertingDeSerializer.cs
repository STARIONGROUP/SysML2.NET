...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class FeatureInvertingDeSerializer
    {
        ...
        internal static IFeatureInverting DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "FeatureInverting")
            {
                throw new InvalidOperationException($"The FeatureInvertingDeSerializer can only be used to deserialize objects of type FeatureInverting, a {typeProperty.GetString()} was provided");
            }

            var featureInvertingInstance = new DTO.FeatureInverting();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    featureInvertingInstance.Id = Guid.Parse(propertyValue);
                }
            }
