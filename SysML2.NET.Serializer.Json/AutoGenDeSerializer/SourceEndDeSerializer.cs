...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class SourceEndDeSerializer
    {
        ...
        internal static ISourceEnd DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (@type.GetString() != "SourceEnd")
            {
                throw new InvalidOperationException($"The SourceEndDeSerializer can only be used to deserialize objects of type ISourceEnd, a {@type.GetString()} was provided");
            }

            var dtoInstance = new Core.DTO.SourceEnd();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the SourceEnd: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the direction Json property was not found in the SourceEnd: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the SourceEnd: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isAbstract Json property was not found in the SourceEnd: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isComposite Json property was not found in the SourceEnd: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isDerived Json property was not found in the SourceEnd: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isEnd Json property was not found in the SourceEnd: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the SourceEnd: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isOrdered Json property was not found in the SourceEnd: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isPortion Json property was not found in the SourceEnd: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isReadOnly Json property was not found in the SourceEnd: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isSufficient Json property was not found in the SourceEnd: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isUnique Json property was not found in the SourceEnd: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the SourceEnd: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the SourceEnd: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the SourceEnd: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the SourceEnd: {dtoInstance.Id}");
            }
