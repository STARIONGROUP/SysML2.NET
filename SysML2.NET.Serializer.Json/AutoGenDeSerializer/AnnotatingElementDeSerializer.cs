// -------------------------------------------------------------------------------------------------
// <copyright file="AnnotatingElementDeSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class AnnotatingElementDeSerializer
    {
        ...
        internal static IAnnotatingElement DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "AnnotatingElement")
            {
                throw new InvalidOperationException($"The AnnotatingElementDeSerializer can only be used to deserialize objects of type AnnotatingElement, a {typeProperty.GetString()} was provided");
            }

            var annotatingElementInstance = new DTO.AnnotatingElement();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    annotatingElementInstance.Id = Guid.Parse(propertyValue);
                }
            }
