...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class FeatureDeSerializer
    {
        ...
        internal static IFeature DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException($"The FeatureDeSerializer can only be used to deserialize objects of type Feature, a {typeProperty.GetString()} was provided");
            }

            var featureInstance = new DTO.Feature();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    featureInstance.Id = Guid.Parse(propertyValue);
                }
            }
