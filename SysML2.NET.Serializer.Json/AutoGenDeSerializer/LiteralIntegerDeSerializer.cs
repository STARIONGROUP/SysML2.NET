// -------------------------------------------------------------------------------------------------
// <copyright file="LiteralIntegerDeSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class LiteralIntegerDeSerializer
    {
        ...
        internal static ILiteralInteger DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "LiteralInteger")
            {
                throw new InvalidOperationException($"The LiteralIntegerDeSerializer can only be used to deserialize objects of type LiteralInteger, a {typeProperty.GetString()} was provided");
            }

            var literalIntegerInstance = new DTO.LiteralInteger();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    literalIntegerInstance.Id = Guid.Parse(propertyValue);
                }
            }
