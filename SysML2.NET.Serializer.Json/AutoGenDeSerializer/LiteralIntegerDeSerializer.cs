...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class LiteralIntegerDeSerializer
    {
        ...
        internal static ILiteralInteger DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new DTO.LiteralInteger();
            ...
            {
                throw new NotImplementedException("LiteralInteger.direction is not yet supported");
            }
            else
            {
            ...
            {
                logger.LogDebug($"the name Json property was not found in the LiteralInteger: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the LiteralInteger: {dtoInstance.Id}");
            }
