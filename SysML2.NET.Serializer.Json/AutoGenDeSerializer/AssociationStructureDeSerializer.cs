...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class AssociationStructureDeSerializer
    {
        ...
        internal static IAssociationStructure DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "AssociationStructure")
            {
                throw new InvalidOperationException($"The AssociationStructureDeSerializer can only be used to deserialize objects of type AssociationStructure, a {typeProperty.GetString()} was provided");
            }

            var associationStructureInstance = new DTO.AssociationStructure();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    associationStructureInstance.Id = Guid.Parse(propertyValue);
                }
            }
