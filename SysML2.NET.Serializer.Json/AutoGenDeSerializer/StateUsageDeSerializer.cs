...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class StateUsageDeSerializer
    {
        ...
        internal static IStateUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug($"the name Json property was not found in the StateUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the StateUsage: {dtoInstance.Id}");
            }
