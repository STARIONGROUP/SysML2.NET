...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class BehaviorDeSerializer
    {
        ...
        internal static IBehavior DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "Behavior")
            {
                throw new InvalidOperationException($"The BehaviorDeSerializer can only be used to deserialize objects of type Behavior, a {typeProperty.GetString()} was provided");
            }

            var behaviorInstance = new DTO.Behavior();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    behaviorInstance.Id = Guid.Parse(propertyValue);
                }
            }
