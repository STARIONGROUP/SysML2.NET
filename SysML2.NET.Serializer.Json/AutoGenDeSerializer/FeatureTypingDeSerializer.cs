...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class FeatureTypingDeSerializer
    {
        ...
        internal static IFeatureTyping DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "FeatureTyping")
            {
                throw new InvalidOperationException($"The FeatureTypingDeSerializer can only be used to deserialize objects of type FeatureTyping, a {typeProperty.GetString()} was provided");
            }

            var featureTypingInstance = new DTO.FeatureTyping();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    featureTypingInstance.Id = Guid.Parse(propertyValue);
                }
            }
