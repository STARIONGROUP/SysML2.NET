...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class PackageDeSerializer
    {
        ...
        internal static IPackage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "Package")
            {
                throw new InvalidOperationException($"The PackageDeSerializer can only be used to deserialize objects of type Package, a {typeProperty.GetString()} was provided");
            }

            var packageInstance = new DTO.Package();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    packageInstance.Id = Guid.Parse(propertyValue);
                }
            }
