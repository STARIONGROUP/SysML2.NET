...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class TransitionFeatureMembershipDeSerializer
    {
        ...
        internal static ITransitionFeatureMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new Core.DTO.TransitionFeatureMembership();
            ...
            if (jsonElement.TryGetProperty("featureOfType", out JsonElement featureOfTypeProperty))
            {
                if (featureOfTypeProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the TransitionFeatureMembership.FeatureOfType property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the featureOfType Json property was not found in the TransitionFeatureMembership: {dtoInstance.Id}");
            }
            ...
            if (jsonElement.TryGetProperty("featuringType", out JsonElement featuringTypeProperty))
            {
                if (featuringTypeProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the TransitionFeatureMembership.FeaturingType property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the featuringType Json property was not found in the TransitionFeatureMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the TransitionFeatureMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the TransitionFeatureMembership: {dtoInstance.Id}");
            }
