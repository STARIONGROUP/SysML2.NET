...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class SatisfyRequirementUsageDeSerializer
    {
        ...
        internal static ISatisfyRequirementUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new DTO.SatisfyRequirementUsage();
            ...
            {
                throw new NotImplementedException("SatisfyRequirementUsage.direction is not yet supported");
            }
            else
            {
            ...
            {
                logger.LogDebug($"the isReadOnly Json property was not found in the SatisfyRequirementUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the SatisfyRequirementUsage: {dtoInstance.Id}");
            }
            ...
            {
                throw new NotImplementedException("SatisfyRequirementUsage.portionKind is not yet supported");
            }
            else
            {
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the SatisfyRequirementUsage: {dtoInstance.Id}");
            }
