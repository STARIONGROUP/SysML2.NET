...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class EnumerationUsageDeSerializer
    {
        ...
        internal static IEnumerationUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug($"the name Json property was not found in the EnumerationUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the EnumerationUsage: {dtoInstance.Id}");
            }
