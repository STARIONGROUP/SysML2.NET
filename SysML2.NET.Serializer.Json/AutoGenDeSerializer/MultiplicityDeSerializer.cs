...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class MultiplicityDeSerializer
    {
        ...
        internal static IMultiplicity DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug($"the name Json property was not found in the Multiplicity: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the Multiplicity: {dtoInstance.Id}");
            }
