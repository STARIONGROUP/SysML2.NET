// -------------------------------------------------------------------------------------------------
// <copyright file="AnnotationDeSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class AnnotationDeSerializer
    {
        ...
        internal static IAnnotation DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new Core.DTO.Annotation();
            ...
            if (jsonElement.TryGetProperty("annotatedElement", out JsonElement annotatedElementProperty))
            {
                ...
                {
                    if (annotatedElementProperty.TryGetProperty("@id", out JsonElement annotatedElementIdProperty))
                    {
            ...
            if (jsonElement.TryGetProperty("annotatingElement", out JsonElement annotatingElementProperty))
            {
                ...
                {
                    if (annotatingElementProperty.TryGetProperty("@id", out JsonElement annotatingElementIdProperty))
                    {
            ...
            {
                logger.LogDebug($"the name Json property was not found in the Annotation: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the Annotation: {dtoInstance.Id}");
            }
