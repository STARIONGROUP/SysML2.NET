// -------------------------------------------------------------------------------------------------
// <copyright file="BindingConnectorDeSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class BindingConnectorDeSerializer
    {
        ...
        internal static IBindingConnector DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new DTO.BindingConnector();
            ...
            {
                throw new NotImplementedException("BindingConnector.direction is not yet supported");
            }
            else
            {
            ...
            {
                logger.LogDebug($"the name Json property was not found in the BindingConnector: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the BindingConnector: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the target Json property was not found in the BindingConnector: {dtoInstance.Id}");
            }
