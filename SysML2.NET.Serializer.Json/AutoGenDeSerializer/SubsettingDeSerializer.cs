...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class SubsettingDeSerializer
    {
        ...
        internal static ISubsetting DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "Subsetting")
            {
                throw new InvalidOperationException($"The SubsettingDeSerializer can only be used to deserialize objects of type Subsetting, a {typeProperty.GetString()} was provided");
            }

            var subsettingInstance = new DTO.Subsetting();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    subsettingInstance.Id = Guid.Parse(propertyValue);
                }
            }
