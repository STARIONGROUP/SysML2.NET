...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class ConnectionUsageDeSerializer
    {
        ...
        internal static IConnectionUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug($"the name Json property was not found in the ConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the ConnectionUsage: {dtoInstance.Id}");
            }
