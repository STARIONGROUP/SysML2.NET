...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class PredicateDeSerializer
    {
        ...
        internal static IPredicate DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "Predicate")
            {
                throw new InvalidOperationException($"The PredicateDeSerializer can only be used to deserialize objects of type Predicate, a {typeProperty.GetString()} was provided");
            }

            var predicateInstance = new DTO.Predicate();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    predicateInstance.Id = Guid.Parse(propertyValue);
                }
            }
