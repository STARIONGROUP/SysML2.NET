...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class AnalysisCaseDefinitionDeSerializer
    {
        ...
        internal static IAnalysisCaseDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new DTO.AnalysisCaseDefinition();
            ...
            {
                logger.LogDebug($"the name Json property was not found in the AnalysisCaseDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the AnalysisCaseDefinition: {dtoInstance.Id}");
            }
