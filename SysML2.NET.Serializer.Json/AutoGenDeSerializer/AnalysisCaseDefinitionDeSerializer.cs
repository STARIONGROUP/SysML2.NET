...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class AnalysisCaseDefinitionDeSerializer
    {
        ...
        internal static IAnalysisCaseDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "AnalysisCaseDefinition")
            {
                throw new InvalidOperationException($"The AnalysisCaseDefinitionDeSerializer can only be used to deserialize objects of type AnalysisCaseDefinition, a {typeProperty.GetString()} was provided");
            }

            var analysisCaseDefinitionInstance = new DTO.AnalysisCaseDefinition();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    analysisCaseDefinitionInstance.Id = Guid.Parse(propertyValue);
                }
            }
