// -------------------------------------------------------------------------------------------------
// <copyright file="RequirementDefinitionDeSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class RequirementDefinitionDeSerializer
    {
        ...
        internal static IRequirementDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new Core.DTO.RequirementDefinition();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the RequirementDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the RequirementDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isAbstract Json property was not found in the RequirementDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the RequirementDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isIndividual Json property was not found in the RequirementDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isSufficient Json property was not found in the RequirementDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isVariation Json property was not found in the RequirementDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the RequirementDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the RequirementDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the RequirementDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the reqId Json property was not found in the RequirementDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the RequirementDefinition: {dtoInstance.Id}");
            }
