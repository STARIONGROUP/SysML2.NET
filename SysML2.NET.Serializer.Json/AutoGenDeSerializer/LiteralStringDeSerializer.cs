...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class LiteralStringDeSerializer
    {
        ...
        internal static ILiteralString DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "LiteralString")
            {
                throw new InvalidOperationException($"The LiteralStringDeSerializer can only be used to deserialize objects of type LiteralString, a {typeProperty.GetString()} was provided");
            }

            var literalStringInstance = new DTO.LiteralString();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    literalStringInstance.Id = Guid.Parse(propertyValue);
                }
            }
