...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class ClassifierDeSerializer
    {
        ...
        internal static IClassifier DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new Core.DTO.Classifier();
            ...
            {
                logger.LogDebug($"the name Json property was not found in the Classifier: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the Classifier: {dtoInstance.Id}");
            }
