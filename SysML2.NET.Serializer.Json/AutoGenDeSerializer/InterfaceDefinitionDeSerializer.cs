...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class InterfaceDefinitionDeSerializer
    {
        ...
        internal static IInterfaceDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "InterfaceDefinition")
            {
                throw new InvalidOperationException($"The InterfaceDefinitionDeSerializer can only be used to deserialize objects of type InterfaceDefinition, a {typeProperty.GetString()} was provided");
            }

            var interfaceDefinitionInstance = new DTO.InterfaceDefinition();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    interfaceDefinitionInstance.Id = Guid.Parse(propertyValue);
                }
            }
