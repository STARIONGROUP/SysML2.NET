...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class BooleanExpressionDeSerializer
    {
        ...
        internal static IBooleanExpression DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug($"the name Json property was not found in the BooleanExpression: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the BooleanExpression: {dtoInstance.Id}");
            }
