...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class FramedConcernMembershipDeSerializer
    {
        ...
        internal static IFramedConcernMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "FramedConcernMembership")
            {
                throw new InvalidOperationException($"The FramedConcernMembershipDeSerializer can only be used to deserialize objects of type FramedConcernMembership, a {typeProperty.GetString()} was provided");
            }

            var framedConcernMembershipInstance = new DTO.FramedConcernMembership();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    framedConcernMembershipInstance.Id = Guid.Parse(propertyValue);
                }
            }
