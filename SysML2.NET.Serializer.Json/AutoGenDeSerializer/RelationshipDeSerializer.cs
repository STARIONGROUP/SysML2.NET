// -------------------------------------------------------------------------------------------------
// <copyright file="RelationshipDeSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Json
{
    ...
    /// <summary>
    /// The purpose of the <see cref="RelationshipDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="IRelationship"/> interface
    /// </summary>
    internal static class RelationshipDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IRelationship"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        /// <param name="jsonElement">
        /// The <see cref="JsonElement"/> that contains the <see cref="IRelationship"/> json object
        /// </param>
        ...
        /// </returns>
        internal static IRelationship DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            var logger = loggerFactory == null ? NullLogger.Instance : loggerFactory.CreateLogger("RelationshipDeSerializer");

            if (!jsonElement.TryGetProperty("@type", out JsonElement @type))
            {
                throw new InvalidOperationException("The @type property is not available, the RelationshipDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "Relationship")
            {
                throw new InvalidOperationException($"The RelationshipDeSerializer can only be used to deserialize objects of type IRelationship, a {@type.GetString()} was provided");
            }

            var dtoInstance = new Core.DTO.Relationship();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    throw new JsonException("The @id property is not present, the Relationship cannot be deserialized");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the Relationship: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the Relationship: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the Relationship: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the Relationship: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the name Json property was not found in the Relationship: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the Relationship: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the Relationship: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the Relationship: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the Relationship: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the Relationship: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the source Json property was not found in the Relationship: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the target Json property was not found in the Relationship: {dtoInstance.Id}");
            }
