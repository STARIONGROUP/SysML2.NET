...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class OwningMembershipDeSerializer
    {
        ...
        internal static IOwningMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug($"the name Json property was not found in the OwningMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the OwningMembership: {dtoInstance.Id}");
            }
