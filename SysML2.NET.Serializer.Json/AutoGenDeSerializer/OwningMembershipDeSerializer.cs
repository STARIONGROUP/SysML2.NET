...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class OwningMembershipDeSerializer
    {
        ...
        internal static IOwningMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "OwningMembership")
            {
                throw new InvalidOperationException($"The OwningMembershipDeSerializer can only be used to deserialize objects of type OwningMembership, a {typeProperty.GetString()} was provided");
            }

            var owningMembershipInstance = new DTO.OwningMembership();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    owningMembershipInstance.Id = Guid.Parse(propertyValue);
                }
            }
