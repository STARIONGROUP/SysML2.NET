...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class FlowConnectionDefinitionDeSerializer
    {
        ...
        internal static IFlowConnectionDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug($"the name Json property was not found in the FlowConnectionDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the FlowConnectionDefinition: {dtoInstance.Id}");
            }
