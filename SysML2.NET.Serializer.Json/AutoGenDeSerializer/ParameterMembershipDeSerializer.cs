        ...
        internal static IParameterMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (jsonElement.TryGetProperty("featureOfType", out JsonElement featureOfTypeProperty))
            {
                if (featureOfTypeProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the ParameterMembership.FeatureOfType property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the featureOfType Json property was not found in the ParameterMembership: {dtoInstance.Id}");
            }
            ...
            if (jsonElement.TryGetProperty("featuringType", out JsonElement featuringTypeProperty))
            {
                if (featuringTypeProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the ParameterMembership.FeaturingType property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the featuringType Json property was not found in the ParameterMembership: {dtoInstance.Id}");
            }
