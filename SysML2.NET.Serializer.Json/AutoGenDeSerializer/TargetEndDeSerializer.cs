...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class TargetEndDeSerializer
    {
        ...
        internal static ITargetEnd DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "TargetEnd")
            {
                throw new InvalidOperationException($"The TargetEndDeSerializer can only be used to deserialize objects of type TargetEnd, a {typeProperty.GetString()} was provided");
            }

            var targetEndInstance = new DTO.TargetEnd();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    targetEndInstance.Id = Guid.Parse(propertyValue);
                }
            }
