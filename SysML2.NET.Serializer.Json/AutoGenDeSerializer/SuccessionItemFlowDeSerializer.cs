...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class SuccessionItemFlowDeSerializer
    {
        ...
        internal static ISuccessionItemFlow DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug($"the name Json property was not found in the SuccessionItemFlow: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the SuccessionItemFlow: {dtoInstance.Id}");
            }
