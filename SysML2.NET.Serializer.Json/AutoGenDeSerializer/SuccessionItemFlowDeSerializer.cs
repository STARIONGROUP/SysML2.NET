...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class SuccessionItemFlowDeSerializer
    {
        ...
        internal static ISuccessionItemFlow DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "SuccessionItemFlow")
            {
                throw new InvalidOperationException($"The SuccessionItemFlowDeSerializer can only be used to deserialize objects of type SuccessionItemFlow, a {typeProperty.GetString()} was provided");
            }

            var successionItemFlowInstance = new DTO.SuccessionItemFlow();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    successionItemFlowInstance.Id = Guid.Parse(propertyValue);
                }
            }
