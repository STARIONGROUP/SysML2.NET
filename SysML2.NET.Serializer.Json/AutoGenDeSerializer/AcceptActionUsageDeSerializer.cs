...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class AcceptActionUsageDeSerializer
    {
        ...
        internal static IAcceptActionUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "AcceptActionUsage")
            {
                throw new InvalidOperationException($"The AcceptActionUsageDeSerializer can only be used to deserialize objects of type AcceptActionUsage, a {typeProperty.GetString()} was provided");
            }

            var acceptActionUsageInstance = new DTO.AcceptActionUsage();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    acceptActionUsageInstance.Id = Guid.Parse(propertyValue);
                }
            }
