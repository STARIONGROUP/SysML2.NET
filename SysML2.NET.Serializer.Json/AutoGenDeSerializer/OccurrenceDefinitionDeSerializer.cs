...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class OccurrenceDefinitionDeSerializer
    {
        ...
        internal static IOccurrenceDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug($"the name Json property was not found in the OccurrenceDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the OccurrenceDefinition: {dtoInstance.Id}");
            }
