...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class AllocationUsageDeSerializer
    {
        ...
        internal static IAllocationUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new DTO.AllocationUsage();
            ...
            {
                throw new NotImplementedException("AllocationUsage.direction is not yet supported");
            }
            else
            {
            ...
            {
                throw new NotImplementedException("AllocationUsage.portionKind is not yet supported");
            }
            else
            {
