// -------------------------------------------------------------------------------------------------
// <copyright file="LiteralRationalDeSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class LiteralRationalDeSerializer
    {
        ...
        internal static ILiteralRational DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (typeProperty.GetString() != "LiteralRational")
            {
                throw new InvalidOperationException($"The LiteralRationalDeSerializer can only be used to deserialize objects of type LiteralRational, a {typeProperty.GetString()} was provided");
            }

            var literalRationalInstance = new DTO.LiteralRational();
            ...
            if (jsonElement.TryGetProperty("@id", out JsonElement idProperty))
            {
                ...
                {
                    literalRationalInstance.Id = Guid.Parse(propertyValue);
                }
            }
