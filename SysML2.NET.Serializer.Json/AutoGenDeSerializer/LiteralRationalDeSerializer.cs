...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class LiteralRationalDeSerializer
    {
        ...
        internal static ILiteralRational DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new DTO.LiteralRational();
            ...
            {
                throw new NotImplementedException("LiteralRational.direction is not yet supported");
            }
            else
            {
            ...
            {
                logger.LogDebug($"the name Json property was not found in the LiteralRational: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the shortName Json property was not found in the LiteralRational: {dtoInstance.Id}");
            }
