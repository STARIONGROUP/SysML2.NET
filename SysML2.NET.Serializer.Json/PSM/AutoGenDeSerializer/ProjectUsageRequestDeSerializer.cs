// -------------------------------------------------------------------------------------------------
// <copyright file="ProjectUsageRequestDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Json.PSM
{
    ...
    /// <summary>
    /// The purpose of the <see cref="ProjectUsageRequestDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="ProjectUsageRequest"/> class
    /// </summary>
    internal static class ProjectUsageRequestDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="ProjectUsageRequest"/> from the provided <see cref="Utf8JsonReader"/>
        /// </summary>
        /// <param name="reader">
        /// The <see cref="Utf8JsonReader"/> positioned on the <see cref="JsonTokenType.StartObject"/> of the
        /// <see cref="ProjectUsageRequest"/> json object. On return the reader is positioned on the matching
        ...
        /// </param>
        /// <returns>
        /// an instance of <see cref="ProjectUsageRequest"/>
        /// </returns>
