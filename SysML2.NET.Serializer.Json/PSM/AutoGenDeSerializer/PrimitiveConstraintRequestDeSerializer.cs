// -------------------------------------------------------------------------------------------------
// <copyright file="PrimitiveConstraintRequestDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Json.PSM
{
    ...
    /// <summary>
    /// The purpose of the <see cref="PrimitiveConstraintRequestDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="PrimitiveConstraintRequest"/> class
    /// </summary>
    internal static class PrimitiveConstraintRequestDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="PrimitiveConstraintRequest"/> from the provided <see cref="Utf8JsonReader"/>
        /// </summary>
        /// <param name="reader">
        /// The <see cref="Utf8JsonReader"/> positioned on the <see cref="JsonTokenType.StartObject"/> of the
        /// <see cref="PrimitiveConstraintRequest"/> json object. On return the reader is positioned on the matching
        ...
        /// </param>
        /// <returns>
        /// an instance of <see cref="PrimitiveConstraintRequest"/>
        /// </returns>
        ...
        internal static PrimitiveConstraintRequest DeSerialize(ref Utf8JsonReader reader, SerializationModeKind serializationModeKind, bool deserializeDerivedProperties, ILoggerFactory loggerFactory = null)
        {
            ...
            while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
            {
                ...
                if (reader.ValueTextEquals("value"u8))
                {
                    ...
                    primitiveConstraintRequest.Value = new List<ConstraintValue>();
