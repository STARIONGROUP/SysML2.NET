// -------------------------------------------------------------------------------------------------
// <copyright file="TagRequestDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Json.PSM
{
    ...
    /// <summary>
    /// The purpose of the <see cref="TagRequestDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="TagRequest"/> class
    /// </summary>
    internal static class TagRequestDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="TagRequest"/> from the provided <see cref="Utf8JsonReader"/>
        /// </summary>
        /// <param name="reader">
        /// The <see cref="Utf8JsonReader"/> positioned on the <see cref="JsonTokenType.StartObject"/> of the
        /// <see cref="TagRequest"/> json object. On return the reader is positioned on the matching
        ...
        /// </param>
        /// <returns>
        /// an instance of <see cref="TagRequest"/>
        /// </returns>
        ...
        internal static TagRequest DeSerialize(ref Utf8JsonReader reader, SerializationModeKind serializationModeKind, bool deserializeDerivedProperties, ILoggerFactory loggerFactory = null)
        {
            ...
            while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
            {
                ...
                if (reader.ValueTextEquals("alias"u8))
                {
                    ...
                    tagRequest.Alias = new List<string>();
