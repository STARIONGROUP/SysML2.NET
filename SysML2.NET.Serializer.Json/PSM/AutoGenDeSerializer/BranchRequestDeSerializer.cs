// -------------------------------------------------------------------------------------------------
// <copyright file="BranchRequestDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Json.PSM
{
    ...
    /// <summary>
    /// The purpose of the <see cref="BranchRequestDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="BranchRequest"/> class
    /// </summary>
    internal static class BranchRequestDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="BranchRequest"/> from the provided <see cref="Utf8JsonReader"/>
        /// </summary>
        /// <param name="reader">
        /// The <see cref="Utf8JsonReader"/> positioned on the <see cref="JsonTokenType.StartObject"/> of the
        /// <see cref="BranchRequest"/> json object. On return the reader is positioned on the matching
        ...
        /// </param>
        /// <returns>
        /// an instance of <see cref="BranchRequest"/>
        /// </returns>
        ...
        internal static BranchRequest DeSerialize(ref Utf8JsonReader reader, SerializationModeKind serializationModeKind, bool deserializeDerivedProperties, ILoggerFactory loggerFactory = null)
        {
            ...
            while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
            {
                ...
                if (reader.ValueTextEquals("alias"u8))
                {
                    ...
                    branchRequest.Alias = new List<string>();
