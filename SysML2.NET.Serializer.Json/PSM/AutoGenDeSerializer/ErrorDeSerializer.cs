// -------------------------------------------------------------------------------------------------
// <copyright file="ErrorDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Json.PSM
{
    ...
    /// <summary>
    /// The purpose of the <see cref="ErrorDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="Error"/> class
    /// </summary>
    internal static class ErrorDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="Error"/> from the provided <see cref="Utf8JsonReader"/>
        /// </summary>
        /// <param name="reader">
        /// The <see cref="Utf8JsonReader"/> positioned on the <see cref="JsonTokenType.StartObject"/> of the
        /// <see cref="Error"/> json object. On return the reader is positioned on the matching
