// -------------------------------------------------------------------------------------------------
// <copyright file="DataIdentityRequestDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Json.PSM
{
    ...
    /// <summary>
    /// The purpose of the <see cref="DataIdentityRequestDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="DataIdentityRequest"/> class
    /// </summary>
    internal static class DataIdentityRequestDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="DataIdentityRequest"/> from the provided <see cref="Utf8JsonReader"/>
        /// </summary>
        /// <param name="reader">
        /// The <see cref="Utf8JsonReader"/> positioned on the <see cref="JsonTokenType.StartObject"/> of the
        /// <see cref="DataIdentityRequest"/> json object. On return the reader is positioned on the matching
        ...
        /// </param>
        /// <returns>
        /// an instance of <see cref="DataIdentityRequest"/>
        /// </returns>
        ...
        internal static DataIdentityRequest DeSerialize(ref Utf8JsonReader reader, SerializationModeKind serializationModeKind, bool deserializeDerivedProperties, ILoggerFactory loggerFactory = null)
        {
            ...
            while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
            {
                ...
                if (reader.ValueTextEquals("alias"u8))
                {
                    ...
                    dataIdentityRequest.Alias = new List<string>();
