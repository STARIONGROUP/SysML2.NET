// -------------------------------------------------------------------------------------------------
// <copyright file="DeSerializeRequestDelegate.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Json.PSM
{
    ...
    /// <summary>
    /// Deserializes a single <see cref="IRequest"/> from the provided <see cref="Utf8JsonReader"/>.
    /// </summary>
    /// <param name="reader">
