// -------------------------------------------------------------------------------------------------
// <copyright file="TagSerializer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Json.PSM
{
    ...
    internal static class TagSerializer
    {
        ...
        /// Thrown when the object is not a <see cref="Tag"/>
        /// </exception>
        ...
        internal static void Serialize(object obj, Utf8JsonWriter writer, SerializationModeKind serializationModeKind, bool includeDerivedProperties)
        {
            ...
            {
                throw new ArgumentException("The object shall be a Tag", nameof(obj));
            }
