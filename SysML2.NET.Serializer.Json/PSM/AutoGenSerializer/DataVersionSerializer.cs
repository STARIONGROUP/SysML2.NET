// -------------------------------------------------------------------------------------------------
// <copyright file="DataVersionSerializer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Json.PSM
{
    ...
    internal static class DataVersionSerializer
    {
        ...
        /// Thrown when the object is not a <see cref="DataVersion"/>
        /// </exception>
        ...
        {
            if (obj is not DataVersion dataVersion)
            {
                throw new ArgumentException("The object shall be a DataVersion", nameof(obj));
            }
            ...
            writer.WriteString("name"u8, dataVersion.Name);

            if (dataVersion.Payload != null)
            {
                writer.WritePropertyName("payload"u8);
                PsmSerializationDispatcher.Provide(dataVersion.Payload.GetType())(dataVersion.Payload, writer, serializationModeKind, includeDerivedProperties);
            }
            else
            {
