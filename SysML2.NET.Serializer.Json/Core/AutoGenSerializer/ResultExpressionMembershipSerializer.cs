...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class ResultExpressionMembershipSerializer
    {
        ...
        {
            if (obj is not IResultExpressionMembership iResultExpressionMembership)
            {
            ...
            {
                SerializeAsJsonWithDerivedProperties(iResultExpressionMembership, writer);
            }
            else
            {
                SerializeAsJsonWithoutDerivedProperties(iResultExpressionMembership, writer);
            }
        ...
        /// <summary>
        /// Serializes an instance of <see cref="IResultExpressionMembership"/> using an <see cref="Utf8JsonWriter"/> as JSON including derived properties
        /// </summary>
        /// <param name=" iResultExpressionMembership">
        /// The <see cref="IResultExpressionMembership"/> to serialize
        /// </param>
        /// <param name="writer">
        /// The target <see cref="Utf8JsonWriter"/>
        /// </param>
        private static void SerializeAsJsonWithDerivedProperties(IResultExpressionMembership iResultExpressionMembership, Utf8JsonWriter writer)
        {
            ...
            foreach (var item in iResultExpressionMembership.documentation)
            {
                writer.WriteStartObject();
                writer.WritePropertyName("@id"u8);
                writer.WriteStringValue(item);
            ...
            writer.WriteBooleanValue(iResultExpressionMembership.isLibraryElement);
            ...
            writer.WriteStringValue(iResultExpressionMembership.memberElementId);
            ...
            writer.WriteStartObject();
            writer.WritePropertyName("@id"u8);
            writer.WriteStringValue(iResultExpressionMembership.membershipOwningNamespace);
            writer.WriteEndObject();
            ...
            foreach (var item in iResultExpressionMembership.ownedAnnotation)
            {
                writer.WriteStartObject();
                writer.WritePropertyName("@id"u8);
                writer.WriteStringValue(item);
            ...
            foreach (var item in iResultExpressionMembership.ownedElement)
            {
                writer.WriteStartObject();
                writer.WritePropertyName("@id"u8);
                writer.WriteStringValue(item);
            ...
            writer.WriteStartObject();
            writer.WritePropertyName("@id"u8);
            writer.WriteStringValue(iResultExpressionMembership.ownedMemberElement);
            writer.WriteEndObject();

            writer.WritePropertyName("ownedMemberElementId"u8);
            writer.WriteStringValue(iResultExpressionMembership.ownedMemberElementId);

            writer.WritePropertyName("ownedMemberFeature"u8);
            writer.WriteStartObject();
            writer.WritePropertyName("@id"u8);
            writer.WriteStringValue(iResultExpressionMembership.ownedMemberFeature);
            writer.WriteEndObject();

            writer.WritePropertyName("ownedMemberName"u8);
            writer.WriteStringValue(iResultExpressionMembership.ownedMemberName);

            writer.WritePropertyName("ownedMemberShortName"u8);
            writer.WriteStringValue(iResultExpressionMembership.ownedMemberShortName);
            ...
            writer.WriteStartObject();
            writer.WritePropertyName("@id"u8);
            writer.WriteStringValue(iResultExpressionMembership.ownedResultExpression);
            writer.WriteEndObject();

            writer.WritePropertyName("owner"u8);

            if (iResultExpressionMembership.owner.HasValue)
            {
                writer.WriteStartObject();
                writer.WritePropertyName("@id"u8);
                writer.WriteStringValue(iResultExpressionMembership.owner.Value);
                writer.WriteEndObject();
            }
            else
            {
            ...
            if (iResultExpressionMembership.owningMembership.HasValue)
            {
                writer.WriteStartObject();
                writer.WritePropertyName("@id"u8);
                writer.WriteStringValue(iResultExpressionMembership.owningMembership.Value);
                writer.WriteEndObject();
            }
            else
            {
            ...
            if (iResultExpressionMembership.owningNamespace.HasValue)
            {
                writer.WriteStartObject();
                writer.WritePropertyName("@id"u8);
                writer.WriteStringValue(iResultExpressionMembership.owningNamespace.Value);
                writer.WriteEndObject();
            }
            else
            {
            ...
            writer.WriteStartObject();
            writer.WritePropertyName("@id"u8);
            writer.WriteStringValue(iResultExpressionMembership.owningType);
            writer.WriteEndObject();

            writer.WritePropertyName("qualifiedName"u8);
            writer.WriteStringValue(iResultExpressionMembership.qualifiedName);

            writer.WriteStartArray("relatedElement"u8);

            foreach (var item in iResultExpressionMembership.relatedElement)
            {
                writer.WriteStartObject();
                writer.WritePropertyName("@id"u8);
                writer.WriteStringValue(item);
            ...
            foreach (var item in iResultExpressionMembership.textualRepresentation)
            {
                writer.WriteStartObject();
                writer.WritePropertyName("@id"u8);
                writer.WriteStringValue(item);
        ...
        /// <summary>
        /// Serializes an instance of <see cref="IResultExpressionMembership"/> using an <see cref="Utf8JsonWriter"/> as JSON excluding derived properties
        /// </summary>
        /// <param name=" iResultExpressionMembership">
        /// The <see cref="IResultExpressionMembership"/> to serialize
        /// </param>
        ...
        /// The target <see cref="Utf8JsonWriter"/>
        /// </param>
        private static void SerializeAsJsonWithoutDerivedProperties(IResultExpressionMembership iResultExpressionMembership, Utf8JsonWriter writer)
        {
            writer.WriteStartArray("aliasIds"u8);
