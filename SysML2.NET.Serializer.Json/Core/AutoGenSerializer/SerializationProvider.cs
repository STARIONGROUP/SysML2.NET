...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class SerializationProvider
    {
        private static readonly Dictionary<System.Type, Action<object, Utf8JsonWriter, SerializationModeKind>> SerializerActionMap = new Dictionary<System.Type, Action<object, Utf8JsonWriter, SerializationModeKind>>
        {
            ...
            { typeof(SysML2.NET.Core.DTO.ConstructorExpression), ConstructorExpressionSerializer.Serialize },
            ...
            { typeof(SysML2.NET.Core.DTO.Flow), FlowSerializer.Serialize },
            { typeof(SysML2.NET.Core.DTO.FlowDefinition), FlowDefinitionSerializer.Serialize },
            { typeof(SysML2.NET.Core.DTO.FlowEnd), FlowEndSerializer.Serialize },
            { typeof(SysML2.NET.Core.DTO.FlowUsage), FlowUsageSerializer.Serialize },
            ...
            { typeof(SysML2.NET.Core.DTO.PayloadFeature), PayloadFeatureSerializer.Serialize },
            ...
            { typeof(SysML2.NET.Core.DTO.SuccessionFlow), SuccessionFlowSerializer.Serialize },
            { typeof(SysML2.NET.Core.DTO.SuccessionFlowUsage), SuccessionFlowUsageSerializer.Serialize },
