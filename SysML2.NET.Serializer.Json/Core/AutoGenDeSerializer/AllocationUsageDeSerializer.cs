// -------------------------------------------------------------------------------------------------
// <copyright file="AllocationUsageDeSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class AllocationUsageDeSerializer
    {
        ...
        internal static IAllocationUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug($"the isDirected Json property was not found in the AllocationUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isReadOnly Json property was not found in the AllocationUsage: {dtoInstance.Id}");
            }
