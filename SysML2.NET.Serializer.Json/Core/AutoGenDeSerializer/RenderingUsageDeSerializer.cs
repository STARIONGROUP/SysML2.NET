// -------------------------------------------------------------------------------------------------
// <copyright file="RenderingUsageDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="RenderingUsageDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="IRenderingUsage"/> interface
    /// </summary>
    internal static class RenderingUsageDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IRenderingUsage"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IRenderingUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the RenderingUsageDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "RenderingUsage")
            {
                throw new InvalidOperationException($"The RenderingUsageDeSerializer can only be used to deserialize objects of type IRenderingUsage, a {@type.GetString()} was provided");
            }

            var dtoInstance = new SysML2.NET.Core.DTO.RenderingUsage();
            ...
            if (jsonElement.TryGetProperty("@id"u8, out JsonElement idProperty))
            {
                ...
                {
                    throw new JsonException("The @id property is not present, the RenderingUsage cannot be deserialized");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the RenderingUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the RenderingUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the RenderingUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the direction Json property was not found in the RenderingUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the RenderingUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isAbstract Json property was not found in the RenderingUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isComposite Json property was not found in the RenderingUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isConstant Json property was not found in the RenderingUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isDerived Json property was not found in the RenderingUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isEnd Json property was not found in the RenderingUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the RenderingUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isIndividual Json property was not found in the RenderingUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isOrdered Json property was not found in the RenderingUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isPortion Json property was not found in the RenderingUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isSufficient Json property was not found in the RenderingUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isUnique Json property was not found in the RenderingUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isVariable Json property was not found in the RenderingUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isVariation Json property was not found in the RenderingUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the RenderingUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the RenderingUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the portionKind Json property was not found in the RenderingUsage: {dtoInstance.Id}");
            }
