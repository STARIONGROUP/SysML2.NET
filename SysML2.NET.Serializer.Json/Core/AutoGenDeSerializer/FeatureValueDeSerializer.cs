...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class FeatureValueDeSerializer
    {
        ...
        internal static IFeatureValue DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.FeatureValue();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the FeatureValue: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the FeatureValue: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the FeatureValue: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isDefault Json property was not found in the FeatureValue: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the FeatureValue: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the FeatureValue: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isInitial Json property was not found in the FeatureValue: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the memberElement Json property was not found in the FeatureValue: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the memberName Json property was not found in the FeatureValue: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the memberShortName Json property was not found in the FeatureValue: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the FeatureValue: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the FeatureValue: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the FeatureValue: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the FeatureValue: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the source Json property was not found in the FeatureValue: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the target Json property was not found in the FeatureValue: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the visibility Json property was not found in the FeatureValue: {dtoInstance.Id}");
            }
