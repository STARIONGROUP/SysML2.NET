    ...
    internal static class FeatureValueDeSerializer
    {
        ...
        internal static IFeatureValue DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (jsonElement.TryGetProperty("featureWithValue"u8, out var featureWithValueProperty))
            {
                ...
                {
                    if (featureWithValueProperty.TryGetProperty("@id"u8, out var featureWithValueExternalIdProperty))
                    {
                        var propertyValue = featureWithValueExternalIdProperty.GetString();
            ...
            {
                logger.LogDebug("the memberElement Json property was not found in the FeatureValue: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the memberElementId Json property was not found in the FeatureValue: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the memberName Json property was not found in the FeatureValue: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the memberShortName Json property was not found in the FeatureValue: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("ownedMemberElement"u8, out var ownedMemberElementProperty))
            {
                if (ownedMemberElementProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the FeatureValue.ownedMemberElement property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the ownedMemberElement Json property was not found in the FeatureValue: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the source Json property was not found in the FeatureValue: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the target Json property was not found in the FeatureValue: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("value"u8, out var valueProperty))
            {
                ...
                {
                    if (valueProperty.TryGetProperty("@id"u8, out var valueExternalIdProperty))
                    {
                        var propertyValue = valueExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.value = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
