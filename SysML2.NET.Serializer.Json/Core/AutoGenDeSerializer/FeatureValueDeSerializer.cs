...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IFeatureValue"/> from the provided <see cref="Utf8JsonReader"/>
        /// </summary>
        /// <param name="reader">
        /// The <see cref="Utf8JsonReader"/> positioned on the <see cref="JsonTokenType.StartObject"/> of the
        /// <see cref="IFeatureValue"/> json object. On return the reader is positioned on the matching
        ...
        /// </remarks>
        internal static IFeatureValue DeSerialize(ref Utf8JsonReader reader, SerializationModeKind serializationModeKind, bool deserializeDerivedProperties, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.Kernel.FeatureValues.FeatureValue();
        ...
        /// <summary>
        /// Deserializes properties of a <see cref="SysML2.NET.Core.DTO.Kernel.FeatureValues.FeatureValue" />
        /// from a <see cref="Utf8JsonReader" />, including derived properties
        /// </summary>
        /// <param name="dtoInstance">
        /// The <see cref="SysML2.NET.Core.DTO.Kernel.FeatureValues.FeatureValue"/> instance holding deserialized values
        /// </param>
        /// <param name="reader">
        /// The <see cref="Utf8JsonReader"/> positioned on the <see cref="JsonTokenType.StartObject"/> of the
        /// <see cref="IFeatureValue"/> json object
        /// </param>
        /// <param name="logger">
        /// The <see cref="ILogger"/> to produce logging statement
        /// </param>
        private static void DeserializeDtoIncludingDerivedProperties(SysML2.NET.Core.DTO.Kernel.FeatureValues.FeatureValue dtoInstance, ref Utf8JsonReader reader, ILogger logger)
        {
            ...
            var featureWithValueSeen = false;
            var isDefaultSeen = false;
            var isImpliedSeen = false;
            var isImpliedIncludedSeen = false;
            var isInitialSeen = false;
            ...
            while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
            {
                ...
                {
                    throw new JsonException("Expected a property name in the FeatureValue json object.");
                }
                ...
                if (reader.ValueTextEquals("featureWithValue"u8))
                {
                    featureWithValueSeen = true;
                    reader.Read();
                    ...
                    else if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var featureWithValueValue))
                    {
                        dtoInstance.featureWithValue = featureWithValueValue;
                    }

                    continue;
                }

                if (reader.ValueTextEquals("isDefault"u8))
                {
                    isDefaultSeen = true;
                    reader.Read();
                    ...
                    if (reader.TokenType != JsonTokenType.Null)
                    {
                        dtoInstance.IsDefault = reader.GetBoolean();
                    }
                ...
                if (reader.ValueTextEquals("isInitial"u8))
                {
                    isInitialSeen = true;
                    reader.Read();
                    ...
                    if (reader.TokenType != JsonTokenType.Null)
                    {
                        dtoInstance.IsInitial = reader.GetBoolean();
                    }
                ...
                if (reader.ValueTextEquals("membershipOwningNamespace"u8))
                {
                    ...
                    if (reader.TokenType == JsonTokenType.Null)
                    {
                        ...
                        if (logger.IsEnabled(LogLevel.Debug))
                        {
                            logger.LogDebug("the FeatureValue.membershipOwningNamespace property was not found in the Json. The value is set to Guid.Empty");
                        }
                    }
                ...
                if (reader.ValueTextEquals("value"u8))
                {
                    ...
                    if (reader.TokenType == JsonTokenType.Null)
                    {
                        dtoInstance.value = Guid.Empty;

                        if (logger.IsEnabled(LogLevel.Debug))
                        {
                            logger.LogDebug("the FeatureValue.value property was not found in the Json. The value is set to Guid.Empty");
                        }
                    }
                    else if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var valueValue))
                    {
        ...
        /// The <see cref="ILogger"/> to produce logging statement
        /// </param>
        private static void DeserializeDtoExcludingDerivedProperties(SysML2.NET.Core.DTO.Kernel.FeatureValues.FeatureValue dtoInstance, ref Utf8JsonReader reader, ILogger logger)
        {
            var aliasIdsSeen = false;
            var declaredNameSeen = false;
            var declaredShortNameSeen = false;
