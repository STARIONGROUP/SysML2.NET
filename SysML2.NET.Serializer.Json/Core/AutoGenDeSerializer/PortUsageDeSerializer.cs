...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IPortUsage"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IPortUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the PortUsageDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "PortUsage")
            {
                throw new InvalidOperationException($"The PortUsageDeSerializer can only be used to deserialize objects of type IPortUsage, a {@type.GetString()} was provided");
            }
            ...
            {
                logger.LogDebug("the definition Json property was not found in the PortUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isVariable Json property was not found in the PortUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the occurrenceDefinition Json property was not found in the PortUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                foreach (var arrayItem in portDefinitionProperty.EnumerateArray())
                {
                    if (arrayItem.TryGetProperty("@id"u8, out var portDefinitionExternalIdProperty))
                    {
                        var propertyValue = portDefinitionExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.portDefinition.Add(Guid.Parse(propertyValue));
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the type Json property was not found in the PortUsage: { Id }", dtoInstance.Id);
            }
