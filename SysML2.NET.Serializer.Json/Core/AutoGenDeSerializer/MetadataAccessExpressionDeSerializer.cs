...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class MetadataAccessExpressionDeSerializer
    {
        ...
        internal static IMetadataAccessExpression DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug("the behavior Json property was not found in the MetadataAccessExpression: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the directedFeature Json property was not found in the MetadataAccessExpression: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("referencedElement"u8, out var referencedElementProperty))
            {
                ...
                {
                    if (referencedElementProperty.TryGetProperty("@id"u8, out var referencedElementExternalIdProperty))
                    {
                        var propertyValue = referencedElementExternalIdProperty.GetString();
