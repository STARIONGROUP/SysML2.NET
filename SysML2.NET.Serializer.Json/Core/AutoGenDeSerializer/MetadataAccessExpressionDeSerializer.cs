...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class MetadataAccessExpressionDeSerializer
    {
        ...
        internal static IMetadataAccessExpression DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.MetadataAccessExpression();
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the MetadataAccessExpression: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the MetadataAccessExpression: {dtoInstance.Id}");
            }
