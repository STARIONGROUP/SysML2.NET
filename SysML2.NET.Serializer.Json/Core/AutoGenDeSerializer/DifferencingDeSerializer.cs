...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class DifferencingDeSerializer
    {
        ...
        internal static IDifferencing DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.Differencing();
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the Differencing: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the Differencing: {dtoInstance.Id}");
            }
            ...
            if (jsonElement.TryGetProperty("differencingType"u8, out JsonElement differencingTypeProperty))
            {
                ...
                {
                    if (differencingTypeProperty.TryGetProperty("@id"u8, out JsonElement differencingTypeIdProperty))
                    {
