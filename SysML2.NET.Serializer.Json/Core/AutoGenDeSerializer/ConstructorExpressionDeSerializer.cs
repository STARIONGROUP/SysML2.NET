// -------------------------------------------------------------------------------------------------
// <copyright file="ConstructorExpressionDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="ConstructorExpressionDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="IConstructorExpression"/> interface
    /// </summary>
    internal static class ConstructorExpressionDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IConstructorExpression"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IConstructorExpression DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the ConstructorExpressionDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "ConstructorExpression")
            {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.ConstructorExpression();
            ...
            if (jsonElement.TryGetProperty("@id"u8, out JsonElement idProperty))
            {
                ...
                {
                    throw new JsonException("The @id property is not present, the ConstructorExpression cannot be deserialized");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the ConstructorExpression: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the ConstructorExpression: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the ConstructorExpression: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the direction Json property was not found in the ConstructorExpression: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the ConstructorExpression: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isAbstract Json property was not found in the ConstructorExpression: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isComposite Json property was not found in the ConstructorExpression: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isConstant Json property was not found in the ConstructorExpression: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isDerived Json property was not found in the ConstructorExpression: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isEnd Json property was not found in the ConstructorExpression: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the ConstructorExpression: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isOrdered Json property was not found in the ConstructorExpression: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isPortion Json property was not found in the ConstructorExpression: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isSufficient Json property was not found in the ConstructorExpression: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isUnique Json property was not found in the ConstructorExpression: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isVariable Json property was not found in the ConstructorExpression: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the ConstructorExpression: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the ConstructorExpression: {dtoInstance.Id}");
            }
