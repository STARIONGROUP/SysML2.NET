...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class InterfaceUsageDeSerializer
    {
        ...
        internal static IInterfaceUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug("the association Json property was not found in the InterfaceUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the connectionDefinition Json property was not found in the InterfaceUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the definition Json property was not found in the InterfaceUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the endFeature Json property was not found in the InterfaceUsage: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("interfaceDefinition"u8, out var interfaceDefinitionProperty))
            {
                foreach (var arrayItem in interfaceDefinitionProperty.EnumerateArray())
                {
                    if (arrayItem.TryGetProperty("@id"u8, out var interfaceDefinitionExternalIdProperty))
                    {
                        var propertyValue = interfaceDefinitionExternalIdProperty.GetString();
            ...
            {
                logger.LogDebug("the isVariable Json property was not found in the InterfaceUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the relatedElement Json property was not found in the InterfaceUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the source Json property was not found in the InterfaceUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the target Json property was not found in the InterfaceUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the type Json property was not found in the InterfaceUsage: { Id }", dtoInstance.Id);
            }
