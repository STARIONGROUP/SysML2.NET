...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="ISuccessionFlowUsage"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static ISuccessionFlowUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, bool deserializeDerivedProperties, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the SuccessionFlowUsageDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "SuccessionFlowUsage")
            {
                throw new InvalidOperationException($"The SuccessionFlowUsageDeSerializer can only be used to deserialize objects of type ISuccessionFlowUsage, a {@type.GetString()} was provided");
            }
