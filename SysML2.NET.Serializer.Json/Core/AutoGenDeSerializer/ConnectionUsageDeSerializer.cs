// -------------------------------------------------------------------------------------------------
// <copyright file="ConnectionUsageDeSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class ConnectionUsageDeSerializer
    {
        ...
        internal static IConnectionUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug($"the isDirected Json property was not found in the ConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isReadOnly Json property was not found in the ConnectionUsage: {dtoInstance.Id}");
            }
