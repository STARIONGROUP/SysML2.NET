...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IExhibitStateUsage"/> from the provided <see cref="Utf8JsonReader"/>
        /// </summary>
        /// <param name="reader">
        /// The <see cref="Utf8JsonReader"/> positioned on the <see cref="JsonTokenType.StartObject"/> of the
        /// <see cref="IExhibitStateUsage"/> json object. On return the reader is positioned on the matching
        ...
        /// </remarks>
        internal static IExhibitStateUsage DeSerialize(ref Utf8JsonReader reader, SerializationModeKind serializationModeKind, bool deserializeDerivedProperties, ILoggerFactory loggerFactory = null)
        {
        ...
        /// <summary>
        /// Deserializes properties of a <see cref="SysML2.NET.Core.DTO.Systems.States.ExhibitStateUsage" />
        /// from a <see cref="Utf8JsonReader" />, including derived properties
        /// </summary>
        /// <param name="dtoInstance">
        /// The <see cref="SysML2.NET.Core.DTO.Systems.States.ExhibitStateUsage"/> instance holding deserialized values
        /// </param>
        /// <param name="reader">
        /// The <see cref="Utf8JsonReader"/> positioned on the <see cref="JsonTokenType.StartObject"/> of the
        /// <see cref="IExhibitStateUsage"/> json object
        /// </param>
        /// <param name="logger">
        /// The <see cref="ILogger"/> to produce logging statement
        /// </param>
        private static void DeserializeDtoIncludingDerivedProperties(SysML2.NET.Core.DTO.Systems.States.ExhibitStateUsage dtoInstance, ref Utf8JsonReader reader, ILogger logger)
        {
            ...
            while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
            {
                ...
                {
                    throw new JsonException("Expected a property name in the ExhibitStateUsage json object.");
                }
                ...
                if (reader.ValueTextEquals("doAction"u8))
                {
                    doActionSeen = true;
                    reader.Read();
                    ...
                    else if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var doActionValue))
                    {
                        dtoInstance.doAction = doActionValue;
                    }
                ...
                if (reader.ValueTextEquals("entryAction"u8))
                {
                    entryActionSeen = true;
                    reader.Read();
                    ...
                    else if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var entryActionValue))
                    {
                        dtoInstance.entryAction = entryActionValue;
                    }

                    continue;
                }

                if (reader.ValueTextEquals("exhibitedState"u8))
                {
                    exhibitedStateSeen = true;
                    reader.Read();
                    ...
                    else if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var exhibitedStateValue))
                    {
                        dtoInstance.exhibitedState = exhibitedStateValue;
                    }

                    continue;
                }

                if (reader.ValueTextEquals("exitAction"u8))
                {
                    exitActionSeen = true;
                    reader.Read();
                    ...
                    else if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var exitActionValue))
                    {
                        dtoInstance.exitAction = exitActionValue;
                    }
                ...
                if (reader.ValueTextEquals("isParallel"u8))
                {
                    isParallelSeen = true;
                    reader.Read();
                    ...
                    if (reader.TokenType != JsonTokenType.Null)
                    {
                        dtoInstance.IsParallel = reader.GetBoolean();
                    }
                ...
                if (reader.ValueTextEquals("stateDefinition"u8))
                {
                    stateDefinitionSeen = true;
                    reader.Read();
                    ...
                    while (reader.Read() && reader.TokenType != JsonTokenType.EndArray)
                    {
                        if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var stateDefinitionValue))
                        {
                            dtoInstance.stateDefinition.Add(stateDefinitionValue);
                        }
                    }
        ...
        /// The <see cref="ILogger"/> to produce logging statement
        /// </param>
        private static void DeserializeDtoExcludingDerivedProperties(SysML2.NET.Core.DTO.Systems.States.ExhibitStateUsage dtoInstance, ref Utf8JsonReader reader, ILogger logger)
        {
            var aliasIdsSeen = false;
            var declaredNameSeen = false;
            var declaredShortNameSeen = false;
