...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class FeatureInvertingDeSerializer
    {
        ...
        internal static IFeatureInverting DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            IFeatureInverting dtoInstance = new SysML2.NET.Core.DTO.Core.Features.FeatureInverting();
            ...
            {
                logger.LogDebug("the source Json property was not found in the FeatureInverting: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the target Json property was not found in the FeatureInverting: { Id }", dtoInstance.Id);
            }
