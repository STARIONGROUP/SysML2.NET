...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IAllocationDefinition"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IAllocationDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, bool deserializeDerivedProperties, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the AllocationDefinitionDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "AllocationDefinition")
            {
        ...
        private static void DeserializeDtoIncludingDerivedProperties(SysML2.NET.Core.DTO.Systems.Allocations.AllocationDefinition dtoInstance, JsonElement jsonElement, ILogger logger)
        {
            ...
            if (jsonElement.TryGetProperty("allocation"u8, out var allocationProperty))
            {
                foreach (var arrayItem in allocationProperty.EnumerateArray())
                {
                    if (arrayItem.TryGetProperty("@id"u8, out var allocationExternalIdProperty))
                    {
                        var propertyValue = allocationExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.allocation.Add(Guid.Parse(propertyValue));
                        }
                    }
                }
            }
