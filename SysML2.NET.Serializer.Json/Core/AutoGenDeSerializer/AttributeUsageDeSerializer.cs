...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IAttributeUsage"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IAttributeUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the AttributeUsageDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "AttributeUsage")
            {
                throw new InvalidOperationException($"The AttributeUsageDeSerializer can only be used to deserialize objects of type IAttributeUsage, a {@type.GetString()} was provided");
            }
            ...
            {
                logger.LogDebug("the definition Json property was not found in the AttributeUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isVariable Json property was not found in the AttributeUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the type Json property was not found in the AttributeUsage: { Id }", dtoInstance.Id);
            }
