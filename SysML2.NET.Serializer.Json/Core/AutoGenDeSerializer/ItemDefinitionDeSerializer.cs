...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IItemDefinition"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IItemDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the ItemDefinitionDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "ItemDefinition")
            {
                throw new InvalidOperationException($"The ItemDefinitionDeSerializer can only be used to deserialize objects of type IItemDefinition, a {@type.GetString()} was provided");
            }
