...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class ItemDefinitionDeSerializer
    {
        ...
        internal static IItemDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.ItemDefinition();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the ItemDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the ItemDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the ItemDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the ItemDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isAbstract Json property was not found in the ItemDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the ItemDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isIndividual Json property was not found in the ItemDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isSufficient Json property was not found in the ItemDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isVariation Json property was not found in the ItemDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the ItemDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the ItemDefinition: {dtoInstance.Id}");
            }
