...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IAssertConstraintUsage"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IAssertConstraintUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the AssertConstraintUsageDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "AssertConstraintUsage")
            {
                throw new InvalidOperationException($"The AssertConstraintUsageDeSerializer can only be used to deserialize objects of type IAssertConstraintUsage, a {@type.GetString()} was provided");
            }
            ...
            {
                logger.LogDebug("the behavior Json property was not found in the AssertConstraintUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the definition Json property was not found in the AssertConstraintUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the directedFeature Json property was not found in the AssertConstraintUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the function Json property was not found in the AssertConstraintUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isVariable Json property was not found in the AssertConstraintUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the predicate Json property was not found in the AssertConstraintUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the type Json property was not found in the AssertConstraintUsage: { Id }", dtoInstance.Id);
            }
