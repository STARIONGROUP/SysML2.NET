...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class AssertConstraintUsageDeSerializer
    {
        ...
        internal static IAssertConstraintUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.AssertConstraintUsage();
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the AssertConstraintUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the AssertConstraintUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isConstant Json property was not found in the AssertConstraintUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the AssertConstraintUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isVariable Json property was not found in the AssertConstraintUsage: {dtoInstance.Id}");
            }
