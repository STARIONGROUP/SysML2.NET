// -------------------------------------------------------------------------------------------------
// <copyright file="ActorMembershipDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class ActorMembershipDeSerializer
    {
        ...
        internal static IActorMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (@type.GetString() != "ActorMembership")
            {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.Systems.Requirements.ActorMembership();
            ...
            {
                logger.LogDebug("the documentation Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isLibraryElement Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("memberElement"u8, out var memberElementProperty))
            {
                if (memberElementProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the ActorMembership.MemberElement property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the memberElement Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the memberElementId Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the memberName Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("membershipOwningNamespace"u8, out var membershipOwningNamespaceProperty))
            {
                if (membershipOwningNamespaceProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the ActorMembership.membershipOwningNamespace property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the membershipOwningNamespace Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the memberShortName Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the name Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }

            if (jsonElement.TryGetProperty("ownedActorParameter"u8, out var ownedActorParameterProperty))
            {
                if (ownedActorParameterProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.ownedActorParameter = Guid.Empty;
                    logger.LogDebug($"the ActorMembership.ownedActorParameter property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
                    if (ownedActorParameterProperty.TryGetProperty("@id"u8, out var ownedActorParameterExternalIdProperty))
                    {
                        var propertyValue = ownedActorParameterExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.ownedActorParameter = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the ownedActorParameter Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedAnnotation Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedElement Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("ownedMemberElement"u8, out var ownedMemberElementProperty))
            {
                if (ownedMemberElementProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the ActorMembership.ownedMemberElement property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the ownedMemberElement Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedMemberElementId Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("ownedMemberFeature"u8, out var ownedMemberFeatureProperty))
            {
                if (ownedMemberFeatureProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the ActorMembership.ownedMemberFeature property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the ownedMemberFeature Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedMemberName Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("ownedMemberParameter"u8, out var ownedMemberParameterProperty))
            {
                if (ownedMemberParameterProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the ActorMembership.ownedMemberParameter property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the ownedMemberParameter Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedMemberShortName Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owner Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningMembership Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningNamespace Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("owningType"u8, out var owningTypeProperty))
            {
                if (owningTypeProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the ActorMembership.owningType property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the owningType Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the qualifiedName Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the relatedElement Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the shortName Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the source Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the target Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the textualRepresentation Json property was not found in the ActorMembership: { Id }", dtoInstance.Id);
            }
