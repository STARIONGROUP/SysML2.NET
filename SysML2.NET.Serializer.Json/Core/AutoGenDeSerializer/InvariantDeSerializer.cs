...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class InvariantDeSerializer
    {
        ...
        internal static IInvariant DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug("the behavior Json property was not found in the Invariant: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the directedFeature Json property was not found in the Invariant: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the function Json property was not found in the Invariant: { Id }", dtoInstance.Id);
            }
