...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class InvariantDeSerializer
    {
        ...
        internal static IInvariant DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.Invariant();
            ...
            {
                logger.LogDebug($"the isConstant Json property was not found in the Invariant: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isVariable Json property was not found in the Invariant: {dtoInstance.Id}");
            }
