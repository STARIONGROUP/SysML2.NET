...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class CollectExpressionDeSerializer
    {
        ...
        internal static ICollectExpression DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug("the behavior Json property was not found in the CollectExpression: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the directedFeature Json property was not found in the CollectExpression: { Id }", dtoInstance.Id);
            }
