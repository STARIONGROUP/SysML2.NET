...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class BindingConnectorDeSerializer
    {
        ...
        internal static IBindingConnector DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug("the endFeature Json property was not found in the BindingConnector: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the relatedElement Json property was not found in the BindingConnector: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the source Json property was not found in the BindingConnector: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the target Json property was not found in the BindingConnector: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the type Json property was not found in the BindingConnector: { Id }", dtoInstance.Id);
            }
