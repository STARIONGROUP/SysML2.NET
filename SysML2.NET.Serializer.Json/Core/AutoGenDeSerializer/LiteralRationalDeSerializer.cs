...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class LiteralRationalDeSerializer
    {
        ...
        internal static ILiteralRational DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug("the behavior Json property was not found in the LiteralRational: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the directedFeature Json property was not found in the LiteralRational: { Id }", dtoInstance.Id);
            }
