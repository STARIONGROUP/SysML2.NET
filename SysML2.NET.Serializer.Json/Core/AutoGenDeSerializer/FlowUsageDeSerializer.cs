// -------------------------------------------------------------------------------------------------
// <copyright file="FlowUsageDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="FlowUsageDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="IFlowUsage"/> interface
    /// </summary>
    internal static class FlowUsageDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IFlowUsage"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IFlowUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the FlowUsageDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "FlowUsage")
            {
                throw new InvalidOperationException($"The FlowUsageDeSerializer can only be used to deserialize objects of type IFlowUsage, a {@type.GetString()} was provided");
            }

            var dtoInstance = new SysML2.NET.Core.DTO.Systems.Flows.FlowUsage();
            ...
            if (jsonElement.TryGetProperty("@id"u8, out var idProperty))
            {
                ...
                {
                    throw new JsonException("The @id property is not present, the FlowUsage cannot be deserialized");
                }
                else
                {
            ...
            {
                logger.LogDebug("the actionDefinition Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the association Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the behavior Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the chainingFeature Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }

            if (jsonElement.TryGetProperty("connectorEnd"u8, out var connectorEndProperty))
            {
                foreach (var arrayItem in connectorEndProperty.EnumerateArray())
                {
                    if (arrayItem.TryGetProperty("@id"u8, out var connectorEndExternalIdProperty))
                    {
                        var propertyValue = connectorEndExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.connectorEnd.Add(Guid.Parse(propertyValue));
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the connectorEnd Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the crossFeature Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("defaultFeaturingType"u8, out var defaultFeaturingTypeProperty))
            {
                if (defaultFeaturingTypeProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.defaultFeaturingType = null;
                }
                else
                {
                    if (defaultFeaturingTypeProperty.TryGetProperty("@id"u8, out var defaultFeaturingTypeExternalIdProperty))
                    {
                        var propertyValue = defaultFeaturingTypeExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.defaultFeaturingType = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the defaultFeaturingType Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the definition Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the differencingType Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the directedFeature Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the directedUsage Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the documentation Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the endFeature Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the endOwningType Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the feature Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the featureMembership Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("featureTarget"u8, out var featureTargetProperty))
            {
                if (featureTargetProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the FlowUsage.featureTarget property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the featureTarget Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the featuringType Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }

            if (jsonElement.TryGetProperty("flowDefinition"u8, out var flowDefinitionProperty))
            {
                foreach (var arrayItem in flowDefinitionProperty.EnumerateArray())
                {
                    if (arrayItem.TryGetProperty("@id"u8, out var flowDefinitionExternalIdProperty))
                    {
                        var propertyValue = flowDefinitionExternalIdProperty.GetString();
            ...
            {
                logger.LogDebug("the flowDefinition Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }

            if (jsonElement.TryGetProperty("flowEnd"u8, out var flowEndProperty))
            {
                foreach (var arrayItem in flowEndProperty.EnumerateArray())
                {
                    if (arrayItem.TryGetProperty("@id"u8, out var flowEndExternalIdProperty))
                    {
                        var propertyValue = flowEndExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.flowEnd.Add(Guid.Parse(propertyValue));
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the flowEnd Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the importedMembership Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the individualDefinition Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the inheritedFeature Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the inheritedMembership Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the input Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the interaction Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the intersectingType Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isConjugated Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isLibraryElement Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isReference Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isVariable Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the mayTimeVary Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the member Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the membership Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the multiplicity Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the name Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedAction Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedAllocation Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedAnalysisCase Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedAttribute Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedCalculation Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedCase Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedConcern Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedConnection Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedConstraint Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedEnumeration Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedFlow Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedInterface Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedItem Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedMetadata Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedOccurrence Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedPart Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedPort Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedReference Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedRendering Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedRequirement Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedState Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedTransition Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedUsage Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedUseCase Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedVerificationCase Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedView Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedViewpoint Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the occurrenceDefinition Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the output Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedAnnotation Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedConjugator Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedCrossSubsetting Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedDifferencing Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedDisjoining Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedElement Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedEndFeature Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedFeature Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedFeatureChaining Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedFeatureInverting Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedFeatureMembership Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedImport Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedIntersecting Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedMember Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedMembership Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedRedefinition Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedReferenceSubsetting Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedSpecialization Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedSubsetting Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedTypeFeaturing Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedTyping Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedUnioning Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owner Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningDefinition Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningFeatureMembership Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningMembership Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningNamespace Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningType Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningUsage Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the parameter Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }

            if (jsonElement.TryGetProperty("payloadFeature"u8, out var payloadFeatureProperty))
            {
                if (payloadFeatureProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.payloadFeature = null;
                }
                else
                {
                    if (payloadFeatureProperty.TryGetProperty("@id"u8, out var payloadFeatureExternalIdProperty))
                    {
                        var propertyValue = payloadFeatureExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.payloadFeature = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the payloadFeature Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }

            if (jsonElement.TryGetProperty("payloadType"u8, out var payloadTypeProperty))
            {
                foreach (var arrayItem in payloadTypeProperty.EnumerateArray())
                {
                    if (arrayItem.TryGetProperty("@id"u8, out var payloadTypeExternalIdProperty))
                    {
                        var propertyValue = payloadTypeExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.payloadType.Add(Guid.Parse(propertyValue));
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the payloadType Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the qualifiedName Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the relatedElement Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("relatedFeature"u8, out var relatedFeatureProperty))
            {
                ...
                {
                    if (arrayItem.TryGetProperty("@id"u8, out var relatedFeatureExternalIdProperty))
                    {
                        var propertyValue = relatedFeatureExternalIdProperty.GetString();
            ...
            {
                logger.LogDebug("the relatedFeature Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the shortName Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the source Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("sourceFeature"u8, out var sourceFeatureProperty))
            {
                ...
                {
                    dtoInstance.sourceFeature = null;
                }
                else
                {
                    if (sourceFeatureProperty.TryGetProperty("@id"u8, out var sourceFeatureExternalIdProperty))
                    {
                        var propertyValue = sourceFeatureExternalIdProperty.GetString();
            ...
            {
                logger.LogDebug("the sourceFeature Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }

            if (jsonElement.TryGetProperty("sourceOutputFeature"u8, out var sourceOutputFeatureProperty))
            {
                if (sourceOutputFeatureProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.sourceOutputFeature = null;
                }
                else
                {
                    if (sourceOutputFeatureProperty.TryGetProperty("@id"u8, out var sourceOutputFeatureExternalIdProperty))
                    {
                        var propertyValue = sourceOutputFeatureExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.sourceOutputFeature = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the sourceOutputFeature Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the target Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }

            if (jsonElement.TryGetProperty("targetFeature"u8, out var targetFeatureProperty))
            {
                foreach (var arrayItem in targetFeatureProperty.EnumerateArray())
                {
                    if (arrayItem.TryGetProperty("@id"u8, out var targetFeatureExternalIdProperty))
                    {
                        var propertyValue = targetFeatureExternalIdProperty.GetString();
            ...
            {
                logger.LogDebug("the targetFeature Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }

            if (jsonElement.TryGetProperty("targetInputFeature"u8, out var targetInputFeatureProperty))
            {
                if (targetInputFeatureProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.targetInputFeature = null;
                }
                else
                {
                    if (targetInputFeatureProperty.TryGetProperty("@id"u8, out var targetInputFeatureExternalIdProperty))
                    {
                        var propertyValue = targetInputFeatureExternalIdProperty.GetString();
            ...
            {
                logger.LogDebug("the targetInputFeature Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the textualRepresentation Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the type Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the unioningType Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the usage Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the variant Json property was not found in the FlowUsage: { Id }", dtoInstance.Id);
            }
