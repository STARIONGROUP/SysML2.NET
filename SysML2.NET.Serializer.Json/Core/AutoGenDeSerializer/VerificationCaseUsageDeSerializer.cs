...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class VerificationCaseUsageDeSerializer
    {
        ...
        internal static IVerificationCaseUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug("the actionDefinition Json property was not found in the VerificationCaseUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the behavior Json property was not found in the VerificationCaseUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the calculationDefinition Json property was not found in the VerificationCaseUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the definition Json property was not found in the VerificationCaseUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the directedFeature Json property was not found in the VerificationCaseUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the function Json property was not found in the VerificationCaseUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isVariable Json property was not found in the VerificationCaseUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the occurrenceDefinition Json property was not found in the VerificationCaseUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the type Json property was not found in the VerificationCaseUsage: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("verificationCaseDefinition"u8, out var verificationCaseDefinitionProperty))
            {
                if (verificationCaseDefinitionProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.verificationCaseDefinition = null;
                }
                else
                {
                    if (verificationCaseDefinitionProperty.TryGetProperty("@id"u8, out var verificationCaseDefinitionExternalIdProperty))
                    {
                        var propertyValue = verificationCaseDefinitionExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.verificationCaseDefinition = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
            ...
            {
                foreach (var arrayItem in verifiedRequirementProperty.EnumerateArray())
                {
                    if (arrayItem.TryGetProperty("@id"u8, out var verifiedRequirementExternalIdProperty))
                    {
                        var propertyValue = verifiedRequirementExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.verifiedRequirement.Add(Guid.Parse(propertyValue));
                        }
                    }
                }
            }
