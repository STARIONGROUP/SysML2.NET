...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class UnioningDeSerializer
    {
        ...
        internal static IUnioning DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug("the source Json property was not found in the Unioning: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("typeUnioned"u8, out var typeUnionedProperty))
            {
                if (typeUnionedProperty.ValueKind == JsonValueKind.Null)
                {
                ...
                {
                    if (typeUnionedProperty.TryGetProperty("@id"u8, out var typeUnionedExternalIdProperty))
                    {
                        var propertyValue = typeUnionedExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.typeUnioned = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
