...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class AnalysisCaseUsageDeSerializer
    {
        ...
        internal static IAnalysisCaseUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.AnalysisCaseUsage();
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the AnalysisCaseUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the AnalysisCaseUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isConstant Json property was not found in the AnalysisCaseUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the AnalysisCaseUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isVariable Json property was not found in the AnalysisCaseUsage: {dtoInstance.Id}");
            }
