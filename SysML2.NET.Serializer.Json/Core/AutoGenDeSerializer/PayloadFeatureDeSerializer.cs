...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IPayloadFeature"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IPayloadFeature DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, bool deserializeDerivedProperties, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the PayloadFeatureDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "PayloadFeature")
            {
                throw new InvalidOperationException($"The PayloadFeatureDeSerializer can only be used to deserialize objects of type IPayloadFeature, a {@type.GetString()} was provided");
            }
