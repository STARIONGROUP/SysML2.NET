        ...
        internal static IEndFeatureMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (jsonElement.TryGetProperty("memberElement"u8, out var memberElementProperty))
            {
                if (memberElementProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the EndFeatureMembership.MemberElement property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the memberElement Json property was not found in the EndFeatureMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the memberElementId Json property was not found in the EndFeatureMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the memberName Json property was not found in the EndFeatureMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("membershipOwningNamespace"u8, out var membershipOwningNamespaceProperty))
            {
                if (membershipOwningNamespaceProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the EndFeatureMembership.membershipOwningNamespace property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the membershipOwningNamespace Json property was not found in the EndFeatureMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the memberShortName Json property was not found in the EndFeatureMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("ownedMemberElement"u8, out var ownedMemberElementProperty))
            {
                if (ownedMemberElementProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the EndFeatureMembership.ownedMemberElement property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the ownedMemberElement Json property was not found in the EndFeatureMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the source Json property was not found in the EndFeatureMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the target Json property was not found in the EndFeatureMembership: { Id }", dtoInstance.Id);
            }
