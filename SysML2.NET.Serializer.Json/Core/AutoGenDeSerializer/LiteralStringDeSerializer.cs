...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class LiteralStringDeSerializer
    {
        ...
        internal static ILiteralString DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.LiteralString();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the LiteralString: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the LiteralString: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the LiteralString: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the direction Json property was not found in the LiteralString: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the LiteralString: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isAbstract Json property was not found in the LiteralString: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isComposite Json property was not found in the LiteralString: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isConstant Json property was not found in the LiteralString: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isDerived Json property was not found in the LiteralString: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isEnd Json property was not found in the LiteralString: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the LiteralString: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isOrdered Json property was not found in the LiteralString: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isPortion Json property was not found in the LiteralString: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isSufficient Json property was not found in the LiteralString: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isUnique Json property was not found in the LiteralString: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isVariable Json property was not found in the LiteralString: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the LiteralString: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the LiteralString: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the value Json property was not found in the LiteralString: {dtoInstance.Id}");
            }
