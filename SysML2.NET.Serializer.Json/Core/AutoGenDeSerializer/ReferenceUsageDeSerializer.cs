...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IReferenceUsage"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IReferenceUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the ReferenceUsageDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "ReferenceUsage")
            {
                throw new InvalidOperationException($"The ReferenceUsageDeSerializer can only be used to deserialize objects of type IReferenceUsage, a {@type.GetString()} was provided");
            }
            ...
            {
                logger.LogDebug("the isVariable Json property was not found in the ReferenceUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the type Json property was not found in the ReferenceUsage: { Id }", dtoInstance.Id);
            }
