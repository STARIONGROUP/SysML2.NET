...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IPartUsage"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IPartUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the PartUsageDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "PartUsage")
            {
                throw new InvalidOperationException($"The PartUsageDeSerializer can only be used to deserialize objects of type IPartUsage, a {@type.GetString()} was provided");
            }
            ...
            {
                logger.LogDebug("the definition Json property was not found in the PartUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isVariable Json property was not found in the PartUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the type Json property was not found in the PartUsage: { Id }", dtoInstance.Id);
            }
