...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class ConjugationDeSerializer
    {
        ...
        internal static IConjugation DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.Conjugation();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the Conjugation: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the conjugatedType Json property was not found in the Conjugation: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the Conjugation: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the Conjugation: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the Conjugation: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the Conjugation: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the Conjugation: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the originalType Json property was not found in the Conjugation: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the Conjugation: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the Conjugation: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the Conjugation: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the Conjugation: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the source Json property was not found in the Conjugation: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the target Json property was not found in the Conjugation: {dtoInstance.Id}");
            }
