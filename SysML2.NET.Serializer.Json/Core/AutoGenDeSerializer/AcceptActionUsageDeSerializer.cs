...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class AcceptActionUsageDeSerializer
    {
        ...
        internal static IAcceptActionUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug("the behavior Json property was not found in the AcceptActionUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the definition Json property was not found in the AcceptActionUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the directedFeature Json property was not found in the AcceptActionUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the occurrenceDefinition Json property was not found in the AcceptActionUsage: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("payloadParameter"u8, out var payloadParameterProperty))
            {
                if (payloadParameterProperty.ValueKind == JsonValueKind.Null)
                {
                ...
                {
                    if (payloadParameterProperty.TryGetProperty("@id"u8, out var payloadParameterExternalIdProperty))
                    {
                        var propertyValue = payloadParameterExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.payloadParameter = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the type Json property was not found in the AcceptActionUsage: { Id }", dtoInstance.Id);
            }
