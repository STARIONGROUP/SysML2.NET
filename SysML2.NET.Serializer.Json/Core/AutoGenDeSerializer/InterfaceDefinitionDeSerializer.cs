...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class InterfaceDefinitionDeSerializer
    {
        ...
        internal static IInterfaceDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug("the associationEnd Json property was not found in the InterfaceDefinition: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the connectionEnd Json property was not found in the InterfaceDefinition: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the endFeature Json property was not found in the InterfaceDefinition: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the relatedElement Json property was not found in the InterfaceDefinition: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the source Json property was not found in the InterfaceDefinition: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the target Json property was not found in the InterfaceDefinition: { Id }", dtoInstance.Id);
            }
