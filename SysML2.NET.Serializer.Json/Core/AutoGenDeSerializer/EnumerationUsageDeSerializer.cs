...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IEnumerationUsage"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IEnumerationUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, bool deserializeDerivedProperties, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the EnumerationUsageDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "EnumerationUsage")
            {
                throw new InvalidOperationException($"The EnumerationUsageDeSerializer can only be used to deserialize objects of type IEnumerationUsage, a {@type.GetString()} was provided");
            }
        ...
        private static void DeserializeDtoIncludingDerivedProperties(SysML2.NET.Core.DTO.Systems.Enumerations.EnumerationUsage dtoInstance, JsonElement jsonElement, ILogger logger)
        {
            ...
            if (jsonElement.TryGetProperty("enumerationDefinition"u8, out var enumerationDefinitionProperty))
            {
                if (enumerationDefinitionProperty.ValueKind == JsonValueKind.Null)
                {
                ...
                {
                    if (enumerationDefinitionProperty.TryGetProperty("@id"u8, out var enumerationDefinitionExternalIdProperty))
                    {
                        var propertyValue = enumerationDefinitionExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.enumerationDefinition = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
