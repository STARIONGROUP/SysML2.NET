...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="ITransitionUsage"/> from the provided <see cref="Utf8JsonReader"/>
        /// </summary>
        /// <param name="reader">
        /// The <see cref="Utf8JsonReader"/> positioned on the <see cref="JsonTokenType.StartObject"/> of the
        /// <see cref="ITransitionUsage"/> json object. On return the reader is positioned on the matching
        ...
        /// </remarks>
        internal static ITransitionUsage DeSerialize(ref Utf8JsonReader reader, SerializationModeKind serializationModeKind, bool deserializeDerivedProperties, ILoggerFactory loggerFactory = null)
        {
        ...
        /// <summary>
        /// Deserializes properties of a <see cref="SysML2.NET.Core.DTO.Systems.States.TransitionUsage" />
        /// from a <see cref="Utf8JsonReader" />, including derived properties
        /// </summary>
        /// <param name="dtoInstance">
        /// The <see cref="SysML2.NET.Core.DTO.Systems.States.TransitionUsage"/> instance holding deserialized values
        /// </param>
        /// <param name="reader">
        /// The <see cref="Utf8JsonReader"/> positioned on the <see cref="JsonTokenType.StartObject"/> of the
        /// <see cref="ITransitionUsage"/> json object
        /// </param>
        /// <param name="logger">
        /// The <see cref="ILogger"/> to produce logging statement
        /// </param>
        private static void DeserializeDtoIncludingDerivedProperties(SysML2.NET.Core.DTO.Systems.States.TransitionUsage dtoInstance, ref Utf8JsonReader reader, ILogger logger)
        {
            ...
            var successionSeen = false;
            var targetSeen = false;
            var textualRepresentationSeen = false;
            var triggerActionSeen = false;
            ...
            while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
            {
                ...
                {
                    throw new JsonException("Expected a property name in the TransitionUsage json object.");
                }
                ...
                if (reader.ValueTextEquals("effectAction"u8))
                {
                    effectActionSeen = true;
                    reader.Read();
                    ...
                    while (reader.Read() && reader.TokenType != JsonTokenType.EndArray)
                    {
                        if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var effectActionValue))
                        {
                            dtoInstance.effectAction.Add(effectActionValue);
                        }
                    }
                ...
                if (reader.ValueTextEquals("guardExpression"u8))
                {
                    guardExpressionSeen = true;
                    reader.Read();
                    ...
                    while (reader.Read() && reader.TokenType != JsonTokenType.EndArray)
                    {
                        if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var guardExpressionValue))
                        {
                            dtoInstance.guardExpression.Add(guardExpressionValue);
                        }
                    }
                ...
                if (reader.ValueTextEquals("source"u8))
                {
                    ...
                    else if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var sourceValue))
                    {
                        dtoInstance.source = sourceValue;
                    }

                    continue;
                }

                if (reader.ValueTextEquals("succession"u8))
                {
                    successionSeen = true;
                    reader.Read();
                    ...
                    else if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var successionValue))
                    {
                        dtoInstance.succession = successionValue;
                    }
                ...
                if (reader.ValueTextEquals("target"u8))
                {
                    ...
                    else if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var targetValue))
                    {
                        dtoInstance.target = targetValue;
                    }
                ...
                if (reader.ValueTextEquals("triggerAction"u8))
                {
                    triggerActionSeen = true;
                    reader.Read();
                    ...
                    while (reader.Read() && reader.TokenType != JsonTokenType.EndArray)
                    {
                        if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var triggerActionValue))
                        {
                            dtoInstance.triggerAction.Add(triggerActionValue);
                        }
                    }
        ...
        /// The <see cref="ILogger"/> to produce logging statement
        /// </param>
        private static void DeserializeDtoExcludingDerivedProperties(SysML2.NET.Core.DTO.Systems.States.TransitionUsage dtoInstance, ref Utf8JsonReader reader, ILogger logger)
        {
            var aliasIdsSeen = false;
            var declaredNameSeen = false;
            var declaredShortNameSeen = false;
