...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class RequirementDefinitionDeSerializer
    {
        ...
        internal static IRequirementDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.RequirementDefinition();
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the RequirementDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the RequirementDefinition: {dtoInstance.Id}");
            }
