...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IRequirementDefinition"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IRequirementDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the RequirementDefinitionDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "RequirementDefinition")
            {
            ...
            {
                logger.LogDebug("the directedFeature Json property was not found in the RequirementDefinition: { Id }", dtoInstance.Id);
            }
