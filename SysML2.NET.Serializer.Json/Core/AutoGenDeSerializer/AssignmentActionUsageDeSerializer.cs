...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IAssignmentActionUsage"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IAssignmentActionUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the AssignmentActionUsageDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "AssignmentActionUsage")
            {
            ...
            {
                logger.LogDebug("the behavior Json property was not found in the AssignmentActionUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the definition Json property was not found in the AssignmentActionUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the directedFeature Json property was not found in the AssignmentActionUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the occurrenceDefinition Json property was not found in the AssignmentActionUsage: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("referent"u8, out var referentProperty))
            {
                if (referentProperty.ValueKind == JsonValueKind.Null)
                {
                ...
                {
                    if (referentProperty.TryGetProperty("@id"u8, out var referentExternalIdProperty))
                    {
                        var propertyValue = referentExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.referent = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
            ...
            if (jsonElement.TryGetProperty("targetArgument"u8, out var targetArgumentProperty))
            {
                if (targetArgumentProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.targetArgument = null;
                }
                else
                {
                    if (targetArgumentProperty.TryGetProperty("@id"u8, out var targetArgumentExternalIdProperty))
                    {
                        var propertyValue = targetArgumentExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.targetArgument = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the type Json property was not found in the AssignmentActionUsage: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("valueExpression"u8, out var valueExpressionProperty))
            {
                if (valueExpressionProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.valueExpression = null;
                }
                else
                {
                    if (valueExpressionProperty.TryGetProperty("@id"u8, out var valueExpressionExternalIdProperty))
                    {
                        var propertyValue = valueExpressionExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.valueExpression = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
