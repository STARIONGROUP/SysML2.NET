...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IActionDefinition"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IActionDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the ActionDefinitionDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "ActionDefinition")
            {
            ...
            {
                logger.LogDebug("the directedFeature Json property was not found in the ActionDefinition: { Id }", dtoInstance.Id);
            }
