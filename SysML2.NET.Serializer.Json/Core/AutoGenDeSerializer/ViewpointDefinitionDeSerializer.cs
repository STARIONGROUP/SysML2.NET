...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IViewpointDefinition"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IViewpointDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the ViewpointDefinitionDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "ViewpointDefinition")
            {
                throw new InvalidOperationException($"The ViewpointDefinitionDeSerializer can only be used to deserialize objects of type IViewpointDefinition, a {@type.GetString()} was provided");
            }
            ...
            {
                logger.LogDebug("the declaredShortName Json property was not found in the ViewpointDefinition: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the directedFeature Json property was not found in the ViewpointDefinition: { Id }", dtoInstance.Id);
            }
