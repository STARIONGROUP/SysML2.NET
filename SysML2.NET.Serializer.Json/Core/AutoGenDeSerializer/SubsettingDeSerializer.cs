...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class SubsettingDeSerializer
    {
        ...
        internal static ISubsetting DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.Subsetting();
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the Subsetting: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the Subsetting: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the Subsetting: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the Subsetting: {dtoInstance.Id}");
            }
