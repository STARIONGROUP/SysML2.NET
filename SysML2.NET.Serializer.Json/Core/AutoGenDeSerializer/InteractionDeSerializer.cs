// -------------------------------------------------------------------------------------------------
// <copyright file="InteractionDeSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class InteractionDeSerializer
    {
        ...
        internal static IInteraction DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.Interaction();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the Interaction: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the Interaction: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the Interaction: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the Interaction: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isAbstract Json property was not found in the Interaction: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the Interaction: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the Interaction: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isSufficient Json property was not found in the Interaction: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the Interaction: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the Interaction: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the Interaction: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the Interaction: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the source Json property was not found in the Interaction: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the target Json property was not found in the Interaction: {dtoInstance.Id}");
            }
