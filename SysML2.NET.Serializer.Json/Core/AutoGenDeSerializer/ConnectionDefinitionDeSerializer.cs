...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IConnectionDefinition"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IConnectionDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the ConnectionDefinitionDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "ConnectionDefinition")
            {
                throw new InvalidOperationException($"The ConnectionDefinitionDeSerializer can only be used to deserialize objects of type IConnectionDefinition, a {@type.GetString()} was provided");
            }
            ...
            {
                logger.LogDebug("the associationEnd Json property was not found in the ConnectionDefinition: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("connectionEnd"u8, out var connectionEndProperty))
            {
                ...
                {
                    if (arrayItem.TryGetProperty("@id"u8, out var connectionEndExternalIdProperty))
                    {
                        var propertyValue = connectionEndExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.connectionEnd.Add(Guid.Parse(propertyValue));
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the endFeature Json property was not found in the ConnectionDefinition: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the relatedElement Json property was not found in the ConnectionDefinition: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the source Json property was not found in the ConnectionDefinition: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the target Json property was not found in the ConnectionDefinition: { Id }", dtoInstance.Id);
            }
