...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IOccurrenceUsage"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IOccurrenceUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the OccurrenceUsageDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "OccurrenceUsage")
            {
                throw new InvalidOperationException($"The OccurrenceUsageDeSerializer can only be used to deserialize objects of type IOccurrenceUsage, a {@type.GetString()} was provided");
            }
            ...
            {
                logger.LogDebug("the definition Json property was not found in the OccurrenceUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isVariable Json property was not found in the OccurrenceUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the type Json property was not found in the OccurrenceUsage: { Id }", dtoInstance.Id);
            }
