...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class DisjoiningDeSerializer
    {
        ...
        internal static IDisjoining DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.Disjoining();
            ...
            if (jsonElement.TryGetProperty("disjoiningType"u8, out JsonElement disjoiningTypeProperty))
            {
                ...
                {
                    if (disjoiningTypeProperty.TryGetProperty("@id"u8, out JsonElement disjoiningTypeIdProperty))
                    {
            ...
            if (jsonElement.TryGetProperty("typeDisjoined"u8, out JsonElement typeDisjoinedProperty))
            {
                ...
                {
                    if (typeDisjoinedProperty.TryGetProperty("@id"u8, out JsonElement typeDisjoinedIdProperty))
                    {
