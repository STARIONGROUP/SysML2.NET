...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class VariantMembershipDeSerializer
    {
        ...
        internal static IVariantMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.VariantMembership();
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the VariantMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the VariantMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the VariantMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the VariantMembership: {dtoInstance.Id}");
            }
