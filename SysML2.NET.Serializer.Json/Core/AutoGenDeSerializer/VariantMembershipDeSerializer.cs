...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class VariantMembershipDeSerializer
    {
        ...
        internal static IVariantMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug("the memberElement Json property was not found in the VariantMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the memberElementId Json property was not found in the VariantMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the memberName Json property was not found in the VariantMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the memberShortName Json property was not found in the VariantMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("ownedMemberElement"u8, out var ownedMemberElementProperty))
            {
                if (ownedMemberElementProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the VariantMembership.ownedMemberElement property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the ownedMemberElement Json property was not found in the VariantMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("ownedVariantUsage"u8, out var ownedVariantUsageProperty))
            {
                if (ownedVariantUsageProperty.ValueKind == JsonValueKind.Null)
                {
                ...
                {
                    if (ownedVariantUsageProperty.TryGetProperty("@id"u8, out var ownedVariantUsageExternalIdProperty))
                    {
                        var propertyValue = ownedVariantUsageExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.ownedVariantUsage = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the source Json property was not found in the VariantMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the target Json property was not found in the VariantMembership: { Id }", dtoInstance.Id);
            }
