// -------------------------------------------------------------------------------------------------
// <copyright file="StateSubactionMembershipDeSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class StateSubactionMembershipDeSerializer
    {
        ...
        internal static IStateSubactionMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.StateSubactionMembership();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the StateSubactionMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the StateSubactionMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the StateSubactionMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the StateSubactionMembership: {dtoInstance.Id}");
            }
            ...
            if (jsonElement.TryGetProperty("feature"u8, out JsonElement featureProperty))
            {
                if (featureProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the StateSubactionMembership.Feature property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the feature Json property was not found in the StateSubactionMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the StateSubactionMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the StateSubactionMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the kind Json property was not found in the StateSubactionMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the memberElement Json property was not found in the StateSubactionMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the memberName Json property was not found in the StateSubactionMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the memberShortName Json property was not found in the StateSubactionMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the StateSubactionMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the StateSubactionMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the StateSubactionMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the StateSubactionMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the source Json property was not found in the StateSubactionMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the target Json property was not found in the StateSubactionMembership: {dtoInstance.Id}");
            }
            ...
            if (jsonElement.TryGetProperty("type"u8, out JsonElement typeProperty))
            {
                if (typeProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the StateSubactionMembership.Type property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the type Json property was not found in the StateSubactionMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the visibility Json property was not found in the StateSubactionMembership: {dtoInstance.Id}");
            }
