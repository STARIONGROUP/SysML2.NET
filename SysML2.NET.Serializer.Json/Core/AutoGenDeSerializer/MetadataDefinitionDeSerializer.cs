...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class MetadataDefinitionDeSerializer
    {
        ...
        internal static IMetadataDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.MetadataDefinition();
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the MetadataDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the MetadataDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the MetadataDefinition: {dtoInstance.Id}");
            }
