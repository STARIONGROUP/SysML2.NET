...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IConcernUsage"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IConcernUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the ConcernUsageDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "ConcernUsage")
            {
                throw new InvalidOperationException($"The ConcernUsageDeSerializer can only be used to deserialize objects of type IConcernUsage, a {@type.GetString()} was provided");
            }
            ...
            {
                logger.LogDebug("the behavior Json property was not found in the ConcernUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                if (concernDefinitionProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.concernDefinition = null;
                }
                else
                {
                    if (concernDefinitionProperty.TryGetProperty("@id"u8, out var concernDefinitionExternalIdProperty))
                    {
                        var propertyValue = concernDefinitionExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.concernDefinition = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the constraintDefinition Json property was not found in the ConcernUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the declaredShortName Json property was not found in the ConcernUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the definition Json property was not found in the ConcernUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the directedFeature Json property was not found in the ConcernUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the function Json property was not found in the ConcernUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isVariable Json property was not found in the ConcernUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the predicate Json property was not found in the ConcernUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the requirementDefinition Json property was not found in the ConcernUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the type Json property was not found in the ConcernUsage: { Id }", dtoInstance.Id);
            }
