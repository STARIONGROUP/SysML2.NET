...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class DataTypeDeSerializer
    {
        ...
        internal static IDataType DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.DataType();
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the DataType: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the DataType: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the DataType: {dtoInstance.Id}");
            }
