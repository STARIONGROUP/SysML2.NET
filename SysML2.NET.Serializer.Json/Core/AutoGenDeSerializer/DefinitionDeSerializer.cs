...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IDefinition"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, bool deserializeDerivedProperties, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the DefinitionDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "Definition")
            {
                throw new InvalidOperationException($"The DefinitionDeSerializer can only be used to deserialize objects of type IDefinition, a {@type.GetString()} was provided");
            }
