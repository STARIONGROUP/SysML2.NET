...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class MembershipExposeDeSerializer
    {
        ...
        internal static IMembershipExpose DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.MembershipExpose();
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the MembershipExpose: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the MembershipExpose: {dtoInstance.Id}");
            }
