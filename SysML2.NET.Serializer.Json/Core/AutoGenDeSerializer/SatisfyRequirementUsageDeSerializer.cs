...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="ISatisfyRequirementUsage"/> from the provided <see cref="Utf8JsonReader"/>
        /// </summary>
        /// <param name="reader">
        /// The <see cref="Utf8JsonReader"/> positioned on the <see cref="JsonTokenType.StartObject"/> of the
        /// <see cref="ISatisfyRequirementUsage"/> json object. On return the reader is positioned on the matching
        ...
        /// </remarks>
        internal static ISatisfyRequirementUsage DeSerialize(ref Utf8JsonReader reader, SerializationModeKind serializationModeKind, bool deserializeDerivedProperties, ILoggerFactory loggerFactory = null)
        {
        ...
        /// <summary>
        /// Deserializes properties of a <see cref="SysML2.NET.Core.DTO.Systems.Requirements.SatisfyRequirementUsage" />
        /// from a <see cref="Utf8JsonReader" />, including derived properties
        /// </summary>
        /// <param name="dtoInstance">
        /// The <see cref="SysML2.NET.Core.DTO.Systems.Requirements.SatisfyRequirementUsage"/> instance holding deserialized values
        /// </param>
        /// <param name="reader">
        /// The <see cref="Utf8JsonReader"/> positioned on the <see cref="JsonTokenType.StartObject"/> of the
        /// <see cref="ISatisfyRequirementUsage"/> json object
        /// </param>
        /// <param name="logger">
        /// The <see cref="ILogger"/> to produce logging statement
        /// </param>
        private static void DeserializeDtoIncludingDerivedProperties(SysML2.NET.Core.DTO.Systems.Requirements.SatisfyRequirementUsage dtoInstance, ref Utf8JsonReader reader, ILogger logger)
        {
            var actorParameterSeen = false;
            var aliasIdsSeen = false;
            var assumedConstraintSeen = false;
            ...
            var occurrenceDefinitionSeen = false;
            ...
            var reqIdSeen = false;
            var requiredConstraintSeen = false;
            var requirementDefinitionSeen = false;
            var resultSeen = false;
            var satisfiedRequirementSeen = false;
            var satisfyingFeatureSeen = false;
            var shortNameSeen = false;
            var stakeholderParameterSeen = false;
            ...
            while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
            {
                ...
                {
                    throw new JsonException("Expected a property name in the SatisfyRequirementUsage json object.");
                }
                ...
                if (reader.ValueTextEquals("assumedConstraint"u8))
                {
                    assumedConstraintSeen = true;
                    reader.Read();
                    ...
                    while (reader.Read() && reader.TokenType != JsonTokenType.EndArray)
                    {
                        if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var assumedConstraintValue))
                        {
                            dtoInstance.assumedConstraint.Add(assumedConstraintValue);
                        }
                    }
                ...
                if (reader.ValueTextEquals("framedConcern"u8))
                {
                    framedConcernSeen = true;
                    reader.Read();
                    ...
                    while (reader.Read() && reader.TokenType != JsonTokenType.EndArray)
                    {
                        if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var framedConcernValue))
                        {
                            dtoInstance.framedConcern.Add(framedConcernValue);
                        }
                    }
                ...
                if (reader.ValueTextEquals("isNegated"u8))
                {
                    isNegatedSeen = true;
                    reader.Read();
                    ...
                    if (reader.TokenType != JsonTokenType.Null)
                    {
                        dtoInstance.IsNegated = reader.GetBoolean();
                    }
                ...
                if (reader.ValueTextEquals("occurrenceDefinition"u8))
                {
                    occurrenceDefinitionSeen = true;
                    reader.Read();
                    ...
                    while (reader.Read() && reader.TokenType != JsonTokenType.EndArray)
                    {
                        if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var occurrenceDefinitionValue))
                        {
                            dtoInstance.occurrenceDefinition.Add(occurrenceDefinitionValue);
                        }
                    }
                ...
                if (reader.ValueTextEquals("reqId"u8))
                {
                    reqIdSeen = true;
                    reader.Read();

                    dtoInstance.ReqId = reader.GetString();

                    continue;
                }

                if (reader.ValueTextEquals("requiredConstraint"u8))
                {
                    requiredConstraintSeen = true;
                    reader.Read();
                    ...
                    while (reader.Read() && reader.TokenType != JsonTokenType.EndArray)
                    {
                        if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var requiredConstraintValue))
                        {
                            dtoInstance.requiredConstraint.Add(requiredConstraintValue);
                        }
                    }
                ...
                if (reader.ValueTextEquals("requirementDefinition"u8))
                {
                    requirementDefinitionSeen = true;
                    reader.Read();
                    ...
                    else if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var requirementDefinitionValue))
                    {
                        dtoInstance.requirementDefinition = requirementDefinitionValue;
                    }
                ...
                if (reader.ValueTextEquals("satisfiedRequirement"u8))
                {
                    satisfiedRequirementSeen = true;
                    reader.Read();
                    ...
                    else if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var satisfiedRequirementValue))
                    {
                        dtoInstance.satisfiedRequirement = satisfiedRequirementValue;
                    }

                    continue;
                }

                if (reader.ValueTextEquals("satisfyingFeature"u8))
                {
                    satisfyingFeatureSeen = true;
                    reader.Read();
                    ...
                    else if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var satisfyingFeatureValue))
                    {
                        dtoInstance.satisfyingFeature = satisfyingFeatureValue;
                    }
                ...
                if (reader.ValueTextEquals("stakeholderParameter"u8))
                {
                    stakeholderParameterSeen = true;
                    reader.Read();
                    ...
                    while (reader.Read() && reader.TokenType != JsonTokenType.EndArray)
                    {
                        if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var stakeholderParameterValue))
                        {
                            dtoInstance.stakeholderParameter.Add(stakeholderParameterValue);
                        }
                    }
                ...
                if (reader.ValueTextEquals("text"u8))
                {
                    ...
                    while (reader.Read() && reader.TokenType != JsonTokenType.EndArray)
                    {
                        ...
                        if (textValue != null)
                        {
                            dtoInstance.text.Add(textValue);
                        }
                    }
        ...
        /// The <see cref="ILogger"/> to produce logging statement
        /// </param>
        private static void DeserializeDtoExcludingDerivedProperties(SysML2.NET.Core.DTO.Systems.Requirements.SatisfyRequirementUsage dtoInstance, ref Utf8JsonReader reader, ILogger logger)
        {
            var aliasIdsSeen = false;
            var declaredNameSeen = false;
            var directionSeen = false;
