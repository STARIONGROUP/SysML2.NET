// -------------------------------------------------------------------------------------------------
// <copyright file="SatisfyRequirementUsageDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class SatisfyRequirementUsageDeSerializer
    {
        ...
        internal static ISatisfyRequirementUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (@type.GetString() != "SatisfyRequirementUsage")
            {
                throw new InvalidOperationException($"The SatisfyRequirementUsageDeSerializer can only be used to deserialize objects of type ISatisfyRequirementUsage, a {@type.GetString()} was provided");
            }

            var dtoInstance = new SysML2.NET.Core.DTO.Systems.Requirements.SatisfyRequirementUsage();
            ...
            {
                logger.LogDebug("the actorParameter Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("assertedConstraint"u8, out var assertedConstraintProperty))
            {
                if (assertedConstraintProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.assertedConstraint = Guid.Empty;
                    logger.LogDebug($"the SatisfyRequirementUsage.assertedConstraint property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
                    if (assertedConstraintProperty.TryGetProperty("@id"u8, out var assertedConstraintExternalIdProperty))
                    {
                        var propertyValue = assertedConstraintExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.assertedConstraint = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the assertedConstraint Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }

            if (jsonElement.TryGetProperty("assumedConstraint"u8, out var assumedConstraintProperty))
            {
                foreach (var arrayItem in assumedConstraintProperty.EnumerateArray())
                {
                    if (arrayItem.TryGetProperty("@id"u8, out var assumedConstraintExternalIdProperty))
                    {
                        var propertyValue = assumedConstraintExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.assumedConstraint.Add(Guid.Parse(propertyValue));
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the assumedConstraint Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the behavior Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the chainingFeature Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the constraintDefinition Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the crossFeature Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the declaredShortName Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the definition Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the differencingType Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the directedFeature Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the directedUsage Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the documentation Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the endFeature Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the endOwningType Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the feature Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the featureMembership Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("featureTarget"u8, out var featureTargetProperty))
            {
                if (featureTargetProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the SatisfyRequirementUsage.featureTarget property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the featureTarget Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the featuringType Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }

            if (jsonElement.TryGetProperty("framedConcern"u8, out var framedConcernProperty))
            {
                foreach (var arrayItem in framedConcernProperty.EnumerateArray())
                {
                    if (arrayItem.TryGetProperty("@id"u8, out var framedConcernExternalIdProperty))
                    {
                        var propertyValue = framedConcernExternalIdProperty.GetString();
            ...
            {
                logger.LogDebug("the framedConcern Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the function Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the importedMembership Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the individualDefinition Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the inheritedFeature Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the inheritedMembership Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the input Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the intersectingType Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isConjugated Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isLibraryElement Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isModelLevelEvaluable Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isReference Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isVariable Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the mayTimeVary Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the member Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the membership Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the multiplicity Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the name Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedAction Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedAllocation Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedAnalysisCase Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedAttribute Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedCalculation Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedCase Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedConcern Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedConnection Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedConstraint Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedEnumeration Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedFlow Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedInterface Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedItem Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedMetadata Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedOccurrence Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedPart Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedPort Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedReference Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedRendering Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedRequirement Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedState Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedTransition Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedUsage Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedUseCase Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedVerificationCase Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedView Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedViewpoint Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the occurrenceDefinition Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the output Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedAnnotation Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedConjugator Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedCrossSubsetting Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedDifferencing Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedDisjoining Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedElement Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedEndFeature Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedFeature Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedFeatureChaining Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedFeatureInverting Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedFeatureMembership Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedImport Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedIntersecting Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedMember Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedMembership Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedRedefinition Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedReferenceSubsetting Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedSpecialization Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedSubsetting Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedTypeFeaturing Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedTyping Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedUnioning Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owner Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningDefinition Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningFeatureMembership Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningMembership Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningNamespace Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningType Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningUsage Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the parameter Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the predicate Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the qualifiedName Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                foreach (var arrayItem in requiredConstraintProperty.EnumerateArray())
                {
                    if (arrayItem.TryGetProperty("@id"u8, out var requiredConstraintExternalIdProperty))
                    {
                        var propertyValue = requiredConstraintExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.requiredConstraint.Add(Guid.Parse(propertyValue));
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the requiredConstraint Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the requirementDefinition Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("result"u8, out var resultProperty))
            {
                if (resultProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the SatisfyRequirementUsage.result property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the result Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }

            if (jsonElement.TryGetProperty("satisfiedRequirement"u8, out var satisfiedRequirementProperty))
            {
                if (satisfiedRequirementProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.satisfiedRequirement = Guid.Empty;
                    logger.LogDebug($"the SatisfyRequirementUsage.satisfiedRequirement property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
                    if (satisfiedRequirementProperty.TryGetProperty("@id"u8, out var satisfiedRequirementExternalIdProperty))
                    {
                        var propertyValue = satisfiedRequirementExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.satisfiedRequirement = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the satisfiedRequirement Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }

            if (jsonElement.TryGetProperty("satisfyingFeature"u8, out var satisfyingFeatureProperty))
            {
                if (satisfyingFeatureProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.satisfyingFeature = Guid.Empty;
                    logger.LogDebug($"the SatisfyRequirementUsage.satisfyingFeature property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
                    if (satisfyingFeatureProperty.TryGetProperty("@id"u8, out var satisfyingFeatureExternalIdProperty))
                    {
                        var propertyValue = satisfyingFeatureExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.satisfyingFeature = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the satisfyingFeature Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the shortName Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }

            if (jsonElement.TryGetProperty("stakeholderParameter"u8, out var stakeholderParameterProperty))
            {
                foreach (var arrayItem in stakeholderParameterProperty.EnumerateArray())
                {
                    if (arrayItem.TryGetProperty("@id"u8, out var stakeholderParameterExternalIdProperty))
                    {
                        var propertyValue = stakeholderParameterExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.stakeholderParameter.Add(Guid.Parse(propertyValue));
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the stakeholderParameter Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("subjectParameter"u8, out var subjectParameterProperty))
            {
                if (subjectParameterProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the SatisfyRequirementUsage.subjectParameter property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the subjectParameter Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }

            if (jsonElement.TryGetProperty("text"u8, out var textProperty))
            {
                foreach (var arrayItem in textProperty.EnumerateArray())
                {
                    var propertyValue = arrayItem.GetString();

                    if (propertyValue != null)
                    {
                        dtoInstance.text.Add(propertyValue);
                    }
                }
            }
            else
            {
                logger.LogDebug("the text Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the textualRepresentation Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the type Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the unioningType Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the usage Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the variant Json property was not found in the SatisfyRequirementUsage: { Id }", dtoInstance.Id);
            }
