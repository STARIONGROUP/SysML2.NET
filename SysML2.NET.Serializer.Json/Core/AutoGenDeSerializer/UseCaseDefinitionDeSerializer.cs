...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IUseCaseDefinition"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IUseCaseDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the UseCaseDefinitionDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "UseCaseDefinition")
            {
            ...
            {
                logger.LogDebug("the directedFeature Json property was not found in the UseCaseDefinition: { Id }", dtoInstance.Id);
            }
