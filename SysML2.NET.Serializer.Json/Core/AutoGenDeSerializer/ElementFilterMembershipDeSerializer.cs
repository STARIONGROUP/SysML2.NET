...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class ElementFilterMembershipDeSerializer
    {
        ...
        internal static IElementFilterMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (jsonElement.TryGetProperty("condition"u8, out var conditionProperty))
            {
                if (conditionProperty.ValueKind == JsonValueKind.Null)
                {
                ...
                {
                    if (conditionProperty.TryGetProperty("@id"u8, out var conditionExternalIdProperty))
                    {
                        var propertyValue = conditionExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.condition = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
            ...
            if (jsonElement.TryGetProperty("memberElement"u8, out var memberElementProperty))
            {
                if (memberElementProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the ElementFilterMembership.MemberElement property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the memberElement Json property was not found in the ElementFilterMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the memberElementId Json property was not found in the ElementFilterMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the memberName Json property was not found in the ElementFilterMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the memberShortName Json property was not found in the ElementFilterMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("ownedMemberElement"u8, out var ownedMemberElementProperty))
            {
                if (ownedMemberElementProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the ElementFilterMembership.ownedMemberElement property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the ownedMemberElement Json property was not found in the ElementFilterMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the source Json property was not found in the ElementFilterMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the target Json property was not found in the ElementFilterMembership: { Id }", dtoInstance.Id);
            }
