// -------------------------------------------------------------------------------------------------
// <copyright file="TransitionFeatureKindDeSerializer.cs" company="Starion Group S.A.">
//
    ...
    internal static class TransitionFeatureKindDeSerializer
    {
        ...
        internal static TransitionFeatureKind Deserialize(string value)
        {
            ...
            return value switch
            {
                ...
                _ => throw new ArgumentException($"{value} is not a valid TransitionFeatureKind", nameof(value))
            };
        }
