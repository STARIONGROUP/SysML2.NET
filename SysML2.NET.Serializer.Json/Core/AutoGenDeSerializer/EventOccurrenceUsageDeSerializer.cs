...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IEventOccurrenceUsage"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IEventOccurrenceUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the EventOccurrenceUsageDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "EventOccurrenceUsage")
            {
                throw new InvalidOperationException($"The EventOccurrenceUsageDeSerializer can only be used to deserialize objects of type IEventOccurrenceUsage, a {@type.GetString()} was provided");
            }
            ...
            {
                logger.LogDebug("the definition Json property was not found in the EventOccurrenceUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isVariable Json property was not found in the EventOccurrenceUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the type Json property was not found in the EventOccurrenceUsage: { Id }", dtoInstance.Id);
            }
