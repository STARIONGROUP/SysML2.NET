...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class ConcernDefinitionDeSerializer
    {
        ...
        internal static IConcernDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.ConcernDefinition();
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the ConcernDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the ConcernDefinition: {dtoInstance.Id}");
            }
