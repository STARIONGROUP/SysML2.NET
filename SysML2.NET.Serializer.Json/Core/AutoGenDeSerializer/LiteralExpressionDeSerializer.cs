...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class LiteralExpressionDeSerializer
    {
        ...
        internal static ILiteralExpression DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug("the behavior Json property was not found in the LiteralExpression: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the directedFeature Json property was not found in the LiteralExpression: { Id }", dtoInstance.Id);
            }
