// -------------------------------------------------------------------------------------------------
// <copyright file="SuccessionFlowConnectionUsageDeSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="SuccessionFlowConnectionUsageDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="ISuccessionFlowConnectionUsage"/> interface
    /// </summary>
    internal static class SuccessionFlowConnectionUsageDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="ISuccessionFlowConnectionUsage"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        /// <param name="jsonElement">
        /// The <see cref="JsonElement"/> that contains the <see cref="ISuccessionFlowConnectionUsage"/> json object
        /// </param>
        ...
        /// </returns>
        internal static ISuccessionFlowConnectionUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            var logger = loggerFactory == null ? NullLogger.Instance : loggerFactory.CreateLogger("SuccessionFlowConnectionUsageDeSerializer");

            if (!jsonElement.TryGetProperty("@type"u8, out JsonElement @type))
            {
                throw new InvalidOperationException("The @type property is not available, the SuccessionFlowConnectionUsageDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "SuccessionFlowConnectionUsage")
            {
                throw new InvalidOperationException($"The SuccessionFlowConnectionUsageDeSerializer can only be used to deserialize objects of type ISuccessionFlowConnectionUsage, a {@type.GetString()} was provided");
            }

            var dtoInstance = new SysML2.NET.Core.DTO.SuccessionFlowConnectionUsage();
            ...
            if (jsonElement.TryGetProperty("@id"u8, out JsonElement idProperty))
            {
                ...
                {
                    throw new JsonException("The @id property is not present, the SuccessionFlowConnectionUsage cannot be deserialized");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the direction Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isAbstract Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isComposite Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isDerived Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isDirected Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isEnd Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isIndividual Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isOrdered Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isPortion Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isReadOnly Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isSufficient Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isUnique Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isVariation Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the portionKind Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the source Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the target Json property was not found in the SuccessionFlowConnectionUsage: {dtoInstance.Id}");
            }
