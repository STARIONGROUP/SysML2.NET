...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class ConstraintUsageDeSerializer
    {
        ...
        internal static IConstraintUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (@type.GetString() != "ConstraintUsage")
            {
                throw new InvalidOperationException($"The ConstraintUsageDeSerializer can only be used to deserialize objects of type IConstraintUsage, a {@type.GetString()} was provided");
            }
            ...
            {
                logger.LogDebug("the behavior Json property was not found in the ConstraintUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the definition Json property was not found in the ConstraintUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the directedFeature Json property was not found in the ConstraintUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the function Json property was not found in the ConstraintUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isVariable Json property was not found in the ConstraintUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the predicate Json property was not found in the ConstraintUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the type Json property was not found in the ConstraintUsage: { Id }", dtoInstance.Id);
            }
