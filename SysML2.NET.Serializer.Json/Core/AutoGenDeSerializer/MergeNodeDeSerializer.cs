// -------------------------------------------------------------------------------------------------
// <copyright file="MergeNodeDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="MergeNodeDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="IMergeNode"/> interface
    /// </summary>
    internal static class MergeNodeDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IMergeNode"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IMergeNode DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the MergeNodeDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "MergeNode")
            {
                throw new InvalidOperationException($"The MergeNodeDeSerializer can only be used to deserialize objects of type IMergeNode, a {@type.GetString()} was provided");
            }

            var dtoInstance = new SysML2.NET.Core.DTO.Systems.Actions.MergeNode();
            ...
            if (jsonElement.TryGetProperty("@id"u8, out var idProperty))
            {
                ...
                {
                    throw new JsonException("The @id property is not present, the MergeNode cannot be deserialized");
                }
                else
                {
            ...
            {
                logger.LogDebug("the actionDefinition Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the behavior Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the chainingFeature Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the crossFeature Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the definition Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the differencingType Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the directedFeature Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the directedUsage Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the documentation Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the endFeature Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the endOwningType Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the feature Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the featureMembership Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("featureTarget"u8, out var featureTargetProperty))
            {
                if (featureTargetProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the MergeNode.featureTarget property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the featureTarget Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the featuringType Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the importedMembership Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the individualDefinition Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the inheritedFeature Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the inheritedMembership Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the input Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the intersectingType Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isConjugated Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isLibraryElement Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isReference Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isVariable Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the mayTimeVary Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the member Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the membership Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the multiplicity Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the name Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedAction Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedAllocation Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedAnalysisCase Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedAttribute Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedCalculation Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedCase Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedConcern Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedConnection Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedConstraint Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedEnumeration Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedFlow Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedInterface Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedItem Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedMetadata Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedOccurrence Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedPart Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedPort Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedReference Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedRendering Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedRequirement Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedState Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedTransition Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedUsage Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedUseCase Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedVerificationCase Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedView Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the nestedViewpoint Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the occurrenceDefinition Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the output Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedAnnotation Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedConjugator Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedCrossSubsetting Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedDifferencing Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedDisjoining Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedElement Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedEndFeature Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedFeature Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedFeatureChaining Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedFeatureInverting Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedFeatureMembership Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedImport Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedIntersecting Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedMember Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedMembership Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedRedefinition Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedReferenceSubsetting Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedSpecialization Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedSubsetting Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedTypeFeaturing Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedTyping Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedUnioning Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owner Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningDefinition Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningFeatureMembership Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningMembership Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningNamespace Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningType Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningUsage Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the parameter Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the qualifiedName Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the shortName Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the textualRepresentation Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the type Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the unioningType Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the usage Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the variant Json property was not found in the MergeNode: { Id }", dtoInstance.Id);
            }
