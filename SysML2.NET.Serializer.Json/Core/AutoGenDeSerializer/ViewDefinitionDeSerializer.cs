...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IViewDefinition"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IViewDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, bool deserializeDerivedProperties, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the ViewDefinitionDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "ViewDefinition")
            {
                throw new InvalidOperationException($"The ViewDefinitionDeSerializer can only be used to deserialize objects of type IViewDefinition, a {@type.GetString()} was provided");
            }
        ...
        private static void DeserializeDtoIncludingDerivedProperties(SysML2.NET.Core.DTO.Systems.Views.ViewDefinition dtoInstance, JsonElement jsonElement, ILogger logger)
        {
            ...
            if (jsonElement.TryGetProperty("view"u8, out var viewProperty))
            {
                foreach (var arrayItem in viewProperty.EnumerateArray())
                {
                    if (arrayItem.TryGetProperty("@id"u8, out var viewExternalIdProperty))
                    {
                        var propertyValue = viewExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.view.Add(Guid.Parse(propertyValue));
                        }
                    }
                }
            }
