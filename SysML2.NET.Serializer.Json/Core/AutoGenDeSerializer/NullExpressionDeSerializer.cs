...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class NullExpressionDeSerializer
    {
        ...
        internal static INullExpression DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug("the behavior Json property was not found in the NullExpression: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the directedFeature Json property was not found in the NullExpression: { Id }", dtoInstance.Id);
            }
