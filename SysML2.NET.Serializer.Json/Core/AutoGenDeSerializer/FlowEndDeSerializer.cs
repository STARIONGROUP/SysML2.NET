...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IFlowEnd"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IFlowEnd DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, bool deserializeDerivedProperties, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the FlowEndDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "FlowEnd")
            {
