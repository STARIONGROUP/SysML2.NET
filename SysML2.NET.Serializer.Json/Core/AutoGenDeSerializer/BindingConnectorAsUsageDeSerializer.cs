...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IBindingConnectorAsUsage"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IBindingConnectorAsUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug("the endFeature Json property was not found in the BindingConnectorAsUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isVariable Json property was not found in the BindingConnectorAsUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the relatedElement Json property was not found in the BindingConnectorAsUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the source Json property was not found in the BindingConnectorAsUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the target Json property was not found in the BindingConnectorAsUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the type Json property was not found in the BindingConnectorAsUsage: { Id }", dtoInstance.Id);
            }
