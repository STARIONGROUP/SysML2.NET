// -------------------------------------------------------------------------------------------------
// <copyright file="CaseDefinitionDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="CaseDefinitionDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="ICaseDefinition"/> interface
    /// </summary>
    internal static class CaseDefinitionDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="ICaseDefinition"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static ICaseDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the CaseDefinitionDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "CaseDefinition")
            {
                throw new InvalidOperationException($"The CaseDefinitionDeSerializer can only be used to deserialize objects of type ICaseDefinition, a {@type.GetString()} was provided");
            }

            var dtoInstance = new SysML2.NET.Core.DTO.CaseDefinition();
            ...
            if (jsonElement.TryGetProperty("@id"u8, out JsonElement idProperty))
            {
                ...
                {
                    throw new JsonException("The @id property is not present, the CaseDefinition cannot be deserialized");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the CaseDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the CaseDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the CaseDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the CaseDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isAbstract Json property was not found in the CaseDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the CaseDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isIndividual Json property was not found in the CaseDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isSufficient Json property was not found in the CaseDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isVariation Json property was not found in the CaseDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the CaseDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the CaseDefinition: {dtoInstance.Id}");
            }
