// -------------------------------------------------------------------------------------------------
// <copyright file="LifeClassDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class LifeClassDeSerializer
    {
        ...
        internal static ILifeClass DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.LifeClass();
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the LifeClass: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the LifeClass: {dtoInstance.Id}");
            }
