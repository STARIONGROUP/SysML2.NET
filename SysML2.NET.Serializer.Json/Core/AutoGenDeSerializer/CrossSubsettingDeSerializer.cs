...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    /// </summary>
    internal static class CrossSubsettingDeSerializer
    {
        /// <summary>
        ...
        internal static ICrossSubsetting DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.CrossSubsetting();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the CrossSubsetting: {dtoInstance.Id}");
            }
            ...
            if (jsonElement.TryGetProperty("crossedFeature"u8, out JsonElement crossedFeatureProperty))
            {
                ...
                {
                    if (crossedFeatureProperty.TryGetProperty("@id"u8, out JsonElement crossedFeatureIdProperty))
                    {
            ...
            {
                logger.LogDebug($"the crossedFeature Json property was not found in the CrossSubsetting: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the CrossSubsetting: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the CrossSubsetting: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the CrossSubsetting: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the general Json property was not found in the CrossSubsetting: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the CrossSubsetting: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the CrossSubsetting: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the CrossSubsetting: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the CrossSubsetting: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the CrossSubsetting: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the CrossSubsetting: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the source Json property was not found in the CrossSubsetting: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the specific Json property was not found in the CrossSubsetting: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the subsettedFeature Json property was not found in the CrossSubsetting: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the subsettingFeature Json property was not found in the CrossSubsetting: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the target Json property was not found in the CrossSubsetting: {dtoInstance.Id}");
            }
