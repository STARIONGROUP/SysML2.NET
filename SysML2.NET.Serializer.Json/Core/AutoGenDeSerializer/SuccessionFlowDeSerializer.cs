// -------------------------------------------------------------------------------------------------
// <copyright file="SuccessionFlowDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="SuccessionFlowDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="ISuccessionFlow"/> interface
    /// </summary>
    internal static class SuccessionFlowDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="ISuccessionFlow"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static ISuccessionFlow DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the SuccessionFlowDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "SuccessionFlow")
            {
                throw new InvalidOperationException($"The SuccessionFlowDeSerializer can only be used to deserialize objects of type ISuccessionFlow, a {@type.GetString()} was provided");
            }

            var dtoInstance = new SysML2.NET.Core.DTO.Kernel.Interactions.SuccessionFlow();
            ...
            if (jsonElement.TryGetProperty("@id"u8, out var idProperty))
            {
                ...
                {
                    throw new JsonException("The @id property is not present, the SuccessionFlow cannot be deserialized");
                }
                else
                {
            ...
            {
                logger.LogDebug("the association Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the behavior Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the chainingFeature Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the connectorEnd Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the crossFeature Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the defaultFeaturingType Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the differencingType Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the directedFeature Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the documentation Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the endFeature Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the endOwningType Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the feature Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the featureMembership Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("featureTarget"u8, out var featureTargetProperty))
            {
                if (featureTargetProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the SuccessionFlow.featureTarget property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the featureTarget Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the featuringType Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the flowEnd Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the importedMembership Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the inheritedFeature Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the inheritedMembership Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the input Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the interaction Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the intersectingType Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isConjugated Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isLibraryElement Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the member Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the membership Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the multiplicity Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the name Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the output Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedAnnotation Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedConjugator Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedCrossSubsetting Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedDifferencing Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedDisjoining Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedElement Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedEndFeature Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedFeature Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedFeatureChaining Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedFeatureInverting Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedFeatureMembership Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedImport Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedIntersecting Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedMember Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedMembership Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedRedefinition Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedReferenceSubsetting Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedSpecialization Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedSubsetting Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedTypeFeaturing Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedTyping Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedUnioning Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owner Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningFeatureMembership Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningMembership Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningNamespace Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningType Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the parameter Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the payloadFeature Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the payloadType Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the qualifiedName Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the relatedElement Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the relatedFeature Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the shortName Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the source Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the sourceFeature Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the sourceOutputFeature Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the target Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the targetFeature Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the targetInputFeature Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the textualRepresentation Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the type Json property was not found in the SuccessionFlow: { Id }", dtoInstance.Id);
            }
