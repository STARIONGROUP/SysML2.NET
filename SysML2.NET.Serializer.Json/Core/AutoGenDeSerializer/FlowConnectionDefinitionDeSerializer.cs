// -------------------------------------------------------------------------------------------------
// <copyright file="FlowConnectionDefinitionDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="FlowConnectionDefinitionDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="IFlowConnectionDefinition"/> interface
    /// </summary>
    internal static class FlowConnectionDefinitionDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IFlowConnectionDefinition"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        /// <param name="jsonElement">
        /// The <see cref="JsonElement"/> that contains the <see cref="IFlowConnectionDefinition"/> json object
        /// </param>
        ...
        /// </returns>
        internal static IFlowConnectionDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            var logger = loggerFactory == null ? NullLogger.Instance : loggerFactory.CreateLogger("FlowConnectionDefinitionDeSerializer");

            if (!jsonElement.TryGetProperty("@type"u8, out JsonElement @type))
            {
                throw new InvalidOperationException("The @type property is not available, the FlowConnectionDefinitionDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "FlowConnectionDefinition")
            {
                throw new InvalidOperationException($"The FlowConnectionDefinitionDeSerializer can only be used to deserialize objects of type IFlowConnectionDefinition, a {@type.GetString()} was provided");
            }

            var dtoInstance = new SysML2.NET.Core.DTO.FlowConnectionDefinition();
            ...
            if (jsonElement.TryGetProperty("@id"u8, out JsonElement idProperty))
            {
                ...
                {
                    throw new JsonException("The @id property is not present, the FlowConnectionDefinition cannot be deserialized");
                }
                else
                {
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the FlowConnectionDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the FlowConnectionDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the FlowConnectionDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the FlowConnectionDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isAbstract Json property was not found in the FlowConnectionDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the FlowConnectionDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the FlowConnectionDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isIndividual Json property was not found in the FlowConnectionDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isSufficient Json property was not found in the FlowConnectionDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isVariation Json property was not found in the FlowConnectionDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the FlowConnectionDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the FlowConnectionDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the FlowConnectionDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the FlowConnectionDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the source Json property was not found in the FlowConnectionDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the target Json property was not found in the FlowConnectionDefinition: {dtoInstance.Id}");
            }
