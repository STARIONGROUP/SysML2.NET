...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IIncludeUseCaseUsage"/> from the provided <see cref="Utf8JsonReader"/>
        /// </summary>
        /// <param name="reader">
        /// The <see cref="Utf8JsonReader"/> positioned on the <see cref="JsonTokenType.StartObject"/> of the
        /// <see cref="IIncludeUseCaseUsage"/> json object. On return the reader is positioned on the matching
        ...
        /// </remarks>
        internal static IIncludeUseCaseUsage DeSerialize(ref Utf8JsonReader reader, SerializationModeKind serializationModeKind, bool deserializeDerivedProperties, ILoggerFactory loggerFactory = null)
        {
        ...
        /// <summary>
        /// Deserializes properties of a <see cref="SysML2.NET.Core.DTO.Systems.UseCases.IncludeUseCaseUsage" />
        /// from a <see cref="Utf8JsonReader" />, including derived properties
        /// </summary>
        /// <param name="dtoInstance">
        /// The <see cref="SysML2.NET.Core.DTO.Systems.UseCases.IncludeUseCaseUsage"/> instance holding deserialized values
        /// </param>
        /// <param name="reader">
        /// The <see cref="Utf8JsonReader"/> positioned on the <see cref="JsonTokenType.StartObject"/> of the
        /// <see cref="IIncludeUseCaseUsage"/> json object
        /// </param>
        /// <param name="logger">
        /// The <see cref="ILogger"/> to produce logging statement
        /// </param>
        private static void DeserializeDtoIncludingDerivedProperties(SysML2.NET.Core.DTO.Systems.UseCases.IncludeUseCaseUsage dtoInstance, ref Utf8JsonReader reader, ILogger logger)
        {
            ...
            var usageSeen = false;
            var useCaseDefinitionSeen = false;
            var useCaseIncludedSeen = false;
            ...
            while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
            {
                ...
                {
                    throw new JsonException("Expected a property name in the IncludeUseCaseUsage json object.");
                }
                ...
                if (reader.ValueTextEquals("includedUseCase"u8))
                {
                    includedUseCaseSeen = true;
                    reader.Read();
                    ...
                    while (reader.Read() && reader.TokenType != JsonTokenType.EndArray)
                    {
                        if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var includedUseCaseValue))
                        {
                            dtoInstance.includedUseCase.Add(includedUseCaseValue);
                        }
                    }
                ...
                if (reader.ValueTextEquals("useCaseDefinition"u8))
                {
                    useCaseDefinitionSeen = true;
                    reader.Read();
                    ...
                    else if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var useCaseDefinitionValue))
                    {
                        dtoInstance.useCaseDefinition = useCaseDefinitionValue;
                    }

                    continue;
                }

                if (reader.ValueTextEquals("useCaseIncluded"u8))
                {
                    useCaseIncludedSeen = true;
                    reader.Read();
                    ...
                    else if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var useCaseIncludedValue))
                    {
                        dtoInstance.useCaseIncluded = useCaseIncludedValue;
                    }
        ...
        /// The <see cref="ILogger"/> to produce logging statement
        /// </param>
        private static void DeserializeDtoExcludingDerivedProperties(SysML2.NET.Core.DTO.Systems.UseCases.IncludeUseCaseUsage dtoInstance, ref Utf8JsonReader reader, ILogger logger)
        {
            var aliasIdsSeen = false;
            var declaredNameSeen = false;
            var declaredShortNameSeen = false;
