...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class RequirementVerificationMembershipDeSerializer
    {
        ...
        private static void DeserializeDtoIncludingDerivedProperties(SysML2.NET.Core.DTO.Systems.VerificationCases.RequirementVerificationMembership dtoInstance, JsonElement jsonElement, ILogger logger)
        {
            ...
            {
                if (ownedRequirementProperty.ValueKind == JsonValueKind.Null)
                {
                ...
                {
                    if (ownedRequirementProperty.TryGetProperty("@id"u8, out var ownedRequirementExternalIdProperty))
                    {
                        var propertyValue = ownedRequirementExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.ownedRequirement = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
            ...
            {
                if (verifiedRequirementProperty.ValueKind == JsonValueKind.Null)
                {
                ...
                {
                    if (verifiedRequirementProperty.TryGetProperty("@id"u8, out var verifiedRequirementExternalIdProperty))
                    {
                        var propertyValue = verifiedRequirementExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.verifiedRequirement = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
