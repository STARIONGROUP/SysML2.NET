...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class EnumerationDefinitionDeSerializer
    {
        ...
        internal static IEnumerationDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            if (@type.GetString() != "EnumerationDefinition")
            {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.EnumerationDefinition();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the EnumerationDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the EnumerationDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the EnumerationDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the EnumerationDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isAbstract Json property was not found in the EnumerationDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the EnumerationDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isSufficient Json property was not found in the EnumerationDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isVariation Json property was not found in the EnumerationDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the EnumerationDefinition: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the EnumerationDefinition: {dtoInstance.Id}");
            }
