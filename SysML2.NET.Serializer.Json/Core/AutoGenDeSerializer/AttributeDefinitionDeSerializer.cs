...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IAttributeDefinition"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IAttributeDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, bool deserializeDerivedProperties, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the AttributeDefinitionDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "AttributeDefinition")
            {
                throw new InvalidOperationException($"The AttributeDefinitionDeSerializer can only be used to deserialize objects of type IAttributeDefinition, a {@type.GetString()} was provided");
            }
