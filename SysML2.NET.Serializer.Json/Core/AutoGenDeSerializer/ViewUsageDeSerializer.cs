...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IViewUsage"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IViewUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the ViewUsageDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "ViewUsage")
            {
                throw new InvalidOperationException($"The ViewUsageDeSerializer can only be used to deserialize objects of type IViewUsage, a {@type.GetString()} was provided");
            }
            ...
            {
                logger.LogDebug("the definition Json property was not found in the ViewUsage: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("exposedElement"u8, out var exposedElementProperty))
            {
                foreach (var arrayItem in exposedElementProperty.EnumerateArray())
                {
                    if (arrayItem.TryGetProperty("@id"u8, out var exposedElementExternalIdProperty))
                    {
                        var propertyValue = exposedElementExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.exposedElement.Add(Guid.Parse(propertyValue));
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the isVariable Json property was not found in the ViewUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the partDefinition Json property was not found in the ViewUsage: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("satisfiedViewpoint"u8, out var satisfiedViewpointProperty))
            {
                foreach (var arrayItem in satisfiedViewpointProperty.EnumerateArray())
                {
                    if (arrayItem.TryGetProperty("@id"u8, out var satisfiedViewpointExternalIdProperty))
                    {
                        var propertyValue = satisfiedViewpointExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.satisfiedViewpoint.Add(Guid.Parse(propertyValue));
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the type Json property was not found in the ViewUsage: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("viewCondition"u8, out var viewConditionProperty))
            {
                foreach (var arrayItem in viewConditionProperty.EnumerateArray())
                {
                    if (arrayItem.TryGetProperty("@id"u8, out var viewConditionExternalIdProperty))
                    {
                        var propertyValue = viewConditionExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.viewCondition.Add(Guid.Parse(propertyValue));
                        }
                    }
                }
            }
            ...
            if (jsonElement.TryGetProperty("viewDefinition"u8, out var viewDefinitionProperty))
            {
                if (viewDefinitionProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.viewDefinition = null;
                }
                else
                {
                    if (viewDefinitionProperty.TryGetProperty("@id"u8, out var viewDefinitionExternalIdProperty))
                    {
                        var propertyValue = viewDefinitionExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.viewDefinition = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
            ...
            if (jsonElement.TryGetProperty("viewRendering"u8, out var viewRenderingProperty))
            {
                if (viewRenderingProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.viewRendering = null;
                }
                else
                {
                    if (viewRenderingProperty.TryGetProperty("@id"u8, out var viewRenderingExternalIdProperty))
                    {
                        var propertyValue = viewRenderingExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.viewRendering = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
