...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class ReturnParameterMembershipDeSerializer
    {
        ...
        internal static IReturnParameterMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.ReturnParameterMembership();
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the ReturnParameterMembership: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the ReturnParameterMembership: {dtoInstance.Id}");
            }
