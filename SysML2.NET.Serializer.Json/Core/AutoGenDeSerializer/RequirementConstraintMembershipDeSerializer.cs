// -------------------------------------------------------------------------------------------------
// <copyright file="RequirementConstraintMembershipDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="RequirementConstraintMembershipDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="IRequirementConstraintMembership"/> interface
    /// </summary>
    internal static class RequirementConstraintMembershipDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IRequirementConstraintMembership"/> from the provided <see cref="Utf8JsonReader"/>
        /// </summary>
        /// <param name="reader">
        /// The <see cref="Utf8JsonReader"/> positioned on the <see cref="JsonTokenType.StartObject"/> of the
        /// <see cref="IRequirementConstraintMembership"/> json object. On return the reader is positioned on the matching
        ...
        /// </remarks>
        internal static IRequirementConstraintMembership DeSerialize(ref Utf8JsonReader reader, SerializationModeKind serializationModeKind, bool deserializeDerivedProperties, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.Systems.Requirements.RequirementConstraintMembership();
        ...
        /// <summary>
        /// Deserializes properties of a <see cref="SysML2.NET.Core.DTO.Systems.Requirements.RequirementConstraintMembership" />
        /// from a <see cref="Utf8JsonReader" />, including derived properties
        /// </summary>
        /// <param name="dtoInstance">
        /// The <see cref="SysML2.NET.Core.DTO.Systems.Requirements.RequirementConstraintMembership"/> instance holding deserialized values
        /// </param>
        /// <param name="reader">
        /// The <see cref="Utf8JsonReader"/> positioned on the <see cref="JsonTokenType.StartObject"/> of the
        /// <see cref="IRequirementConstraintMembership"/> json object
        /// </param>
        /// <param name="logger">
        /// The <see cref="ILogger"/> to produce logging statement
        /// </param>
        private static void DeserializeDtoIncludingDerivedProperties(SysML2.NET.Core.DTO.Systems.Requirements.RequirementConstraintMembership dtoInstance, ref Utf8JsonReader reader, ILogger logger)
        {
            ...
            var ownedMemberElementIdSeen = false;
            var ownedMemberNameSeen = false;
            var ownedMemberShortNameSeen = false;
            ...
            var referencedConstraintSeen = false;
            ...
            while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
            {
                ...
                {
                    throw new JsonException("Expected a property name in the RequirementConstraintMembership json object.");
                }
                ...
                if (reader.ValueTextEquals("@id"u8))
                {
                    ...
                    {
                        throw new JsonException("The @id property is not present, the RequirementConstraintMembership cannot be deserialized");
                    }
                ...
                if (reader.ValueTextEquals("kind"u8))
                {
                    ...
                    dtoInstance.Kind = RequirementConstraintKindDeSerializer.Deserialize(reader.GetString());
                ...
                if (reader.ValueTextEquals("ownedConstraint"u8))
                {
                    ...
                    if (reader.TokenType == JsonTokenType.Null)
                    {
                        ...
                        {
                            logger.LogDebug("the RequirementConstraintMembership.ownedConstraint property was not found in the Json. The value is set to Guid.Empty");
                        }
                    }
                    else if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var ownedConstraintValue))
                    {
                        dtoInstance.ownedConstraint = ownedConstraintValue;
                    }
                ...
                if (reader.ValueTextEquals("ownedMemberElementId"u8))
                {
                    ownedMemberElementIdSeen = true;
                    reader.Read();

                    var ownedMemberElementIdValue = reader.GetString();

                    if (ownedMemberElementIdValue != null)
                    {
                        dtoInstance.ownedMemberElementId = ownedMemberElementIdValue;
                    }

                    continue;
                }

                if (reader.ValueTextEquals("ownedMemberName"u8))
                {
                    ownedMemberNameSeen = true;
                    reader.Read();

                    dtoInstance.ownedMemberName = reader.GetString();

                    continue;
                }

                if (reader.ValueTextEquals("ownedMemberShortName"u8))
                {
                    ownedMemberShortNameSeen = true;
                    reader.Read();

                    dtoInstance.ownedMemberShortName = reader.GetString();
                ...
                if (reader.ValueTextEquals("owningType"u8))
                {
                    ...
                    if (reader.TokenType == JsonTokenType.Null)
                    {
                        ...
                        if (logger.IsEnabled(LogLevel.Debug))
                        {
                            logger.LogDebug("the RequirementConstraintMembership.owningType property was not found in the Json. The value is set to Guid.Empty");
                        }
                    }
                ...
                if (reader.ValueTextEquals("referencedConstraint"u8))
                {
                    referencedConstraintSeen = true;
                    reader.Read();
                    ...
                    if (reader.TokenType == JsonTokenType.Null)
                    {
                        ...
                        if (logger.IsEnabled(LogLevel.Debug))
                        {
                            logger.LogDebug("the RequirementConstraintMembership.referencedConstraint property was not found in the Json. The value is set to Guid.Empty");
                        }
                    }
                    else if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var referencedConstraintValue))
                    {
                        dtoInstance.referencedConstraint = referencedConstraintValue;
                    }
            ...
            if (logger.IsEnabled(LogLevel.Debug))
            {
                ...
                {
                    logger.LogDebug("the documentation Json property was not found in the RequirementConstraintMembership: {Id}", dtoInstance.Id);
                }
                if (!elementIdSeen)
                {
                ...
                {
                    logger.LogDebug("the isLibraryElement Json property was not found in the RequirementConstraintMembership: {Id}", dtoInstance.Id);
                }
                if (!kindSeen)
                {
                ...
                if (!nameSeen)
                {
                    logger.LogDebug("the name Json property was not found in the RequirementConstraintMembership: {Id}", dtoInstance.Id);
                }
                if (!ownedAnnotationSeen)
                {
                    logger.LogDebug("the ownedAnnotation Json property was not found in the RequirementConstraintMembership: {Id}", dtoInstance.Id);
                }
                if (!ownedConstraintSeen)
                {
                    logger.LogDebug("the ownedConstraint Json property was not found in the RequirementConstraintMembership: {Id}", dtoInstance.Id);
                }
                if (!ownedElementSeen)
                {
                    logger.LogDebug("the ownedElement Json property was not found in the RequirementConstraintMembership: {Id}", dtoInstance.Id);
                }
                if (!ownedMemberElementIdSeen)
                {
                    logger.LogDebug("the ownedMemberElementId Json property was not found in the RequirementConstraintMembership: {Id}", dtoInstance.Id);
                }
                if (!ownedMemberNameSeen)
                {
                    logger.LogDebug("the ownedMemberName Json property was not found in the RequirementConstraintMembership: {Id}", dtoInstance.Id);
                }
                if (!ownedMemberShortNameSeen)
                {
                    logger.LogDebug("the ownedMemberShortName Json property was not found in the RequirementConstraintMembership: {Id}", dtoInstance.Id);
                }
                ...
                if (!ownerSeen)
                {
                    logger.LogDebug("the owner Json property was not found in the RequirementConstraintMembership: {Id}", dtoInstance.Id);
                }
                if (!owningMembershipSeen)
                {
                    logger.LogDebug("the owningMembership Json property was not found in the RequirementConstraintMembership: {Id}", dtoInstance.Id);
                }
                if (!owningNamespaceSeen)
                {
                    logger.LogDebug("the owningNamespace Json property was not found in the RequirementConstraintMembership: {Id}", dtoInstance.Id);
                }
                ...
                if (!owningTypeSeen)
                {
                    logger.LogDebug("the owningType Json property was not found in the RequirementConstraintMembership: {Id}", dtoInstance.Id);
                }
                if (!qualifiedNameSeen)
                {
                    logger.LogDebug("the qualifiedName Json property was not found in the RequirementConstraintMembership: {Id}", dtoInstance.Id);
                }
                if (!referencedConstraintSeen)
                {
                    logger.LogDebug("the referencedConstraint Json property was not found in the RequirementConstraintMembership: {Id}", dtoInstance.Id);
                }
                if (!relatedElementSeen)
                {
                    logger.LogDebug("the relatedElement Json property was not found in the RequirementConstraintMembership: {Id}", dtoInstance.Id);
                }
                if (!shortNameSeen)
                {
                    logger.LogDebug("the shortName Json property was not found in the RequirementConstraintMembership: {Id}", dtoInstance.Id);
                }
                if (!textualRepresentationSeen)
                {
                    logger.LogDebug("the textualRepresentation Json property was not found in the RequirementConstraintMembership: {Id}", dtoInstance.Id);
                }
                if (!visibilitySeen)
                {
        ...
        /// The <see cref="ILogger"/> to produce logging statement
        /// </param>
        private static void DeserializeDtoExcludingDerivedProperties(SysML2.NET.Core.DTO.Systems.Requirements.RequirementConstraintMembership dtoInstance, ref Utf8JsonReader reader, ILogger logger)
        {
            var aliasIdsSeen = false;
            var declaredNameSeen = false;
            var declaredShortNameSeen = false;
