// -------------------------------------------------------------------------------------------------
// <copyright file="NamespaceExposeDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    /// for the <see cref="INamespaceExpose"/> interface
    /// </summary>
    internal static class NamespaceExposeDeSerializer
    {
        ...
        internal static INamespaceExpose DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.NamespaceExpose();
            ...
            {
                logger.LogDebug($"the aliasIds Json property was not found in the NamespaceExpose: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredName Json property was not found in the NamespaceExpose: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the declaredShortName Json property was not found in the NamespaceExpose: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the elementId Json property was not found in the NamespaceExpose: {dtoInstance.Id}");
            }
            ...
            if (jsonElement.TryGetProperty("importedNamespace"u8, out JsonElement importedNamespaceProperty))
            {
                ...
                {
                    if (importedNamespaceProperty.TryGetProperty("@id"u8, out JsonElement importedNamespaceIdProperty))
                    {
            ...
            {
                logger.LogDebug($"the importedNamespace Json property was not found in the NamespaceExpose: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImplied Json property was not found in the NamespaceExpose: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImpliedIncluded Json property was not found in the NamespaceExpose: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isImportAll Json property was not found in the NamespaceExpose: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isRecursive Json property was not found in the NamespaceExpose: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelatedElement Json property was not found in the NamespaceExpose: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the ownedRelationship Json property was not found in the NamespaceExpose: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelatedElement Json property was not found in the NamespaceExpose: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the owningRelationship Json property was not found in the NamespaceExpose: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the source Json property was not found in the NamespaceExpose: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the target Json property was not found in the NamespaceExpose: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the visibility Json property was not found in the NamespaceExpose: {dtoInstance.Id}");
            }
