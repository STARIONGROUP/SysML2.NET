...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class NamespaceExposeDeSerializer
    {
        ...
        internal static INamespaceExpose DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            INamespaceExpose dtoInstance = new SysML2.NET.Core.DTO.Systems.Views.NamespaceExpose();
            ...
            {
                logger.LogDebug("the source Json property was not found in the NamespaceExpose: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the target Json property was not found in the NamespaceExpose: { Id }", dtoInstance.Id);
            }
