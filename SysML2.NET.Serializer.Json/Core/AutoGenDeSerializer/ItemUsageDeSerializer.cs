...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IItemUsage"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IItemUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the ItemUsageDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "ItemUsage")
            {
                throw new InvalidOperationException($"The ItemUsageDeSerializer can only be used to deserialize objects of type IItemUsage, a {@type.GetString()} was provided");
            }
            ...
            {
                logger.LogDebug("the definition Json property was not found in the ItemUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isVariable Json property was not found in the ItemUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the type Json property was not found in the ItemUsage: { Id }", dtoInstance.Id);
            }
