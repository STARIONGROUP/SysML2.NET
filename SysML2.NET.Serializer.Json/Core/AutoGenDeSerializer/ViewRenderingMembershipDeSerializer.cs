...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class ViewRenderingMembershipDeSerializer
    {
        ...
        internal static IViewRenderingMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug("the memberElement Json property was not found in the ViewRenderingMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the memberElementId Json property was not found in the ViewRenderingMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the memberName Json property was not found in the ViewRenderingMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("membershipOwningNamespace"u8, out var membershipOwningNamespaceProperty))
            {
                if (membershipOwningNamespaceProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the ViewRenderingMembership.membershipOwningNamespace property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the membershipOwningNamespace Json property was not found in the ViewRenderingMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the memberShortName Json property was not found in the ViewRenderingMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("ownedMemberElement"u8, out var ownedMemberElementProperty))
            {
                if (ownedMemberElementProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the ViewRenderingMembership.ownedMemberElement property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the ownedMemberElement Json property was not found in the ViewRenderingMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("ownedMemberFeature"u8, out var ownedMemberFeatureProperty))
            {
                if (ownedMemberFeatureProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the ViewRenderingMembership.ownedMemberFeature property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the ownedMemberFeature Json property was not found in the ViewRenderingMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                if (ownedRenderingProperty.ValueKind == JsonValueKind.Null)
                {
                ...
                {
                    if (ownedRenderingProperty.TryGetProperty("@id"u8, out var ownedRenderingExternalIdProperty))
                    {
                        var propertyValue = ownedRenderingExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.ownedRendering = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
            ...
            if (jsonElement.TryGetProperty("referencedRendering"u8, out var referencedRenderingProperty))
            {
                if (referencedRenderingProperty.ValueKind == JsonValueKind.Null)
                {
                ...
                {
                    if (referencedRenderingProperty.TryGetProperty("@id"u8, out var referencedRenderingExternalIdProperty))
                    {
                        var propertyValue = referencedRenderingExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.referencedRendering = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the source Json property was not found in the ViewRenderingMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the target Json property was not found in the ViewRenderingMembership: { Id }", dtoInstance.Id);
            }
