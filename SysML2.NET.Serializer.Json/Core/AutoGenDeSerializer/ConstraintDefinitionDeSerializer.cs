...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IConstraintDefinition"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IConstraintDefinition DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the ConstraintDefinitionDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "ConstraintDefinition")
            {
            ...
            {
                logger.LogDebug("the directedFeature Json property was not found in the ConstraintDefinition: { Id }", dtoInstance.Id);
            }
