// -------------------------------------------------------------------------------------------------
// <copyright file="OperatorExpressionDeSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class OperatorExpressionDeSerializer
    {
        ...
        internal static IOperatorExpression DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug($"the isReadOnly Json property was not found in the OperatorExpression: {dtoInstance.Id}");
            }
