// -------------------------------------------------------------------------------------------------
// <copyright file="SuccessionAsUsageDeSerializer.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class SuccessionAsUsageDeSerializer
    {
        ...
        internal static ISuccessionAsUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug($"the isDirected Json property was not found in the SuccessionAsUsage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isReadOnly Json property was not found in the SuccessionAsUsage: {dtoInstance.Id}");
            }
