...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="ISuccessionAsUsage"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static ISuccessionAsUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the SuccessionAsUsageDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "SuccessionAsUsage")
            {
                throw new InvalidOperationException($"The SuccessionAsUsageDeSerializer can only be used to deserialize objects of type ISuccessionAsUsage, a {@type.GetString()} was provided");
            }
            ...
            {
                logger.LogDebug("the endFeature Json property was not found in the SuccessionAsUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isVariable Json property was not found in the SuccessionAsUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the relatedElement Json property was not found in the SuccessionAsUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the source Json property was not found in the SuccessionAsUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the target Json property was not found in the SuccessionAsUsage: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the type Json property was not found in the SuccessionAsUsage: { Id }", dtoInstance.Id);
            }
