...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="ISendActionUsage"/> from the provided <see cref="Utf8JsonReader"/>
        /// </summary>
        /// <param name="reader">
        /// The <see cref="Utf8JsonReader"/> positioned on the <see cref="JsonTokenType.StartObject"/> of the
        /// <see cref="ISendActionUsage"/> json object. On return the reader is positioned on the matching
        ...
        /// </remarks>
        internal static ISendActionUsage DeSerialize(ref Utf8JsonReader reader, SerializationModeKind serializationModeKind, bool deserializeDerivedProperties, ILoggerFactory loggerFactory = null)
        {
        ...
        /// <summary>
        /// Deserializes properties of a <see cref="SysML2.NET.Core.DTO.Systems.Actions.SendActionUsage" />
        /// from a <see cref="Utf8JsonReader" />, including derived properties
        /// </summary>
        /// <param name="dtoInstance">
        /// The <see cref="SysML2.NET.Core.DTO.Systems.Actions.SendActionUsage"/> instance holding deserialized values
        /// </param>
        /// <param name="reader">
        /// The <see cref="Utf8JsonReader"/> positioned on the <see cref="JsonTokenType.StartObject"/> of the
        /// <see cref="ISendActionUsage"/> json object
        /// </param>
        /// <param name="logger">
        /// The <see cref="ILogger"/> to produce logging statement
        /// </param>
        private static void DeserializeDtoIncludingDerivedProperties(SysML2.NET.Core.DTO.Systems.Actions.SendActionUsage dtoInstance, ref Utf8JsonReader reader, ILogger logger)
        {
            ...
            var payloadArgumentSeen = false;
            var portionKindSeen = false;
            var qualifiedNameSeen = false;
            var receiverArgumentSeen = false;
            var senderArgumentSeen = false;
            ...
            while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
            {
                ...
                {
                    throw new JsonException("Expected a property name in the SendActionUsage json object.");
                }
                ...
                if (reader.ValueTextEquals("payloadArgument"u8))
                {
                    payloadArgumentSeen = true;
                    reader.Read();

                    if (reader.TokenType == JsonTokenType.Null)
                    {
                        dtoInstance.payloadArgument = null;
                    }
                    else if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var payloadArgumentValue))
                    {
                        dtoInstance.payloadArgument = payloadArgumentValue;
                    }
                ...
                if (reader.ValueTextEquals("receiverArgument"u8))
                {
                    receiverArgumentSeen = true;
                    reader.Read();
                    ...
                    else if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var receiverArgumentValue))
                    {
                        dtoInstance.receiverArgument = receiverArgumentValue;
                    }

                    continue;
                }

                if (reader.ValueTextEquals("senderArgument"u8))
                {
                    senderArgumentSeen = true;
                    reader.Read();
                    ...
                    else if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var senderArgumentValue))
                    {
                        dtoInstance.senderArgument = senderArgumentValue;
                    }
        ...
        /// The <see cref="ILogger"/> to produce logging statement
        /// </param>
        private static void DeserializeDtoExcludingDerivedProperties(SysML2.NET.Core.DTO.Systems.Actions.SendActionUsage dtoInstance, ref Utf8JsonReader reader, ILogger logger)
        {
            var aliasIdsSeen = false;
            var declaredNameSeen = false;
            var declaredShortNameSeen = false;
