// -------------------------------------------------------------------------------------------------
// <copyright file="SubjectMembershipDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="SubjectMembershipDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="ISubjectMembership"/> interface
    /// </summary>
    internal static class SubjectMembershipDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="ISubjectMembership"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static ISubjectMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the SubjectMembershipDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "SubjectMembership")
            {
                throw new InvalidOperationException($"The SubjectMembershipDeSerializer can only be used to deserialize objects of type ISubjectMembership, a {@type.GetString()} was provided");
            }

            var dtoInstance = new SysML2.NET.Core.DTO.Systems.Requirements.SubjectMembership();
            ...
            if (jsonElement.TryGetProperty("@id"u8, out var idProperty))
            {
                ...
                {
                    throw new JsonException("The @id property is not present, the SubjectMembership cannot be deserialized");
                }
                else
                {
            ...
            {
                logger.LogDebug("the documentation Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isLibraryElement Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("memberElement"u8, out var memberElementProperty))
            {
                if (memberElementProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the SubjectMembership.MemberElement property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the memberElement Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the memberElementId Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the memberName Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("membershipOwningNamespace"u8, out var membershipOwningNamespaceProperty))
            {
                if (membershipOwningNamespaceProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the SubjectMembership.membershipOwningNamespace property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the membershipOwningNamespace Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the memberShortName Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the name Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedAnnotation Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedElement Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("ownedMemberElement"u8, out var ownedMemberElementProperty))
            {
                if (ownedMemberElementProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the SubjectMembership.ownedMemberElement property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the ownedMemberElement Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedMemberElementId Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("ownedMemberFeature"u8, out var ownedMemberFeatureProperty))
            {
                if (ownedMemberFeatureProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the SubjectMembership.ownedMemberFeature property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the ownedMemberFeature Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedMemberName Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("ownedMemberParameter"u8, out var ownedMemberParameterProperty))
            {
                if (ownedMemberParameterProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the SubjectMembership.ownedMemberParameter property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the ownedMemberParameter Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedMemberShortName Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("ownedSubjectParameter"u8, out var ownedSubjectParameterProperty))
            {
                if (ownedSubjectParameterProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.ownedSubjectParameter = Guid.Empty;
                    logger.LogDebug($"the SubjectMembership.ownedSubjectParameter property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
                    if (ownedSubjectParameterProperty.TryGetProperty("@id"u8, out var ownedSubjectParameterExternalIdProperty))
                    {
                        var propertyValue = ownedSubjectParameterExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.ownedSubjectParameter = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the ownedSubjectParameter Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owner Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningMembership Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningNamespace Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("owningType"u8, out var owningTypeProperty))
            {
                if (owningTypeProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the SubjectMembership.owningType property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the owningType Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the qualifiedName Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the relatedElement Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the shortName Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the source Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the target Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the textualRepresentation Json property was not found in the SubjectMembership: { Id }", dtoInstance.Id);
            }
