// -------------------------------------------------------------------------------------------------
// <copyright file="StakeholderMembershipDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    /// <summary>
    /// The purpose of the <see cref="StakeholderMembershipDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="IStakeholderMembership"/> interface
    /// </summary>
    internal static class StakeholderMembershipDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="IStakeholderMembership"/> from the provided <see cref="JsonElement"/>
        /// </summary>
        ...
        internal static IStakeholderMembership DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                throw new InvalidOperationException("The @type property is not available, the StakeholderMembershipDeSerializer cannot be used to deserialize this JsonElement");
            }

            if (@type.GetString() != "StakeholderMembership")
            {
                throw new InvalidOperationException($"The StakeholderMembershipDeSerializer can only be used to deserialize objects of type IStakeholderMembership, a {@type.GetString()} was provided");
            }

            var dtoInstance = new SysML2.NET.Core.DTO.Systems.Requirements.StakeholderMembership();
            ...
            if (jsonElement.TryGetProperty("@id"u8, out var idProperty))
            {
                ...
                {
                    throw new JsonException("The @id property is not present, the StakeholderMembership cannot be deserialized");
                }
                else
                {
            ...
            {
                logger.LogDebug("the documentation Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the isLibraryElement Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("memberElement"u8, out var memberElementProperty))
            {
                if (memberElementProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the StakeholderMembership.MemberElement property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the memberElement Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the memberElementId Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the memberName Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("membershipOwningNamespace"u8, out var membershipOwningNamespaceProperty))
            {
                if (membershipOwningNamespaceProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the StakeholderMembership.membershipOwningNamespace property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the membershipOwningNamespace Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the memberShortName Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the name Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedAnnotation Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedElement Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("ownedMemberElement"u8, out var ownedMemberElementProperty))
            {
                if (ownedMemberElementProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the StakeholderMembership.ownedMemberElement property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the ownedMemberElement Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedMemberElementId Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("ownedMemberFeature"u8, out var ownedMemberFeatureProperty))
            {
                if (ownedMemberFeatureProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the StakeholderMembership.ownedMemberFeature property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the ownedMemberFeature Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedMemberName Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }

            if (jsonElement.TryGetProperty("ownedMemberParameter"u8, out var ownedMemberParameterProperty))
            {
                if (ownedMemberParameterProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.ownedMemberParameter = Guid.Empty;
                    logger.LogDebug($"the StakeholderMembership.ownedMemberParameter property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
                    if (ownedMemberParameterProperty.TryGetProperty("@id"u8, out var ownedMemberParameterExternalIdProperty))
                    {
                        var propertyValue = ownedMemberParameterExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.ownedMemberParameter = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the ownedMemberParameter Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the ownedMemberShortName Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("ownedStakeholderParameter"u8, out var ownedStakeholderParameterProperty))
            {
                if (ownedStakeholderParameterProperty.ValueKind == JsonValueKind.Null)
                {
                    dtoInstance.ownedStakeholderParameter = Guid.Empty;
                    logger.LogDebug($"the StakeholderMembership.ownedStakeholderParameter property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
                    if (ownedStakeholderParameterProperty.TryGetProperty("@id"u8, out var ownedStakeholderParameterExternalIdProperty))
                    {
                        var propertyValue = ownedStakeholderParameterExternalIdProperty.GetString();

                        if (propertyValue != null)
                        {
                            dtoInstance.ownedStakeholderParameter = Guid.Parse(propertyValue);
                        }
                    }
                }
            }
            ...
            {
                logger.LogDebug("the ownedStakeholderParameter Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owner Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningMembership Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the owningNamespace Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            if (jsonElement.TryGetProperty("owningType"u8, out var owningTypeProperty))
            {
                if (owningTypeProperty.ValueKind == JsonValueKind.Null)
                {
                    ...
                    logger.LogDebug($"the StakeholderMembership.owningType property was not found in the Json. The value is set to Guid.Empty");
                }
                else
                {
            ...
            {
                logger.LogDebug("the owningType Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the qualifiedName Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the relatedElement Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the shortName Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the source Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the target Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the textualRepresentation Json property was not found in the StakeholderMembership: { Id }", dtoInstance.Id);
            }
