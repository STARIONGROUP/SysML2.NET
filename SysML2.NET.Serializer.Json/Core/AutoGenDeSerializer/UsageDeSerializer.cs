...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class UsageDeSerializer
    {
        ...
        internal static IUsage DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.Usage();
            ...
            {
                logger.LogDebug($"the isConstant Json property was not found in the Usage: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isVariable Json property was not found in the Usage: {dtoInstance.Id}");
            }
