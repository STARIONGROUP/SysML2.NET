...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class SerializationProvider
    {
        private static readonly Dictionary<System.Type, Action<object, Utf8JsonWriter, SerializationModeKind>> SerializerActionMap = new Dictionary<System.Type, Action<object, Utf8JsonWriter, SerializationModeKind>>
        {
            ...
            { typeof(Core.DTO.MembershipExpose), MembershipExposeSerializer.Serialize },
            { typeof(Core.DTO.MembershipImport), MembershipImportSerializer.Serialize },
            ...
            { typeof(Core.DTO.NamespaceExpose), NamespaceExposeSerializer.Serialize },
            { typeof(Core.DTO.NamespaceImport), NamespaceImportSerializer.Serialize },
