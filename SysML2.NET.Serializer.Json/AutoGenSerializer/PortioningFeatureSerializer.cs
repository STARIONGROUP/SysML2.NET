...
namespace SysML2.NET.Serializer.Json
{
    ...
    internal static class PortioningFeatureSerializer
    {
        ...
        {
            if (!(obj is IPortioningFeature iPortioningFeature))
            {
                throw new ArgumentException("The object shall be an IPortioningFeature", nameof(obj));
            }
            ...
            writer.WriteStringValue(iPortioningFeature.DeclaredName);
            writer.WritePropertyName("declaredShortName");
            writer.WriteStringValue(iPortioningFeature.DeclaredShortName);
            writer.WritePropertyName("direction");
            if (iPortioningFeature.Direction.HasValue)
            {
                writer.WriteStringValue(iPortioningFeature.Direction.Value.ToString().ToLower());
            }
            else
            {
            ...
            writer.WriteBooleanValue(iPortioningFeature.IsImpliedIncluded);
