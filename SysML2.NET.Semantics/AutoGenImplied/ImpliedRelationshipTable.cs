...
namespace SysML2.NET.Semantics.Implied
{
    ...
    public static class ImpliedRelationshipTable
    {
        ...
        [
            ...
            new("checkFeaturePortionSpecialization", "Occurrence::Occurrence::portions", "Feature", true),
            new("checkFeatureSpecialization", "Base::things", "Feature", false),
            new("checkFeatureSubobjectSpecialization", "Occurrence::Occurrence::suboccurrences", "Feature", true),
            new("checkFeatureSuboccurrenceSpecialization", "Occurrence::Occurrence::suboccurrences", "Feature", true),
            ...
            new("checkStepEnclosedPerformanceSpecialization", "Performances::Performance::enclosedPerformance", "Step", true),
            new("checkStepOwnedPerformanceSpecialization", "Objects::Object::ownedPerformance", "Step", true),
            new("checkStepSpecialization", "Performances::performances", "Step", false),
            new("checkStepSubperformanceSpecialization", "Performances::Performance::subperformance", "Step", true),
        ...
        [
            ...
            new("checkItemUsageSubitemSpecialization", "Items::Item::subitem", "ItemUsage", true),
            new("checkOccurrenceUsageSnapshotSpecialization", "Occurrences::Occurrence::snapshots", "OccurrenceUsage", true),
            new("checkOccurrenceUsageSpecialization", "Occurrences::occurrences", "OccurrenceUsage", false),
            new("checkOccurrenceUsageSuboccurrenceSpecialization", "Occurrences::Occurrence::suboccurrences", "OccurrenceUsage", true),
            new("checkOccurrenceUsageTimeSliceSpecialization", "Occurrences::Occurrence::timeSlices", "OccurrenceUsage", true),
        ...
        [
            ...
            new("checkActionUsageSpecialization", "Actions::actions", "ActionUsage", false),
            new("checkActionUsageSubactionSpecialization", "Actions::Action::subactions", "ActionUsage", true),
            new("checkControlNodeSpecialization", "Action::Action::controls", "ControlNode", false),
        ...
        [
            ...
            new("checkFeatureSubobjectSpecialization", "Occurrence::Occurrence::suboccurrences", "Feature", true),
            new("checkFeatureSuboccurrenceSpecialization", "Occurrence::Occurrence::suboccurrences", "Feature", true),
            new("checkJoinNodeSpecialization", "Actions::Action::join", "JoinNode", false),
            new("checkOccurrenceUsageSnapshotSpecialization", "Occurrences::Occurrence::snapshots", "OccurrenceUsage", true),
            new("checkOccurrenceUsageSpecialization", "Occurrences::occurrences", "OccurrenceUsage", false),
            new("checkOccurrenceUsageSuboccurrenceSpecialization", "Occurrences::Occurrence::suboccurrences", "OccurrenceUsage", true),
            new("checkOccurrenceUsageTimeSliceSpecialization", "Occurrences::Occurrence::timeSlices", "OccurrenceUsage", true),
