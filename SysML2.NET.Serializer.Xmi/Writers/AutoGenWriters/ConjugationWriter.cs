...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class ConjugationWriter : XmiDataWriter<IConjugation>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IConjugation poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IConjugation poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (poco.OriginalType != null)
            {
                await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.OriginalType, "originalType", elementOriginMap, currentFileUri);
            }
