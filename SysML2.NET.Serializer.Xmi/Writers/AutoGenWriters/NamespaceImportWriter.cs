...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class NamespaceImportWriter : XmiDataWriter<INamespaceImport>
    {
        ...
        public override void Write(XmlWriter xmlWriter, INamespaceImport poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, INamespaceImport poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
