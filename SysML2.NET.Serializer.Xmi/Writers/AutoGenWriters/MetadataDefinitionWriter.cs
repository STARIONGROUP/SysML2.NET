...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class MetadataDefinitionWriter : XmiDataWriter<IMetadataDefinition>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IMetadataDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IMetadataDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
