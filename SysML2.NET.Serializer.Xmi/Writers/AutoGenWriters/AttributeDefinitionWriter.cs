...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class AttributeDefinitionWriter : XmiDataWriter<IAttributeDefinition>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IAttributeDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IAttributeDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
