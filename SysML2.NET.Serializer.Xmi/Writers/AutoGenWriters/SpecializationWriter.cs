...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class SpecializationWriter : XmiDataWriter<ISpecialization>
    {
        ...
        public override void Write(XmlWriter xmlWriter, ISpecialization poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, ISpecialization poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (poco.General != null)
            {
                await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.General, "general", elementOriginMap, currentFileUri);
            }
            ...
            if (poco.Specific != null)
            {
                await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.Specific, "specific", elementOriginMap, currentFileUri);
            }
