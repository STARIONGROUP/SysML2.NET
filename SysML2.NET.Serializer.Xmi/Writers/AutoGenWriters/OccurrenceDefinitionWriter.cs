...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class OccurrenceDefinitionWriter : XmiDataWriter<IOccurrenceDefinition>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IOccurrenceDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IOccurrenceDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
