...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public static class CommentWriter
    {
        ...
        public static void Write(XmlWriter xmlWriter, IComment poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
