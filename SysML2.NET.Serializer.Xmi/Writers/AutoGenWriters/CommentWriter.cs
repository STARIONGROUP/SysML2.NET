...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class CommentWriter : XmiDataWriter<IComment>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IComment poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IComment poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
