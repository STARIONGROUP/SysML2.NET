...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    /// to the XMI document
    /// </summary>
    public static class FeatureValueWriter
    {
        /// <summary>
        ...
        public static void Write(XmlWriter xmlWriter, IFeatureValue poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                ...
                {
                    xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.featureWithValue, "featureWithValue", elementOriginMap, currentFileUri);
                }
                ...
                if (poco.value != null)
                {
                    xmiWriterFacade.WriteContainedElement(xmlWriter, (IData)poco.value, "value", includeDerivedProperties, elementOriginMap, currentFileUri);
                }
            }
