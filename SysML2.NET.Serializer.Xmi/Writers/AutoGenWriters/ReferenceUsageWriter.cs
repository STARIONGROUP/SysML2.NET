...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class ReferenceUsageWriter : XmiDataWriter<IReferenceUsage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IReferenceUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IReferenceUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
