...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class BooleanExpressionWriter : XmiDataWriter<IBooleanExpression>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IBooleanExpression poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IBooleanExpression poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.predicate != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.predicate, "predicate", elementOriginMap, currentFileUri);
                }
            }
