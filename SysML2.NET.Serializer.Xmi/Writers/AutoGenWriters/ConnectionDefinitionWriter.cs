...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class ConnectionDefinitionWriter : XmiDataWriter<IConnectionDefinition>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IConnectionDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IConnectionDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
