...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class MetadataFeatureWriter : XmiDataWriter<IMetadataFeature>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IMetadataFeature poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IMetadataFeature poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.metaclass != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.metaclass, "metaclass", elementOriginMap, currentFileUri);
                }
            }
