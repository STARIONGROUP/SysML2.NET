...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    /// to the XMI document
    /// </summary>
    public static class AllocationUsageWriter
    {
        /// <summary>
        ...
        public static void Write(XmlWriter xmlWriter, IAllocationUsage poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.allocationDefinition != null)
                {
                    ...
                    {
                        xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)item, "allocationDefinition", elementOriginMap, currentFileUri);
                    }
                }
                ...
                if (poco.partDefinition != null)
                {
                    ...
                    {
                        xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)item, "partDefinition", elementOriginMap, currentFileUri);
                    }
                }
