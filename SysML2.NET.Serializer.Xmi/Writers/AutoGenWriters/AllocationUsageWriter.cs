...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class AllocationUsageWriter : XmiDataWriter<IAllocationUsage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IAllocationUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IAllocationUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.allocationDefinition != null)
                {
                    foreach (var item in poco.allocationDefinition)
                    {
                        await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)item, "allocationDefinition", elementOriginMap, currentFileUri);
                    }
                }
            }
            ...
            if (includeDerivedProperties)
            {
                if (poco.itemDefinition != null)
                {
                    foreach (var item in poco.itemDefinition)
                    {
                        await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)item, "itemDefinition", elementOriginMap, currentFileUri);
                    }
                }
            }
            ...
            if (includeDerivedProperties)
            {
                if (poco.partDefinition != null)
                {
                    foreach (var item in poco.partDefinition)
                    {
                        await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)item, "partDefinition", elementOriginMap, currentFileUri);
                    }
                }
            }
