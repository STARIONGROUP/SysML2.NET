...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class ViewpointDefinitionWriter : XmiDataWriter<IViewpointDefinition>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IViewpointDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IViewpointDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
