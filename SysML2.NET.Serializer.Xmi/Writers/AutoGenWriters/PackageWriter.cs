...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public static class PackageWriter
    {
        ...
        public static void Write(XmlWriter xmlWriter, IPackage poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                ...
                if (poco.filterCondition != null)
                {
                    ...
                    {
                        xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)item, "filterCondition", elementOriginMap, currentFileUri);
                    }
                }
