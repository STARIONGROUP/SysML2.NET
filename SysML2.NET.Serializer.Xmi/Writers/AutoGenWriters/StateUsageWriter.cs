...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class StateUsageWriter : XmiDataWriter<IStateUsage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IStateUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IStateUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
