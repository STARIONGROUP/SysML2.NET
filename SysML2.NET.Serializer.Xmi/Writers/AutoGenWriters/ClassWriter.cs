...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public static class ClassWriter
    {
        ...
        public static void Write(XmlWriter xmlWriter, IClass poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
