...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class ClassWriter : XmiDataWriter<IClass>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IClass poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IClass poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
