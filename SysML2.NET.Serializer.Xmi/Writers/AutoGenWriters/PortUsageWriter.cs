...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class PortUsageWriter : XmiDataWriter<IPortUsage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IPortUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IPortUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.portDefinition != null)
                {
                    foreach (var item in poco.portDefinition)
                    {
                        await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)item, "portDefinition", elementOriginMap, currentFileUri);
                    }
                }
            }
