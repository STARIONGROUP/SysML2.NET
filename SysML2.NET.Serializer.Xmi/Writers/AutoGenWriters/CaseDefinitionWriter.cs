...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class CaseDefinitionWriter : XmiDataWriter<ICaseDefinition>
    {
        ...
        public override void Write(XmlWriter xmlWriter, ICaseDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, ICaseDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
