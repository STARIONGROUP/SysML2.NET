...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class InterfaceUsageWriter : XmiDataWriter<IInterfaceUsage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IInterfaceUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IInterfaceUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.interfaceDefinition != null)
                {
                    foreach (var item in poco.interfaceDefinition)
                    {
                        await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)item, "interfaceDefinition", elementOriginMap, currentFileUri);
                    }
                }
            }
