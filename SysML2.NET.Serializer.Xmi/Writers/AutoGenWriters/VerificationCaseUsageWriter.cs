...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class VerificationCaseUsageWriter : XmiDataWriter<IVerificationCaseUsage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IVerificationCaseUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IVerificationCaseUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.verificationCaseDefinition != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.verificationCaseDefinition, "verificationCaseDefinition", elementOriginMap, currentFileUri);
                }
            }
            ...
            if (includeDerivedProperties)
            {
                if (poco.verifiedRequirement != null)
                {
                    foreach (var item in poco.verifiedRequirement)
                    {
                        await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)item, "verifiedRequirement", elementOriginMap, currentFileUri);
                    }
                }
            }
