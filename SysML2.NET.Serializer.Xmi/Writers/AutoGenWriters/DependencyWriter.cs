...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    /// to the XMI document
    /// </summary>
    public class DependencyWriter : XmiDataWriter<IDependency>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DependencyWriter" />
        /// </summary>
        ...
        public DependencyWriter(IXmiDataWriterFacade xmiDataWriterFacade, ILoggerFactory loggerFactory) : base(xmiDataWriterFacade, loggerFactory)
        {
        ...
        /// <param name="poco">The <see cref="IDependency" /> to write</param>
        ...
        public override void Write(XmlWriter xmlWriter, IDependency poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            xmlWriter.WriteStartElement(elementName);
            xmlWriter.WriteAttributeString("xsi", "type", null, "sysml:Dependency");
            ...
            if (poco.Client != null)
            {
                foreach (var item in poco.Client)
                {
                    this.XmiDataWriterFacade.WriteReferenceElement(xmlWriter, (IData)item, "client", elementOriginMap, currentFileUri);
                }
            }
            ...
            if (poco.Supplier != null)
            {
                foreach (var item in poco.Supplier)
                {
                    this.XmiDataWriterFacade.WriteReferenceElement(xmlWriter, (IData)item, "supplier", elementOriginMap, currentFileUri);
                }
            }
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IDependency poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            await xmlWriter.WriteStartElementAsync(null, elementName, null);
            await xmlWriter.WriteAttributeStringAsync("xsi", "type", null, "sysml:Dependency");
            ...
            if (poco.Client != null)
            {
                foreach (var item in poco.Client)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)item, "client", elementOriginMap, currentFileUri);
                }
            }
            ...
            if (poco.Supplier != null)
            {
                foreach (var item in poco.Supplier)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)item, "supplier", elementOriginMap, currentFileUri);
                }
            }
