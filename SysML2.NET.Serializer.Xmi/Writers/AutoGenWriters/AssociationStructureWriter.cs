...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class AssociationStructureWriter : XmiDataWriter<IAssociationStructure>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IAssociationStructure poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IAssociationStructure poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
