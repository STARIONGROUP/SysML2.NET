...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class OccurrenceUsageWriter : XmiDataWriter<IOccurrenceUsage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IOccurrenceUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IOccurrenceUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
