...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class ParameterMembershipWriter : XmiDataWriter<IParameterMembership>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IParameterMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IParameterMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
