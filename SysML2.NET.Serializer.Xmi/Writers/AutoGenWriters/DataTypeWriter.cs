...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class DataTypeWriter : XmiDataWriter<IDataType>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IDataType poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IDataType poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
