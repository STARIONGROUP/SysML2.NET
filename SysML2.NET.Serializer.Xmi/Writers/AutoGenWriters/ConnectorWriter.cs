...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class ConnectorWriter : XmiDataWriter<IConnector>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IConnector poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IConnector poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
