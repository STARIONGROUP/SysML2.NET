...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class PartDefinitionWriter : XmiDataWriter<IPartDefinition>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IPartDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IPartDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
