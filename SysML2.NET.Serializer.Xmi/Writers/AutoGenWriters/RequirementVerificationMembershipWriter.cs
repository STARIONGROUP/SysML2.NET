...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class RequirementVerificationMembershipWriter : XmiDataWriter<IRequirementVerificationMembership>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IRequirementVerificationMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            xmlWriter.WriteAttributeString("kind", poco.Kind.ToString());
            ...
            if (includeDerivedProperties)
            {
                ...
                {
                    this.XmiDataWriterFacade.WriteContainedElement(xmlWriter, (IData)poco.ownedRequirement, "ownedRequirement", includeDerivedProperties, includesImplied, elementOriginMap, currentFileUri);
                }
            }
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IRequirementVerificationMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            await xmlWriter.WriteAttributeStringAsync(null, "kind", null, poco.Kind.ToString());
            ...
            if (includeDerivedProperties)
            {
                if (poco.ownedRequirement != null)
                {
                    await this.XmiDataWriterFacade.WriteContainedElementAsync(xmlWriter, (IData)poco.ownedRequirement, "ownedRequirement", includeDerivedProperties, includesImplied, elementOriginMap, currentFileUri);
                }
            }
            ...
            if (includeDerivedProperties)
            {
                if (poco.verifiedRequirement != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.verifiedRequirement, "verifiedRequirement", elementOriginMap, currentFileUri);
                }
            }
