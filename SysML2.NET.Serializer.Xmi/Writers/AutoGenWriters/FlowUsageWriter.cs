...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class FlowUsageWriter : XmiDataWriter<IFlowUsage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IFlowUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IFlowUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
