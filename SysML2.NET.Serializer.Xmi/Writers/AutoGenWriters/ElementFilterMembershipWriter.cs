...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    /// to the XMI document
    /// </summary>
    public static class ElementFilterMembershipWriter
    {
        /// <summary>
        ...
        public static void Write(XmlWriter xmlWriter, IElementFilterMembership poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                ...
                {
                    xmiWriterFacade.WriteContainedElement(xmlWriter, (IData)poco.condition, "condition", includeDerivedProperties, elementOriginMap, currentFileUri);
                }
