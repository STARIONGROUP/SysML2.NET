...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class DifferencingWriter : XmiDataWriter<IDifferencing>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IDifferencing poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.typeDifferenced != null)
                {
                    this.XmiDataWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.typeDifferenced, "typeDifferenced", elementOriginMap, currentFileUri);
                }
            }
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IDifferencing poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (poco.DifferencingType != null)
            {
                await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.DifferencingType, "differencingType", elementOriginMap, currentFileUri);
            }
            ...
            if (includeDerivedProperties)
            {
                if (poco.typeDifferenced != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.typeDifferenced, "typeDifferenced", elementOriginMap, currentFileUri);
                }
            }
