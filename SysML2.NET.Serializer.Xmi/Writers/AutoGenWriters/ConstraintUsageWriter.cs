...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class ConstraintUsageWriter : XmiDataWriter<IConstraintUsage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IConstraintUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IConstraintUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
