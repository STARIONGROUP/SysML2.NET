...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class InvariantWriter : XmiDataWriter<IInvariant>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IInvariant poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IInvariant poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
