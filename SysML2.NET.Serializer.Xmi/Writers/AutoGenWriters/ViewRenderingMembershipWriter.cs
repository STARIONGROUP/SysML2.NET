...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class ViewRenderingMembershipWriter : XmiDataWriter<IViewRenderingMembership>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IViewRenderingMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                ...
                {
                    this.XmiDataWriterFacade.WriteContainedElement(xmlWriter, (IData)poco.ownedRendering, "ownedRendering", includeDerivedProperties, includesImplied, elementOriginMap, currentFileUri);
                }
            }
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IViewRenderingMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.ownedRendering != null)
                {
                    await this.XmiDataWriterFacade.WriteContainedElementAsync(xmlWriter, (IData)poco.ownedRendering, "ownedRendering", includeDerivedProperties, includesImplied, elementOriginMap, currentFileUri);
                }
            }
            ...
            if (includeDerivedProperties)
            {
                if (poco.referencedRendering != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.referencedRendering, "referencedRendering", elementOriginMap, currentFileUri);
                }
            }
