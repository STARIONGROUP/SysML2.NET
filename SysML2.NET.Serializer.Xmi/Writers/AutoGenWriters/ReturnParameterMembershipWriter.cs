...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    /// to the XMI document
    /// </summary>
    public static class ReturnParameterMembershipWriter
    {
        /// <summary>
        ...
        public static void Write(XmlWriter xmlWriter, IReturnParameterMembership poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
