...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class UseCaseUsageWriter : XmiDataWriter<IUseCaseUsage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IUseCaseUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IUseCaseUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
