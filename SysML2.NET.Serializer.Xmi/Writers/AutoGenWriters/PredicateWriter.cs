...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public static class PredicateWriter
    {
        ...
        public static void Write(XmlWriter xmlWriter, IPredicate poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
