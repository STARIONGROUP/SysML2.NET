...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class MetadataAccessExpressionWriter : XmiDataWriter<IMetadataAccessExpression>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IMetadataAccessExpression poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                ...
                {
                    this.XmiDataWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.referencedElement, "referencedElement", elementOriginMap, currentFileUri);
                }
            }
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IMetadataAccessExpression poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.referencedElement != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.referencedElement, "referencedElement", elementOriginMap, currentFileUri);
                }
            }
