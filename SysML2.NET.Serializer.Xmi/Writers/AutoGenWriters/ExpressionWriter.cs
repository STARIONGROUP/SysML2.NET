...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public static class ExpressionWriter
    {
        ...
        public static void Write(XmlWriter xmlWriter, IExpression poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
