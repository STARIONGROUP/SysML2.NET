...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class ConstraintDefinitionWriter : XmiDataWriter<IConstraintDefinition>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IConstraintDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IConstraintDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
