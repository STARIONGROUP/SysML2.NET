...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public static class FeatureWriter
    {
        ...
        public static void Write(XmlWriter xmlWriter, IFeature poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
