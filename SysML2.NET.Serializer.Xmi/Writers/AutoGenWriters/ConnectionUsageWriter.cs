...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class ConnectionUsageWriter : XmiDataWriter<IConnectionUsage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IConnectionUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IConnectionUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.connectionDefinition != null)
                {
                    foreach (var item in poco.connectionDefinition)
                    {
                        await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)item, "connectionDefinition", elementOriginMap, currentFileUri);
                    }
                }
            }
