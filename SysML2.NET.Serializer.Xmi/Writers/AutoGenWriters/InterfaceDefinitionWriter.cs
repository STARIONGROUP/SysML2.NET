...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class InterfaceDefinitionWriter : XmiDataWriter<IInterfaceDefinition>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IInterfaceDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IInterfaceDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.interfaceEnd != null)
                {
                    foreach (var item in poco.interfaceEnd)
                    {
                        await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)item, "interfaceEnd", elementOriginMap, currentFileUri);
                    }
                }
            }
