...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class UnioningWriter : XmiDataWriter<IUnioning>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IUnioning poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.typeUnioned != null)
                {
                    this.XmiDataWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.typeUnioned, "typeUnioned", elementOriginMap, currentFileUri);
                }
            }
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IUnioning poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.typeUnioned != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.typeUnioned, "typeUnioned", elementOriginMap, currentFileUri);
                }
            }

            if (poco.UnioningType != null)
            {
                await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.UnioningType, "unioningType", elementOriginMap, currentFileUri);
            }
