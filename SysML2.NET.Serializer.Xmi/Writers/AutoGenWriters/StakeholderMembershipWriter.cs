...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    /// to the XMI document
    /// </summary>
    public static class StakeholderMembershipWriter
    {
        /// <summary>
        ...
        public static void Write(XmlWriter xmlWriter, IStakeholderMembership poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                ...
                {
                    xmiWriterFacade.WriteContainedElement(xmlWriter, (IData)poco.ownedStakeholderParameter, "ownedStakeholderParameter", includeDerivedProperties, elementOriginMap, currentFileUri);
                }
                if (poco.owner != null)
                {
