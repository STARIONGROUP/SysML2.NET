...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class StakeholderMembershipWriter : XmiDataWriter<IStakeholderMembership>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IStakeholderMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                ...
                {
                    this.XmiDataWriterFacade.WriteContainedElement(xmlWriter, (IData)poco.ownedStakeholderParameter, "ownedStakeholderParameter", includeDerivedProperties, includesImplied, elementOriginMap, currentFileUri);
                }
            }
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IStakeholderMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.ownedStakeholderParameter != null)
                {
                    await this.XmiDataWriterFacade.WriteContainedElementAsync(xmlWriter, (IData)poco.ownedStakeholderParameter, "ownedStakeholderParameter", includeDerivedProperties, includesImplied, elementOriginMap, currentFileUri);
                }
            }
