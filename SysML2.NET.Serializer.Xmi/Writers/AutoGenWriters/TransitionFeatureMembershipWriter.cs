...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    /// to the XMI document
    /// </summary>
    public static class TransitionFeatureMembershipWriter
    {
        /// <summary>
        ...
        public static void Write(XmlWriter xmlWriter, ITransitionFeatureMembership poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                ...
                {
                    xmiWriterFacade.WriteContainedElement(xmlWriter, (IData)poco.transitionFeature, "transitionFeature", includeDerivedProperties, elementOriginMap, currentFileUri);
                }
            }
