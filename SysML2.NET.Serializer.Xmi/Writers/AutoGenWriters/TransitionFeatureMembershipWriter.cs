...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class TransitionFeatureMembershipWriter : XmiDataWriter<ITransitionFeatureMembership>
    {
        ...
        public override void Write(XmlWriter xmlWriter, ITransitionFeatureMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                ...
                {
                    this.XmiDataWriterFacade.WriteContainedElement(xmlWriter, (IData)poco.transitionFeature, "transitionFeature", includeDerivedProperties, includesImplied, elementOriginMap, currentFileUri);
                }
            }
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, ITransitionFeatureMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.transitionFeature != null)
                {
                    await this.XmiDataWriterFacade.WriteContainedElementAsync(xmlWriter, (IData)poco.transitionFeature, "transitionFeature", includeDerivedProperties, includesImplied, elementOriginMap, currentFileUri);
                }
            }
