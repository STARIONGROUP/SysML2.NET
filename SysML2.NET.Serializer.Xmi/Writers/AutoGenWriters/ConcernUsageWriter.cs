...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class ConcernUsageWriter : XmiDataWriter<IConcernUsage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IConcernUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IConcernUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.concernDefinition != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.concernDefinition, "concernDefinition", elementOriginMap, currentFileUri);
                }
            }
