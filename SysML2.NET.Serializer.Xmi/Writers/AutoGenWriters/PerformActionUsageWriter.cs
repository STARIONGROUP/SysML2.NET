...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class PerformActionUsageWriter : XmiDataWriter<IPerformActionUsage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IPerformActionUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IPerformActionUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.performedAction != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.performedAction, "performedAction", elementOriginMap, currentFileUri);
                }
            }
