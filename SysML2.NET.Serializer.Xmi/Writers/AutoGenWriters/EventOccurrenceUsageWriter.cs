...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class EventOccurrenceUsageWriter : XmiDataWriter<IEventOccurrenceUsage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IEventOccurrenceUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IEventOccurrenceUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.eventOccurrence != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.eventOccurrence, "eventOccurrence", elementOriginMap, currentFileUri);
                }
            }
