...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class SendActionUsageWriter : XmiDataWriter<ISendActionUsage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, ISendActionUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, ISendActionUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.senderArgument != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.senderArgument, "senderArgument", elementOriginMap, currentFileUri);
                }
            }
