...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class BindingConnectorAsUsageWriter : XmiDataWriter<IBindingConnectorAsUsage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IBindingConnectorAsUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IBindingConnectorAsUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
