...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class CrossSubsettingWriter : XmiDataWriter<ICrossSubsetting>
    {
        ...
        public override void Write(XmlWriter xmlWriter, ICrossSubsetting poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.crossingFeature != null)
                {
                    this.XmiDataWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.crossingFeature, "crossingFeature", elementOriginMap, currentFileUri);
                }
            }
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, ICrossSubsetting poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (poco.CrossedFeature != null)
            {
                await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.CrossedFeature, "crossedFeature", elementOriginMap, currentFileUri);
            }
            ...
            if (includeDerivedProperties)
            {
                if (poco.crossingFeature != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.crossingFeature, "crossingFeature", elementOriginMap, currentFileUri);
                }
            }
