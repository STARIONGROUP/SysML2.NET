...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    /// to the XMI document
    /// </summary>
    public static class AssignmentActionUsageWriter
    {
        /// <summary>
        ...
        public static void Write(XmlWriter xmlWriter, IAssignmentActionUsage poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                ...
                {
                    xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.referent, "referent", elementOriginMap, currentFileUri);
                }
                if (poco.targetArgument != null)
                {
                    xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.targetArgument, "targetArgument", elementOriginMap, currentFileUri);
                }
                ...
                {
                    xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.valueExpression, "valueExpression", elementOriginMap, currentFileUri);
                }
