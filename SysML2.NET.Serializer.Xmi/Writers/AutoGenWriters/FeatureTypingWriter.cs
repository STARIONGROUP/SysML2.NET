...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class FeatureTypingWriter : XmiDataWriter<IFeatureTyping>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IFeatureTyping poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IFeatureTyping poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (poco.Type != null)
            {
                await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.Type, "type", elementOriginMap, currentFileUri);
            }
