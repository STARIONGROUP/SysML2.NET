...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class ActorMembershipWriter : XmiDataWriter<IActorMembership>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IActorMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                ...
                {
                    this.XmiDataWriterFacade.WriteContainedElement(xmlWriter, (IData)poco.ownedActorParameter, "ownedActorParameter", includeDerivedProperties, includesImplied, elementOriginMap, currentFileUri);
                }
            }
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IActorMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.ownedActorParameter != null)
                {
                    await this.XmiDataWriterFacade.WriteContainedElementAsync(xmlWriter, (IData)poco.ownedActorParameter, "ownedActorParameter", includeDerivedProperties, includesImplied, elementOriginMap, currentFileUri);
                }
            }
