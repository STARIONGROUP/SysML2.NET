...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    /// to the XMI document
    /// </summary>
    public static class ViewUsageWriter
    {
        /// <summary>
        ...
        public static void Write(XmlWriter xmlWriter, IViewUsage poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                ...
                if (poco.exposedElement != null)
                {
                    ...
                    {
                        xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)item, "exposedElement", elementOriginMap, currentFileUri);
                    }
                }
                ...
                if (poco.itemDefinition != null)
                {
                    ...
                    {
                        xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)item, "itemDefinition", elementOriginMap, currentFileUri);
                    }
                }
                if (poco.member != null)
                {
                ...
                if (poco.satisfiedViewpoint != null)
                {
                    ...
                    {
                        xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)item, "satisfiedViewpoint", elementOriginMap, currentFileUri);
                    }
                }
                ...
                if (poco.viewCondition != null)
                {
                    ...
                    {
                        xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)item, "viewCondition", elementOriginMap, currentFileUri);
                    }
                }
                if (poco.viewDefinition != null)
                {
                    xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.viewDefinition, "viewDefinition", elementOriginMap, currentFileUri);
                }
                if (poco.viewRendering != null)
                {
                    xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.viewRendering, "viewRendering", elementOriginMap, currentFileUri);
                }
            }
