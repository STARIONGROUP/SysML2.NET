...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class ViewUsageWriter : XmiDataWriter<IViewUsage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IViewUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.exposedElement != null)
                {
                    ...
                    {
                        this.XmiDataWriterFacade.WriteReferenceElement(xmlWriter, (IData)item, "exposedElement", elementOriginMap, currentFileUri);
                    }
                }
            }
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IViewUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.exposedElement != null)
                {
                    foreach (var item in poco.exposedElement)
                    {
                        await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)item, "exposedElement", elementOriginMap, currentFileUri);
                    }
                }
            }
            ...
            if (includeDerivedProperties)
            {
                if (poco.viewDefinition != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.viewDefinition, "viewDefinition", elementOriginMap, currentFileUri);
                }
            }
