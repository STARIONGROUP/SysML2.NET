...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    /// to the XMI document
    /// </summary>
    public static class EndFeatureMembershipWriter
    {
        /// <summary>
        ...
        public static void Write(XmlWriter xmlWriter, IEndFeatureMembership poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                ...
                {
                    xmiWriterFacade.WriteContainedElement(xmlWriter, (IData)poco.ownedMemberFeature, "ownedMemberFeature", includeDerivedProperties, elementOriginMap, currentFileUri);
                }
                if (poco.owner != null)
                {
