...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class EndFeatureMembershipWriter : XmiDataWriter<IEndFeatureMembership>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IEndFeatureMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                ...
                {
                    this.XmiDataWriterFacade.WriteContainedElement(xmlWriter, (IData)poco.ownedMemberFeature, "ownedMemberFeature", includeDerivedProperties, includesImplied, elementOriginMap, currentFileUri);
                }
            }
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IEndFeatureMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.ownedMemberFeature != null)
                {
                    await this.XmiDataWriterFacade.WriteContainedElementAsync(xmlWriter, (IData)poco.ownedMemberFeature, "ownedMemberFeature", includeDerivedProperties, includesImplied, elementOriginMap, currentFileUri);
                }
            }
