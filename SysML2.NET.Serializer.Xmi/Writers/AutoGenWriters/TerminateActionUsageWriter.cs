...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class TerminateActionUsageWriter : XmiDataWriter<ITerminateActionUsage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, ITerminateActionUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, ITerminateActionUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.terminatedOccurrenceArgument != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.terminatedOccurrenceArgument, "terminatedOccurrenceArgument", elementOriginMap, currentFileUri);
                }
            }
