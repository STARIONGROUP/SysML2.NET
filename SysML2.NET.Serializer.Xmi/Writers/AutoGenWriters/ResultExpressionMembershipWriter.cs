...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class ResultExpressionMembershipWriter : XmiDataWriter<IResultExpressionMembership>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IResultExpressionMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                ...
                {
                    this.XmiDataWriterFacade.WriteContainedElement(xmlWriter, (IData)poco.ownedResultExpression, "ownedResultExpression", includeDerivedProperties, includesImplied, elementOriginMap, currentFileUri);
                }
            }
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IResultExpressionMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.ownedResultExpression != null)
                {
                    await this.XmiDataWriterFacade.WriteContainedElementAsync(xmlWriter, (IData)poco.ownedResultExpression, "ownedResultExpression", includeDerivedProperties, includesImplied, elementOriginMap, currentFileUri);
                }
            }
