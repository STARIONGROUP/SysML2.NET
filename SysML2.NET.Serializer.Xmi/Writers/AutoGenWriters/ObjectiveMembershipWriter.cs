...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class ObjectiveMembershipWriter : XmiDataWriter<IObjectiveMembership>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IObjectiveMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                ...
                {
                    this.XmiDataWriterFacade.WriteContainedElement(xmlWriter, (IData)poco.ownedObjectiveRequirement, "ownedObjectiveRequirement", includeDerivedProperties, includesImplied, elementOriginMap, currentFileUri);
                }
            }
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IObjectiveMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.ownedObjectiveRequirement != null)
                {
                    await this.XmiDataWriterFacade.WriteContainedElementAsync(xmlWriter, (IData)poco.ownedObjectiveRequirement, "ownedObjectiveRequirement", includeDerivedProperties, includesImplied, elementOriginMap, currentFileUri);
                }
            }
