...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class SuccessionWriter : XmiDataWriter<ISuccession>
    {
        ...
        public override void Write(XmlWriter xmlWriter, ISuccession poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, ISuccession poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
