...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    /// to the XMI document
    /// </summary>
    public static class StateSubactionMembershipWriter
    {
        /// <summary>
        ...
        public static void Write(XmlWriter xmlWriter, IStateSubactionMembership poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.action != null)
                {
                    xmiWriterFacade.WriteContainedElement(xmlWriter, (IData)poco.action, "action", includeDerivedProperties, elementOriginMap, currentFileUri);
                }
