...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class StateSubactionMembershipWriter : XmiDataWriter<IStateSubactionMembership>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IStateSubactionMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.action != null)
                {
                    this.XmiDataWriterFacade.WriteContainedElement(xmlWriter, (IData)poco.action, "action", includeDerivedProperties, includesImplied, elementOriginMap, currentFileUri);
                }
            }
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IStateSubactionMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.action != null)
                {
                    await this.XmiDataWriterFacade.WriteContainedElementAsync(xmlWriter, (IData)poco.action, "action", includeDerivedProperties, includesImplied, elementOriginMap, currentFileUri);
                }
            }
