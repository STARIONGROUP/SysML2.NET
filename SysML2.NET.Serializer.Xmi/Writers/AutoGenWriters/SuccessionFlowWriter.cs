...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class SuccessionFlowWriter : XmiDataWriter<ISuccessionFlow>
    {
        ...
        public override void Write(XmlWriter xmlWriter, ISuccessionFlow poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, ISuccessionFlow poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.interaction != null)
                {
                    foreach (var item in poco.interaction)
                    {
                        await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)item, "interaction", elementOriginMap, currentFileUri);
                    }
                }
            }
