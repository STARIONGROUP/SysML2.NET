...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class PortConjugationWriter : XmiDataWriter<IPortConjugation>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IPortConjugation poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IPortConjugation poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (poco.ConjugatedType != null)
            {
                await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.ConjugatedType, "conjugatedType", elementOriginMap, currentFileUri);
            }
