...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class BindingConnectorWriter : XmiDataWriter<IBindingConnector>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IBindingConnector poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IBindingConnector poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
