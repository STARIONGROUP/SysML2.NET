...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public static class StepWriter
    {
        ...
        public static void Write(XmlWriter xmlWriter, IStep poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.behavior != null)
                {
                    ...
                    {
                        xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)item, "behavior", elementOriginMap, currentFileUri);
                    }
                }
