...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class RequirementUsageWriter : XmiDataWriter<IRequirementUsage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IRequirementUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IRequirementUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
