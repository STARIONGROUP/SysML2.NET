...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public static class AnnotationWriter
    {
        ...
        public static void Write(XmlWriter xmlWriter, IAnnotation poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            {
                xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.AnnotatedElement, "annotatedElement", elementOriginMap, currentFileUri);
            }
            ...
            if (includeDerivedProperties)
            {
                ...
                {
                    xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.annotatingElement, "annotatingElement", elementOriginMap, currentFileUri);
                }
                ...
                {
                    xmiWriterFacade.WriteContainedElement(xmlWriter, (IData)poco.ownedAnnotatingElement, "ownedAnnotatingElement", includeDerivedProperties, elementOriginMap, currentFileUri);
                }
                ...
                {
                    xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.owningAnnotatedElement, "owningAnnotatedElement", elementOriginMap, currentFileUri);
                }
                if (poco.owningAnnotatingElement != null)
                {
                    xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.owningAnnotatingElement, "owningAnnotatingElement", elementOriginMap, currentFileUri);
                }
