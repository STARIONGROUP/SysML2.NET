...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class AnnotationWriter : XmiDataWriter<IAnnotation>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IAnnotation poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            {
                this.XmiDataWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.AnnotatedElement, "annotatedElement", elementOriginMap, currentFileUri);
            }
            ...
            if (includeDerivedProperties)
            {
                ...
                {
                    this.XmiDataWriterFacade.WriteContainedElement(xmlWriter, (IData)poco.ownedAnnotatingElement, "ownedAnnotatingElement", includeDerivedProperties, includesImplied, elementOriginMap, currentFileUri);
                }
            }
            ...
            if (includeDerivedProperties)
            {
                if (poco.owningAnnotatedElement != null)
                {
                    this.XmiDataWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.owningAnnotatedElement, "owningAnnotatedElement", elementOriginMap, currentFileUri);
                }
            }

            if (includeDerivedProperties)
            {
                if (poco.owningAnnotatingElement != null)
                {
                    this.XmiDataWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.owningAnnotatingElement, "owningAnnotatingElement", elementOriginMap, currentFileUri);
                }
            }
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IAnnotation poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (poco.AnnotatedElement != null)
            {
                await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.AnnotatedElement, "annotatedElement", elementOriginMap, currentFileUri);
            }
            ...
            if (includeDerivedProperties)
            {
                if (poco.annotatingElement != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.annotatingElement, "annotatingElement", elementOriginMap, currentFileUri);
                }
            }
            ...
            if (includeDerivedProperties)
            {
                if (poco.ownedAnnotatingElement != null)
                {
                    await this.XmiDataWriterFacade.WriteContainedElementAsync(xmlWriter, (IData)poco.ownedAnnotatingElement, "ownedAnnotatingElement", includeDerivedProperties, includesImplied, elementOriginMap, currentFileUri);
                }
            }
            ...
            if (includeDerivedProperties)
            {
                if (poco.owningAnnotatedElement != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.owningAnnotatedElement, "owningAnnotatedElement", elementOriginMap, currentFileUri);
                }
            }
            ...
            if (includeDerivedProperties)
            {
                if (poco.owningAnnotatingElement != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.owningAnnotatingElement, "owningAnnotatingElement", elementOriginMap, currentFileUri);
                }
            }
