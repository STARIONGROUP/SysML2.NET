...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class PortDefinitionWriter : XmiDataWriter<IPortDefinition>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IPortDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IPortDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
