...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class InteractionWriter : XmiDataWriter<IInteraction>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IInteraction poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IInteraction poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
