...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public static class InteractionWriter
    {
        ...
        public static void Write(XmlWriter xmlWriter, IInteraction poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
