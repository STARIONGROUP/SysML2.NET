...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public static class DefinitionWriter
    {
        ...
        public static void Write(XmlWriter xmlWriter, IDefinition poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
