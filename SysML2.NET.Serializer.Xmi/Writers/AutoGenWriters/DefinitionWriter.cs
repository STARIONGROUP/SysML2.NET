...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class DefinitionWriter : XmiDataWriter<IDefinition>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
