...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class ForLoopActionUsageWriter : XmiDataWriter<IForLoopActionUsage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IForLoopActionUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IForLoopActionUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.loopVariable != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.loopVariable, "loopVariable", elementOriginMap, currentFileUri);
                }
            }
            ...
            if (includeDerivedProperties)
            {
                if (poco.seqArgument != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.seqArgument, "seqArgument", elementOriginMap, currentFileUri);
                }
            }
