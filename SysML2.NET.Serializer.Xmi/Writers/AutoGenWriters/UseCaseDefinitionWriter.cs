...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class UseCaseDefinitionWriter : XmiDataWriter<IUseCaseDefinition>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IUseCaseDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IUseCaseDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
