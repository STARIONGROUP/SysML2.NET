...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class ClassifierWriter : XmiDataWriter<IClassifier>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IClassifier poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IClassifier poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
