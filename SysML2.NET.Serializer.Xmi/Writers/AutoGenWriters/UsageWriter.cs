...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class UsageWriter : XmiDataWriter<IUsage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
