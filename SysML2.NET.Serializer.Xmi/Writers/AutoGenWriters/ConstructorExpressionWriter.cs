...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class ConstructorExpressionWriter : XmiDataWriter<IConstructorExpression>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IConstructorExpression poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IConstructorExpression poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
