...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class MetaclassWriter : XmiDataWriter<IMetaclass>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IMetaclass poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IMetaclass poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
