...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public static class StructureWriter
    {
        ...
        public static void Write(XmlWriter xmlWriter, IStructure poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
