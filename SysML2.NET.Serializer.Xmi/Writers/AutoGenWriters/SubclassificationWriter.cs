...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class SubclassificationWriter : XmiDataWriter<ISubclassification>
    {
        ...
        public override void Write(XmlWriter xmlWriter, ISubclassification poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.owningClassifier != null)
                {
                    this.XmiDataWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.owningClassifier, "owningClassifier", elementOriginMap, currentFileUri);
                }
            }
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, ISubclassification poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.owningClassifier != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.owningClassifier, "owningClassifier", elementOriginMap, currentFileUri);
                }
            }
            ...
            if (poco.Subclassifier != null)
            {
                await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.Subclassifier, "subclassifier", elementOriginMap, currentFileUri);
            }

            if (poco.Superclassifier != null)
            {
                await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.Superclassifier, "superclassifier", elementOriginMap, currentFileUri);
            }
