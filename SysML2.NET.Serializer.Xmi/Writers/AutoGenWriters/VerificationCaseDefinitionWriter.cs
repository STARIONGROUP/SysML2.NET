...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class VerificationCaseDefinitionWriter : XmiDataWriter<IVerificationCaseDefinition>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IVerificationCaseDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IVerificationCaseDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
