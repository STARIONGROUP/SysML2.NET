...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class MultiplicityRangeWriter : XmiDataWriter<IMultiplicityRange>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IMultiplicityRange poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IMultiplicityRange poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.bound != null)
                {
                    foreach (var item in poco.bound)
                    {
                        await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)item, "bound", elementOriginMap, currentFileUri);
                    }
                }
            }
            ...
            if (includeDerivedProperties)
            {
                if (poco.lowerBound != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.lowerBound, "lowerBound", elementOriginMap, currentFileUri);
                }
            }
            ...
            if (includeDerivedProperties)
            {
                if (poco.upperBound != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.upperBound, "upperBound", elementOriginMap, currentFileUri);
                }
            }
