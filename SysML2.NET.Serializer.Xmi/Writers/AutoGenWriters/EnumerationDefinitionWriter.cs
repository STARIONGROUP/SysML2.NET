...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class EnumerationDefinitionWriter : XmiDataWriter<IEnumerationDefinition>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IEnumerationDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IEnumerationDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.enumeratedValue != null)
                {
                    foreach (var item in poco.enumeratedValue)
                    {
                        await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)item, "enumeratedValue", elementOriginMap, currentFileUri);
                    }
                }
            }
