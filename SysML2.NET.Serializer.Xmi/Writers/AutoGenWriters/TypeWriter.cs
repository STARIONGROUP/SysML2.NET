...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class TypeWriter : XmiDataWriter<IType>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IType poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IType poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
