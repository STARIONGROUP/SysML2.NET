...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public static class TypeWriter
    {
        ...
        public static void Write(XmlWriter xmlWriter, IType poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
