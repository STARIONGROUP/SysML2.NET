...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class TypeFeaturingWriter : XmiDataWriter<ITypeFeaturing>
    {
        ...
        public override void Write(XmlWriter xmlWriter, ITypeFeaturing poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.owningFeatureOfType != null)
                {
                    this.XmiDataWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.owningFeatureOfType, "owningFeatureOfType", elementOriginMap, currentFileUri);
                }
            }
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, ITypeFeaturing poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (poco.FeatureOfType != null)
            {
                await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.FeatureOfType, "featureOfType", elementOriginMap, currentFileUri);
            }

            if (poco.FeaturingType != null)
            {
                await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.FeaturingType, "featuringType", elementOriginMap, currentFileUri);
            }
            ...
            if (includeDerivedProperties)
            {
                if (poco.owningFeatureOfType != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.owningFeatureOfType, "owningFeatureOfType", elementOriginMap, currentFileUri);
                }
            }
