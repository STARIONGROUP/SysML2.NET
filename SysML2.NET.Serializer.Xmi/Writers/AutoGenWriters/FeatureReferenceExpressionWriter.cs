...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class FeatureReferenceExpressionWriter : XmiDataWriter<IFeatureReferenceExpression>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IFeatureReferenceExpression poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IFeatureReferenceExpression poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
