...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class AttributeUsageWriter : XmiDataWriter<IAttributeUsage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IAttributeUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IAttributeUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.attributeDefinition != null)
                {
                    foreach (var item in poco.attributeDefinition)
                    {
                        await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)item, "attributeDefinition", elementOriginMap, currentFileUri);
                    }
                }
            }
