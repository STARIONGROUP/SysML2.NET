...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class LibraryPackageWriter : XmiDataWriter<ILibraryPackage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, ILibraryPackage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, ILibraryPackage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
