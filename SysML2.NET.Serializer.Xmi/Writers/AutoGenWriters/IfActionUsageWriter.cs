...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class IfActionUsageWriter : XmiDataWriter<IIfActionUsage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IIfActionUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IIfActionUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.elseAction != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.elseAction, "elseAction", elementOriginMap, currentFileUri);
                }
            }
            ...
            if (includeDerivedProperties)
            {
                if (poco.ifArgument != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.ifArgument, "ifArgument", elementOriginMap, currentFileUri);
                }
            }
            ...
            if (includeDerivedProperties)
            {
                if (poco.thenAction != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.thenAction, "thenAction", elementOriginMap, currentFileUri);
                }
            }
