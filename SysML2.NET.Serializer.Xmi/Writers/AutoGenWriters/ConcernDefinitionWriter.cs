...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class ConcernDefinitionWriter : XmiDataWriter<IConcernDefinition>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IConcernDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IConcernDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
