...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    /// to the XMI document
    /// </summary>
    public static class RenderingDefinitionWriter
    {
        /// <summary>
        ...
        public static void Write(XmlWriter xmlWriter, IRenderingDefinition poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                ...
                if (poco.rendering != null)
                {
                    ...
                    {
                        xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)item, "rendering", elementOriginMap, currentFileUri);
                    }
                }
