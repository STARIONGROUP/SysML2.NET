...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class RenderingDefinitionWriter : XmiDataWriter<IRenderingDefinition>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IRenderingDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IRenderingDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.rendering != null)
                {
                    foreach (var item in poco.rendering)
                    {
                        await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)item, "rendering", elementOriginMap, currentFileUri);
                    }
                }
            }
