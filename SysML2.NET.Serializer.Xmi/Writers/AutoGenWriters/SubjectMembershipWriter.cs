...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class SubjectMembershipWriter : XmiDataWriter<ISubjectMembership>
    {
        ...
        public override void Write(XmlWriter xmlWriter, ISubjectMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                ...
                {
                    this.XmiDataWriterFacade.WriteContainedElement(xmlWriter, (IData)poco.ownedSubjectParameter, "ownedSubjectParameter", includeDerivedProperties, includesImplied, elementOriginMap, currentFileUri);
                }
            }
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, ISubjectMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.ownedSubjectParameter != null)
                {
                    await this.XmiDataWriterFacade.WriteContainedElementAsync(xmlWriter, (IData)poco.ownedSubjectParameter, "ownedSubjectParameter", includeDerivedProperties, includesImplied, elementOriginMap, currentFileUri);
                }
            }
