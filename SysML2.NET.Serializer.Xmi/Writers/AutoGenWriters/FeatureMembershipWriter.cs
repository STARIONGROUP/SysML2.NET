...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class FeatureMembershipWriter : XmiDataWriter<IFeatureMembership>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IFeatureMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IFeatureMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
