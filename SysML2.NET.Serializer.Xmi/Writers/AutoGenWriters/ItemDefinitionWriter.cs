...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class ItemDefinitionWriter : XmiDataWriter<IItemDefinition>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IItemDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IItemDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
