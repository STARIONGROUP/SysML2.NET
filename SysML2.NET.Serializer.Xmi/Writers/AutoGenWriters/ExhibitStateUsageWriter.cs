...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    /// to the XMI document
    /// </summary>
    public static class ExhibitStateUsageWriter
    {
        /// <summary>
        ...
        public static void Write(XmlWriter xmlWriter, IExhibitStateUsage poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                ...
                {
                    xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.doAction, "doAction", elementOriginMap, currentFileUri);
                }
                ...
                {
                    xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.entryAction, "entryAction", elementOriginMap, currentFileUri);
                }
                if (poco.exhibitedState != null)
                {
                    xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.exhibitedState, "exhibitedState", elementOriginMap, currentFileUri);
                }
                if (poco.exitAction != null)
                {
                    xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.exitAction, "exitAction", elementOriginMap, currentFileUri);
                }
                ...
                if (poco.stateDefinition != null)
                {
                    ...
                    {
                        xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)item, "stateDefinition", elementOriginMap, currentFileUri);
                    }
                }
