...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class ExhibitStateUsageWriter : XmiDataWriter<IExhibitStateUsage>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IExhibitStateUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IExhibitStateUsage poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.doAction != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.doAction, "doAction", elementOriginMap, currentFileUri);
                }
            }
            ...
            if (includeDerivedProperties)
            {
                if (poco.entryAction != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.entryAction, "entryAction", elementOriginMap, currentFileUri);
                }
            }
            ...
            if (includeDerivedProperties)
            {
                if (poco.exhibitedState != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.exhibitedState, "exhibitedState", elementOriginMap, currentFileUri);
                }
            }
            ...
            if (includeDerivedProperties)
            {
                if (poco.exitAction != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.exitAction, "exitAction", elementOriginMap, currentFileUri);
                }
            }
            ...
            if (includeDerivedProperties)
            {
                if (poco.stateDefinition != null)
                {
                    foreach (var item in poco.stateDefinition)
                    {
                        await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)item, "stateDefinition", elementOriginMap, currentFileUri);
                    }
                }
            }
