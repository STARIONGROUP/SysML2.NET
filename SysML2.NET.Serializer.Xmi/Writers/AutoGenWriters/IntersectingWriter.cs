...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class IntersectingWriter : XmiDataWriter<IIntersecting>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IIntersecting poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (includeDerivedProperties)
            {
                if (poco.typeIntersected != null)
                {
                    this.XmiDataWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.typeIntersected, "typeIntersected", elementOriginMap, currentFileUri);
                }
            }
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IIntersecting poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (poco.IntersectingType != null)
            {
                await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.IntersectingType, "intersectingType", elementOriginMap, currentFileUri);
            }
            ...
            if (includeDerivedProperties)
            {
                if (poco.typeIntersected != null)
                {
                    await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.typeIntersected, "typeIntersected", elementOriginMap, currentFileUri);
                }
            }
