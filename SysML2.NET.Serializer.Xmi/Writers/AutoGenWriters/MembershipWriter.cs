...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    /// to the XMI document
    /// </summary>
    public static class MembershipWriter
    {
        /// <summary>
        ...
        public static void Write(XmlWriter xmlWriter, IMembership poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            {
                xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.MemberElement, "memberElement", elementOriginMap, currentFileUri);
            }
            ...
            if (includeDerivedProperties)
            {
                ...
                {
                    xmiWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.membershipOwningNamespace, "membershipOwningNamespace", elementOriginMap, currentFileUri);
                }
