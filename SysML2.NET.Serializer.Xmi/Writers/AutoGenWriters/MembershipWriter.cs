...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class MembershipWriter : XmiDataWriter<IMembership>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            {
                this.XmiDataWriterFacade.WriteReferenceElement(xmlWriter, (IData)poco.MemberElement, "memberElement", elementOriginMap, currentFileUri);
            }
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IMembership poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
            ...
            if (poco.MemberElement != null)
            {
                await this.XmiDataWriterFacade.WriteReferenceElementAsync(xmlWriter, (IData)poco.MemberElement, "memberElement", elementOriginMap, currentFileUri);
            }
