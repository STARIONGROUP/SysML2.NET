...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class FlowWriter : XmiDataWriter<IFlow>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IFlow poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IFlow poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
