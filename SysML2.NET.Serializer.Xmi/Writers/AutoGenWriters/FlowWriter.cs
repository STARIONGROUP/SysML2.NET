...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public static class FlowWriter
    {
        ...
        public static void Write(XmlWriter xmlWriter, IFlow poco, string elementName, bool includeDerivedProperties, IXmiDataWriterFacade xmiWriterFacade, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
