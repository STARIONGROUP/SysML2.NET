...
namespace SysML2.NET.Serializer.Xmi.Writers
{
    ...
    public class FlowDefinitionWriter : XmiDataWriter<IFlowDefinition>
    {
        ...
        public override void Write(XmlWriter xmlWriter, IFlowDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
        ...
        public override async Task WriteAsync(XmlWriter xmlWriter, IFlowDefinition poco, string elementName, bool includeDerivedProperties, bool includesImplied, IXmiElementOriginMap elementOriginMap = null, Uri currentFileUri = null)
        {
