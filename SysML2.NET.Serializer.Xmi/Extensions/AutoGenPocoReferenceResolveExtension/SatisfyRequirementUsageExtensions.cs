...
namespace SysML2.NET.Serializer.Xmi.Extensions
{
    ...
    /// <summary>
    /// Provides extensions methods for the <see cref="SysML2.NET.Core.POCO.Systems.Requirements.SatisfyRequirementUsage"/> to help resolve reference for properties
    /// </summary>
