...
namespace SysML2.NET.Dal
{
    ...
    public static class FlowDefinitionExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.FlowDefinition poco, Core.DTO.FlowDefinition dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.FlowDefinition poco, Core.DTO.FlowDefinition dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.FlowDefinition"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.FlowDefinition"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.FlowDefinition"/>
        /// </returns>
        public static Core.DTO.FlowDefinition ToDto(this Core.POCO.FlowDefinition poco)
        {
            var dto = new Core.DTO.FlowDefinition();
