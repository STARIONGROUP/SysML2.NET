...
namespace SysML2.NET.Dal
{
    ...
    /// <summary>
    /// A static class that provides extension methods for the <see cref="Core.POCO.Systems.Requirements.RequirementDefinition"/> class
    /// </summary>
    public static class RequirementDefinitionExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="Core.POCO.Systems.Requirements.RequirementDefinition"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from contained properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="Core.POCO.Systems.Requirements.RequirementDefinition"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="Core.DTO.Systems.Requirements.RequirementDefinition"/> with
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.Systems.Requirements.RequirementDefinition poco, Core.DTO.Systems.Requirements.RequirementDefinition dto)
        {
            if (poco == null)
            {
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="Core.POCO.Systems.Requirements.RequirementDefinition"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Core.POCO.Systems.Requirements.RequirementDefinition poco, Core.DTO.Systems.Requirements.RequirementDefinition dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.Root.Elements.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.Systems.Requirements.RequirementDefinition"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.Systems.Requirements.RequirementDefinition"/> from which a DTO is to be created
        /// </param>
        /// <param name="includeDerivedProperties">
        /// Asserts that derived properties should also be mapped during the creation of the <see cref="Core.DTO.Systems.Requirements.RequirementDefinition"/>
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.Systems.Requirements.RequirementDefinition"/>
        /// </returns>
        public static Core.DTO.Systems.Requirements.RequirementDefinition ToDto(this Core.POCO.Systems.Requirements.RequirementDefinition poco, bool includeDerivedProperties = false)
        {
            var dto = new Core.DTO.Systems.Requirements.RequirementDefinition();
