...
namespace SysML2.NET.Dal
{
    ...
    /// <summary>
    /// A static class that provides extension methods for the <see cref="Core.POCO.Kernel.Expressions.IndexExpression"/> class
    /// </summary>
    public static class IndexExpressionExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="Core.POCO.Kernel.Expressions.IndexExpression"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from contained properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="Core.POCO.Kernel.Expressions.IndexExpression"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="Core.DTO.Kernel.Expressions.IndexExpression"/> with
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.Kernel.Expressions.IndexExpression poco, Core.DTO.Kernel.Expressions.IndexExpression dto)
        {
            if (poco == null)
            {
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="Core.POCO.Kernel.Expressions.IndexExpression"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Core.POCO.Kernel.Expressions.IndexExpression poco, Core.DTO.Kernel.Expressions.IndexExpression dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.Root.Elements.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.Kernel.Expressions.IndexExpression"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.Kernel.Expressions.IndexExpression"/> from which a DTO is to be created
        /// </param>
        /// <param name="includeDerivedProperties">
        /// Asserts that derived properties should also be mapped during the creation of the <see cref="Core.DTO.Kernel.Expressions.IndexExpression"/>
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.Kernel.Expressions.IndexExpression"/>
        /// </returns>
        public static Core.DTO.Kernel.Expressions.IndexExpression ToDto(this Core.POCO.Kernel.Expressions.IndexExpression poco, bool includeDerivedProperties = false)
        {
            var dto = new Core.DTO.Kernel.Expressions.IndexExpression();
