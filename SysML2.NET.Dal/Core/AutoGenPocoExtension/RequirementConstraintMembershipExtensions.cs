// -------------------------------------------------------------------------------------------------
// <copyright file="RequirementConstraintMembershipExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class RequirementConstraintMembershipExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.RequirementConstraintMembership poco, Core.DTO.RequirementConstraintMembership dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.RequirementConstraintMembership poco, Core.DTO.RequirementConstraintMembership dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.RequirementConstraintMembership"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.RequirementConstraintMembership"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.RequirementConstraintMembership"/>
        /// </returns>
        public static Core.DTO.RequirementConstraintMembership ToDto(this Core.POCO.RequirementConstraintMembership poco)
        {
            var dto = new Core.DTO.RequirementConstraintMembership();
