// -------------------------------------------------------------------------------------------------
// <copyright file="TriggerInvocationExpressionExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class TriggerInvocationExpressionExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.TriggerInvocationExpression poco, Core.DTO.TriggerInvocationExpression dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.TriggerInvocationExpression poco, Core.DTO.TriggerInvocationExpression dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.TriggerInvocationExpression"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.TriggerInvocationExpression"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.TriggerInvocationExpression"/>
        /// </returns>
        public static Core.DTO.TriggerInvocationExpression ToDto(this Core.POCO.TriggerInvocationExpression poco)
        {
            var dto = new Core.DTO.TriggerInvocationExpression();
