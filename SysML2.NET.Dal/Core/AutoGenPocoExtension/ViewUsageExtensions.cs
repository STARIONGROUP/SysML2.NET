...
namespace SysML2.NET.Dal
{
    ...
    public static class ViewUsageExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.Systems.Views.ViewUsage poco, Core.DTO.Systems.Views.ViewUsage dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.Systems.Views.ViewUsage poco, Core.DTO.Systems.Views.ViewUsage dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.Root.Elements.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.Systems.Views.ViewUsage"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.Systems.Views.ViewUsage"/> from which a DTO is to be created
        /// </param>
        /// <param name="includeDerivedProperties">
        /// Asserts that derived properties should also be mapped during the creation of the <see cref="Core.DTO.Systems.Views.ViewUsage"/>
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.Systems.Views.ViewUsage"/>
        /// </returns>
        public static Core.DTO.Systems.Views.ViewUsage ToDto(this Core.POCO.Systems.Views.ViewUsage poco, bool includeDerivedProperties = false)
        {
            var dto = new Core.DTO.Systems.Views.ViewUsage();
            ...
            if (includeDerivedProperties)
            {
                ...
                dto.exposedElement = poco.exposedElement.Select(x => x.Id).ToList();
                ...
                dto.viewDefinition = poco.viewDefinition?.Id;
