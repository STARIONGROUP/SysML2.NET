// -------------------------------------------------------------------------------------------------
// <copyright file="OccurrenceDefinitionExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class OccurrenceDefinitionExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.OccurrenceDefinition poco, Core.DTO.OccurrenceDefinition dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.OccurrenceDefinition poco, Core.DTO.OccurrenceDefinition dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.OccurrenceDefinition"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.OccurrenceDefinition"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.OccurrenceDefinition"/>
        /// </returns>
        public static Core.DTO.OccurrenceDefinition ToDto(this Core.POCO.OccurrenceDefinition poco)
        {
            var dto = new Core.DTO.OccurrenceDefinition();
