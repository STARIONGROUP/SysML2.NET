...
namespace SysML2.NET.Dal
{
    ...
    public static class FeatureMembershipExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.Core.Types.FeatureMembership poco, Core.DTO.Core.Types.FeatureMembership dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.Core.Types.FeatureMembership poco, Core.DTO.Core.Types.FeatureMembership dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.Root.Elements.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.Core.Types.FeatureMembership"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
