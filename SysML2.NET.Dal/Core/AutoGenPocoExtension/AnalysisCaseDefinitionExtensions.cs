// -------------------------------------------------------------------------------------------------
// <copyright file="AnalysisCaseDefinitionExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class AnalysisCaseDefinitionExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.AnalysisCaseDefinition poco, Core.DTO.AnalysisCaseDefinition dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.AnalysisCaseDefinition poco, Core.DTO.AnalysisCaseDefinition dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.AnalysisCaseDefinition"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.AnalysisCaseDefinition"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.AnalysisCaseDefinition"/>
        /// </returns>
        public static Core.DTO.AnalysisCaseDefinition ToDto(this Core.POCO.AnalysisCaseDefinition poco)
        {
            var dto = new Core.DTO.AnalysisCaseDefinition();
