...
namespace SysML2.NET.Dal
{
    ...
    {
        /// <summary>
        /// Updates the value properties of the <see cref="Core.POCO.Systems.Connections.ConnectionUsage"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from contained properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="Core.POCO.Systems.Connections.ConnectionUsage"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="Core.DTO.Systems.Connections.ConnectionUsage"/> with
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.Systems.Connections.ConnectionUsage poco, Core.DTO.Systems.Connections.ConnectionUsage dto)
        {
            if (poco == null)
            {
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="Core.POCO.Systems.Connections.ConnectionUsage"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Core.POCO.Systems.Connections.ConnectionUsage poco, Core.DTO.Systems.Connections.ConnectionUsage dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.Root.Elements.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.Systems.Connections.ConnectionUsage"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.Systems.Connections.ConnectionUsage"/> from which a DTO is to be created
        /// </param>
        /// <param name="includeDerivedProperties">
        /// Asserts that derived properties should also be mapped during the creation of the <see cref="Core.DTO.Systems.Connections.ConnectionUsage"/>
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.Systems.Connections.ConnectionUsage"/>
        /// </returns>
        public static Core.DTO.Systems.Connections.ConnectionUsage ToDto(this Core.POCO.Systems.Connections.ConnectionUsage poco, bool includeDerivedProperties = false)
        {
            var dto = new Core.DTO.Systems.Connections.ConnectionUsage();
            ...
            if (includeDerivedProperties)
            {
                ...
                dto.connectionDefinition = poco.connectionDefinition.Select(x => x.Id).ToList();
