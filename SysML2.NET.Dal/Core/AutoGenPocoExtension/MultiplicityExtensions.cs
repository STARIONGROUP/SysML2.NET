// -------------------------------------------------------------------------------------------------
// <copyright file="MultiplicityExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class MultiplicityExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.Multiplicity poco, Core.DTO.Multiplicity dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.Multiplicity poco, Core.DTO.Multiplicity dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.Multiplicity"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.Multiplicity"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.Multiplicity"/>
        /// </returns>
        public static Core.DTO.Multiplicity ToDto(this Core.POCO.Multiplicity poco)
        {
            var dto = new Core.DTO.Multiplicity();
