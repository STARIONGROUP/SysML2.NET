// -------------------------------------------------------------------------------------------------
// <copyright file="ItemFlowEndExtensions.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    /// <summary>
    /// A static class that provides extension methods for the <see cref="ItemFlowEnd"/> class
    /// </summary>
    public static class ItemFlowEndExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="ItemFlowEnd"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from contained properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="ItemFlowEnd"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="ItemFlowEnd"/> with
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.ItemFlowEnd poco, Core.DTO.ItemFlowEnd dto)
        {
            if (poco == null)
            {
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="ItemFlowEnd"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Core.POCO.ItemFlowEnd poco, Core.DTO.ItemFlowEnd dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.ItemFlowEnd"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.ItemFlowEnd"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.ItemFlowEnd"/>
        /// </returns>
        public static Core.DTO.ItemFlowEnd ToDto(this Core.POCO.ItemFlowEnd poco)
        {
            var dto = new Core.DTO.ItemFlowEnd();
