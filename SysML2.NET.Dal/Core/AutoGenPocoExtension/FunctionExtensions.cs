...
namespace SysML2.NET.Dal
{
    ...
    public static class FunctionExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.Kernel.Functions.Function poco, Core.DTO.Kernel.Functions.Function dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.Kernel.Functions.Function poco, Core.DTO.Kernel.Functions.Function dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.Root.Elements.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.Kernel.Functions.Function"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
