...
namespace SysML2.NET.Dal
{
    ...
    {
        /// <summary>
        /// Updates the value properties of the <see cref="Core.POCO.Systems.States.TransitionUsage"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from contained properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="Core.POCO.Systems.States.TransitionUsage"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="Core.DTO.Systems.States.TransitionUsage"/> with
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.Systems.States.TransitionUsage poco, Core.DTO.Systems.States.TransitionUsage dto)
        {
            if (poco == null)
            {
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="Core.POCO.Systems.States.TransitionUsage"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Core.POCO.Systems.States.TransitionUsage poco, Core.DTO.Systems.States.TransitionUsage dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.Root.Elements.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.Systems.States.TransitionUsage"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.Systems.States.TransitionUsage"/> from which a DTO is to be created
        /// </param>
        /// <param name="includeDerivedProperties">
        /// Asserts that derived properties should also be mapped during the creation of the <see cref="Core.DTO.Systems.States.TransitionUsage"/>
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.Systems.States.TransitionUsage"/>
        /// </returns>
        public static Core.DTO.Systems.States.TransitionUsage ToDto(this Core.POCO.Systems.States.TransitionUsage poco, bool includeDerivedProperties = false)
        {
            var dto = new Core.DTO.Systems.States.TransitionUsage();
            ...
            if (includeDerivedProperties)
            {
                ...
                dto.effectAction = poco.effectAction.Select(x => x.Id).ToList();
                ...
                dto.guardExpression = poco.guardExpression.Select(x => x.Id).ToList();
                ...
                dto.source = poco.source.Id;
                dto.succession = poco.succession.Id;
                dto.target = poco.target.Id;
                dto.textualRepresentation = poco.textualRepresentation.Select(x => x.Id).ToList();
                dto.triggerAction = poco.triggerAction.Select(x => x.Id).ToList();
