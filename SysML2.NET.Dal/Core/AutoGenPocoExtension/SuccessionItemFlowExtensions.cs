// -------------------------------------------------------------------------------------------------
// <copyright file="SuccessionItemFlowExtensions.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    /// <summary>
    /// A static class that provides extension methods for the <see cref="SuccessionItemFlow"/> class
    /// </summary>
    public static class SuccessionItemFlowExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="SuccessionItemFlow"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from contained properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="SuccessionItemFlow"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="SuccessionItemFlow"/> with
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.SuccessionItemFlow poco, Core.DTO.SuccessionItemFlow dto)
        {
            if (poco == null)
            {
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="SuccessionItemFlow"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Core.POCO.SuccessionItemFlow poco, Core.DTO.SuccessionItemFlow dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.SuccessionItemFlow"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.SuccessionItemFlow"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.SuccessionItemFlow"/>
        /// </returns>
        public static Core.DTO.SuccessionItemFlow ToDto(this Core.POCO.SuccessionItemFlow poco)
        {
            var dto = new Core.DTO.SuccessionItemFlow();
