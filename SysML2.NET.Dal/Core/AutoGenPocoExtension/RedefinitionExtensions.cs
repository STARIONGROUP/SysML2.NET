// -------------------------------------------------------------------------------------------------
// <copyright file="RedefinitionExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class RedefinitionExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.Redefinition poco, Core.DTO.Redefinition dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.Redefinition poco, Core.DTO.Redefinition dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
            ...
            {
                poco.RedefinedFeature = (Core.POCO.Feature)lazyPoco.Value;
            }
            else
            {
            ...
            {
                poco.RedefiningFeature = (Core.POCO.Feature)lazyPoco.Value;
            }
            else
            {
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.Redefinition"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.Redefinition"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.Redefinition"/>
        /// </returns>
        public static Core.DTO.Redefinition ToDto(this Core.POCO.Redefinition poco)
        {
            var dto = new Core.DTO.Redefinition();
