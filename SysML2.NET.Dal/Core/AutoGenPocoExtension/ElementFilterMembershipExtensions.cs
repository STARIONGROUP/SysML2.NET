...
namespace SysML2.NET.Dal
{
    ...
    using Core.POCO.Kernel.Packages;

    /// <summary>
    /// A static class that provides extension methods for the <see cref="Core.POCO.Kernel.Packages.ElementFilterMembership"/> class
    /// </summary>
    public static class ElementFilterMembershipExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="Core.POCO.Kernel.Packages.ElementFilterMembership"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from contained properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="Core.POCO.Kernel.Packages.ElementFilterMembership"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="Core.DTO.Kernel.Packages.ElementFilterMembership"/> with
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.Kernel.Packages.ElementFilterMembership poco, Core.DTO.Kernel.Packages.ElementFilterMembership dto)
        {
            if (poco == null)
            {
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="Core.POCO.Kernel.Packages.ElementFilterMembership"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Core.POCO.Kernel.Packages.ElementFilterMembership poco, Core.DTO.Kernel.Packages.ElementFilterMembership dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.Root.Elements.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.Kernel.Packages.ElementFilterMembership"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.Kernel.Packages.ElementFilterMembership"/> from which a DTO is to be created
        /// </param>
        /// <param name="includeDerivedProperties">
        /// Asserts that derived properties should also be mapped during the creation of the <see cref="Core.DTO.Kernel.Packages.ElementFilterMembership"/>
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.Kernel.Packages.ElementFilterMembership"/>
        /// </returns>
        public static Core.DTO.Kernel.Packages.ElementFilterMembership ToDto(this Core.POCO.Kernel.Packages.ElementFilterMembership poco, bool includeDerivedProperties = false)
        {
            var dto = new Core.DTO.Kernel.Packages.ElementFilterMembership();
            ...
            {
                dto.condition = poco.condition.Id;
