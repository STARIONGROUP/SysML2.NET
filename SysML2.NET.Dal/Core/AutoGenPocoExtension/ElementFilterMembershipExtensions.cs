// -------------------------------------------------------------------------------------------------
// <copyright file="ElementFilterMembershipExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class ElementFilterMembershipExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.ElementFilterMembership poco, Core.DTO.ElementFilterMembership dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.ElementFilterMembership poco, Core.DTO.ElementFilterMembership dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.ElementFilterMembership"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.ElementFilterMembership"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.ElementFilterMembership"/>
        /// </returns>
        public static Core.DTO.ElementFilterMembership ToDto(this Core.POCO.ElementFilterMembership poco)
        {
            var dto = new Core.DTO.ElementFilterMembership();
