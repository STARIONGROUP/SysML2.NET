...
namespace SysML2.NET.Dal
{
    ...
    public static class InterfaceDefinitionExtensions
    {
        ...
        /// </returns>
        public static Core.DTO.Systems.Interfaces.InterfaceDefinition ToDto(this Core.POCO.Systems.Interfaces.InterfaceDefinition poco)
        {
            ...
            ((Core.DTO.Systems.Connections.IConnectionDefinition)dto).IsSufficient = ((Core.POCO.Systems.Connections.IConnectionDefinition)poco).IsSufficient;
            ((Core.DTO.Core.Types.IType)dto).IsSufficient = ((Core.POCO.Core.Types.IType)poco).IsSufficient;
