// -------------------------------------------------------------------------------------------------
// <copyright file="InterfaceDefinitionExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class InterfaceDefinitionExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.InterfaceDefinition poco, Core.DTO.InterfaceDefinition dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.InterfaceDefinition poco, Core.DTO.InterfaceDefinition dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.InterfaceDefinition"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.InterfaceDefinition"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.InterfaceDefinition"/>
        /// </returns>
        public static Core.DTO.InterfaceDefinition ToDto(this Core.POCO.InterfaceDefinition poco)
        {
            var dto = new Core.DTO.InterfaceDefinition();
