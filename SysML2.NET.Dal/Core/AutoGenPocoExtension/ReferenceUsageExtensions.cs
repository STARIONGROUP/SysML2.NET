// -------------------------------------------------------------------------------------------------
// <copyright file="ReferenceUsageExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class ReferenceUsageExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.ReferenceUsage poco, Core.DTO.ReferenceUsage dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.ReferenceUsage poco, Core.DTO.ReferenceUsage dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.ReferenceUsage"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.ReferenceUsage"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.ReferenceUsage"/>
        /// </returns>
        public static Core.DTO.ReferenceUsage ToDto(this Core.POCO.ReferenceUsage poco)
        {
            var dto = new Core.DTO.ReferenceUsage();
