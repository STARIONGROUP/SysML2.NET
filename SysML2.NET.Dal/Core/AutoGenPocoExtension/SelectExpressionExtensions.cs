...
namespace SysML2.NET.Dal
{
    ...
    public static class SelectExpressionExtensions
    {
        ...
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.Kernel.Expressions.SelectExpression poco, Core.DTO.Kernel.Expressions.SelectExpression dto)
        {
            ...
            ((Core.POCO.Kernel.Expressions.ISelectExpression)poco).Operator = ((Core.DTO.Kernel.Expressions.ISelectExpression)dto).Operator;
        ...
        /// </returns>
        public static Core.DTO.Kernel.Expressions.SelectExpression ToDto(this Core.POCO.Kernel.Expressions.SelectExpression poco)
        {
            ...
            ((Core.DTO.Kernel.Expressions.ISelectExpression)dto).Operator = ((Core.POCO.Kernel.Expressions.ISelectExpression)poco).Operator;
