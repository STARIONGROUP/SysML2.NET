...
namespace SysML2.NET.Dal
{
    ...
    public static class StateSubactionMembershipExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.Systems.States.StateSubactionMembership poco, Core.DTO.Systems.States.StateSubactionMembership dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.Systems.States.StateSubactionMembership poco, Core.DTO.Systems.States.StateSubactionMembership dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.Root.Elements.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.Systems.States.StateSubactionMembership"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
