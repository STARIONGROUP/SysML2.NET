// -------------------------------------------------------------------------------------------------
// <copyright file="SatisfyRequirementUsageExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class SatisfyRequirementUsageExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.SatisfyRequirementUsage poco, Core.DTO.SatisfyRequirementUsage dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.SatisfyRequirementUsage poco, Core.DTO.SatisfyRequirementUsage dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.SatisfyRequirementUsage"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.SatisfyRequirementUsage"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.SatisfyRequirementUsage"/>
        /// </returns>
        public static Core.DTO.SatisfyRequirementUsage ToDto(this Core.POCO.SatisfyRequirementUsage poco)
        {
            var dto = new Core.DTO.SatisfyRequirementUsage();
