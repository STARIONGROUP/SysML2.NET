// -------------------------------------------------------------------------------------------------
// <copyright file="LiteralIntegerExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class LiteralIntegerExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.LiteralInteger poco, Core.DTO.LiteralInteger dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.LiteralInteger poco, Core.DTO.LiteralInteger dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.LiteralInteger"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.LiteralInteger"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.LiteralInteger"/>
        /// </returns>
        public static Core.DTO.LiteralInteger ToDto(this Core.POCO.LiteralInteger poco)
        {
            var dto = new Core.DTO.LiteralInteger();
