// -------------------------------------------------------------------------------------------------
// <copyright file="RequirementVerificationMembershipExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class RequirementVerificationMembershipExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.RequirementVerificationMembership poco, Core.DTO.RequirementVerificationMembership dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.RequirementVerificationMembership poco, Core.DTO.RequirementVerificationMembership dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.RequirementVerificationMembership"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.RequirementVerificationMembership"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.RequirementVerificationMembership"/>
        /// </returns>
        public static Core.DTO.RequirementVerificationMembership ToDto(this Core.POCO.RequirementVerificationMembership poco)
        {
            var dto = new Core.DTO.RequirementVerificationMembership();
