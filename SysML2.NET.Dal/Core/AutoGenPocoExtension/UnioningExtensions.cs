// -------------------------------------------------------------------------------------------------
// <copyright file="UnioningExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class UnioningExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.Unioning poco, Core.DTO.Unioning dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.Unioning poco, Core.DTO.Unioning dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
            ...
            {
                poco.UnioningType = (Core.POCO.Type)lazyPoco.Value;
            }
            else
            {
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.Unioning"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.Unioning"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.Unioning"/>
        /// </returns>
        public static Core.DTO.Unioning ToDto(this Core.POCO.Unioning poco)
        {
            var dto = new Core.DTO.Unioning();
