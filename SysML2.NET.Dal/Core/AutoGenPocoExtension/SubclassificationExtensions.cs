...
namespace SysML2.NET.Dal
{
    ...
    /// <summary>
    /// A static class that provides extension methods for the <see cref="Core.POCO.Core.Classifiers.Subclassification"/> class
    /// </summary>
    public static class SubclassificationExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="Core.POCO.Core.Classifiers.Subclassification"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from contained properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="Core.POCO.Core.Classifiers.Subclassification"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="Core.DTO.Core.Classifiers.Subclassification"/> with
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.Core.Classifiers.Subclassification poco, Core.DTO.Core.Classifiers.Subclassification dto)
        {
            if (poco == null)
            {
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="Core.POCO.Core.Classifiers.Subclassification"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Core.POCO.Core.Classifiers.Subclassification poco, Core.DTO.Core.Classifiers.Subclassification dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.Root.Elements.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
            ...
            {
                poco.Superclassifier = null;
            }

        }

        /// <summary>
        /// Creates a <see cref="Core.DTO.Core.Classifiers.Subclassification"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.Core.Classifiers.Subclassification"/> from which a DTO is to be created
        /// </param>
        /// <param name="includeDerivedProperties">
        /// Asserts that derived properties should also be mapped during the creation of the <see cref="Core.DTO.Core.Classifiers.Subclassification"/>
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.Core.Classifiers.Subclassification"/>
        /// </returns>
        public static Core.DTO.Core.Classifiers.Subclassification ToDto(this Core.POCO.Core.Classifiers.Subclassification poco, bool includeDerivedProperties = false)
        {
            var dto = new Core.DTO.Core.Classifiers.Subclassification();
            ...
            if (includeDerivedProperties)
            {
                ...
                dto.owningClassifier = poco.owningClassifier?.Id;
