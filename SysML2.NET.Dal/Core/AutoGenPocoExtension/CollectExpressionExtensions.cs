...
namespace SysML2.NET.Dal
{
    ...
    public static class CollectExpressionExtensions
    {
        ...
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.Kernel.Expressions.CollectExpression poco, Core.DTO.Kernel.Expressions.CollectExpression dto)
        {
            ...
            ((Core.POCO.Kernel.Expressions.ICollectExpression)poco).Operator = ((Core.DTO.Kernel.Expressions.ICollectExpression)dto).Operator;
        ...
        /// </returns>
        public static Core.DTO.Kernel.Expressions.CollectExpression ToDto(this Core.POCO.Kernel.Expressions.CollectExpression poco)
        {
            ...
            ((Core.DTO.Kernel.Expressions.ICollectExpression)dto).Operator = ((Core.POCO.Kernel.Expressions.ICollectExpression)poco).Operator;
