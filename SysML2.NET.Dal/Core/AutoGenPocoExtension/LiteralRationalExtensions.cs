// -------------------------------------------------------------------------------------------------
// <copyright file="LiteralRationalExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class LiteralRationalExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.LiteralRational poco, Core.DTO.LiteralRational dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.LiteralRational poco, Core.DTO.LiteralRational dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.LiteralRational"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.LiteralRational"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.LiteralRational"/>
        /// </returns>
        public static Core.DTO.LiteralRational ToDto(this Core.POCO.LiteralRational poco)
        {
            var dto = new Core.DTO.LiteralRational();
