...
namespace SysML2.NET.Dal
{
    ...
    /// <summary>
    /// A static class that provides extension methods for the <see cref="Core.POCO.Systems.Attributes.AttributeDefinition"/> class
    /// </summary>
    public static class AttributeDefinitionExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="Core.POCO.Systems.Attributes.AttributeDefinition"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from contained properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="Core.POCO.Systems.Attributes.AttributeDefinition"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="Core.DTO.Systems.Attributes.AttributeDefinition"/> with
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="Core.POCO.Systems.Attributes.AttributeDefinition"/> using the data (identifiers) encapsulated in the DTO
        ...
        /// Asserts that derived properties should also be mapped during the creation of the <see cref="Core.DTO.Systems.Attributes.AttributeDefinition"/>
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.Systems.Attributes.AttributeDefinition"/>
        /// </returns>
        public static Core.DTO.Systems.Attributes.AttributeDefinition ToDto(this Core.POCO.Systems.Attributes.AttributeDefinition poco, bool includeDerivedProperties = false)
        {
