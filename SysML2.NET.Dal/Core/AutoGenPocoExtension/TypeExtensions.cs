...
namespace SysML2.NET.Dal
{
    ...
    /// <summary>
    /// A static class that provides extension methods for the <see cref="Core.POCO.Core.Types.Type"/> class
    /// </summary>
    public static class TypeExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="Core.POCO.Core.Types.Type"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from contained properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="Core.POCO.Core.Types.Type"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="Core.DTO.Core.Types.Type"/> with
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.Core.Types.Type poco, Core.DTO.Core.Types.Type dto)
        {
            if (poco == null)
            {
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="Core.POCO.Core.Types.Type"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Core.POCO.Core.Types.Type poco, Core.DTO.Core.Types.Type dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.Root.Elements.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.Core.Types.Type"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.Core.Types.Type"/> from which a DTO is to be created
        /// </param>
        /// <param name="includeDerivedProperties">
        /// Asserts that derived properties should also be mapped during the creation of the <see cref="Core.DTO.Core.Types.Type"/>
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.Core.Types.Type"/>
        /// </returns>
        public static Core.DTO.Core.Types.Type ToDto(this Core.POCO.Core.Types.Type poco, bool includeDerivedProperties = false)
        {
            var dto = new Core.DTO.Core.Types.Type();
