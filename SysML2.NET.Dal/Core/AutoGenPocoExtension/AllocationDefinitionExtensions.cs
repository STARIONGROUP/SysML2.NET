// -------------------------------------------------------------------------------------------------
// <copyright file="AllocationDefinitionExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class AllocationDefinitionExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.AllocationDefinition poco, Core.DTO.AllocationDefinition dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.AllocationDefinition poco, Core.DTO.AllocationDefinition dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.AllocationDefinition"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.AllocationDefinition"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.AllocationDefinition"/>
        /// </returns>
        public static Core.DTO.AllocationDefinition ToDto(this Core.POCO.AllocationDefinition poco)
        {
            var dto = new Core.DTO.AllocationDefinition();
