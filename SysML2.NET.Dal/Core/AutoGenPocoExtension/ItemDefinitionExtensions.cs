...
namespace SysML2.NET.Dal
{
    ...
    using Core.POCO.Systems.Items;

    /// <summary>
    /// A static class that provides extension methods for the <see cref="Core.POCO.Systems.Items.ItemDefinition"/> class
    /// </summary>
    public static class ItemDefinitionExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="Core.POCO.Systems.Items.ItemDefinition"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from contained properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="Core.POCO.Systems.Items.ItemDefinition"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="Core.DTO.Systems.Items.ItemDefinition"/> with
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.Systems.Items.ItemDefinition poco, Core.DTO.Systems.Items.ItemDefinition dto)
        {
            if (poco == null)
            {
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="Core.POCO.Systems.Items.ItemDefinition"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Core.POCO.Systems.Items.ItemDefinition poco, Core.DTO.Systems.Items.ItemDefinition dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.Root.Elements.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.Systems.Items.ItemDefinition"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.Systems.Items.ItemDefinition"/> from which a DTO is to be created
        /// </param>
        /// <param name="includeDerivedProperties">
        /// Asserts that derived properties should also be mapped during the creation of the <see cref="Core.DTO.Systems.Items.ItemDefinition"/>
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.Systems.Items.ItemDefinition"/>
        /// </returns>
        public static Core.DTO.Systems.Items.ItemDefinition ToDto(this Core.POCO.Systems.Items.ItemDefinition poco, bool includeDerivedProperties = false)
        {
            var dto = new Core.DTO.Systems.Items.ItemDefinition();
