// -------------------------------------------------------------------------------------------------
// <copyright file="VerificationCaseDefinitionExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class VerificationCaseDefinitionExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.VerificationCaseDefinition poco, Core.DTO.VerificationCaseDefinition dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.VerificationCaseDefinition poco, Core.DTO.VerificationCaseDefinition dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.VerificationCaseDefinition"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.VerificationCaseDefinition"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.VerificationCaseDefinition"/>
        /// </returns>
        public static Core.DTO.VerificationCaseDefinition ToDto(this Core.POCO.VerificationCaseDefinition poco)
        {
            var dto = new Core.DTO.VerificationCaseDefinition();
