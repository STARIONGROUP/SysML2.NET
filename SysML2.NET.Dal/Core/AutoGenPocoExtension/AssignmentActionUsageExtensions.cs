// -------------------------------------------------------------------------------------------------
// <copyright file="AssignmentActionUsageExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class AssignmentActionUsageExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.AssignmentActionUsage poco, Core.DTO.AssignmentActionUsage dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.AssignmentActionUsage poco, Core.DTO.AssignmentActionUsage dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.AssignmentActionUsage"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.AssignmentActionUsage"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.AssignmentActionUsage"/>
        /// </returns>
        public static Core.DTO.AssignmentActionUsage ToDto(this Core.POCO.AssignmentActionUsage poco)
        {
            var dto = new Core.DTO.AssignmentActionUsage();
