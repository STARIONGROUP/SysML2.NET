// -------------------------------------------------------------------------------------------------
// <copyright file="DecisionNodeExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class DecisionNodeExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.DecisionNode poco, Core.DTO.DecisionNode dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.DecisionNode poco, Core.DTO.DecisionNode dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.DecisionNode"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.DecisionNode"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.DecisionNode"/>
        /// </returns>
        public static Core.DTO.DecisionNode ToDto(this Core.POCO.DecisionNode poco)
        {
            var dto = new Core.DTO.DecisionNode();
