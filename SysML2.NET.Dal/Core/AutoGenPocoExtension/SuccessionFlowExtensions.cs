...
namespace SysML2.NET.Dal
{
    ...
    public static class SuccessionFlowExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.SuccessionFlow poco, Core.DTO.SuccessionFlow dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.SuccessionFlow poco, Core.DTO.SuccessionFlow dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.SuccessionFlow"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.SuccessionFlow"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.SuccessionFlow"/>
        /// </returns>
        public static Core.DTO.SuccessionFlow ToDto(this Core.POCO.SuccessionFlow poco)
        {
            var dto = new Core.DTO.SuccessionFlow();
