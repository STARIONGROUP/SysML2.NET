// -------------------------------------------------------------------------------------------------
// <copyright file="OccurrenceUsageExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class OccurrenceUsageExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.OccurrenceUsage poco, Core.DTO.OccurrenceUsage dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.OccurrenceUsage poco, Core.DTO.OccurrenceUsage dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.OccurrenceUsage"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.OccurrenceUsage"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.OccurrenceUsage"/>
        /// </returns>
        public static Core.DTO.OccurrenceUsage ToDto(this Core.POCO.OccurrenceUsage poco)
        {
            var dto = new Core.DTO.OccurrenceUsage();
