// -------------------------------------------------------------------------------------------------
// <copyright file="ConnectionDefinitionExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class ConnectionDefinitionExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.ConnectionDefinition poco, Core.DTO.ConnectionDefinition dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.ConnectionDefinition poco, Core.DTO.ConnectionDefinition dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.ConnectionDefinition"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.ConnectionDefinition"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.ConnectionDefinition"/>
        /// </returns>
        public static Core.DTO.ConnectionDefinition ToDto(this Core.POCO.ConnectionDefinition poco)
        {
            var dto = new Core.DTO.ConnectionDefinition();
