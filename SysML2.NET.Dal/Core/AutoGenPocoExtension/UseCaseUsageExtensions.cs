// -------------------------------------------------------------------------------------------------
// <copyright file="UseCaseUsageExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class UseCaseUsageExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.UseCaseUsage poco, Core.DTO.UseCaseUsage dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.UseCaseUsage poco, Core.DTO.UseCaseUsage dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.UseCaseUsage"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.UseCaseUsage"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.UseCaseUsage"/>
        /// </returns>
        public static Core.DTO.UseCaseUsage ToDto(this Core.POCO.UseCaseUsage poco)
        {
            var dto = new Core.DTO.UseCaseUsage();
