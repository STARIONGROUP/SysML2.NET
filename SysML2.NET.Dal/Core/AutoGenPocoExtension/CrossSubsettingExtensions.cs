...
namespace SysML2.NET.Dal
{
    ...
    public static class CrossSubsettingExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.CrossSubsetting poco, Core.DTO.CrossSubsetting dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.CrossSubsetting poco, Core.DTO.CrossSubsetting dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
            ...
            {
                poco.CrossedFeature = (Core.POCO.Feature)lazyPoco.Value;
            }
            else
            {
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.CrossSubsetting"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.CrossSubsetting"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.CrossSubsetting"/>
        /// </returns>
        public static Core.DTO.CrossSubsetting ToDto(this Core.POCO.CrossSubsetting poco)
        {
            var dto = new Core.DTO.CrossSubsetting();
