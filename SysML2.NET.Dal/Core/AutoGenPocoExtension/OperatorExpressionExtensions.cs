// -------------------------------------------------------------------------------------------------
// <copyright file="OperatorExpressionExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class OperatorExpressionExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.OperatorExpression poco, Core.DTO.OperatorExpression dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.OperatorExpression poco, Core.DTO.OperatorExpression dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.OperatorExpression"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.OperatorExpression"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.OperatorExpression"/>
        /// </returns>
        public static Core.DTO.OperatorExpression ToDto(this Core.POCO.OperatorExpression poco)
        {
            var dto = new Core.DTO.OperatorExpression();
