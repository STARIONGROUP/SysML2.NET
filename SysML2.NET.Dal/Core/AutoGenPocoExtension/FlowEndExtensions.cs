...
namespace SysML2.NET.Dal
{
    ...
    public static class FlowEndExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.FlowEnd poco, Core.DTO.FlowEnd dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.FlowEnd poco, Core.DTO.FlowEnd dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.FlowEnd"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.FlowEnd"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.FlowEnd"/>
        /// </returns>
        public static Core.DTO.FlowEnd ToDto(this Core.POCO.FlowEnd poco)
        {
            var dto = new Core.DTO.FlowEnd();
