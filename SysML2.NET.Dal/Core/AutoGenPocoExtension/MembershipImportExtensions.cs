// -------------------------------------------------------------------------------------------------
// <copyright file="MembershipImportExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class MembershipImportExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.MembershipImport poco, Core.DTO.MembershipImport dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.MembershipImport poco, Core.DTO.MembershipImport dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
            ...
            {
                poco.ImportedMembership = (Core.POCO.Membership)lazyPoco.Value;
            }
            else
            {
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.MembershipImport"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.MembershipImport"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.MembershipImport"/>
        /// </returns>
        public static Core.DTO.MembershipImport ToDto(this Core.POCO.MembershipImport poco)
        {
            var dto = new Core.DTO.MembershipImport();
