...
namespace SysML2.NET.Dal
{
    ...
    public static class ConstructorExpressionExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.ConstructorExpression poco, Core.DTO.ConstructorExpression dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.ConstructorExpression poco, Core.DTO.ConstructorExpression dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.ConstructorExpression"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.ConstructorExpression"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.ConstructorExpression"/>
        /// </returns>
        public static Core.DTO.ConstructorExpression ToDto(this Core.POCO.ConstructorExpression poco)
        {
            var dto = new Core.DTO.ConstructorExpression();
