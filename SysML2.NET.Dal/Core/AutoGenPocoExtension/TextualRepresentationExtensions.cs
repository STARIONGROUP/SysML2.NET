...
namespace SysML2.NET.Dal
{
    ...
    public static class TextualRepresentationExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.Root.Annotations.TextualRepresentation poco, Core.DTO.Root.Annotations.TextualRepresentation dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.Root.Annotations.TextualRepresentation poco, Core.DTO.Root.Annotations.TextualRepresentation dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.Root.Elements.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.Root.Annotations.TextualRepresentation"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
