// -------------------------------------------------------------------------------------------------
// <copyright file="EventOccurrenceUsageExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class EventOccurrenceUsageExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.EventOccurrenceUsage poco, Core.DTO.EventOccurrenceUsage dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.EventOccurrenceUsage poco, Core.DTO.EventOccurrenceUsage dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.EventOccurrenceUsage"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.EventOccurrenceUsage"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.EventOccurrenceUsage"/>
        /// </returns>
        public static Core.DTO.EventOccurrenceUsage ToDto(this Core.POCO.EventOccurrenceUsage poco)
        {
            var dto = new Core.DTO.EventOccurrenceUsage();
