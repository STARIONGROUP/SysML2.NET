// -------------------------------------------------------------------------------------------------
// <copyright file="SuccessionFlowConnectionUsageExtensions.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    /// <summary>
    /// A static class that provides extension methods for the <see cref="SuccessionFlowConnectionUsage"/> class
    /// </summary>
    public static class SuccessionFlowConnectionUsageExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="SuccessionFlowConnectionUsage"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from contained properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="SuccessionFlowConnectionUsage"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="SuccessionFlowConnectionUsage"/> with
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.SuccessionFlowConnectionUsage poco, Core.DTO.SuccessionFlowConnectionUsage dto)
        {
            if (poco == null)
            {
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="SuccessionFlowConnectionUsage"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Core.POCO.SuccessionFlowConnectionUsage poco, Core.DTO.SuccessionFlowConnectionUsage dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.SuccessionFlowConnectionUsage"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.SuccessionFlowConnectionUsage"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.SuccessionFlowConnectionUsage"/>
        /// </returns>
        public static Core.DTO.SuccessionFlowConnectionUsage ToDto(this Core.POCO.SuccessionFlowConnectionUsage poco)
        {
            var dto = new Core.DTO.SuccessionFlowConnectionUsage();
