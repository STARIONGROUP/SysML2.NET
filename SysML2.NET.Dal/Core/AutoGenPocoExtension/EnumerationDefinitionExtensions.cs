...
namespace SysML2.NET.Dal
{
    ...
    /// <summary>
    /// A static class that provides extension methods for the <see cref="Core.POCO.Systems.Enumerations.EnumerationDefinition"/> class
    /// </summary>
    public static class EnumerationDefinitionExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="Core.POCO.Systems.Enumerations.EnumerationDefinition"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from contained properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="Core.POCO.Systems.Enumerations.EnumerationDefinition"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="Core.DTO.Systems.Enumerations.EnumerationDefinition"/> with
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="Core.POCO.Systems.Enumerations.EnumerationDefinition"/> using the data (identifiers) encapsulated in the DTO
        ...
        /// Asserts that derived properties should also be mapped during the creation of the <see cref="Core.DTO.Systems.Enumerations.EnumerationDefinition"/>
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.Systems.Enumerations.EnumerationDefinition"/>
        /// </returns>
        public static Core.DTO.Systems.Enumerations.EnumerationDefinition ToDto(this Core.POCO.Systems.Enumerations.EnumerationDefinition poco, bool includeDerivedProperties = false)
        {
            ...
            if (includeDerivedProperties)
            {
                ...
                dto.enumeratedValue = poco.enumeratedValue.Select(x => x.Id).ToList();
