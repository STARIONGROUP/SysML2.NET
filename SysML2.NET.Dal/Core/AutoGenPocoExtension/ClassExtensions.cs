...
namespace SysML2.NET.Dal
{
    ...
    using Core.POCO.Kernel.Classes;

    /// <summary>
    /// A static class that provides extension methods for the <see cref="Core.POCO.Kernel.Classes.Class"/> class
    /// </summary>
    public static class ClassExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="Core.POCO.Kernel.Classes.Class"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from contained properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="Core.POCO.Kernel.Classes.Class"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="Core.DTO.Kernel.Classes.Class"/> with
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.Kernel.Classes.Class poco, Core.DTO.Kernel.Classes.Class dto)
        {
            if (poco == null)
            {
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="Core.POCO.Kernel.Classes.Class"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Core.POCO.Kernel.Classes.Class poco, Core.DTO.Kernel.Classes.Class dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.Root.Elements.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.Kernel.Classes.Class"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.Kernel.Classes.Class"/> from which a DTO is to be created
        /// </param>
        /// <param name="includeDerivedProperties">
        /// Asserts that derived properties should also be mapped during the creation of the <see cref="Core.DTO.Kernel.Classes.Class"/>
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.Kernel.Classes.Class"/>
        /// </returns>
        public static Core.DTO.Kernel.Classes.Class ToDto(this Core.POCO.Kernel.Classes.Class poco, bool includeDerivedProperties = false)
        {
            var dto = new Core.DTO.Kernel.Classes.Class();
