// -------------------------------------------------------------------------------------------------
// <copyright file="BindingConnectorExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class BindingConnectorExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.BindingConnector poco, Core.DTO.BindingConnector dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.BindingConnector poco, Core.DTO.BindingConnector dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.BindingConnector"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.BindingConnector"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.BindingConnector"/>
        /// </returns>
        public static Core.DTO.BindingConnector ToDto(this Core.POCO.BindingConnector poco)
        {
            var dto = new Core.DTO.BindingConnector();
