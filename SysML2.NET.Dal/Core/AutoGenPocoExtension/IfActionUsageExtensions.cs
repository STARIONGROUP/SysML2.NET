...
namespace SysML2.NET.Dal
{
    ...
    /// <summary>
    /// A static class that provides extension methods for the <see cref="Core.POCO.Systems.Actions.IfActionUsage"/> class
    /// </summary>
    public static class IfActionUsageExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="Core.POCO.Systems.Actions.IfActionUsage"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from contained properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="Core.POCO.Systems.Actions.IfActionUsage"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="Core.DTO.Systems.Actions.IfActionUsage"/> with
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="Core.POCO.Systems.Actions.IfActionUsage"/> using the data (identifiers) encapsulated in the DTO
        ...
        /// Asserts that derived properties should also be mapped during the creation of the <see cref="Core.DTO.Systems.Actions.IfActionUsage"/>
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.Systems.Actions.IfActionUsage"/>
        /// </returns>
        public static Core.DTO.Systems.Actions.IfActionUsage ToDto(this Core.POCO.Systems.Actions.IfActionUsage poco, bool includeDerivedProperties = false)
        {
            ...
            if (includeDerivedProperties)
            {
                ...
                dto.elseAction = poco.elseAction?.Id;
                ...
                dto.ifArgument = poco.ifArgument.Id;
                ...
                dto.thenAction = poco.thenAction.Id;
