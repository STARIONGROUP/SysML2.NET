...
namespace SysML2.NET.Dal
{
    ...
    public static class IfActionUsageExtensions
    {
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.IfActionUsage"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.IfActionUsage"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.IfActionUsage"/>
        /// </returns>
        public static Core.DTO.IfActionUsage ToDto(this Core.POCO.IfActionUsage poco)
        {
            var dto = new Core.DTO.IfActionUsage();
