...
namespace SysML2.NET.Dal
{
    ...
    public static class BooleanExpressionExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.BooleanExpression poco, Core.DTO.BooleanExpression dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.BooleanExpression poco, Core.DTO.BooleanExpression dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.BooleanExpression"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.BooleanExpression"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.BooleanExpression"/>
        /// </returns>
        public static Core.DTO.BooleanExpression ToDto(this Core.POCO.BooleanExpression poco)
        {
            var dto = new Core.DTO.BooleanExpression();
