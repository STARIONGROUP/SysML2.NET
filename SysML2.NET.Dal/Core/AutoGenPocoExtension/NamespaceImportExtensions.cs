...
namespace SysML2.NET.Dal
{
    ...
    /// <summary>
    /// A static class that provides extension methods for the <see cref="Core.POCO.Root.Namespaces.NamespaceImport"/> class
    /// </summary>
    public static class NamespaceImportExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="Core.POCO.Root.Namespaces.NamespaceImport"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from contained properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="Core.POCO.Root.Namespaces.NamespaceImport"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="Core.DTO.Root.Namespaces.NamespaceImport"/> with
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="Core.POCO.Root.Namespaces.NamespaceImport"/> using the data (identifiers) encapsulated in the DTO
        ...
        /// Asserts that derived properties should also be mapped during the creation of the <see cref="Core.DTO.Root.Namespaces.NamespaceImport"/>
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.Root.Namespaces.NamespaceImport"/>
        /// </returns>
        public static Core.DTO.Root.Namespaces.NamespaceImport ToDto(this Core.POCO.Root.Namespaces.NamespaceImport poco, bool includeDerivedProperties = false)
        {
