// -------------------------------------------------------------------------------------------------
// <copyright file="WhileLoopActionUsageExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class WhileLoopActionUsageExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.WhileLoopActionUsage poco, Core.DTO.WhileLoopActionUsage dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.WhileLoopActionUsage poco, Core.DTO.WhileLoopActionUsage dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.WhileLoopActionUsage"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.WhileLoopActionUsage"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.WhileLoopActionUsage"/>
        /// </returns>
        public static Core.DTO.WhileLoopActionUsage ToDto(this Core.POCO.WhileLoopActionUsage poco)
        {
            var dto = new Core.DTO.WhileLoopActionUsage();
