// -------------------------------------------------------------------------------------------------
// <copyright file="IntersectingExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class IntersectingExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.Intersecting poco, Core.DTO.Intersecting dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.Intersecting poco, Core.DTO.Intersecting dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
            ...
            {
                poco.IntersectingType = (Core.POCO.Type)lazyPoco.Value;
            }
            else
            {
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.Intersecting"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.Intersecting"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.Intersecting"/>
        /// </returns>
        public static Core.DTO.Intersecting ToDto(this Core.POCO.Intersecting poco)
        {
            var dto = new Core.DTO.Intersecting();
