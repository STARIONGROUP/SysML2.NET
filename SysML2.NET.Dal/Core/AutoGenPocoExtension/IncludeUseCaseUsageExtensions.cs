// -------------------------------------------------------------------------------------------------
// <copyright file="IncludeUseCaseUsageExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class IncludeUseCaseUsageExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.IncludeUseCaseUsage poco, Core.DTO.IncludeUseCaseUsage dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.IncludeUseCaseUsage poco, Core.DTO.IncludeUseCaseUsage dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.IncludeUseCaseUsage"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.IncludeUseCaseUsage"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.IncludeUseCaseUsage"/>
        /// </returns>
        public static Core.DTO.IncludeUseCaseUsage ToDto(this Core.POCO.IncludeUseCaseUsage poco)
        {
            var dto = new Core.DTO.IncludeUseCaseUsage();
