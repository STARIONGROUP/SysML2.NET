// -------------------------------------------------------------------------------------------------
// <copyright file="LiteralStringExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class LiteralStringExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.LiteralString poco, Core.DTO.LiteralString dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.LiteralString poco, Core.DTO.LiteralString dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.LiteralString"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.LiteralString"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.LiteralString"/>
        /// </returns>
        public static Core.DTO.LiteralString ToDto(this Core.POCO.LiteralString poco)
        {
            var dto = new Core.DTO.LiteralString();
