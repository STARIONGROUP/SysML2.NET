// -------------------------------------------------------------------------------------------------
// <copyright file="MetadataAccessExpressionExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class MetadataAccessExpressionExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.MetadataAccessExpression poco, Core.DTO.MetadataAccessExpression dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.MetadataAccessExpression poco, Core.DTO.MetadataAccessExpression dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
            ...
            if (cache.TryGetValue(dto.ReferencedElement, out lazyPoco))
            {
                poco.ReferencedElement = (IElement)lazyPoco.Value;
            }
            else
            {
                poco.ReferencedElement = null;
            }
