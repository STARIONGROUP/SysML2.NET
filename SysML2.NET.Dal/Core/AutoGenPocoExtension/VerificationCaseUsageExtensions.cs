// -------------------------------------------------------------------------------------------------
// <copyright file="VerificationCaseUsageExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class VerificationCaseUsageExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.VerificationCaseUsage poco, Core.DTO.VerificationCaseUsage dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.VerificationCaseUsage poco, Core.DTO.VerificationCaseUsage dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.VerificationCaseUsage"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.VerificationCaseUsage"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.VerificationCaseUsage"/>
        /// </returns>
        public static Core.DTO.VerificationCaseUsage ToDto(this Core.POCO.VerificationCaseUsage poco)
        {
            var dto = new Core.DTO.VerificationCaseUsage();
