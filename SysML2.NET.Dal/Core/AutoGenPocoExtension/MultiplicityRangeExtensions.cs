// -------------------------------------------------------------------------------------------------
// <copyright file="MultiplicityRangeExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    /// <summary>
    /// A static class that provides extension methods for the <see cref="MultiplicityRange"/> class
    /// </summary>
    public static class MultiplicityRangeExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="MultiplicityRange"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from contained properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="MultiplicityRange"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="MultiplicityRange"/> with
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.MultiplicityRange poco, Core.DTO.MultiplicityRange dto)
        {
            if (poco == null)
            {
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="MultiplicityRange"/> using the data (identifiers) encapsulated in the DTO
        ...
        public static void UpdateReferenceProperties(this Core.POCO.MultiplicityRange poco, Core.DTO.MultiplicityRange dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.MultiplicityRange"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.MultiplicityRange"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.MultiplicityRange"/>
        /// </returns>
        public static Core.DTO.MultiplicityRange ToDto(this Core.POCO.MultiplicityRange poco)
        {
            var dto = new Core.DTO.MultiplicityRange();
