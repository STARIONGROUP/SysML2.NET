...
namespace SysML2.NET.Dal
{
    ...
    /// <summary>
    /// A static class that provides extension methods for the <see cref="TypeFeaturing"/> class
    /// </summary>
    public static class TypeFeaturingExtensions
    {
        /// <summary>
        /// Updates the value properties of the <see cref="TypeFeaturing"/> by setting the value equal to that of the dto
        /// Removes deleted objects from the reference properties and returns the unique identifiers
        /// of the objects that have been removed from contained properties
        /// </summary>
        /// <param name="poco">
        /// The <see cref="TypeFeaturing"/> that is to be updated
        /// </param>
        /// <param name="dto">
        /// The DTO that is used to update the <see cref="TypeFeaturing"/> with
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Updates the Reference properties of the <see cref="TypeFeaturing"/> using the data (identifiers) encapsulated in the DTO
