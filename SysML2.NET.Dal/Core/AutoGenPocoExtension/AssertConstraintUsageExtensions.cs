// -------------------------------------------------------------------------------------------------
// <copyright file="AssertConstraintUsageExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class AssertConstraintUsageExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.AssertConstraintUsage poco, Core.DTO.AssertConstraintUsage dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.AssertConstraintUsage poco, Core.DTO.AssertConstraintUsage dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.AssertConstraintUsage"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.AssertConstraintUsage"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.AssertConstraintUsage"/>
        /// </returns>
        public static Core.DTO.AssertConstraintUsage ToDto(this Core.POCO.AssertConstraintUsage poco)
        {
            var dto = new Core.DTO.AssertConstraintUsage();
