...
namespace SysML2.NET.Dal
{
    ...
    public class InvariantFactory
    {
        ...
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Core.DTO.Kernel.Functions.Invariant"/>
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static Core.POCO.Kernel.Functions.Invariant Create(Core.DTO.Kernel.Functions.Invariant dto)
        {
            if (dto == null)
            {
            ...
            var poco = new Core.POCO.Kernel.Functions.Invariant();
