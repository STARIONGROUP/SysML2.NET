...
namespace SysML2.NET.Dal
{
    ...
    public static class PerformActionUsageFactory
    {
        ...
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Core.DTO.Systems.Actions.PerformActionUsage"/>
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static Core.POCO.Systems.Actions.PerformActionUsage Create(Core.DTO.Systems.Actions.PerformActionUsage dto)
        {
            if (dto == null)
            {
            ...
            var poco = new Core.POCO.Systems.Actions.PerformActionUsage();
