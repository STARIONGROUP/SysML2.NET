...
namespace SysML2.NET.Dal
{
    ...
    public static class ViewDefinitionFactory
    {
        ...
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Core.DTO.Systems.Views.ViewDefinition"/>
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static Core.POCO.Systems.Views.ViewDefinition Create(Core.DTO.Systems.Views.ViewDefinition dto)
        {
            if (dto == null)
            {
            ...
            var poco = new Core.POCO.Systems.Views.ViewDefinition();
