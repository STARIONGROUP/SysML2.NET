...
namespace SysML2.NET.Dal
{
    ...
    public class MetadataAccessExpressionFactory
    {
        ...
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Core.DTO.Kernel.Expressions.MetadataAccessExpression"/>
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static Core.POCO.Kernel.Expressions.MetadataAccessExpression Create(Core.DTO.Kernel.Expressions.MetadataAccessExpression dto)
        {
            if (dto == null)
            {
            ...
            var poco = new Core.POCO.Kernel.Expressions.MetadataAccessExpression();
