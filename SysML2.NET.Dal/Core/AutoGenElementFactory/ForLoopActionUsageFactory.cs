...
namespace SysML2.NET.Dal
{
    ...
    public static class ForLoopActionUsageFactory
    {
        ...
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Core.DTO.Systems.Actions.ForLoopActionUsage"/>
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static Core.POCO.Systems.Actions.ForLoopActionUsage Create(Core.DTO.Systems.Actions.ForLoopActionUsage dto)
        {
            if (dto == null)
            {
            ...
            var poco = new Core.POCO.Systems.Actions.ForLoopActionUsage();
