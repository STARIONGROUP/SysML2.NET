...
namespace SysML2.NET.Dal
{
    ...
    public static class MergeNodeFactory
    {
        ...
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Core.DTO.Systems.Actions.MergeNode"/>
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static Core.POCO.Systems.Actions.MergeNode Create(Core.DTO.Systems.Actions.MergeNode dto)
        {
            if (dto == null)
            {
            ...
            var poco = new Core.POCO.Systems.Actions.MergeNode();
