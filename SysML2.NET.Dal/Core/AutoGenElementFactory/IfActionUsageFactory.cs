// -------------------------------------------------------------------------------------------------
// <copyright file="IfActionUsageFactory.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    /// <see cref="Core.POCO.Systems.Actions.IfActionUsage"/> based on a <see cref="Core.DTO.Systems.Actions.IfActionUsage"/>
    /// </summary>
    public static class IfActionUsageFactory
    {
        /// <summary>
        /// Creates an instance of the <see cref="Core.POCO.Systems.Actions.IfActionUsage"/> and sets the value properties
        /// based on the DTO
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Core.DTO.Systems.Actions.IfActionUsage"/>
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static Core.POCO.Systems.Actions.IfActionUsage Create(Core.DTO.Systems.Actions.IfActionUsage dto)
        {
            if (dto == null)
            {
            ...
            var poco = new Core.POCO.Systems.Actions.IfActionUsage();
