...
namespace SysML2.NET.Dal
{
    ...
    public class ViewUsageFactory
    {
        ...
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Core.DTO.Systems.Views.ViewUsage"/>
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static Core.POCO.Systems.Views.ViewUsage Create(Core.DTO.Systems.Views.ViewUsage dto)
        {
            if (dto == null)
            {
            ...
            var poco = new Core.POCO.Systems.Views.ViewUsage();
