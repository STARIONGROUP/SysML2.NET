// -------------------------------------------------------------------------------------------------
// <copyright file="VariantMembershipFactory.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class VariantMembershipFactory
    {
        ...
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Core.DTO.Systems.DefinitionAndUsage.VariantMembership"/>
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static Core.POCO.Systems.DefinitionAndUsage.VariantMembership Create(Core.DTO.Systems.DefinitionAndUsage.VariantMembership dto)
        {
            if (dto == null)
            {
            ...
            var poco = new Core.POCO.Systems.DefinitionAndUsage.VariantMembership();
