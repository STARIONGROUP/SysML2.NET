...
namespace SysML2.NET.Dal
{
    ...
    /// <see cref="Core.POCO.FlowEnd"/> based on a <see cref="Core.DTO.FlowEnd"/>
    /// </summary>
    public class FlowEndFactory
    {
        /// <summary>
        /// Creates an instance of the <see cref="Core.POCO.FlowEnd"/> and sets the value properties
        /// based on the DTO
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Core.DTO.FlowEnd"/>
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public Core.POCO.FlowEnd Create(Core.DTO.FlowEnd dto)
        {
            if (dto == null)
            {
            ...
            var poco = new Core.POCO.FlowEnd
            {
                Id = dto.Id,
