...
namespace SysML2.NET.Dal
{
    ...
    public static class ConnectionUsageFactory
    {
        ...
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Core.DTO.Systems.Connections.ConnectionUsage"/>
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static Core.POCO.Systems.Connections.ConnectionUsage Create(Core.DTO.Systems.Connections.ConnectionUsage dto)
        {
            if (dto == null)
            {
            ...
            var poco = new Core.POCO.Systems.Connections.ConnectionUsage();
