// -------------------------------------------------------------------------------------------------
// <copyright file="CollectExpressionFactory.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public class CollectExpressionFactory
    {
        ...
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Core.DTO.Kernel.Expressions.CollectExpression"/>
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public Core.POCO.Kernel.Expressions.CollectExpression Create(Core.DTO.Kernel.Expressions.CollectExpression dto)
        {
            if (dto == null)
            {
            ...
            var poco = new Core.POCO.Kernel.Expressions.CollectExpression();
