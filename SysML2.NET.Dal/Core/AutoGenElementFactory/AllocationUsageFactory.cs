// -------------------------------------------------------------------------------------------------
// <copyright file="AllocationUsageFactory.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public class AllocationUsageFactory
    {
        ...
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Core.DTO.Systems.Allocations.AllocationUsage"/>
        /// </param>
        /// <returns>
        ...
        public static Core.POCO.Systems.Allocations.AllocationUsage Create(Core.DTO.Systems.Allocations.AllocationUsage dto)
        {
            ...
            var poco = new Core.POCO.Systems.Allocations.AllocationUsage();
