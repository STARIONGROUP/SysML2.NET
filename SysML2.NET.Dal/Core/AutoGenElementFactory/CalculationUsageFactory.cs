...
namespace SysML2.NET.Dal
{
    ...
    public class CalculationUsageFactory
    {
        ...
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Core.DTO.Systems.Calculations.CalculationUsage"/>
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static Core.POCO.Systems.Calculations.CalculationUsage Create(Core.DTO.Systems.Calculations.CalculationUsage dto)
        {
            if (dto == null)
            {
            ...
            var poco = new Core.POCO.Systems.Calculations.CalculationUsage();
