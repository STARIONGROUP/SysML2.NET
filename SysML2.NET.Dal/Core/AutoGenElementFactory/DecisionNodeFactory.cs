...
namespace SysML2.NET.Dal
{
    ...
    /// <see cref="Core.POCO.Systems.Actions.DecisionNode"/> based on a <see cref="Core.DTO.Systems.Actions.DecisionNode"/>
    /// </summary>
    public class DecisionNodeFactory
    {
        /// <summary>
        /// Creates an instance of the <see cref="Core.POCO.Systems.Actions.DecisionNode"/> and sets the value properties
        /// based on the DTO
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Core.DTO.Systems.Actions.DecisionNode"/>
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static Core.POCO.Systems.Actions.DecisionNode Create(Core.DTO.Systems.Actions.DecisionNode dto)
        {
            if (dto == null)
            {
            ...
            var poco = new Core.POCO.Systems.Actions.DecisionNode();
