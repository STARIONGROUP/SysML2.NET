...
namespace SysML2.NET.Dal
{
    ...
    public static class SuccessionFlowUsageFactory
    {
        ...
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Core.DTO.Systems.Flows.SuccessionFlowUsage"/>
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static Core.POCO.Systems.Flows.SuccessionFlowUsage Create(Core.DTO.Systems.Flows.SuccessionFlowUsage dto)
        {
            if (dto == null)
            {
            ...
            var poco = new Core.POCO.Systems.Flows.SuccessionFlowUsage();
