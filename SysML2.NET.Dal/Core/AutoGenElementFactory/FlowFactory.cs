...
namespace SysML2.NET.Dal
{
    ...
    public static class FlowFactory
    {
        ...
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Core.DTO.Kernel.Interactions.Flow"/>
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static Core.POCO.Kernel.Interactions.Flow Create(Core.DTO.Kernel.Interactions.Flow dto)
        {
            if (dto == null)
            {
            ...
            var poco = new Core.POCO.Kernel.Interactions.Flow();
