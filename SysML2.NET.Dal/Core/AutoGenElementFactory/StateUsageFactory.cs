...
namespace SysML2.NET.Dal
{
    ...
    public static class StateUsageFactory
    {
        ...
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Core.DTO.Systems.States.StateUsage"/>
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static Core.POCO.Systems.States.StateUsage Create(Core.DTO.Systems.States.StateUsage dto)
        {
            if (dto == null)
            {
            ...
            var poco = new Core.POCO.Systems.States.StateUsage();
