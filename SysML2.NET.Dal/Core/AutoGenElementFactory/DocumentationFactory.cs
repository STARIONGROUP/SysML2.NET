...
namespace SysML2.NET.Dal
{
    ...
    public static class DocumentationFactory
    {
        ...
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Core.DTO.Root.Annotations.Documentation"/>
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static Core.POCO.Root.Annotations.Documentation Create(Core.DTO.Root.Annotations.Documentation dto)
        {
            if (dto == null)
            {
            ...
            var poco = new Core.POCO.Root.Annotations.Documentation();
