...
namespace SysML2.NET.Dal
{
    ...
    public static class InterfaceDefinitionFactory
    {
        ...
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Core.DTO.Systems.Interfaces.InterfaceDefinition"/>
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static Core.POCO.Systems.Interfaces.InterfaceDefinition Create(Core.DTO.Systems.Interfaces.InterfaceDefinition dto)
        {
            if (dto == null)
            {
            ...
            var poco = new Core.POCO.Systems.Interfaces.InterfaceDefinition();
