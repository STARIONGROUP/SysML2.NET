...
namespace SysML2.NET.Dal
{
    ...
    public static class AnnotationFactory
    {
        ...
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Core.DTO.Root.Annotations.Annotation"/>
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static Core.POCO.Root.Annotations.Annotation Create(Core.DTO.Root.Annotations.Annotation dto)
        {
            if (dto == null)
            {
            ...
            var poco = new Core.POCO.Root.Annotations.Annotation();
