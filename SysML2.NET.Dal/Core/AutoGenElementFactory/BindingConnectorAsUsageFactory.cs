...
namespace SysML2.NET.Dal
{
    ...
    public static class BindingConnectorAsUsageFactory
    {
        ...
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Core.DTO.Systems.Connections.BindingConnectorAsUsage"/>
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static Core.POCO.Systems.Connections.BindingConnectorAsUsage Create(Core.DTO.Systems.Connections.BindingConnectorAsUsage dto)
        {
            if (dto == null)
            {
            ...
            var poco = new Core.POCO.Systems.Connections.BindingConnectorAsUsage();
