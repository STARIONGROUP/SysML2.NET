// -------------------------------------------------------------------------------------------------
// <copyright file="BindingConnectorAsUsageExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class BindingConnectorAsUsageExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.BindingConnectorAsUsage poco, Core.DTO.BindingConnectorAsUsage dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.BindingConnectorAsUsage poco, Core.DTO.BindingConnectorAsUsage dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.BindingConnectorAsUsage"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.BindingConnectorAsUsage"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.BindingConnectorAsUsage"/>
        /// </returns>
        public static Core.DTO.BindingConnectorAsUsage ToDto(this Core.POCO.BindingConnectorAsUsage poco)
        {
            var dto = new Core.DTO.BindingConnectorAsUsage();
