...
namespace SysML2.NET.Dal
{
    ...
    public static class FeatureInvertingExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.FeatureInverting poco, Core.DTO.FeatureInverting dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.FeatureInverting poco, Core.DTO.FeatureInverting dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
            ...
            {
                poco.FeatureInverted = (Core.POCO.Feature)lazyPoco.Value;
            }
            else
            {
            ...
            {
                poco.InvertingFeature = (Core.POCO.Feature)lazyPoco.Value;
            }
            else
            {
