// -------------------------------------------------------------------------------------------------
// <copyright file="CalculationDefinitionExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class CalculationDefinitionExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.CalculationDefinition poco, Core.DTO.CalculationDefinition dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.CalculationDefinition poco, Core.DTO.CalculationDefinition dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.CalculationDefinition"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.CalculationDefinition"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.CalculationDefinition"/>
        /// </returns>
        public static Core.DTO.CalculationDefinition ToDto(this Core.POCO.CalculationDefinition poco)
        {
            var dto = new Core.DTO.CalculationDefinition();
