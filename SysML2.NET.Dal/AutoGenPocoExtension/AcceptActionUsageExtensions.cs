// -------------------------------------------------------------------------------------------------
// <copyright file="AcceptActionUsageExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class AcceptActionUsageExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.AcceptActionUsage poco, Core.DTO.AcceptActionUsage dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.AcceptActionUsage poco, Core.DTO.AcceptActionUsage dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.AcceptActionUsage"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.AcceptActionUsage"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.AcceptActionUsage"/>
        /// </returns>
        public static Core.DTO.AcceptActionUsage ToDto(this Core.POCO.AcceptActionUsage poco)
        {
            var dto = new Core.DTO.AcceptActionUsage();
