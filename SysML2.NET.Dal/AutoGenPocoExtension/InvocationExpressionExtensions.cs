// -------------------------------------------------------------------------------------------------
// <copyright file="InvocationExpressionExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class InvocationExpressionExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.InvocationExpression poco, Core.DTO.InvocationExpression dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.InvocationExpression poco, Core.DTO.InvocationExpression dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.InvocationExpression"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.InvocationExpression"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.InvocationExpression"/>
        /// </returns>
        public static Core.DTO.InvocationExpression ToDto(this Core.POCO.InvocationExpression poco)
        {
            var dto = new Core.DTO.InvocationExpression();
