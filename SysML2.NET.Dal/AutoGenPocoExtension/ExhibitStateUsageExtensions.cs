// -------------------------------------------------------------------------------------------------
// <copyright file="ExhibitStateUsageExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class ExhibitStateUsageExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.ExhibitStateUsage poco, Core.DTO.ExhibitStateUsage dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.ExhibitStateUsage poco, Core.DTO.ExhibitStateUsage dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.ExhibitStateUsage"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.ExhibitStateUsage"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.ExhibitStateUsage"/>
        /// </returns>
        public static Core.DTO.ExhibitStateUsage ToDto(this Core.POCO.ExhibitStateUsage poco)
        {
            var dto = new Core.DTO.ExhibitStateUsage();
