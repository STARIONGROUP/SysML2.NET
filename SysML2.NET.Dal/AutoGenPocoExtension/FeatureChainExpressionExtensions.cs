// -------------------------------------------------------------------------------------------------
// <copyright file="FeatureChainExpressionExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class FeatureChainExpressionExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.FeatureChainExpression poco, Core.DTO.FeatureChainExpression dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.FeatureChainExpression poco, Core.DTO.FeatureChainExpression dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.FeatureChainExpression"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.FeatureChainExpression"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.FeatureChainExpression"/>
        /// </returns>
        public static Core.DTO.FeatureChainExpression ToDto(this Core.POCO.FeatureChainExpression poco)
        {
            var dto = new Core.DTO.FeatureChainExpression();
