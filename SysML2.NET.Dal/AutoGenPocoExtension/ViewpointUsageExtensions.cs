// -------------------------------------------------------------------------------------------------
// <copyright file="ViewpointUsageExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class ViewpointUsageExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.ViewpointUsage poco, Core.DTO.ViewpointUsage dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.ViewpointUsage poco, Core.DTO.ViewpointUsage dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.ViewpointUsage"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.ViewpointUsage"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.ViewpointUsage"/>
        /// </returns>
        public static Core.DTO.ViewpointUsage ToDto(this Core.POCO.ViewpointUsage poco)
        {
            var dto = new Core.DTO.ViewpointUsage();
