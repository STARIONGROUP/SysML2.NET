// -------------------------------------------------------------------------------------------------
// <copyright file="ForLoopActionUsageExtensions.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class ForLoopActionUsageExtensions
    {
        ...
        /// </exception>
        public static IEnumerable<Guid> UpdateValueAndRemoveDeletedReferenceProperties(this Core.POCO.ForLoopActionUsage poco, Core.DTO.ForLoopActionUsage dto)
        {
            if (poco == null)
            {
        ...
        public static void UpdateReferenceProperties(this Core.POCO.ForLoopActionUsage poco, Core.DTO.ForLoopActionUsage dto, ConcurrentDictionary<Guid, Lazy<Core.POCO.IElement>> cache)
        {
            if (poco == null)
            {
                throw new ArgumentNullException(nameof(poco), $"the {nameof(poco)} may not be null");
        ...
        /// <summary>
        /// Creates a <see cref="Core.DTO.ForLoopActionUsage"/> based on the provided POCO
        /// </summary>
        /// <param name="poco">
        /// The subject <see cref="Core.POCO.ForLoopActionUsage"/> from which a DTO is to be created
        /// </param>
        /// <returns>
        /// An instance of <see cref="Core.POCO.ForLoopActionUsage"/>
        /// </returns>
        public static Core.DTO.ForLoopActionUsage ToDto(this Core.POCO.ForLoopActionUsage poco)
        {
            var dto = new Core.DTO.ForLoopActionUsage();
