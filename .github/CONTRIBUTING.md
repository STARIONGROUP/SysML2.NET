...
We would like to start with saying thank you for wanting to contribute to SysML2.NET codebase. We want to keep it as easy as possible to contribute changes that get things working in your environment. There are a few guidelines that we need contributors to follow so that we have a chance of keeping on top of things.
...
- Use `this` when accessing instance members, e.g. `this.Name = "SysML2.NET";`.
