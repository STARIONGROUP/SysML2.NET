...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    /// <summary>
    /// Hand-Coded part of the <see cref="LiteralExpressionTextualNotationBuilder"/>
    /// </summary>
    public static partial class LiteralExpressionTextualNotationBuilder
    {
        ...
        private static void BuildValue(ILiteralExpression poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
        }
    }
}
