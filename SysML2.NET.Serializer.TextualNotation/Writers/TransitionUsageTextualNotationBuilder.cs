...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class TransitionUsageTextualNotationBuilder
    {
        ...
        /// </remarks>
        private static void BuildTargetTransitionUsageHandCoded(ITransitionUsage poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
