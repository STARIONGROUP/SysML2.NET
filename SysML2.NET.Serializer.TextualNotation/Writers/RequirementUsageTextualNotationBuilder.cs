...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class RequirementUsageTextualNotationBuilder
    {
        ...
        private static void BuildRequirementVerificationUsageHandCoded(IRequirementUsage poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
