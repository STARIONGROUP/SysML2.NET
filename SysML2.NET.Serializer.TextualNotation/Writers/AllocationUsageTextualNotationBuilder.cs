...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class AllocationUsageTextualNotationBuilder
    {
        ...
        /// </remarks>
        private static void BuildAllocationUsageDeclarationHandCoded(IAllocationUsage poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
