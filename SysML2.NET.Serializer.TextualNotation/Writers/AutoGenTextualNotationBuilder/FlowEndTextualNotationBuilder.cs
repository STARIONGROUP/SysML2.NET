...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class FlowEndTextualNotationBuilder
    {
        ...
        public static void BuildFlowEnd(SysML2.NET.Core.POCO.Kernel.Interactions.IFlowEnd poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
