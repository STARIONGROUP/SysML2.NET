...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class DocumentationTextualNotationBuilder
    {
        ...
        public static void BuildDocumentation(SysML2.NET.Core.POCO.Root.Annotations.IDocumentation poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
