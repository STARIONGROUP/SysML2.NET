...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    /// <summary>
    /// The <see cref="CaseDefinitionTextualNotationBuilder" /> provides Textual Notation Builder for the <see cref="SysML2.NET.Core.POCO.Systems.Cases.ICaseDefinition" /> element
    /// </summary>
    public static partial class CaseDefinitionTextualNotationBuilder
    {
        /// <summary>
        ...
        public static void BuildCaseDefinition(SysML2.NET.Core.POCO.Systems.Cases.ICaseDefinition poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
