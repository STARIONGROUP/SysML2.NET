...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class ExhibitStateUsageTextualNotationBuilder
    {
        ...
        public static void BuildExhibitStateUsage(SysML2.NET.Core.POCO.Systems.States.IExhibitStateUsage poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
