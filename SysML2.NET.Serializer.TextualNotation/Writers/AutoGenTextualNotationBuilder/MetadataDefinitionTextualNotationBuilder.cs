// -------------------------------------------------------------------------------------------------
// <copyright file="MetadataDefinitionTextualNotationBuilder.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class MetadataDefinitionTextualNotationBuilder
    {
        ...
        public static void BuildMetadataDefinition(SysML2.NET.Core.POCO.Systems.Metadata.IMetadataDefinition poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
