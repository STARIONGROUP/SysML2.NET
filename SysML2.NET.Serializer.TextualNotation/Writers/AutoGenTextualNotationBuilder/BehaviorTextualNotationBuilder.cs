// -------------------------------------------------------------------------------------------------
// <copyright file="BehaviorTextualNotationBuilder.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class BehaviorTextualNotationBuilder
    {
        ...
        public static void BuildBehavior(SysML2.NET.Core.POCO.Kernel.Behaviors.IBehavior poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
