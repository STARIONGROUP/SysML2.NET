...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class SpecializationTextualNotationBuilder
    {
        ...
        public static void BuildOwnedSpecialization(SysML2.NET.Core.POCO.Core.Types.ISpecialization poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
        ...
        /// <param name="writerContext">The <see cref="TextualNotationWriterContext" /> providing the serialization context for the current <paramref name="poco"/></param>
        /// <param name="stringBuilder">The <see cref="IndentedStringBuilder" /> that accumulates the entire textual notation with indentation</param>
        public static void BuildSpecificType(SysML2.NET.Core.POCO.Core.Types.ISpecialization poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
            ...
            {
                SharedTextualNotationBuilder.AppendQualifiedName(stringBuilder, poco.Specific, writerContext, poco);
        ...
        /// <param name="writerContext">The <see cref="TextualNotationWriterContext" /> providing the serialization context for the current <paramref name="poco"/></param>
        /// <param name="stringBuilder">The <see cref="IndentedStringBuilder" /> that accumulates the entire textual notation with indentation</param>
        public static void BuildGeneralType(SysML2.NET.Core.POCO.Core.Types.ISpecialization poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
            ...
            {
                SharedTextualNotationBuilder.AppendQualifiedName(stringBuilder, poco.General, writerContext, poco);
                stringBuilder.Append(' ');
            }
        ...
        /// <param name="writerContext">The <see cref="TextualNotationWriterContext" /> providing the serialization context for the current <paramref name="poco"/></param>
        /// <param name="stringBuilder">The <see cref="IndentedStringBuilder" /> that accumulates the entire textual notation with indentation</param>
        public static void BuildSpecialization(SysML2.NET.Core.POCO.Core.Types.ISpecialization poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
