// -------------------------------------------------------------------------------------------------
// <copyright file="VerificationCaseDefinitionTextualNotationBuilder.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class VerificationCaseDefinitionTextualNotationBuilder
    {
        ...
        public static void BuildVerificationCaseDefinition(SysML2.NET.Core.POCO.Systems.VerificationCases.IVerificationCaseDefinition poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
