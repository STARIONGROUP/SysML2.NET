// -------------------------------------------------------------------------------------------------
// <copyright file="AssociationStructureTextualNotationBuilder.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class AssociationStructureTextualNotationBuilder
    {
        ...
        public static void BuildAssociationStructure(SysML2.NET.Core.POCO.Kernel.Associations.IAssociationStructure poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
