// -------------------------------------------------------------------------------------------------
// <copyright file="MembershipImportTextualNotationBuilder.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class MembershipImportTextualNotationBuilder
    {
        ...
        public static void BuildMembershipImport(SysML2.NET.Core.POCO.Root.Namespaces.IMembershipImport poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
