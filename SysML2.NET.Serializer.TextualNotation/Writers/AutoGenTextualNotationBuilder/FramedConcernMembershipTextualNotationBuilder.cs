...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class FramedConcernMembershipTextualNotationBuilder
    {
        ...
        public static void BuildFramedConcernMember(SysML2.NET.Core.POCO.Systems.Requirements.IFramedConcernMembership poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
