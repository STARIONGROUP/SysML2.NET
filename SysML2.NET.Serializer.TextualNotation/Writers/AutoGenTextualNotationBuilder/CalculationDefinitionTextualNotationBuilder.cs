...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class CalculationDefinitionTextualNotationBuilder
    {
        ...
        public static void BuildCalculationDefinition(SysML2.NET.Core.POCO.Systems.Calculations.ICalculationDefinition poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
