// -------------------------------------------------------------------------------------------------
// <copyright file="ConstraintDefinitionTextualNotationBuilder.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class ConstraintDefinitionTextualNotationBuilder
    {
        ...
        public static void BuildConstraintDefinition(SysML2.NET.Core.POCO.Systems.Constraints.IConstraintDefinition poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
