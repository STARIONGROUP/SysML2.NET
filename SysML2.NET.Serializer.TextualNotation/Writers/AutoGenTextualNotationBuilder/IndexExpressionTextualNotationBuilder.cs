...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class IndexExpressionTextualNotationBuilder
    {
        ...
        public static void BuildIndexExpression(SysML2.NET.Core.POCO.Kernel.Expressions.IIndexExpression poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
