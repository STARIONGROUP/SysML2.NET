...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    /// <summary>
    /// The <see cref="UnioningTextualNotationBuilder" /> provides Textual Notation Builder for the <see cref="SysML2.NET.Core.POCO.Core.Types.IUnioning" /> element
    /// </summary>
    public static partial class UnioningTextualNotationBuilder
    {
        /// <summary>
        ...
        public static void BuildUnioning(SysML2.NET.Core.POCO.Core.Types.IUnioning poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
