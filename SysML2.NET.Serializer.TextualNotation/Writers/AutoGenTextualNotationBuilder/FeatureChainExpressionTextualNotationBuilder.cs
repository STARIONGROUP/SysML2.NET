// -------------------------------------------------------------------------------------------------
// <copyright file="FeatureChainExpressionTextualNotationBuilder.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class FeatureChainExpressionTextualNotationBuilder
    {
        ...
        public static void BuildFeatureChainExpression(SysML2.NET.Core.POCO.Kernel.Expressions.IFeatureChainExpression poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
