...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class PortDefinitionTextualNotationBuilder
    {
        ...
        public static void BuildPortDefinition(SysML2.NET.Core.POCO.Systems.Ports.IPortDefinition poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
