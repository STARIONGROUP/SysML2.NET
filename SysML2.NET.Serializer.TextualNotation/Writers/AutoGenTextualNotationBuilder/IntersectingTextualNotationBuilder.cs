// -------------------------------------------------------------------------------------------------
// <copyright file="IntersectingTextualNotationBuilder.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class IntersectingTextualNotationBuilder
    {
        ...
        public static void BuildIntersecting(SysML2.NET.Core.POCO.Core.Types.IIntersecting poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
            ...
            {
                SharedTextualNotationBuilder.AppendQualifiedName(stringBuilder, poco.IntersectingType, writerContext, poco);
