...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class DisjoiningTextualNotationBuilder
    {
        ...
        public static void BuildOwnedDisjoining(SysML2.NET.Core.POCO.Core.Types.IDisjoining poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
        ...
        /// <param name="writerContext">The <see cref="TextualNotationWriterContext" /> providing the serialization context for the current <paramref name="poco"/></param>
        /// <param name="stringBuilder">The <see cref="IndentedStringBuilder" /> that accumulates the entire textual notation with indentation</param>
        public static void BuildDisjoining(SysML2.NET.Core.POCO.Core.Types.IDisjoining poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
