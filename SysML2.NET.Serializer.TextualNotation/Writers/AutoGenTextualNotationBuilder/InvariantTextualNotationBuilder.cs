...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class InvariantTextualNotationBuilder
    {
        ...
        public static void BuildInvariant(SysML2.NET.Core.POCO.Kernel.Functions.IInvariant poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
