...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class TriggerInvocationExpressionTextualNotationBuilder
    {
        ...
        public static void BuildTriggerExpression(SysML2.NET.Core.POCO.Systems.Actions.ITriggerInvocationExpression poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
