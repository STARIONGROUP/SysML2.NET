// -------------------------------------------------------------------------------------------------
// <copyright file="AttributeDefinitionTextualNotationBuilder.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class AttributeDefinitionTextualNotationBuilder
    {
        ...
        public static void BuildAttributeDefinition(SysML2.NET.Core.POCO.Systems.Attributes.IAttributeDefinition poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
