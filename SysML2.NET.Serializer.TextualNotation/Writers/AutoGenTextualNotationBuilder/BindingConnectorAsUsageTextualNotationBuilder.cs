...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class BindingConnectorAsUsageTextualNotationBuilder
    {
        ...
        public static void BuildBindingConnectorAsUsage(SysML2.NET.Core.POCO.Systems.Connections.IBindingConnectorAsUsage poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
