...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class FeatureChainingTextualNotationBuilder
    {
        ...
        public static void BuildOwnedFeatureChaining(SysML2.NET.Core.POCO.Core.Features.IFeatureChaining poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
