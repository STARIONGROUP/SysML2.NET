...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class PayloadFeatureTextualNotationBuilder
    {
        ...
        public static void BuildFlowPayloadFeature(SysML2.NET.Core.POCO.Kernel.Interactions.IPayloadFeature poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
