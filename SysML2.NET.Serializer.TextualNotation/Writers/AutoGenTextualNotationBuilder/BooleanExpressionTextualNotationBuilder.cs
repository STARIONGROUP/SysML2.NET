...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class BooleanExpressionTextualNotationBuilder
    {
        ...
        public static void BuildBooleanExpression(SysML2.NET.Core.POCO.Kernel.Functions.IBooleanExpression poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
