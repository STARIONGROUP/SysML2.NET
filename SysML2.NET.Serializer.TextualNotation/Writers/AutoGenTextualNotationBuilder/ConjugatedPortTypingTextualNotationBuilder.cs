...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class ConjugatedPortTypingTextualNotationBuilder
    {
        ...
        public static void BuildConjugatedPortTyping(SysML2.NET.Core.POCO.Systems.Ports.IConjugatedPortTyping poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
