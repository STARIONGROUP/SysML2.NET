...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class UseCaseUsageTextualNotationBuilder
    {
        ...
        public static void BuildUseCaseUsage(SysML2.NET.Core.POCO.Systems.UseCases.IUseCaseUsage poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
