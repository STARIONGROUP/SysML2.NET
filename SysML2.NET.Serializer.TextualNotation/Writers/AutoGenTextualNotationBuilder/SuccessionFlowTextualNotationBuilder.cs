...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class SuccessionFlowTextualNotationBuilder
    {
        ...
        public static void BuildSuccessionFlow(SysML2.NET.Core.POCO.Kernel.Interactions.ISuccessionFlow poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
