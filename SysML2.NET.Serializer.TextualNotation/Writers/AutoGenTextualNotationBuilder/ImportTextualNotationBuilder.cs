...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class ImportTextualNotationBuilder
    {
        ...
        public static void BuildImportDeclaration(SysML2.NET.Core.POCO.Root.Namespaces.IImport poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
            switch (poco)
            {
        ...
        /// <param name="writerContext">The <see cref="TextualNotationWriterContext" /> providing the serialization context for the current <paramref name="poco"/></param>
        /// <param name="stringBuilder">The <see cref="IndentedStringBuilder" /> that accumulates the entire textual notation with indentation</param>
        public static void BuildImport(SysML2.NET.Core.POCO.Root.Namespaces.IImport poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
