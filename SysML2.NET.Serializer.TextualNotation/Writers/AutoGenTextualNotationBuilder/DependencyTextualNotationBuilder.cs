...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class DependencyTextualNotationBuilder
    {
        ...
        public static void BuildDependency(SysML2.NET.Core.POCO.Root.Dependencies.IDependency poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
