...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class InterfaceDefinitionTextualNotationBuilder
    {
        ...
        public static void BuildInterfaceDefinition(SysML2.NET.Core.POCO.Systems.Interfaces.IInterfaceDefinition poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
