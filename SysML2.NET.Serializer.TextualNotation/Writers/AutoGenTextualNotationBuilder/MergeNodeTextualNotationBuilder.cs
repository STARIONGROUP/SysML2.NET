// -------------------------------------------------------------------------------------------------
// <copyright file="MergeNodeTextualNotationBuilder.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class MergeNodeTextualNotationBuilder
    {
        ...
        public static void BuildMergeNode(SysML2.NET.Core.POCO.Systems.Actions.IMergeNode poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
