...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class ConcernDefinitionTextualNotationBuilder
    {
        ...
        public static void BuildConcernDefinition(SysML2.NET.Core.POCO.Systems.Requirements.IConcernDefinition poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
