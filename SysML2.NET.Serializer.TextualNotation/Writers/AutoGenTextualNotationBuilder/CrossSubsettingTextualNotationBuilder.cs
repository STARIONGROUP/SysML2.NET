...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class CrossSubsettingTextualNotationBuilder
    {
        ...
        public static void BuildOwnedCrossSubsetting(SysML2.NET.Core.POCO.Core.Features.ICrossSubsetting poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
            ...
            {
                SharedTextualNotationBuilder.AppendQualifiedName(stringBuilder, poco.CrossedFeature, writerContext, poco);
