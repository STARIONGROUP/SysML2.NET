...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class ForkNodeTextualNotationBuilder
    {
        ...
        public static void BuildForkNode(SysML2.NET.Core.POCO.Systems.Actions.IForkNode poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
