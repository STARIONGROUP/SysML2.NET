...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class StepTextualNotationBuilder
    {
        ...
        public static void BuildStep(SysML2.NET.Core.POCO.Kernel.Behaviors.IStep poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
