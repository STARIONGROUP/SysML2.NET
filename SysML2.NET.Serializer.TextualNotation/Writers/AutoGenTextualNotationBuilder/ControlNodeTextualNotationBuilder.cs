// -------------------------------------------------------------------------------------------------
// <copyright file="ControlNodeTextualNotationBuilder.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    /// <summary>
    /// The <see cref="ControlNodeTextualNotationBuilder" /> provides Textual Notation Builder for the <see cref="SysML2.NET.Core.POCO.Systems.Actions.IControlNode" /> element
    /// </summary>
    public static partial class ControlNodeTextualNotationBuilder
    {
        /// <summary>
        /// Builds the Textual Notation string for the rule ControlNode
        ...
        public static void BuildControlNode(SysML2.NET.Core.POCO.Systems.Actions.IControlNode poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
            switch (poco)
            {
