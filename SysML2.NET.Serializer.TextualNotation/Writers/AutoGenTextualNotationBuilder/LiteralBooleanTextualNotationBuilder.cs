// -------------------------------------------------------------------------------------------------
// <copyright file="LiteralBooleanTextualNotationBuilder.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class LiteralBooleanTextualNotationBuilder
    {
        ...
        public static void BuildLiteralBoolean(SysML2.NET.Core.POCO.Kernel.Expressions.ILiteralBoolean poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
