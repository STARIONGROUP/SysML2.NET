// -------------------------------------------------------------------------------------------------
// <copyright file="RenderingDefinitionTextualNotationBuilder.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class RenderingDefinitionTextualNotationBuilder
    {
        ...
        public static void BuildRenderingDefinition(SysML2.NET.Core.POCO.Systems.Views.IRenderingDefinition poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
