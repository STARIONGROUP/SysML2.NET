...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class AnalysisCaseDefinitionTextualNotationBuilder
    {
        ...
        public static void BuildAnalysisCaseDefinition(SysML2.NET.Core.POCO.Systems.AnalysisCases.IAnalysisCaseDefinition poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
