// -------------------------------------------------------------------------------------------------
// <copyright file="LiteralInfinityTextualNotationBuilder.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class LiteralInfinityTextualNotationBuilder
    {
        ...
        public static void BuildLiteralInfinity(SysML2.NET.Core.POCO.Kernel.Expressions.ILiteralInfinity poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
