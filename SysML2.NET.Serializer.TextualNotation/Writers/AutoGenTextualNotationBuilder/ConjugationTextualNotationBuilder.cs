...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class ConjugationTextualNotationBuilder
    {
        ...
        public static void BuildOwnedConjugation(SysML2.NET.Core.POCO.Core.Types.IConjugation poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
            ...
            {
                SharedTextualNotationBuilder.AppendQualifiedName(stringBuilder, poco.OriginalType, writerContext, poco);
        ...
        /// <param name="writerContext">The <see cref="TextualNotationWriterContext" /> providing the serialization context for the current <paramref name="poco"/></param>
        /// <param name="stringBuilder">The <see cref="IndentedStringBuilder" /> that accumulates the entire textual notation with indentation</param>
        public static void BuildConjugation(SysML2.NET.Core.POCO.Core.Types.IConjugation poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
            ...
            {
                SharedTextualNotationBuilder.AppendQualifiedName(stringBuilder, poco.ConjugatedType, writerContext, poco);
                stringBuilder.Append(' ');
            }
