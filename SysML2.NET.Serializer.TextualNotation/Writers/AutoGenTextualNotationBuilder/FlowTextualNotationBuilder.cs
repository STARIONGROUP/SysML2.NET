...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class FlowTextualNotationBuilder
    {
        ...
        public static void BuildFlow(SysML2.NET.Core.POCO.Kernel.Interactions.IFlow poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
