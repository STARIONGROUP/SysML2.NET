// -------------------------------------------------------------------------------------------------
// <copyright file="LiteralIntegerTextualNotationBuilder.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class LiteralIntegerTextualNotationBuilder
    {
        ...
        public static void BuildLiteralInteger(SysML2.NET.Core.POCO.Kernel.Expressions.ILiteralInteger poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
