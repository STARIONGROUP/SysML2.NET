...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class StructureTextualNotationBuilder
    {
        ...
        public static void BuildStructure(SysML2.NET.Core.POCO.Kernel.Structures.IStructure poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
