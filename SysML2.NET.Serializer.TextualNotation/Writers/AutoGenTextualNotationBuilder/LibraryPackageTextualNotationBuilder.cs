// -------------------------------------------------------------------------------------------------
// <copyright file="LibraryPackageTextualNotationBuilder.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class LibraryPackageTextualNotationBuilder
    {
        ...
        public static void BuildLibraryPackage(SysML2.NET.Core.POCO.Kernel.Packages.ILibraryPackage poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
