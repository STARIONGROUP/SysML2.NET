...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class TerminateActionUsageTextualNotationBuilder
    {
        ...
        public static void BuildTerminateNode(SysML2.NET.Core.POCO.Systems.Actions.ITerminateActionUsage poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
