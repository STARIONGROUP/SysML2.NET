...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class RelationshipTextualNotationBuilder
    {
        ...
        public static void BuildRelationshipBody(SysML2.NET.Core.POCO.Root.Elements.IRelationship poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
        ...
        /// <param name="writerContext">The <see cref="TextualNotationWriterContext" /> providing the serialization context for the current <paramref name="poco"/></param>
        /// <param name="stringBuilder">The <see cref="IndentedStringBuilder" /> that accumulates the entire textual notation with indentation</param>
        public static void BuildRelationshipOwnedElement(SysML2.NET.Core.POCO.Root.Elements.IRelationship poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
