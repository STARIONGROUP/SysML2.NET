...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    /// <summary>
    /// The <see cref="NamespaceExposeTextualNotationBuilder" /> provides Textual Notation Builder for the <see cref="SysML2.NET.Core.POCO.Systems.Views.INamespaceExpose" /> element
    /// </summary>
    public static partial class NamespaceExposeTextualNotationBuilder
    {
        /// <summary>
        ...
        public static void BuildNamespaceExpose(SysML2.NET.Core.POCO.Systems.Views.INamespaceExpose poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
