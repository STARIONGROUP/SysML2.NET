...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class SatisfyRequirementUsageTextualNotationBuilder
    {
        ...
        public static void BuildSatisfyRequirementUsage(SysML2.NET.Core.POCO.Systems.Requirements.ISatisfyRequirementUsage poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
