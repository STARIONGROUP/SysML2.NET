...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    /// <summary>
    /// The <see cref="ResultExpressionMembershipTextualNotationBuilder" /> provides Textual Notation Builder for the <see cref="SysML2.NET.Core.POCO.Kernel.Functions.IResultExpressionMembership" /> element
    /// </summary>
    public static partial class ResultExpressionMembershipTextualNotationBuilder
    {
        /// <summary>
        ...
        public static void BuildResultExpressionMember(SysML2.NET.Core.POCO.Kernel.Functions.IResultExpressionMembership poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
