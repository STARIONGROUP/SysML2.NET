...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class AnnotatingElementTextualNotationBuilder
    {
        ...
        public static void BuildAnnotatingElement(SysML2.NET.Core.POCO.Root.Annotations.IAnnotatingElement poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
            switch (poco)
            {
