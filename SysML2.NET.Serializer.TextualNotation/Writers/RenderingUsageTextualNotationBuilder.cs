...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class RenderingUsageTextualNotationBuilder
    {
        ...
        private static void BuildViewRenderingUsageHandCoded(IRenderingUsage poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
