...
namespace SysML2.NET.Serializer.TextualNotation.Writers
{
    ...
    public static partial class ClassifierTextualNotationBuilder
    {
        ...
        /// </remarks>
        private static void BuildClassifierDeclarationHandCoded(IClassifier poco, TextualNotationWriterContext writerContext, IndentedStringBuilder stringBuilder)
        {
