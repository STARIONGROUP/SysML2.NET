...
namespace SysML2.NET.Tests.Extend
{
    ...
    public class RequirementDefinitionExtensionsTestFixture
    {
        ...
        public void VerifyComputeActorParameter()
        {
            ...
            Assert.That(requirementDefinition.ComputeActorParameter(), Is.EqualTo([actorPartUsage]));
        }
        ...
        public void VerifyComputeFramedConcern()
        {
            ...
            Assert.That(requirementDefinition.ComputeFramedConcern(), Is.EqualTo([concernUsage]));
        }
        ...
        public void VerifyComputeStakeholderParameter()
        {
            ...
            Assert.That(requirementDefinition.ComputeStakeholderParameter(), Is.EqualTo([stakeholderPartUsage]));
        }
