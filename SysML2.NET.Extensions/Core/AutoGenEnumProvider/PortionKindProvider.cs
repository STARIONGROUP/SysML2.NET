...
namespace SysML2.NET.Extensions.Core
{
    ...
    public static class PortionKindProvider
    {
        ...
        /// <summary>
        /// Tries to parse the <see cref="ReadOnlySpan{Char}"/> to a <see cref="PortionKind"/>
        /// </summary>
        /// <param name="value">
        /// The <see cref="ReadOnlySpan{Char}"/> that is to be parsed
        /// </param>
        /// <param name="result">
        /// When this method returns, contains the <see cref="PortionKind"/> value equivalent
        ...
        /// JIT friendly
        /// </remarks>
        public static bool TryParse(ReadOnlySpan<char> value, out PortionKind result)
        {
            if (value.Length == 9 && value.Equals("timeslice".AsSpan(), StringComparison.OrdinalIgnoreCase))
            {
                result = PortionKind.Timeslice;
                return true;
            }

            if (value.Length == 8 && value.Equals("snapshot".AsSpan(), StringComparison.OrdinalIgnoreCase))
            {
                result = PortionKind.Snapshot;
                return true;
            }
        ...
        /// <see cref="PortionKind"/> enumeration literal.
        /// </summary>
        /// <param name="value">
        /// A UTF-8 encoded sequence representing a <see cref="PortionKind"/> literal.
        /// Valid values are
        /// <list type="bullet">
        /// <item><c>timeslice (9 bytes) </c></item>
        /// <item><c>snapshot (8 bytes) </c></item>
        /// </list>
        /// </param>
        /// <returns>
        /// The corresponding <see cref="PortionKind"/> enumeration value.
        /// </returns>
        /// <exception cref="ArgumentException">
        /// Thrown when the supplied sequence does not represent a valid
        /// <see cref="PortionKind"/> literal.
        /// </exception>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public static PortionKind Parse(in ReadOnlySequence<byte> value)
        {
        ...
        /// <summary>
        /// Converts a <see cref="PortionKind"/> value to its
        /// lowercase UTF-8 encoded byte representation.
        /// </summary>
        /// <param name="value">
        /// The <see cref="PortionKind"/> value to convert.
        /// </param>
        /// <returns>
        /// A <see cref="ReadOnlySpan{Byte}"/> containing the lowercase UTF-8
        /// encoding of the specified <see cref="PortionKind"/>.
        /// </returns>
        /// <exception cref="ArgumentOutOfRangeException">
        /// Thrown when <paramref name="value"/> is not a defined
        /// <see cref="PortionKind"/> enumeration value.
        /// </exception>
        /// <remarks>
        /// <para>
        ...
        /// Valid encodings are:
        /// <list type="bullet">
        /// <item><c>timeslice</c></item>
        /// <item><c>snapshot</c></item>
        /// </list>
        /// </para>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public static ReadOnlySpan<byte> ToUtf8LowerBytes(PortionKind value)
        {
            return value switch
            {
                PortionKind.Timeslice => "timeslice"u8,
                PortionKind.Snapshot => "snapshot"u8,
