// -------------------------------------------------------------------------------------------------
// <copyright file="AnnotationComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IAnnotation"/> instances
    ...
    /// validation scenarios where two <see cref="IAnnotation"/> instances
    ...
    public sealed class AnnotationComparer : IEqualityComparer<IAnnotation>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IAnnotation"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IAnnotation"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IAnnotation"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IAnnotation"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IAnnotation"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IAnnotation"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
