// -------------------------------------------------------------------------------------------------
// <copyright file="ClassComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IClass"/> instances
    ...
    /// validation scenarios where two <see cref="IClass"/> instances
    ...
    public sealed class ClassComparer : IEqualityComparer<IClass>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IClass"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IClass"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IClass"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IClass"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IClass"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IClass"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
