// -------------------------------------------------------------------------------------------------
// <copyright file="LiteralBooleanComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ILiteralBoolean"/> instances
    ...
    /// validation scenarios where two <see cref="ILiteralBoolean"/> instances
    ...
    public sealed class LiteralBooleanComparer : IEqualityComparer<ILiteralBoolean>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ILiteralBoolean"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ILiteralBoolean"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ILiteralBoolean"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ILiteralBoolean"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(ILiteralBoolean x, ILiteralBoolean y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ILiteralBoolean"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ILiteralBoolean"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(ILiteralBoolean obj)
        {
            return HashCode.Combine(typeof(ILiteralBoolean), obj.Id);
        }
    }
}
