// -------------------------------------------------------------------------------------------------
// <copyright file="SendActionUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ISendActionUsage"/> instances
    ...
    /// validation scenarios where two <see cref="ISendActionUsage"/> instances
    ...
    public sealed class SendActionUsageComparer : IEqualityComparer<ISendActionUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ISendActionUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ISendActionUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ISendActionUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ISendActionUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(ISendActionUsage x, ISendActionUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ISendActionUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ISendActionUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(ISendActionUsage obj)
        {
            return HashCode.Combine(typeof(ISendActionUsage), obj.Id);
        }
    }
}
