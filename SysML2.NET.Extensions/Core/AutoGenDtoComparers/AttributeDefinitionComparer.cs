// -------------------------------------------------------------------------------------------------
// <copyright file="AttributeDefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IAttributeDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="IAttributeDefinition"/> instances
    ...
    public sealed class AttributeDefinitionComparer : IEqualityComparer<IAttributeDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IAttributeDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IAttributeDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IAttributeDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IAttributeDefinition"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IAttributeDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IAttributeDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
