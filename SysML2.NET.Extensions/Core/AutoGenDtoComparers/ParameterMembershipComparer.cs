// -------------------------------------------------------------------------------------------------
// <copyright file="ParameterMembershipComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IParameterMembership"/> instances
    ...
    /// validation scenarios where two <see cref="IParameterMembership"/> instances
    ...
    public sealed class ParameterMembershipComparer : IEqualityComparer<IParameterMembership>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IParameterMembership"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IParameterMembership"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IParameterMembership"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IParameterMembership"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IParameterMembership x, IParameterMembership y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IParameterMembership"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IParameterMembership"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IParameterMembership obj)
        {
            return HashCode.Combine(typeof(IParameterMembership), obj.Id);
        }
    }
}
