// -------------------------------------------------------------------------------------------------
// <copyright file="FlowUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IFlowUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IFlowUsage"/> instances
    ...
    public sealed class FlowUsageComparer : IEqualityComparer<IFlowUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IFlowUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IFlowUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IFlowUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IFlowUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IFlowUsage x, IFlowUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IFlowUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IFlowUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IFlowUsage obj)
        {
            return HashCode.Combine(typeof(IFlowUsage), obj.Id);
        }
    }
}
