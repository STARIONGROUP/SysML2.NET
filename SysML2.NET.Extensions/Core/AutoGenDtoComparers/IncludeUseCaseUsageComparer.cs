// -------------------------------------------------------------------------------------------------
// <copyright file="IncludeUseCaseUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IIncludeUseCaseUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IIncludeUseCaseUsage"/> instances
    ...
    public sealed class IncludeUseCaseUsageComparer : IEqualityComparer<IIncludeUseCaseUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IIncludeUseCaseUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IIncludeUseCaseUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IIncludeUseCaseUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IIncludeUseCaseUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IIncludeUseCaseUsage x, IIncludeUseCaseUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IIncludeUseCaseUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IIncludeUseCaseUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IIncludeUseCaseUsage obj)
        {
            return HashCode.Combine(typeof(IIncludeUseCaseUsage), obj.Id);
        }
    }
}
