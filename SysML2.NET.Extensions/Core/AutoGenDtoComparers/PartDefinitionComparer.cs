// -------------------------------------------------------------------------------------------------
// <copyright file="PartDefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IPartDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="IPartDefinition"/> instances
    ...
    public sealed class PartDefinitionComparer : IEqualityComparer<IPartDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IPartDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IPartDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IPartDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IPartDefinition"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IPartDefinition x, IPartDefinition y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IPartDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IPartDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IPartDefinition obj)
        {
            return HashCode.Combine(typeof(IPartDefinition), obj.Id);
        }
    }
}
