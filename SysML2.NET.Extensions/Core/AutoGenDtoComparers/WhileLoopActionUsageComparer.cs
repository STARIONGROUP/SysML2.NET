// -------------------------------------------------------------------------------------------------
// <copyright file="WhileLoopActionUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IWhileLoopActionUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IWhileLoopActionUsage"/> instances
    ...
    public sealed class WhileLoopActionUsageComparer : IEqualityComparer<IWhileLoopActionUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IWhileLoopActionUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IWhileLoopActionUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IWhileLoopActionUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IWhileLoopActionUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IWhileLoopActionUsage x, IWhileLoopActionUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IWhileLoopActionUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IWhileLoopActionUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IWhileLoopActionUsage obj)
        {
            return HashCode.Combine(typeof(IWhileLoopActionUsage), obj.Id);
        }
    }
}
