// -------------------------------------------------------------------------------------------------
// <copyright file="ClassifierComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IClassifier"/> instances
    ...
    /// validation scenarios where two <see cref="IClassifier"/> instances
    ...
    public sealed class ClassifierComparer : IEqualityComparer<IClassifier>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IClassifier"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IClassifier"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IClassifier"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IClassifier"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IClassifier"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IClassifier"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
