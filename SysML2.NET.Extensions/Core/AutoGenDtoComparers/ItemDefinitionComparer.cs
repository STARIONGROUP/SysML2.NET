// -------------------------------------------------------------------------------------------------
// <copyright file="ItemDefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IItemDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="IItemDefinition"/> instances
    ...
    public sealed class ItemDefinitionComparer : IEqualityComparer<IItemDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IItemDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IItemDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IItemDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IItemDefinition"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IItemDefinition x, IItemDefinition y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IItemDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IItemDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IItemDefinition obj)
        {
            return HashCode.Combine(typeof(IItemDefinition), obj.Id);
        }
    }
}
