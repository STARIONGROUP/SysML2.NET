// -------------------------------------------------------------------------------------------------
// <copyright file="DocumentationComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IDocumentation"/> instances
    ...
    /// validation scenarios where two <see cref="IDocumentation"/> instances
    ...
    public sealed class DocumentationComparer : IEqualityComparer<IDocumentation>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IDocumentation"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IDocumentation"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IDocumentation"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IDocumentation"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IDocumentation x, IDocumentation y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IDocumentation"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IDocumentation"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IDocumentation obj)
        {
            return HashCode.Combine(typeof(IDocumentation), obj.Id);
        }
    }
}
