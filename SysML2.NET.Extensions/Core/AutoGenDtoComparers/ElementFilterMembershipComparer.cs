// -------------------------------------------------------------------------------------------------
// <copyright file="ElementFilterMembershipComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IElementFilterMembership"/> instances
    ...
    /// validation scenarios where two <see cref="IElementFilterMembership"/> instances
    ...
    public sealed class ElementFilterMembershipComparer : IEqualityComparer<IElementFilterMembership>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IElementFilterMembership"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IElementFilterMembership"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IElementFilterMembership"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IElementFilterMembership"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IElementFilterMembership x, IElementFilterMembership y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IElementFilterMembership"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IElementFilterMembership"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IElementFilterMembership obj)
        {
            return HashCode.Combine(typeof(IElementFilterMembership), obj.Id);
        }
    }
}
