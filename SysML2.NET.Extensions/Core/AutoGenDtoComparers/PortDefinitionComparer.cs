// -------------------------------------------------------------------------------------------------
// <copyright file="PortDefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IPortDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="IPortDefinition"/> instances
    ...
    public sealed class PortDefinitionComparer : IEqualityComparer<IPortDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IPortDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IPortDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IPortDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IPortDefinition"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IPortDefinition x, IPortDefinition y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IPortDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IPortDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IPortDefinition obj)
        {
            return HashCode.Combine(typeof(IPortDefinition), obj.Id);
        }
    }
}
