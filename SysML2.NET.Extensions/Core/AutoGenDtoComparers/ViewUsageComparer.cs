// -------------------------------------------------------------------------------------------------
// <copyright file="ViewUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IViewUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IViewUsage"/> instances
    ...
    public sealed class ViewUsageComparer : IEqualityComparer<IViewUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IViewUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IViewUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IViewUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IViewUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IViewUsage x, IViewUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IViewUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IViewUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IViewUsage obj)
        {
            return HashCode.Combine(typeof(IViewUsage), obj.Id);
        }
    }
}
