// -------------------------------------------------------------------------------------------------
// <copyright file="ConcernDefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IConcernDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="IConcernDefinition"/> instances
    ...
    public sealed class ConcernDefinitionComparer : IEqualityComparer<IConcernDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IConcernDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IConcernDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IConcernDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IConcernDefinition"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IConcernDefinition x, IConcernDefinition y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IConcernDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IConcernDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IConcernDefinition obj)
        {
            return HashCode.Combine(typeof(IConcernDefinition), obj.Id);
        }
    }
}
