// -------------------------------------------------------------------------------------------------
// <copyright file="CaseUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ICaseUsage"/> instances
    ...
    /// validation scenarios where two <see cref="ICaseUsage"/> instances
    ...
    public sealed class CaseUsageComparer : IEqualityComparer<ICaseUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ICaseUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ICaseUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ICaseUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ICaseUsage"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ICaseUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ICaseUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
