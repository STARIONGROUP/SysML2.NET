// -------------------------------------------------------------------------------------------------
// <copyright file="RenderingDefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IRenderingDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="IRenderingDefinition"/> instances
    ...
    public sealed class RenderingDefinitionComparer : IEqualityComparer<IRenderingDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IRenderingDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IRenderingDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IRenderingDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IRenderingDefinition"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IRenderingDefinition x, IRenderingDefinition y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IRenderingDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IRenderingDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IRenderingDefinition obj)
        {
            return HashCode.Combine(typeof(IRenderingDefinition), obj.Id);
        }
    }
}
