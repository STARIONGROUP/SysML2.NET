// -------------------------------------------------------------------------------------------------
// <copyright file="TransitionUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ITransitionUsage"/> instances
    ...
    /// validation scenarios where two <see cref="ITransitionUsage"/> instances
    ...
    public sealed class TransitionUsageComparer : IEqualityComparer<ITransitionUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ITransitionUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ITransitionUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ITransitionUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ITransitionUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(ITransitionUsage x, ITransitionUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ITransitionUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ITransitionUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(ITransitionUsage obj)
        {
            return HashCode.Combine(typeof(ITransitionUsage), obj.Id);
        }
    }
}
