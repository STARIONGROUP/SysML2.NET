// -------------------------------------------------------------------------------------------------
// <copyright file="AnalysisCaseUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IAnalysisCaseUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IAnalysisCaseUsage"/> instances
    ...
    public sealed class AnalysisCaseUsageComparer : IEqualityComparer<IAnalysisCaseUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IAnalysisCaseUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IAnalysisCaseUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IAnalysisCaseUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IAnalysisCaseUsage"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IAnalysisCaseUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IAnalysisCaseUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
