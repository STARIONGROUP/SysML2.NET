// -------------------------------------------------------------------------------------------------
// <copyright file="OccurrenceUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IOccurrenceUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IOccurrenceUsage"/> instances
    ...
    public sealed class OccurrenceUsageComparer : IEqualityComparer<IOccurrenceUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IOccurrenceUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IOccurrenceUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IOccurrenceUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IOccurrenceUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IOccurrenceUsage x, IOccurrenceUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IOccurrenceUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IOccurrenceUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IOccurrenceUsage obj)
        {
            return HashCode.Combine(typeof(IOccurrenceUsage), obj.Id);
        }
    }
}
