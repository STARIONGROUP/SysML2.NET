// -------------------------------------------------------------------------------------------------
// <copyright file="ReturnParameterMembershipComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IReturnParameterMembership"/> instances
    ...
    /// validation scenarios where two <see cref="IReturnParameterMembership"/> instances
    ...
    public sealed class ReturnParameterMembershipComparer : IEqualityComparer<IReturnParameterMembership>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IReturnParameterMembership"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IReturnParameterMembership"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IReturnParameterMembership"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IReturnParameterMembership"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IReturnParameterMembership x, IReturnParameterMembership y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IReturnParameterMembership"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IReturnParameterMembership"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IReturnParameterMembership obj)
        {
            return HashCode.Combine(typeof(IReturnParameterMembership), obj.Id);
        }
    }
}
