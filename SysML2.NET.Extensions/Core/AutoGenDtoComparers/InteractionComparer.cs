// -------------------------------------------------------------------------------------------------
// <copyright file="InteractionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IInteraction"/> instances
    ...
    /// validation scenarios where two <see cref="IInteraction"/> instances
    ...
    public sealed class InteractionComparer : IEqualityComparer<IInteraction>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IInteraction"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IInteraction"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IInteraction"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IInteraction"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IInteraction x, IInteraction y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IInteraction"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IInteraction"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IInteraction obj)
        {
            return HashCode.Combine(typeof(IInteraction), obj.Id);
        }
    }
}
