// -------------------------------------------------------------------------------------------------
// <copyright file="ConnectionDefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IConnectionDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="IConnectionDefinition"/> instances
    ...
    public sealed class ConnectionDefinitionComparer : IEqualityComparer<IConnectionDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IConnectionDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IConnectionDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IConnectionDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IConnectionDefinition"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IConnectionDefinition x, IConnectionDefinition y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IConnectionDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IConnectionDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IConnectionDefinition obj)
        {
            return HashCode.Combine(typeof(IConnectionDefinition), obj.Id);
        }
    }
}
