// -------------------------------------------------------------------------------------------------
// <copyright file="LiteralStringComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ILiteralString"/> instances
    ...
    /// validation scenarios where two <see cref="ILiteralString"/> instances
    ...
    public sealed class LiteralStringComparer : IEqualityComparer<ILiteralString>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ILiteralString"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ILiteralString"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ILiteralString"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ILiteralString"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(ILiteralString x, ILiteralString y)
        {
            ...
            if (!OrdinalStringComparer.Equals(x.Value, y.Value)) return false;

            return true;
        }

        /// <summary>
        /// Returns a hash code for the specified <see cref="ILiteralString"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ILiteralString"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(ILiteralString obj)
        {
            return HashCode.Combine(typeof(ILiteralString), obj.Id);
        }
    }
}
