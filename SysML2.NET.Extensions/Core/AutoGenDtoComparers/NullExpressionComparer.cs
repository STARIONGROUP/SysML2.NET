// -------------------------------------------------------------------------------------------------
// <copyright file="NullExpressionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="INullExpression"/> instances
    ...
    /// validation scenarios where two <see cref="INullExpression"/> instances
    ...
    public sealed class NullExpressionComparer : IEqualityComparer<INullExpression>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="INullExpression"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="INullExpression"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="INullExpression"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="INullExpression"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(INullExpression x, INullExpression y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="INullExpression"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="INullExpression"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(INullExpression obj)
        {
            return HashCode.Combine(typeof(INullExpression), obj.Id);
        }
    }
}
