// -------------------------------------------------------------------------------------------------
// <copyright file="MetadataDefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IMetadataDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="IMetadataDefinition"/> instances
    ...
    public sealed class MetadataDefinitionComparer : IEqualityComparer<IMetadataDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IMetadataDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IMetadataDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IMetadataDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IMetadataDefinition"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IMetadataDefinition x, IMetadataDefinition y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IMetadataDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IMetadataDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IMetadataDefinition obj)
        {
            return HashCode.Combine(typeof(IMetadataDefinition), obj.Id);
        }
    }
}
