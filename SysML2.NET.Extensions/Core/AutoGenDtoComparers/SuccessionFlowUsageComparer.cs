// -------------------------------------------------------------------------------------------------
// <copyright file="SuccessionFlowUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ISuccessionFlowUsage"/> instances
    ...
    /// validation scenarios where two <see cref="ISuccessionFlowUsage"/> instances
    ...
    public sealed class SuccessionFlowUsageComparer : IEqualityComparer<ISuccessionFlowUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ISuccessionFlowUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ISuccessionFlowUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ISuccessionFlowUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ISuccessionFlowUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(ISuccessionFlowUsage x, ISuccessionFlowUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ISuccessionFlowUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ISuccessionFlowUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(ISuccessionFlowUsage obj)
        {
            return HashCode.Combine(typeof(ISuccessionFlowUsage), obj.Id);
        }
    }
}
