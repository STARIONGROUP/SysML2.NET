// -------------------------------------------------------------------------------------------------
// <copyright file="LiteralInfinityComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ILiteralInfinity"/> instances
    ...
    /// validation scenarios where two <see cref="ILiteralInfinity"/> instances
    ...
    public sealed class LiteralInfinityComparer : IEqualityComparer<ILiteralInfinity>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ILiteralInfinity"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ILiteralInfinity"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ILiteralInfinity"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ILiteralInfinity"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(ILiteralInfinity x, ILiteralInfinity y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ILiteralInfinity"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ILiteralInfinity"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(ILiteralInfinity obj)
        {
            return HashCode.Combine(typeof(ILiteralInfinity), obj.Id);
        }
    }
}
