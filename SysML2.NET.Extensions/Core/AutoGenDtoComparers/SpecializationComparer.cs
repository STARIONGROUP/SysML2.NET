// -------------------------------------------------------------------------------------------------
// <copyright file="SpecializationComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ISpecialization"/> instances
    ...
    /// validation scenarios where two <see cref="ISpecialization"/> instances
    ...
    public sealed class SpecializationComparer : IEqualityComparer<ISpecialization>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ISpecialization"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ISpecialization"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ISpecialization"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ISpecialization"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(ISpecialization x, ISpecialization y)
        {
            ...
            if (x.General != y.General) return false;
            ...
            if (x.Specific != y.Specific) return false;

            return true;
        }

        /// <summary>
        /// Returns a hash code for the specified <see cref="ISpecialization"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ISpecialization"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(ISpecialization obj)
        {
            return HashCode.Combine(typeof(ISpecialization), obj.Id);
        }
    }
}
