// -------------------------------------------------------------------------------------------------
// <copyright file="DisjoiningComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IDisjoining"/> instances
    ...
    /// validation scenarios where two <see cref="IDisjoining"/> instances
    ...
    public sealed class DisjoiningComparer : IEqualityComparer<IDisjoining>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IDisjoining"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IDisjoining"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IDisjoining"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IDisjoining"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IDisjoining x, IDisjoining y)
        {
            ...
            if (x.DisjoiningType != y.DisjoiningType) return false;
            ...
            if (x.TypeDisjoined != y.TypeDisjoined) return false;

            return true;
        }

        /// <summary>
        /// Returns a hash code for the specified <see cref="IDisjoining"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IDisjoining"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IDisjoining obj)
        {
            return HashCode.Combine(typeof(IDisjoining), obj.Id);
        }
    }
}
