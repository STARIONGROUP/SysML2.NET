// -------------------------------------------------------------------------------------------------
// <copyright file="OperatorExpressionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IOperatorExpression"/> instances
    ...
    /// validation scenarios where two <see cref="IOperatorExpression"/> instances
    ...
    public sealed class OperatorExpressionComparer : IEqualityComparer<IOperatorExpression>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IOperatorExpression"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IOperatorExpression"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IOperatorExpression"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IOperatorExpression"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IOperatorExpression x, IOperatorExpression y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IOperatorExpression"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IOperatorExpression"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IOperatorExpression obj)
        {
            return HashCode.Combine(typeof(IOperatorExpression), obj.Id);
        }
    }
}
