// -------------------------------------------------------------------------------------------------
// <copyright file="UnioningComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IUnioning"/> instances
    ...
    /// validation scenarios where two <see cref="IUnioning"/> instances
    ...
    public sealed class UnioningComparer : IEqualityComparer<IUnioning>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IUnioning"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IUnioning"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IUnioning"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IUnioning"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IUnioning x, IUnioning y)
        {
            ...
            if (x.UnioningType != y.UnioningType) return false;

            return true;
        }

        /// <summary>
        /// Returns a hash code for the specified <see cref="IUnioning"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IUnioning"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IUnioning obj)
        {
            return HashCode.Combine(typeof(IUnioning), obj.Id);
        }
    }
}
