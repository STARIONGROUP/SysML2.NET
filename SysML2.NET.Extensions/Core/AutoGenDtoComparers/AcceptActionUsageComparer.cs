// -------------------------------------------------------------------------------------------------
// <copyright file="AcceptActionUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IAcceptActionUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IAcceptActionUsage"/> instances
    ...
    public sealed class AcceptActionUsageComparer : IEqualityComparer<IAcceptActionUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IAcceptActionUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IAcceptActionUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IAcceptActionUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IAcceptActionUsage"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IAcceptActionUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IAcceptActionUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
