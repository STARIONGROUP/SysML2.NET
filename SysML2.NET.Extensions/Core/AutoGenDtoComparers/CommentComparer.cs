// -------------------------------------------------------------------------------------------------
// <copyright file="CommentComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IComment"/> instances
    ...
    /// validation scenarios where two <see cref="IComment"/> instances
    ...
    public sealed class CommentComparer : IEqualityComparer<IComment>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IComment"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IComment"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IComment"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IComment"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IComment"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IComment"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
