// -------------------------------------------------------------------------------------------------
// <copyright file="NamespaceComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="INamespace"/> instances
    ...
    /// validation scenarios where two <see cref="INamespace"/> instances
    ...
    public sealed class NamespaceComparer : IEqualityComparer<INamespace>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="INamespace"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="INamespace"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="INamespace"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="INamespace"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="INamespace"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="INamespace"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        {
            return HashCode.Combine(typeof(INamespace), obj.Id);
        }
    }
}
