// -------------------------------------------------------------------------------------------------
// <copyright file="ConstraintUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IConstraintUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IConstraintUsage"/> instances
    ...
    public sealed class ConstraintUsageComparer : IEqualityComparer<IConstraintUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IConstraintUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IConstraintUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IConstraintUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IConstraintUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IConstraintUsage x, IConstraintUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IConstraintUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IConstraintUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IConstraintUsage obj)
        {
            return HashCode.Combine(typeof(IConstraintUsage), obj.Id);
        }
    }
}
