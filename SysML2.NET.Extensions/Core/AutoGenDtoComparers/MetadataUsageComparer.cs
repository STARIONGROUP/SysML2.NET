// -------------------------------------------------------------------------------------------------
// <copyright file="MetadataUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IMetadataUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IMetadataUsage"/> instances
    ...
    public sealed class MetadataUsageComparer : IEqualityComparer<IMetadataUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IMetadataUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IMetadataUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IMetadataUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IMetadataUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IMetadataUsage x, IMetadataUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IMetadataUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IMetadataUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IMetadataUsage obj)
        {
            return HashCode.Combine(typeof(IMetadataUsage), obj.Id);
        }
    }
}
