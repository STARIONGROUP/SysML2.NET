// -------------------------------------------------------------------------------------------------
// <copyright file="ResultExpressionMembershipComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IResultExpressionMembership"/> instances
    ...
    /// validation scenarios where two <see cref="IResultExpressionMembership"/> instances
    ...
    public sealed class ResultExpressionMembershipComparer : IEqualityComparer<IResultExpressionMembership>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IResultExpressionMembership"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IResultExpressionMembership"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IResultExpressionMembership"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IResultExpressionMembership"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IResultExpressionMembership x, IResultExpressionMembership y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IResultExpressionMembership"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IResultExpressionMembership"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IResultExpressionMembership obj)
        {
            return HashCode.Combine(typeof(IResultExpressionMembership), obj.Id);
        }
    }
}
