// -------------------------------------------------------------------------------------------------
// <copyright file="MultiplicityRangeComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IMultiplicityRange"/> instances
    ...
    /// validation scenarios where two <see cref="IMultiplicityRange"/> instances
    ...
    public sealed class MultiplicityRangeComparer : IEqualityComparer<IMultiplicityRange>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IMultiplicityRange"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IMultiplicityRange"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IMultiplicityRange"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IMultiplicityRange"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IMultiplicityRange"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IMultiplicityRange"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
