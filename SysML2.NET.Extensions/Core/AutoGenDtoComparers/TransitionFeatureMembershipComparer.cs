// -------------------------------------------------------------------------------------------------
// <copyright file="TransitionFeatureMembershipComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ITransitionFeatureMembership"/> instances
    ...
    /// validation scenarios where two <see cref="ITransitionFeatureMembership"/> instances
    ...
    public sealed class TransitionFeatureMembershipComparer : IEqualityComparer<ITransitionFeatureMembership>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ITransitionFeatureMembership"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ITransitionFeatureMembership"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ITransitionFeatureMembership"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ITransitionFeatureMembership"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(ITransitionFeatureMembership x, ITransitionFeatureMembership y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ITransitionFeatureMembership"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ITransitionFeatureMembership"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(ITransitionFeatureMembership obj)
        {
            return HashCode.Combine(typeof(ITransitionFeatureMembership), obj.Id);
        }
    }
}
