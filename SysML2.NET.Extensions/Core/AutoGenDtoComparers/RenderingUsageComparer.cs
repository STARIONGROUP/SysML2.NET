// -------------------------------------------------------------------------------------------------
// <copyright file="RenderingUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IRenderingUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IRenderingUsage"/> instances
    ...
    public sealed class RenderingUsageComparer : IEqualityComparer<IRenderingUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IRenderingUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IRenderingUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IRenderingUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IRenderingUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IRenderingUsage x, IRenderingUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IRenderingUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IRenderingUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IRenderingUsage obj)
        {
            return HashCode.Combine(typeof(IRenderingUsage), obj.Id);
        }
    }
}
