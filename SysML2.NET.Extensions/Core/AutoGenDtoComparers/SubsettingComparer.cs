// -------------------------------------------------------------------------------------------------
// <copyright file="SubsettingComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ISubsetting"/> instances
    ...
    /// validation scenarios where two <see cref="ISubsetting"/> instances
    ...
    public sealed class SubsettingComparer : IEqualityComparer<ISubsetting>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ISubsetting"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ISubsetting"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ISubsetting"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ISubsetting"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(ISubsetting x, ISubsetting y)
        {
            ...
            if (x.SubsettedFeature != y.SubsettedFeature) return false;

            if (x.SubsettingFeature != y.SubsettingFeature) return false;

            return true;
        }

        /// <summary>
        /// Returns a hash code for the specified <see cref="ISubsetting"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ISubsetting"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(ISubsetting obj)
        {
            return HashCode.Combine(typeof(ISubsetting), obj.Id);
        }
    }
}
