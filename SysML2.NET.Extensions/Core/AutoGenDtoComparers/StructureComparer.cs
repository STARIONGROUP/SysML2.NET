// -------------------------------------------------------------------------------------------------
// <copyright file="StructureComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IStructure"/> instances
    ...
    /// validation scenarios where two <see cref="IStructure"/> instances
    ...
    public sealed class StructureComparer : IEqualityComparer<IStructure>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IStructure"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IStructure"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IStructure"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IStructure"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IStructure x, IStructure y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IStructure"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IStructure"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IStructure obj)
        {
            return HashCode.Combine(typeof(IStructure), obj.Id);
        }
    }
}
