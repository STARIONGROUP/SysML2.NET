// -------------------------------------------------------------------------------------------------
// <copyright file="AnalysisCaseDefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IAnalysisCaseDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="IAnalysisCaseDefinition"/> instances
    ...
    public sealed class AnalysisCaseDefinitionComparer : IEqualityComparer<IAnalysisCaseDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IAnalysisCaseDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IAnalysisCaseDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IAnalysisCaseDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IAnalysisCaseDefinition"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IAnalysisCaseDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IAnalysisCaseDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
