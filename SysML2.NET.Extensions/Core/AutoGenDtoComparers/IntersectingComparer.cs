// -------------------------------------------------------------------------------------------------
// <copyright file="IntersectingComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IIntersecting"/> instances
    ...
    /// validation scenarios where two <see cref="IIntersecting"/> instances
    ...
    public sealed class IntersectingComparer : IEqualityComparer<IIntersecting>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IIntersecting"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IIntersecting"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IIntersecting"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IIntersecting"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IIntersecting x, IIntersecting y)
        {
            ...
            if (x.IntersectingType != y.IntersectingType) return false;
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IIntersecting"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IIntersecting"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IIntersecting obj)
        {
            return HashCode.Combine(typeof(IIntersecting), obj.Id);
        }
    }
}
