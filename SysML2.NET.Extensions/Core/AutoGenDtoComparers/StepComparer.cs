// -------------------------------------------------------------------------------------------------
// <copyright file="StepComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IStep"/> instances
    ...
    /// validation scenarios where two <see cref="IStep"/> instances
    ...
    public sealed class StepComparer : IEqualityComparer<IStep>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IStep"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IStep"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IStep"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IStep"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IStep"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IStep"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        {
            return HashCode.Combine(typeof(IStep), obj.Id);
        }
    }
}
