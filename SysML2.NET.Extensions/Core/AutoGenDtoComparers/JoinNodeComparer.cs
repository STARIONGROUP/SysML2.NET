// -------------------------------------------------------------------------------------------------
// <copyright file="JoinNodeComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IJoinNode"/> instances
    ...
    /// validation scenarios where two <see cref="IJoinNode"/> instances
    ...
    public sealed class JoinNodeComparer : IEqualityComparer<IJoinNode>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IJoinNode"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IJoinNode"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IJoinNode"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IJoinNode"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IJoinNode x, IJoinNode y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IJoinNode"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IJoinNode"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IJoinNode obj)
        {
            return HashCode.Combine(typeof(IJoinNode), obj.Id);
        }
    }
}
