// -------------------------------------------------------------------------------------------------
// <copyright file="StateDefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IStateDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="IStateDefinition"/> instances
    ...
    public sealed class StateDefinitionComparer : IEqualityComparer<IStateDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IStateDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IStateDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IStateDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IStateDefinition"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IStateDefinition x, IStateDefinition y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IStateDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IStateDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IStateDefinition obj)
        {
            return HashCode.Combine(typeof(IStateDefinition), obj.Id);
        }
    }
}
