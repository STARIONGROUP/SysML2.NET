// -------------------------------------------------------------------------------------------------
// <copyright file="AttributeUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IAttributeUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IAttributeUsage"/> instances
    ...
    public sealed class AttributeUsageComparer : IEqualityComparer<IAttributeUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IAttributeUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IAttributeUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IAttributeUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IAttributeUsage"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IAttributeUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IAttributeUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
