// -------------------------------------------------------------------------------------------------
// <copyright file="FeatureReferenceExpressionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IFeatureReferenceExpression"/> instances
    ...
    /// validation scenarios where two <see cref="IFeatureReferenceExpression"/> instances
    ...
    public sealed class FeatureReferenceExpressionComparer : IEqualityComparer<IFeatureReferenceExpression>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IFeatureReferenceExpression"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IFeatureReferenceExpression"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IFeatureReferenceExpression"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IFeatureReferenceExpression"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IFeatureReferenceExpression x, IFeatureReferenceExpression y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IFeatureReferenceExpression"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IFeatureReferenceExpression"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IFeatureReferenceExpression obj)
        {
            return HashCode.Combine(typeof(IFeatureReferenceExpression), obj.Id);
        }
    }
}
