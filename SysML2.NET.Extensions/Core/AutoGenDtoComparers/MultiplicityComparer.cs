// -------------------------------------------------------------------------------------------------
// <copyright file="MultiplicityComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IMultiplicity"/> instances
    ...
    /// validation scenarios where two <see cref="IMultiplicity"/> instances
    ...
    public sealed class MultiplicityComparer : IEqualityComparer<IMultiplicity>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IMultiplicity"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IMultiplicity"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IMultiplicity"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IMultiplicity"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IMultiplicity x, IMultiplicity y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IMultiplicity"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IMultiplicity"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IMultiplicity obj)
        {
            return HashCode.Combine(typeof(IMultiplicity), obj.Id);
        }
    }
}
