// -------------------------------------------------------------------------------------------------
// <copyright file="RequirementConstraintMembershipComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IRequirementConstraintMembership"/> instances
    ...
    /// validation scenarios where two <see cref="IRequirementConstraintMembership"/> instances
    ...
    public sealed class RequirementConstraintMembershipComparer : IEqualityComparer<IRequirementConstraintMembership>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IRequirementConstraintMembership"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IRequirementConstraintMembership"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IRequirementConstraintMembership"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IRequirementConstraintMembership"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IRequirementConstraintMembership x, IRequirementConstraintMembership y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IRequirementConstraintMembership"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IRequirementConstraintMembership"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IRequirementConstraintMembership obj)
        {
            return HashCode.Combine(typeof(IRequirementConstraintMembership), obj.Id);
        }
    }
}
