// -------------------------------------------------------------------------------------------------
// <copyright file="SuccessionFlowComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ISuccessionFlow"/> instances
    ...
    /// validation scenarios where two <see cref="ISuccessionFlow"/> instances
    ...
    public sealed class SuccessionFlowComparer : IEqualityComparer<ISuccessionFlow>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ISuccessionFlow"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ISuccessionFlow"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ISuccessionFlow"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ISuccessionFlow"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(ISuccessionFlow x, ISuccessionFlow y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ISuccessionFlow"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ISuccessionFlow"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(ISuccessionFlow obj)
        {
            return HashCode.Combine(typeof(ISuccessionFlow), obj.Id);
        }
    }
}
