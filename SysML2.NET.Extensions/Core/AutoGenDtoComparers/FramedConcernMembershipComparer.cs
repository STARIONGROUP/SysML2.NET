// -------------------------------------------------------------------------------------------------
// <copyright file="FramedConcernMembershipComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IFramedConcernMembership"/> instances
    ...
    /// validation scenarios where two <see cref="IFramedConcernMembership"/> instances
    ...
    public sealed class FramedConcernMembershipComparer : IEqualityComparer<IFramedConcernMembership>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IFramedConcernMembership"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IFramedConcernMembership"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IFramedConcernMembership"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IFramedConcernMembership"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IFramedConcernMembership"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IFramedConcernMembership"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
