// -------------------------------------------------------------------------------------------------
// <copyright file="DecisionNodeComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IDecisionNode"/> instances
    ...
    /// validation scenarios where two <see cref="IDecisionNode"/> instances
    ...
    public sealed class DecisionNodeComparer : IEqualityComparer<IDecisionNode>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IDecisionNode"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IDecisionNode"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IDecisionNode"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IDecisionNode"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IDecisionNode x, IDecisionNode y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IDecisionNode"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IDecisionNode"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IDecisionNode obj)
        {
            return HashCode.Combine(typeof(IDecisionNode), obj.Id);
        }
    }
}
