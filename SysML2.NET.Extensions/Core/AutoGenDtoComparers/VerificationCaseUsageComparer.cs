// -------------------------------------------------------------------------------------------------
// <copyright file="VerificationCaseUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IVerificationCaseUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IVerificationCaseUsage"/> instances
    ...
    public sealed class VerificationCaseUsageComparer : IEqualityComparer<IVerificationCaseUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IVerificationCaseUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IVerificationCaseUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IVerificationCaseUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IVerificationCaseUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IVerificationCaseUsage x, IVerificationCaseUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IVerificationCaseUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IVerificationCaseUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IVerificationCaseUsage obj)
        {
            return HashCode.Combine(typeof(IVerificationCaseUsage), obj.Id);
        }
    }
}
