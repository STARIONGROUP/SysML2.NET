// -------------------------------------------------------------------------------------------------
// <copyright file="ConnectorComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IConnector"/> instances
    ...
    /// validation scenarios where two <see cref="IConnector"/> instances
    ...
    public sealed class ConnectorComparer : IEqualityComparer<IConnector>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IConnector"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IConnector"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IConnector"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IConnector"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IConnector x, IConnector y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IConnector"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IConnector"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IConnector obj)
        {
            return HashCode.Combine(typeof(IConnector), obj.Id);
        }
    }
}
