// -------------------------------------------------------------------------------------------------
// <copyright file="SatisfyRequirementUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ISatisfyRequirementUsage"/> instances
    ...
    /// validation scenarios where two <see cref="ISatisfyRequirementUsage"/> instances
    ...
    public sealed class SatisfyRequirementUsageComparer : IEqualityComparer<ISatisfyRequirementUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ISatisfyRequirementUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ISatisfyRequirementUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ISatisfyRequirementUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ISatisfyRequirementUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(ISatisfyRequirementUsage x, ISatisfyRequirementUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ISatisfyRequirementUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ISatisfyRequirementUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(ISatisfyRequirementUsage obj)
        {
            return HashCode.Combine(typeof(ISatisfyRequirementUsage), obj.Id);
        }
    }
}
