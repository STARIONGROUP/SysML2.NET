// -------------------------------------------------------------------------------------------------
// <copyright file="PredicateComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IPredicate"/> instances
    ...
    /// validation scenarios where two <see cref="IPredicate"/> instances
    ...
    public sealed class PredicateComparer : IEqualityComparer<IPredicate>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IPredicate"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IPredicate"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IPredicate"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IPredicate"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IPredicate x, IPredicate y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IPredicate"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IPredicate"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IPredicate obj)
        {
            return HashCode.Combine(typeof(IPredicate), obj.Id);
        }
    }
}
