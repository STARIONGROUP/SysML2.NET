// -------------------------------------------------------------------------------------------------
// <copyright file="FeatureInvertingComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IFeatureInverting"/> instances
    ...
    /// validation scenarios where two <see cref="IFeatureInverting"/> instances
    ...
    public sealed class FeatureInvertingComparer : IEqualityComparer<IFeatureInverting>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IFeatureInverting"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IFeatureInverting"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IFeatureInverting"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IFeatureInverting"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IFeatureInverting x, IFeatureInverting y)
        {
            ...
            if (x.FeatureInverted != y.FeatureInverted) return false;

            if (x.InvertingFeature != y.InvertingFeature) return false;
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IFeatureInverting"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IFeatureInverting"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IFeatureInverting obj)
        {
            return HashCode.Combine(typeof(IFeatureInverting), obj.Id);
        }
    }
}
