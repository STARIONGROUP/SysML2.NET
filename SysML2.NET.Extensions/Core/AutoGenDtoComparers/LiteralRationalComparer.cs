// -------------------------------------------------------------------------------------------------
// <copyright file="LiteralRationalComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ILiteralRational"/> instances
    ...
    /// validation scenarios where two <see cref="ILiteralRational"/> instances
    ...
    public sealed class LiteralRationalComparer : IEqualityComparer<ILiteralRational>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ILiteralRational"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ILiteralRational"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ILiteralRational"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ILiteralRational"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ILiteralRational"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ILiteralRational"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
