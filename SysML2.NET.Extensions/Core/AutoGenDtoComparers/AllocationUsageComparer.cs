// -------------------------------------------------------------------------------------------------
// <copyright file="AllocationUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IAllocationUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IAllocationUsage"/> instances
    ...
    public sealed class AllocationUsageComparer : IEqualityComparer<IAllocationUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IAllocationUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IAllocationUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IAllocationUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IAllocationUsage"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IAllocationUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IAllocationUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
