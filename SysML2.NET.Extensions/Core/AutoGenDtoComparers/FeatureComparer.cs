// -------------------------------------------------------------------------------------------------
// <copyright file="FeatureComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IFeature"/> instances
    ...
    /// validation scenarios where two <see cref="IFeature"/> instances
    ...
    public sealed class FeatureComparer : IEqualityComparer<IFeature>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IFeature"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IFeature"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IFeature"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IFeature"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IFeature"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IFeature"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
