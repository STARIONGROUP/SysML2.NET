// -------------------------------------------------------------------------------------------------
// <copyright file="ConjugationComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IConjugation"/> instances
    ...
    /// validation scenarios where two <see cref="IConjugation"/> instances
    ...
    public sealed class ConjugationComparer : IEqualityComparer<IConjugation>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IConjugation"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IConjugation"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IConjugation"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IConjugation"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IConjugation x, IConjugation y)
        {
            ...
            if (x.OriginalType != y.OriginalType) return false;
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IConjugation"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IConjugation"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IConjugation obj)
        {
            return HashCode.Combine(typeof(IConjugation), obj.Id);
        }
    }
}
