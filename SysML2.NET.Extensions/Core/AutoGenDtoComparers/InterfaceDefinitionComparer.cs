// -------------------------------------------------------------------------------------------------
// <copyright file="InterfaceDefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IInterfaceDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="IInterfaceDefinition"/> instances
    ...
    public sealed class InterfaceDefinitionComparer : IEqualityComparer<IInterfaceDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IInterfaceDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IInterfaceDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IInterfaceDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IInterfaceDefinition"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IInterfaceDefinition x, IInterfaceDefinition y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IInterfaceDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IInterfaceDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IInterfaceDefinition obj)
        {
            return HashCode.Combine(typeof(IInterfaceDefinition), obj.Id);
        }
    }
}
