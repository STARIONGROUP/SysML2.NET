// -------------------------------------------------------------------------------------------------
// <copyright file="ViewpointUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IViewpointUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IViewpointUsage"/> instances
    ...
    public sealed class ViewpointUsageComparer : IEqualityComparer<IViewpointUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IViewpointUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IViewpointUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IViewpointUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IViewpointUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IViewpointUsage x, IViewpointUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IViewpointUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IViewpointUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IViewpointUsage obj)
        {
            return HashCode.Combine(typeof(IViewpointUsage), obj.Id);
        }
    }
}
