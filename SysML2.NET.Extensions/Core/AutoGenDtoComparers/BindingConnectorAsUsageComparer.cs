// -------------------------------------------------------------------------------------------------
// <copyright file="BindingConnectorAsUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IBindingConnectorAsUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IBindingConnectorAsUsage"/> instances
    ...
    public sealed class BindingConnectorAsUsageComparer : IEqualityComparer<IBindingConnectorAsUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IBindingConnectorAsUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IBindingConnectorAsUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IBindingConnectorAsUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IBindingConnectorAsUsage"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IBindingConnectorAsUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IBindingConnectorAsUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
