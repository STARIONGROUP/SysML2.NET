// -------------------------------------------------------------------------------------------------
// <copyright file="ActionUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IActionUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IActionUsage"/> instances
    ...
    public sealed class ActionUsageComparer : IEqualityComparer<IActionUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IActionUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IActionUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IActionUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IActionUsage"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IActionUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IActionUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
