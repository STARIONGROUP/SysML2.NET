// -------------------------------------------------------------------------------------------------
// <copyright file="BehaviorComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IBehavior"/> instances
    ...
    /// validation scenarios where two <see cref="IBehavior"/> instances
    ...
    public sealed class BehaviorComparer : IEqualityComparer<IBehavior>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IBehavior"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IBehavior"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IBehavior"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IBehavior"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IBehavior"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IBehavior"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
