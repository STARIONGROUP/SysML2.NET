// -------------------------------------------------------------------------------------------------
// <copyright file="IfActionUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IIfActionUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IIfActionUsage"/> instances
    ...
    public sealed class IfActionUsageComparer : IEqualityComparer<IIfActionUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IIfActionUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IIfActionUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IIfActionUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IIfActionUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IIfActionUsage x, IIfActionUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IIfActionUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IIfActionUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IIfActionUsage obj)
        {
            return HashCode.Combine(typeof(IIfActionUsage), obj.Id);
        }
    }
}
