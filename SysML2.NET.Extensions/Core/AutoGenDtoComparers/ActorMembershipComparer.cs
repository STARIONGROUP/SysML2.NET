// -------------------------------------------------------------------------------------------------
// <copyright file="ActorMembershipComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IActorMembership"/> instances
    ...
    /// validation scenarios where two <see cref="IActorMembership"/> instances
    ...
    public sealed class ActorMembershipComparer : IEqualityComparer<IActorMembership>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IActorMembership"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IActorMembership"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IActorMembership"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IActorMembership"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IActorMembership"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IActorMembership"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
