// -------------------------------------------------------------------------------------------------
// <copyright file="VariantMembershipComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IVariantMembership"/> instances
    ...
    /// validation scenarios where two <see cref="IVariantMembership"/> instances
    ...
    public sealed class VariantMembershipComparer : IEqualityComparer<IVariantMembership>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IVariantMembership"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IVariantMembership"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IVariantMembership"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IVariantMembership"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IVariantMembership x, IVariantMembership y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IVariantMembership"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IVariantMembership"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IVariantMembership obj)
        {
            return HashCode.Combine(typeof(IVariantMembership), obj.Id);
        }
    }
}
