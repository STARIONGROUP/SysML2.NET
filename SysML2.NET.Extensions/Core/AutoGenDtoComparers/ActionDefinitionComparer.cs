// -------------------------------------------------------------------------------------------------
// <copyright file="ActionDefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IActionDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="IActionDefinition"/> instances
    ...
    public sealed class ActionDefinitionComparer : IEqualityComparer<IActionDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IActionDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IActionDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IActionDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IActionDefinition"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IActionDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IActionDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
