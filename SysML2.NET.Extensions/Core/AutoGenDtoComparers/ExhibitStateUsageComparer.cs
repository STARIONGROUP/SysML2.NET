// -------------------------------------------------------------------------------------------------
// <copyright file="ExhibitStateUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IExhibitStateUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IExhibitStateUsage"/> instances
    ...
    public sealed class ExhibitStateUsageComparer : IEqualityComparer<IExhibitStateUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IExhibitStateUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IExhibitStateUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IExhibitStateUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IExhibitStateUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IExhibitStateUsage x, IExhibitStateUsage y)
        {
            ...
            if (x.IsParallel != y.IsParallel) return false;
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IExhibitStateUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IExhibitStateUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IExhibitStateUsage obj)
        {
            return HashCode.Combine(typeof(IExhibitStateUsage), obj.Id);
        }
    }
}
