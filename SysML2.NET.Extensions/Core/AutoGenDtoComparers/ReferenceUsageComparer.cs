// -------------------------------------------------------------------------------------------------
// <copyright file="ReferenceUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IReferenceUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IReferenceUsage"/> instances
    ...
    public sealed class ReferenceUsageComparer : IEqualityComparer<IReferenceUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IReferenceUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IReferenceUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IReferenceUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IReferenceUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IReferenceUsage x, IReferenceUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IReferenceUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IReferenceUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IReferenceUsage obj)
        {
            return HashCode.Combine(typeof(IReferenceUsage), obj.Id);
        }
    }
}
