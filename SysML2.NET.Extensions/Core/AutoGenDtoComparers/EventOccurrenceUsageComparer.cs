// -------------------------------------------------------------------------------------------------
// <copyright file="EventOccurrenceUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IEventOccurrenceUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IEventOccurrenceUsage"/> instances
    ...
    public sealed class EventOccurrenceUsageComparer : IEqualityComparer<IEventOccurrenceUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IEventOccurrenceUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IEventOccurrenceUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IEventOccurrenceUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IEventOccurrenceUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IEventOccurrenceUsage x, IEventOccurrenceUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IEventOccurrenceUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IEventOccurrenceUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IEventOccurrenceUsage obj)
        {
            return HashCode.Combine(typeof(IEventOccurrenceUsage), obj.Id);
        }
    }
}
