// -------------------------------------------------------------------------------------------------
// <copyright file="FeatureMembershipComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IFeatureMembership"/> instances
    ...
    /// validation scenarios where two <see cref="IFeatureMembership"/> instances
    ...
    public sealed class FeatureMembershipComparer : IEqualityComparer<IFeatureMembership>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IFeatureMembership"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IFeatureMembership"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IFeatureMembership"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IFeatureMembership"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IFeatureMembership x, IFeatureMembership y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IFeatureMembership"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IFeatureMembership"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IFeatureMembership obj)
        {
            return HashCode.Combine(typeof(IFeatureMembership), obj.Id);
        }
    }
}
