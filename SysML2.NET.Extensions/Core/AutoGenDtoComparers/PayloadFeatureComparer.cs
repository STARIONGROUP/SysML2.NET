// -------------------------------------------------------------------------------------------------
// <copyright file="PayloadFeatureComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IPayloadFeature"/> instances
    ...
    /// validation scenarios where two <see cref="IPayloadFeature"/> instances
    ...
    public sealed class PayloadFeatureComparer : IEqualityComparer<IPayloadFeature>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IPayloadFeature"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IPayloadFeature"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IPayloadFeature"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IPayloadFeature"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IPayloadFeature x, IPayloadFeature y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IPayloadFeature"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IPayloadFeature"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IPayloadFeature obj)
        {
            return HashCode.Combine(typeof(IPayloadFeature), obj.Id);
        }
    }
}
