// -------------------------------------------------------------------------------------------------
// <copyright file="MergeNodeComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IMergeNode"/> instances
    ...
    /// validation scenarios where two <see cref="IMergeNode"/> instances
    ...
    public sealed class MergeNodeComparer : IEqualityComparer<IMergeNode>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IMergeNode"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IMergeNode"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IMergeNode"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IMergeNode"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IMergeNode x, IMergeNode y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IMergeNode"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IMergeNode"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IMergeNode obj)
        {
            return HashCode.Combine(typeof(IMergeNode), obj.Id);
        }
    }
}
