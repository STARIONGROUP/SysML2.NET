// -------------------------------------------------------------------------------------------------
// <copyright file="TextualRepresentationComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ITextualRepresentation"/> instances
    ...
    /// validation scenarios where two <see cref="ITextualRepresentation"/> instances
    ...
    public sealed class TextualRepresentationComparer : IEqualityComparer<ITextualRepresentation>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ITextualRepresentation"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ITextualRepresentation"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ITextualRepresentation"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ITextualRepresentation"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ITextualRepresentation"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ITextualRepresentation"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
