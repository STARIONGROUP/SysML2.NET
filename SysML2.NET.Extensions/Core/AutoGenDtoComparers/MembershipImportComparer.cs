// -------------------------------------------------------------------------------------------------
// <copyright file="MembershipImportComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IMembershipImport"/> instances
    ...
    /// validation scenarios where two <see cref="IMembershipImport"/> instances
    ...
    public sealed class MembershipImportComparer : IEqualityComparer<IMembershipImport>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IMembershipImport"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IMembershipImport"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IMembershipImport"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IMembershipImport"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IMembershipImport x, IMembershipImport y)
        {
            ...
            if (x.ImportedMembership != y.ImportedMembership) return false;
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IMembershipImport"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IMembershipImport"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IMembershipImport obj)
        {
            return HashCode.Combine(typeof(IMembershipImport), obj.Id);
        }
    }
}
