// -------------------------------------------------------------------------------------------------
// <copyright file="CrossSubsettingComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ICrossSubsetting"/> instances
    ...
    /// validation scenarios where two <see cref="ICrossSubsetting"/> instances
    ...
    public sealed class CrossSubsettingComparer : IEqualityComparer<ICrossSubsetting>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ICrossSubsetting"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ICrossSubsetting"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ICrossSubsetting"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ICrossSubsetting"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(ICrossSubsetting x, ICrossSubsetting y)
        {
            ...
            if (x.CrossedFeature != y.CrossedFeature) return false;
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ICrossSubsetting"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ICrossSubsetting"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(ICrossSubsetting obj)
        {
            return HashCode.Combine(typeof(ICrossSubsetting), obj.Id);
        }
    }
}
