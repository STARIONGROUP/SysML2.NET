// -------------------------------------------------------------------------------------------------
// <copyright file="DifferencingComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IDifferencing"/> instances
    ...
    /// validation scenarios where two <see cref="IDifferencing"/> instances
    ...
    public sealed class DifferencingComparer : IEqualityComparer<IDifferencing>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IDifferencing"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IDifferencing"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IDifferencing"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IDifferencing"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IDifferencing x, IDifferencing y)
        {
            ...
            if (x.DifferencingType != y.DifferencingType) return false;
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IDifferencing"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IDifferencing"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IDifferencing obj)
        {
            return HashCode.Combine(typeof(IDifferencing), obj.Id);
        }
    }
}
