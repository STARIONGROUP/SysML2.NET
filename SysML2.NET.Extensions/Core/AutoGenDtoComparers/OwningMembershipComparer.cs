// -------------------------------------------------------------------------------------------------
// <copyright file="OwningMembershipComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IOwningMembership"/> instances
    ...
    /// validation scenarios where two <see cref="IOwningMembership"/> instances
    ...
    public sealed class OwningMembershipComparer : IEqualityComparer<IOwningMembership>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IOwningMembership"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IOwningMembership"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IOwningMembership"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IOwningMembership"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IOwningMembership"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IOwningMembership"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
