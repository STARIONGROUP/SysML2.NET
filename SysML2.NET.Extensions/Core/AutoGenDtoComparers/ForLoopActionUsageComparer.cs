// -------------------------------------------------------------------------------------------------
// <copyright file="ForLoopActionUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IForLoopActionUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IForLoopActionUsage"/> instances
    ...
    public sealed class ForLoopActionUsageComparer : IEqualityComparer<IForLoopActionUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IForLoopActionUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IForLoopActionUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IForLoopActionUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IForLoopActionUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IForLoopActionUsage x, IForLoopActionUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IForLoopActionUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IForLoopActionUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IForLoopActionUsage obj)
        {
            return HashCode.Combine(typeof(IForLoopActionUsage), obj.Id);
        }
    }
}
