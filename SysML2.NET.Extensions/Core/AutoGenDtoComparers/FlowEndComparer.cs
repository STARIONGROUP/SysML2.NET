// -------------------------------------------------------------------------------------------------
// <copyright file="FlowEndComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IFlowEnd"/> instances
    ...
    /// validation scenarios where two <see cref="IFlowEnd"/> instances
    ...
    public sealed class FlowEndComparer : IEqualityComparer<IFlowEnd>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IFlowEnd"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IFlowEnd"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IFlowEnd"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IFlowEnd"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IFlowEnd x, IFlowEnd y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IFlowEnd"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IFlowEnd"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IFlowEnd obj)
        {
            return HashCode.Combine(typeof(IFlowEnd), obj.Id);
        }
    }
}
