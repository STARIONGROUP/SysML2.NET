// -------------------------------------------------------------------------------------------------
// <copyright file="FeatureChainExpressionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IFeatureChainExpression"/> instances
    ...
    /// validation scenarios where two <see cref="IFeatureChainExpression"/> instances
    ...
    public sealed class FeatureChainExpressionComparer : IEqualityComparer<IFeatureChainExpression>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IFeatureChainExpression"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IFeatureChainExpression"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IFeatureChainExpression"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IFeatureChainExpression"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IFeatureChainExpression x, IFeatureChainExpression y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IFeatureChainExpression"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IFeatureChainExpression"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IFeatureChainExpression obj)
        {
            return HashCode.Combine(typeof(IFeatureChainExpression), obj.Id);
        }
    }
}
