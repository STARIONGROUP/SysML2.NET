// -------------------------------------------------------------------------------------------------
// <copyright file="MetaclassComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IMetaclass"/> instances
    ...
    /// validation scenarios where two <see cref="IMetaclass"/> instances
    ...
    public sealed class MetaclassComparer : IEqualityComparer<IMetaclass>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IMetaclass"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IMetaclass"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IMetaclass"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IMetaclass"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IMetaclass x, IMetaclass y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IMetaclass"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IMetaclass"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IMetaclass obj)
        {
            return HashCode.Combine(typeof(IMetaclass), obj.Id);
        }
    }
}
