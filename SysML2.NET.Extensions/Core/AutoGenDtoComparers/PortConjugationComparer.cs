// -------------------------------------------------------------------------------------------------
// <copyright file="PortConjugationComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IPortConjugation"/> instances
    ...
    /// validation scenarios where two <see cref="IPortConjugation"/> instances
    ...
    public sealed class PortConjugationComparer : IEqualityComparer<IPortConjugation>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IPortConjugation"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IPortConjugation"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IPortConjugation"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IPortConjugation"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IPortConjugation x, IPortConjugation y)
        {
            ...
            if (x.ConjugatedType != y.ConjugatedType) return false;
            ...
            if (x.OriginalPortDefinition != y.OriginalPortDefinition) return false;
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IPortConjugation"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IPortConjugation"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IPortConjugation obj)
        {
            return HashCode.Combine(typeof(IPortConjugation), obj.Id);
        }
    }
}
