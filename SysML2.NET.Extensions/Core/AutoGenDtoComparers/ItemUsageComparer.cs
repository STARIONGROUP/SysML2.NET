// -------------------------------------------------------------------------------------------------
// <copyright file="ItemUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IItemUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IItemUsage"/> instances
    ...
    public sealed class ItemUsageComparer : IEqualityComparer<IItemUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IItemUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IItemUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IItemUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IItemUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IItemUsage x, IItemUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IItemUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IItemUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IItemUsage obj)
        {
            return HashCode.Combine(typeof(IItemUsage), obj.Id);
        }
    }
}
