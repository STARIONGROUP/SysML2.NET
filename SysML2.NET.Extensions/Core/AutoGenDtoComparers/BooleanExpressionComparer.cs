// -------------------------------------------------------------------------------------------------
// <copyright file="BooleanExpressionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IBooleanExpression"/> instances
    ...
    /// validation scenarios where two <see cref="IBooleanExpression"/> instances
    ...
    public sealed class BooleanExpressionComparer : IEqualityComparer<IBooleanExpression>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IBooleanExpression"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IBooleanExpression"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IBooleanExpression"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IBooleanExpression"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IBooleanExpression"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IBooleanExpression"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
