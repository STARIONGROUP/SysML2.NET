// -------------------------------------------------------------------------------------------------
// <copyright file="DataTypeComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IDataType"/> instances
    ...
    /// validation scenarios where two <see cref="IDataType"/> instances
    ...
    public sealed class DataTypeComparer : IEqualityComparer<IDataType>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IDataType"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IDataType"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IDataType"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IDataType"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IDataType"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IDataType"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        {
            return HashCode.Combine(typeof(IDataType), obj.Id);
        }
    }
}
