// -------------------------------------------------------------------------------------------------
// <copyright file="ConcernUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IConcernUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IConcernUsage"/> instances
    ...
    public sealed class ConcernUsageComparer : IEqualityComparer<IConcernUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IConcernUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IConcernUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IConcernUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IConcernUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IConcernUsage x, IConcernUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IConcernUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IConcernUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IConcernUsage obj)
        {
            return HashCode.Combine(typeof(IConcernUsage), obj.Id);
        }
    }
}
