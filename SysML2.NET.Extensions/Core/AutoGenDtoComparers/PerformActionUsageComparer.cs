// -------------------------------------------------------------------------------------------------
// <copyright file="PerformActionUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IPerformActionUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IPerformActionUsage"/> instances
    ...
    public sealed class PerformActionUsageComparer : IEqualityComparer<IPerformActionUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IPerformActionUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IPerformActionUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IPerformActionUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IPerformActionUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IPerformActionUsage x, IPerformActionUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IPerformActionUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IPerformActionUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IPerformActionUsage obj)
        {
            return HashCode.Combine(typeof(IPerformActionUsage), obj.Id);
        }
    }
}
