// -------------------------------------------------------------------------------------------------
// <copyright file="SubjectMembershipComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ISubjectMembership"/> instances
    ...
    /// validation scenarios where two <see cref="ISubjectMembership"/> instances
    ...
    public sealed class SubjectMembershipComparer : IEqualityComparer<ISubjectMembership>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ISubjectMembership"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ISubjectMembership"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ISubjectMembership"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ISubjectMembership"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(ISubjectMembership x, ISubjectMembership y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ISubjectMembership"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ISubjectMembership"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(ISubjectMembership obj)
        {
            return HashCode.Combine(typeof(ISubjectMembership), obj.Id);
        }
    }
}
