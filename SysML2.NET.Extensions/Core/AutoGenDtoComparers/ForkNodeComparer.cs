// -------------------------------------------------------------------------------------------------
// <copyright file="ForkNodeComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IForkNode"/> instances
    ...
    /// validation scenarios where two <see cref="IForkNode"/> instances
    ...
    public sealed class ForkNodeComparer : IEqualityComparer<IForkNode>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IForkNode"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IForkNode"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IForkNode"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IForkNode"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IForkNode x, IForkNode y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IForkNode"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IForkNode"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IForkNode obj)
        {
            return HashCode.Combine(typeof(IForkNode), obj.Id);
        }
    }
}
