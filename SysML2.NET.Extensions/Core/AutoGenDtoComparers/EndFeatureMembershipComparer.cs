// -------------------------------------------------------------------------------------------------
// <copyright file="EndFeatureMembershipComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IEndFeatureMembership"/> instances
    ...
    /// validation scenarios where two <see cref="IEndFeatureMembership"/> instances
    ...
    public sealed class EndFeatureMembershipComparer : IEqualityComparer<IEndFeatureMembership>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IEndFeatureMembership"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IEndFeatureMembership"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IEndFeatureMembership"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IEndFeatureMembership"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IEndFeatureMembership x, IEndFeatureMembership y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IEndFeatureMembership"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IEndFeatureMembership"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IEndFeatureMembership obj)
        {
            return HashCode.Combine(typeof(IEndFeatureMembership), obj.Id);
        }
    }
}
