// -------------------------------------------------------------------------------------------------
// <copyright file="TypeComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IType"/> instances
    ...
    /// validation scenarios where two <see cref="IType"/> instances
    ...
    public sealed class TypeComparer : IEqualityComparer<IType>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IType"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IType"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IType"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IType"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IType"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IType"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        {
            return HashCode.Combine(typeof(IType), obj.Id);
        }
    }
}
