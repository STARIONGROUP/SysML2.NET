// -------------------------------------------------------------------------------------------------
// <copyright file="CaseDefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ICaseDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="ICaseDefinition"/> instances
    ...
    public sealed class CaseDefinitionComparer : IEqualityComparer<ICaseDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ICaseDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ICaseDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ICaseDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ICaseDefinition"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ICaseDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ICaseDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
