// -------------------------------------------------------------------------------------------------
// <copyright file="ReferenceSubsettingComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IReferenceSubsetting"/> instances
    ...
    /// validation scenarios where two <see cref="IReferenceSubsetting"/> instances
    ...
    public sealed class ReferenceSubsettingComparer : IEqualityComparer<IReferenceSubsetting>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IReferenceSubsetting"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IReferenceSubsetting"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IReferenceSubsetting"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IReferenceSubsetting"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IReferenceSubsetting"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IReferenceSubsetting"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
