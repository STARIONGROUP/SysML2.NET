// -------------------------------------------------------------------------------------------------
// <copyright file="ViewRenderingMembershipComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IViewRenderingMembership"/> instances
    ...
    /// validation scenarios where two <see cref="IViewRenderingMembership"/> instances
    ...
    public sealed class ViewRenderingMembershipComparer : IEqualityComparer<IViewRenderingMembership>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IViewRenderingMembership"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IViewRenderingMembership"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IViewRenderingMembership"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IViewRenderingMembership"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IViewRenderingMembership x, IViewRenderingMembership y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IViewRenderingMembership"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IViewRenderingMembership"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IViewRenderingMembership obj)
        {
            return HashCode.Combine(typeof(IViewRenderingMembership), obj.Id);
        }
    }
}
