// -------------------------------------------------------------------------------------------------
// <copyright file="ConnectionUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IConnectionUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IConnectionUsage"/> instances
    ...
    public sealed class ConnectionUsageComparer : IEqualityComparer<IConnectionUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IConnectionUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IConnectionUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IConnectionUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IConnectionUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IConnectionUsage x, IConnectionUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IConnectionUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IConnectionUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IConnectionUsage obj)
        {
            return HashCode.Combine(typeof(IConnectionUsage), obj.Id);
        }
    }
}
