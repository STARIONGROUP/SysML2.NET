// -------------------------------------------------------------------------------------------------
// <copyright file="ConstraintDefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IConstraintDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="IConstraintDefinition"/> instances
    ...
    public sealed class ConstraintDefinitionComparer : IEqualityComparer<IConstraintDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IConstraintDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IConstraintDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IConstraintDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IConstraintDefinition"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IConstraintDefinition x, IConstraintDefinition y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IConstraintDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IConstraintDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IConstraintDefinition obj)
        {
            return HashCode.Combine(typeof(IConstraintDefinition), obj.Id);
        }
    }
}
