// -------------------------------------------------------------------------------------------------
// <copyright file="MetadataAccessExpressionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IMetadataAccessExpression"/> instances
    ...
    /// validation scenarios where two <see cref="IMetadataAccessExpression"/> instances
    ...
    public sealed class MetadataAccessExpressionComparer : IEqualityComparer<IMetadataAccessExpression>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IMetadataAccessExpression"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IMetadataAccessExpression"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IMetadataAccessExpression"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IMetadataAccessExpression"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IMetadataAccessExpression x, IMetadataAccessExpression y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IMetadataAccessExpression"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IMetadataAccessExpression"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IMetadataAccessExpression obj)
        {
            return HashCode.Combine(typeof(IMetadataAccessExpression), obj.Id);
        }
    }
}
