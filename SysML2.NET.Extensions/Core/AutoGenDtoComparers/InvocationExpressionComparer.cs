// -------------------------------------------------------------------------------------------------
// <copyright file="InvocationExpressionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IInvocationExpression"/> instances
    ...
    /// validation scenarios where two <see cref="IInvocationExpression"/> instances
    ...
    public sealed class InvocationExpressionComparer : IEqualityComparer<IInvocationExpression>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IInvocationExpression"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IInvocationExpression"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IInvocationExpression"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IInvocationExpression"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IInvocationExpression x, IInvocationExpression y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IInvocationExpression"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IInvocationExpression"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IInvocationExpression obj)
        {
            return HashCode.Combine(typeof(IInvocationExpression), obj.Id);
        }
    }
}
