// -------------------------------------------------------------------------------------------------
// <copyright file="EnumerationUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IEnumerationUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IEnumerationUsage"/> instances
    ...
    public sealed class EnumerationUsageComparer : IEqualityComparer<IEnumerationUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IEnumerationUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IEnumerationUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IEnumerationUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IEnumerationUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IEnumerationUsage x, IEnumerationUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IEnumerationUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IEnumerationUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IEnumerationUsage obj)
        {
            return HashCode.Combine(typeof(IEnumerationUsage), obj.Id);
        }
    }
}
