// -------------------------------------------------------------------------------------------------
// <copyright file="MembershipComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IMembership"/> instances
    ...
    /// validation scenarios where two <see cref="IMembership"/> instances
    ...
    public sealed class MembershipComparer : IEqualityComparer<IMembership>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IMembership"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IMembership"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IMembership"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IMembership"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IMembership"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IMembership"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
