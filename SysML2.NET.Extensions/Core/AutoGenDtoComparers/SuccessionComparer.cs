// -------------------------------------------------------------------------------------------------
// <copyright file="SuccessionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ISuccession"/> instances
    ...
    /// validation scenarios where two <see cref="ISuccession"/> instances
    ...
    public sealed class SuccessionComparer : IEqualityComparer<ISuccession>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ISuccession"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ISuccession"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ISuccession"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ISuccession"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(ISuccession x, ISuccession y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ISuccession"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ISuccession"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(ISuccession obj)
        {
            return HashCode.Combine(typeof(ISuccession), obj.Id);
        }
    }
}
