// -------------------------------------------------------------------------------------------------
// <copyright file="AllocationDefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IAllocationDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="IAllocationDefinition"/> instances
    ...
    public sealed class AllocationDefinitionComparer : IEqualityComparer<IAllocationDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IAllocationDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IAllocationDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IAllocationDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IAllocationDefinition"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IAllocationDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IAllocationDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
