// -------------------------------------------------------------------------------------------------
// <copyright file="ConjugatedPortTypingComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IConjugatedPortTyping"/> instances
    ...
    /// validation scenarios where two <see cref="IConjugatedPortTyping"/> instances
    ...
    public sealed class ConjugatedPortTypingComparer : IEqualityComparer<IConjugatedPortTyping>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IConjugatedPortTyping"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IConjugatedPortTyping"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IConjugatedPortTyping"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IConjugatedPortTyping"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IConjugatedPortTyping x, IConjugatedPortTyping y)
        {
            ...
            if (x.ConjugatedPortDefinition != y.ConjugatedPortDefinition) return false;
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IConjugatedPortTyping"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IConjugatedPortTyping"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IConjugatedPortTyping obj)
        {
            return HashCode.Combine(typeof(IConjugatedPortTyping), obj.Id);
        }
    }
}
