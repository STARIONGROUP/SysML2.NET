// -------------------------------------------------------------------------------------------------
// <copyright file="CalculationUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ICalculationUsage"/> instances
    ...
    /// validation scenarios where two <see cref="ICalculationUsage"/> instances
    ...
    public sealed class CalculationUsageComparer : IEqualityComparer<ICalculationUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ICalculationUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ICalculationUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ICalculationUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ICalculationUsage"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ICalculationUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ICalculationUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
