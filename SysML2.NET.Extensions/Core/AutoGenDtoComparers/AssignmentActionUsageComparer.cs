// -------------------------------------------------------------------------------------------------
// <copyright file="AssignmentActionUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IAssignmentActionUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IAssignmentActionUsage"/> instances
    ...
    public sealed class AssignmentActionUsageComparer : IEqualityComparer<IAssignmentActionUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IAssignmentActionUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IAssignmentActionUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IAssignmentActionUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IAssignmentActionUsage"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IAssignmentActionUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IAssignmentActionUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
