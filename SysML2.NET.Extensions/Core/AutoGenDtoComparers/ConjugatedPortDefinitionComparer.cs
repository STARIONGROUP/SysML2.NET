// -------------------------------------------------------------------------------------------------
// <copyright file="ConjugatedPortDefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IConjugatedPortDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="IConjugatedPortDefinition"/> instances
    ...
    public sealed class ConjugatedPortDefinitionComparer : IEqualityComparer<IConjugatedPortDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IConjugatedPortDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IConjugatedPortDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IConjugatedPortDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IConjugatedPortDefinition"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IConjugatedPortDefinition x, IConjugatedPortDefinition y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IConjugatedPortDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IConjugatedPortDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IConjugatedPortDefinition obj)
        {
            return HashCode.Combine(typeof(IConjugatedPortDefinition), obj.Id);
        }
    }
}
