// -------------------------------------------------------------------------------------------------
// <copyright file="UsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IUsage"/> instances
    ...
    public sealed class UsageComparer : IEqualityComparer<IUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IUsage"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
