// -------------------------------------------------------------------------------------------------
// <copyright file="TypeFeaturingComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ITypeFeaturing"/> instances
    ...
    /// validation scenarios where two <see cref="ITypeFeaturing"/> instances
    ...
    public sealed class TypeFeaturingComparer : IEqualityComparer<ITypeFeaturing>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ITypeFeaturing"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ITypeFeaturing"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ITypeFeaturing"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ITypeFeaturing"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(ITypeFeaturing x, ITypeFeaturing y)
        {
            ...
            if (x.FeatureOfType != y.FeatureOfType) return false;

            if (x.FeaturingType != y.FeaturingType) return false;
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ITypeFeaturing"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ITypeFeaturing"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(ITypeFeaturing obj)
        {
            return HashCode.Combine(typeof(ITypeFeaturing), obj.Id);
        }
    }
}
