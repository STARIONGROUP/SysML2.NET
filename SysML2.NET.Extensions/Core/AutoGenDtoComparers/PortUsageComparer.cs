// -------------------------------------------------------------------------------------------------
// <copyright file="PortUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IPortUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IPortUsage"/> instances
    ...
    public sealed class PortUsageComparer : IEqualityComparer<IPortUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IPortUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IPortUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IPortUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IPortUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IPortUsage x, IPortUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IPortUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IPortUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IPortUsage obj)
        {
            return HashCode.Combine(typeof(IPortUsage), obj.Id);
        }
    }
}
