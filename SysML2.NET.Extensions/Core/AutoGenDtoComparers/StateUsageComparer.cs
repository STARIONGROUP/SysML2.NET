// -------------------------------------------------------------------------------------------------
// <copyright file="StateUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IStateUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IStateUsage"/> instances
    ...
    public sealed class StateUsageComparer : IEqualityComparer<IStateUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IStateUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IStateUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IStateUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IStateUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IStateUsage x, IStateUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IStateUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IStateUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IStateUsage obj)
        {
            return HashCode.Combine(typeof(IStateUsage), obj.Id);
        }
    }
}
