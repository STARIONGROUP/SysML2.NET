// -------------------------------------------------------------------------------------------------
// <copyright file="RedefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IRedefinition"/> instances
    ...
    /// validation scenarios where two <see cref="IRedefinition"/> instances
    ...
    public sealed class RedefinitionComparer : IEqualityComparer<IRedefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IRedefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IRedefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IRedefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IRedefinition"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IRedefinition x, IRedefinition y)
        {
            ...
            if (x.RedefinedFeature != y.RedefinedFeature) return false;

            if (x.RedefiningFeature != y.RedefiningFeature) return false;

            return true;
        }

        /// <summary>
        /// Returns a hash code for the specified <see cref="IRedefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IRedefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IRedefinition obj)
        {
            return HashCode.Combine(typeof(IRedefinition), obj.Id);
        }
    }
}
