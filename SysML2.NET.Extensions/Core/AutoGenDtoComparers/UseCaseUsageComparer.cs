// -------------------------------------------------------------------------------------------------
// <copyright file="UseCaseUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IUseCaseUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IUseCaseUsage"/> instances
    ...
    public sealed class UseCaseUsageComparer : IEqualityComparer<IUseCaseUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IUseCaseUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IUseCaseUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IUseCaseUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IUseCaseUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IUseCaseUsage x, IUseCaseUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IUseCaseUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IUseCaseUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IUseCaseUsage obj)
        {
            return HashCode.Combine(typeof(IUseCaseUsage), obj.Id);
        }
    }
}
