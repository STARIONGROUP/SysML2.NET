// -------------------------------------------------------------------------------------------------
// <copyright file="DefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="IDefinition"/> instances
    ...
    public sealed class DefinitionComparer : IEqualityComparer<IDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IDefinition"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        {
            return HashCode.Combine(typeof(IDefinition), obj.Id);
        }
    }
}
