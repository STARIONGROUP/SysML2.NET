// -------------------------------------------------------------------------------------------------
// <copyright file="NamespaceImportComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="INamespaceImport"/> instances
    ...
    /// validation scenarios where two <see cref="INamespaceImport"/> instances
    ...
    public sealed class NamespaceImportComparer : IEqualityComparer<INamespaceImport>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="INamespaceImport"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="INamespaceImport"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="INamespaceImport"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="INamespaceImport"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(INamespaceImport x, INamespaceImport y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="INamespaceImport"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="INamespaceImport"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(INamespaceImport obj)
        {
            return HashCode.Combine(typeof(INamespaceImport), obj.Id);
        }
    }
}
