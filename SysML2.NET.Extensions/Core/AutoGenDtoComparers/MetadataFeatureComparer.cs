// -------------------------------------------------------------------------------------------------
// <copyright file="MetadataFeatureComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IMetadataFeature"/> instances
    ...
    /// validation scenarios where two <see cref="IMetadataFeature"/> instances
    ...
    public sealed class MetadataFeatureComparer : IEqualityComparer<IMetadataFeature>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IMetadataFeature"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IMetadataFeature"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IMetadataFeature"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IMetadataFeature"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IMetadataFeature x, IMetadataFeature y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IMetadataFeature"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IMetadataFeature"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IMetadataFeature obj)
        {
            return HashCode.Combine(typeof(IMetadataFeature), obj.Id);
        }
    }
}
