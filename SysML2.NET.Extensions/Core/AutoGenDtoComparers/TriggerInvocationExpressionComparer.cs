// -------------------------------------------------------------------------------------------------
// <copyright file="TriggerInvocationExpressionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ITriggerInvocationExpression"/> instances
    ...
    /// validation scenarios where two <see cref="ITriggerInvocationExpression"/> instances
    ...
    public sealed class TriggerInvocationExpressionComparer : IEqualityComparer<ITriggerInvocationExpression>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ITriggerInvocationExpression"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ITriggerInvocationExpression"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ITriggerInvocationExpression"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ITriggerInvocationExpression"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(ITriggerInvocationExpression x, ITriggerInvocationExpression y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ITriggerInvocationExpression"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ITriggerInvocationExpression"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(ITriggerInvocationExpression obj)
        {
            return HashCode.Combine(typeof(ITriggerInvocationExpression), obj.Id);
        }
    }
}
