// -------------------------------------------------------------------------------------------------
// <copyright file="LiteralIntegerComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ILiteralInteger"/> instances
    ...
    /// validation scenarios where two <see cref="ILiteralInteger"/> instances
    ...
    public sealed class LiteralIntegerComparer : IEqualityComparer<ILiteralInteger>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ILiteralInteger"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ILiteralInteger"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ILiteralInteger"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ILiteralInteger"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ILiteralInteger"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ILiteralInteger"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
