// -------------------------------------------------------------------------------------------------
// <copyright file="RequirementDefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IRequirementDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="IRequirementDefinition"/> instances
    ...
    public sealed class RequirementDefinitionComparer : IEqualityComparer<IRequirementDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IRequirementDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IRequirementDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IRequirementDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IRequirementDefinition"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IRequirementDefinition x, IRequirementDefinition y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IRequirementDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IRequirementDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IRequirementDefinition obj)
        {
            return HashCode.Combine(typeof(IRequirementDefinition), obj.Id);
        }
    }
}
