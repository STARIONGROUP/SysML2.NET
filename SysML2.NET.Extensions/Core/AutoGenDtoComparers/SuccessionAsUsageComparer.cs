// -------------------------------------------------------------------------------------------------
// <copyright file="SuccessionAsUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ISuccessionAsUsage"/> instances
    ...
    /// validation scenarios where two <see cref="ISuccessionAsUsage"/> instances
    ...
    public sealed class SuccessionAsUsageComparer : IEqualityComparer<ISuccessionAsUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ISuccessionAsUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ISuccessionAsUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ISuccessionAsUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ISuccessionAsUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(ISuccessionAsUsage x, ISuccessionAsUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ISuccessionAsUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ISuccessionAsUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(ISuccessionAsUsage obj)
        {
            return HashCode.Combine(typeof(ISuccessionAsUsage), obj.Id);
        }
    }
}
