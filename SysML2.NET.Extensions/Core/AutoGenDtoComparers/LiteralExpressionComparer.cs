// -------------------------------------------------------------------------------------------------
// <copyright file="LiteralExpressionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ILiteralExpression"/> instances
    ...
    /// validation scenarios where two <see cref="ILiteralExpression"/> instances
    ...
    public sealed class LiteralExpressionComparer : IEqualityComparer<ILiteralExpression>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ILiteralExpression"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ILiteralExpression"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ILiteralExpression"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ILiteralExpression"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(ILiteralExpression x, ILiteralExpression y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ILiteralExpression"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ILiteralExpression"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(ILiteralExpression obj)
        {
            return HashCode.Combine(typeof(ILiteralExpression), obj.Id);
        }
    }
}
