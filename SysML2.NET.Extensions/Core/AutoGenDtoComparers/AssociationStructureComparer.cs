// -------------------------------------------------------------------------------------------------
// <copyright file="AssociationStructureComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IAssociationStructure"/> instances
    ...
    /// validation scenarios where two <see cref="IAssociationStructure"/> instances
    ...
    public sealed class AssociationStructureComparer : IEqualityComparer<IAssociationStructure>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IAssociationStructure"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IAssociationStructure"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IAssociationStructure"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IAssociationStructure"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IAssociationStructure"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IAssociationStructure"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
