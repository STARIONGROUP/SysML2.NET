// -------------------------------------------------------------------------------------------------
// <copyright file="CollectExpressionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ICollectExpression"/> instances
    ...
    /// validation scenarios where two <see cref="ICollectExpression"/> instances
    ...
    public sealed class CollectExpressionComparer : IEqualityComparer<ICollectExpression>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ICollectExpression"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ICollectExpression"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ICollectExpression"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ICollectExpression"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ICollectExpression"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ICollectExpression"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
