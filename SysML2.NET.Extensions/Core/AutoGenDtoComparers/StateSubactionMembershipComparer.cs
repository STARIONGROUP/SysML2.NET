// -------------------------------------------------------------------------------------------------
// <copyright file="StateSubactionMembershipComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IStateSubactionMembership"/> instances
    ...
    /// validation scenarios where two <see cref="IStateSubactionMembership"/> instances
    ...
    public sealed class StateSubactionMembershipComparer : IEqualityComparer<IStateSubactionMembership>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IStateSubactionMembership"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IStateSubactionMembership"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IStateSubactionMembership"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IStateSubactionMembership"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IStateSubactionMembership x, IStateSubactionMembership y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IStateSubactionMembership"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IStateSubactionMembership"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IStateSubactionMembership obj)
        {
            return HashCode.Combine(typeof(IStateSubactionMembership), obj.Id);
        }
    }
}
