// -------------------------------------------------------------------------------------------------
// <copyright file="OccurrenceDefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IOccurrenceDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="IOccurrenceDefinition"/> instances
    ...
    public sealed class OccurrenceDefinitionComparer : IEqualityComparer<IOccurrenceDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IOccurrenceDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IOccurrenceDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IOccurrenceDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IOccurrenceDefinition"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IOccurrenceDefinition x, IOccurrenceDefinition y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IOccurrenceDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IOccurrenceDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IOccurrenceDefinition obj)
        {
            return HashCode.Combine(typeof(IOccurrenceDefinition), obj.Id);
        }
    }
}
