// -------------------------------------------------------------------------------------------------
// <copyright file="ObjectiveMembershipComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IObjectiveMembership"/> instances
    ...
    /// validation scenarios where two <see cref="IObjectiveMembership"/> instances
    ...
    public sealed class ObjectiveMembershipComparer : IEqualityComparer<IObjectiveMembership>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IObjectiveMembership"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IObjectiveMembership"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IObjectiveMembership"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IObjectiveMembership"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IObjectiveMembership x, IObjectiveMembership y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IObjectiveMembership"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IObjectiveMembership"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IObjectiveMembership obj)
        {
            return HashCode.Combine(typeof(IObjectiveMembership), obj.Id);
        }
    }
}
