// -------------------------------------------------------------------------------------------------
// <copyright file="FunctionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IFunction"/> instances
    ...
    /// validation scenarios where two <see cref="IFunction"/> instances
    ...
    public sealed class FunctionComparer : IEqualityComparer<IFunction>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IFunction"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IFunction"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IFunction"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IFunction"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IFunction"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IFunction"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        {
            return HashCode.Combine(typeof(IFunction), obj.Id);
        }
    }
}
