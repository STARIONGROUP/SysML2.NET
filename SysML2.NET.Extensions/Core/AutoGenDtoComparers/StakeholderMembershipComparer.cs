// -------------------------------------------------------------------------------------------------
// <copyright file="StakeholderMembershipComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IStakeholderMembership"/> instances
    ...
    /// validation scenarios where two <see cref="IStakeholderMembership"/> instances
    ...
    public sealed class StakeholderMembershipComparer : IEqualityComparer<IStakeholderMembership>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IStakeholderMembership"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IStakeholderMembership"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IStakeholderMembership"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IStakeholderMembership"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IStakeholderMembership x, IStakeholderMembership y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IStakeholderMembership"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IStakeholderMembership"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IStakeholderMembership obj)
        {
            return HashCode.Combine(typeof(IStakeholderMembership), obj.Id);
        }
    }
}
