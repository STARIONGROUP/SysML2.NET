// -------------------------------------------------------------------------------------------------
// <copyright file="PartUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IPartUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IPartUsage"/> instances
    ...
    public sealed class PartUsageComparer : IEqualityComparer<IPartUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IPartUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IPartUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IPartUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IPartUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IPartUsage x, IPartUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IPartUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IPartUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IPartUsage obj)
        {
            return HashCode.Combine(typeof(IPartUsage), obj.Id);
        }
    }
}
