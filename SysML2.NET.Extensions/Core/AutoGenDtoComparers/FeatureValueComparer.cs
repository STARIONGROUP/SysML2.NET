// -------------------------------------------------------------------------------------------------
// <copyright file="FeatureValueComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IFeatureValue"/> instances
    ...
    /// validation scenarios where two <see cref="IFeatureValue"/> instances
    ...
    public sealed class FeatureValueComparer : IEqualityComparer<IFeatureValue>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IFeatureValue"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IFeatureValue"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IFeatureValue"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IFeatureValue"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IFeatureValue x, IFeatureValue y)
        {
            ...
            if (x.IsInitial != y.IsInitial) return false;
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IFeatureValue"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IFeatureValue"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IFeatureValue obj)
        {
            return HashCode.Combine(typeof(IFeatureValue), obj.Id);
        }
    }
}
