// -------------------------------------------------------------------------------------------------
// <copyright file="TerminateActionUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ITerminateActionUsage"/> instances
    ...
    /// validation scenarios where two <see cref="ITerminateActionUsage"/> instances
    ...
    public sealed class TerminateActionUsageComparer : IEqualityComparer<ITerminateActionUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ITerminateActionUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ITerminateActionUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ITerminateActionUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ITerminateActionUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(ITerminateActionUsage x, ITerminateActionUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ITerminateActionUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ITerminateActionUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(ITerminateActionUsage obj)
        {
            return HashCode.Combine(typeof(ITerminateActionUsage), obj.Id);
        }
    }
}
