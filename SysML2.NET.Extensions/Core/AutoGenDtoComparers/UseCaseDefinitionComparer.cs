// -------------------------------------------------------------------------------------------------
// <copyright file="UseCaseDefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IUseCaseDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="IUseCaseDefinition"/> instances
    ...
    public sealed class UseCaseDefinitionComparer : IEqualityComparer<IUseCaseDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IUseCaseDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IUseCaseDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IUseCaseDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IUseCaseDefinition"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IUseCaseDefinition x, IUseCaseDefinition y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IUseCaseDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IUseCaseDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IUseCaseDefinition obj)
        {
            return HashCode.Combine(typeof(IUseCaseDefinition), obj.Id);
        }
    }
}
