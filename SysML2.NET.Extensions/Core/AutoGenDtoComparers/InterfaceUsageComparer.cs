// -------------------------------------------------------------------------------------------------
// <copyright file="InterfaceUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IInterfaceUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IInterfaceUsage"/> instances
    ...
    public sealed class InterfaceUsageComparer : IEqualityComparer<IInterfaceUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IInterfaceUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IInterfaceUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IInterfaceUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IInterfaceUsage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IInterfaceUsage x, IInterfaceUsage y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IInterfaceUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IInterfaceUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IInterfaceUsage obj)
        {
            return HashCode.Combine(typeof(IInterfaceUsage), obj.Id);
        }
    }
}
