// -------------------------------------------------------------------------------------------------
// <copyright file="MembershipExposeComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IMembershipExpose"/> instances
    ...
    /// validation scenarios where two <see cref="IMembershipExpose"/> instances
    ...
    public sealed class MembershipExposeComparer : IEqualityComparer<IMembershipExpose>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IMembershipExpose"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IMembershipExpose"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IMembershipExpose"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IMembershipExpose"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IMembershipExpose x, IMembershipExpose y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IMembershipExpose"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IMembershipExpose"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IMembershipExpose obj)
        {
            return HashCode.Combine(typeof(IMembershipExpose), obj.Id);
        }
    }
}
