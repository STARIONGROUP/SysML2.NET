// -------------------------------------------------------------------------------------------------
// <copyright file="InvariantComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IInvariant"/> instances
    ...
    /// validation scenarios where two <see cref="IInvariant"/> instances
    ...
    public sealed class InvariantComparer : IEqualityComparer<IInvariant>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IInvariant"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IInvariant"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IInvariant"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IInvariant"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IInvariant x, IInvariant y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IInvariant"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IInvariant"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IInvariant obj)
        {
            return HashCode.Combine(typeof(IInvariant), obj.Id);
        }
    }
}
