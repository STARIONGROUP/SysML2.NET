// -------------------------------------------------------------------------------------------------
// <copyright file="AssertConstraintUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IAssertConstraintUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IAssertConstraintUsage"/> instances
    ...
    public sealed class AssertConstraintUsageComparer : IEqualityComparer<IAssertConstraintUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IAssertConstraintUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IAssertConstraintUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IAssertConstraintUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IAssertConstraintUsage"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IAssertConstraintUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IAssertConstraintUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
