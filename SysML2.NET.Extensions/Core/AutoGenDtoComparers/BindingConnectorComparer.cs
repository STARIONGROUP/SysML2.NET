// -------------------------------------------------------------------------------------------------
// <copyright file="BindingConnectorComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IBindingConnector"/> instances
    ...
    /// validation scenarios where two <see cref="IBindingConnector"/> instances
    ...
    public sealed class BindingConnectorComparer : IEqualityComparer<IBindingConnector>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IBindingConnector"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IBindingConnector"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IBindingConnector"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IBindingConnector"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IBindingConnector"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IBindingConnector"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
