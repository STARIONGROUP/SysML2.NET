...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IPackage"/> instances
    ...
    /// validation scenarios where two <see cref="IPackage"/> instances
    ...
    public sealed class PackageComparer : IEqualityComparer<IPackage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IPackage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IPackage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IPackage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IPackage"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IPackage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IPackage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        {
            return HashCode.Combine(typeof(IPackage), obj.Id);
        }
    }
}
