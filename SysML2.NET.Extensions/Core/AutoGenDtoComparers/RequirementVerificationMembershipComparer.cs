// -------------------------------------------------------------------------------------------------
// <copyright file="RequirementVerificationMembershipComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IRequirementVerificationMembership"/> instances
    ...
    /// validation scenarios where two <see cref="IRequirementVerificationMembership"/> instances
    ...
    public sealed class RequirementVerificationMembershipComparer : IEqualityComparer<IRequirementVerificationMembership>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IRequirementVerificationMembership"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IRequirementVerificationMembership"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IRequirementVerificationMembership"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IRequirementVerificationMembership"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IRequirementVerificationMembership x, IRequirementVerificationMembership y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IRequirementVerificationMembership"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IRequirementVerificationMembership"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IRequirementVerificationMembership obj)
        {
            return HashCode.Combine(typeof(IRequirementVerificationMembership), obj.Id);
        }
    }
}
