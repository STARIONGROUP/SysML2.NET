// -------------------------------------------------------------------------------------------------
// <copyright file="ConstructorExpressionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IConstructorExpression"/> instances
    ...
    /// validation scenarios where two <see cref="IConstructorExpression"/> instances
    ...
    public sealed class ConstructorExpressionComparer : IEqualityComparer<IConstructorExpression>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IConstructorExpression"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IConstructorExpression"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IConstructorExpression"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IConstructorExpression"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IConstructorExpression x, IConstructorExpression y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IConstructorExpression"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IConstructorExpression"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IConstructorExpression obj)
        {
            return HashCode.Combine(typeof(IConstructorExpression), obj.Id);
        }
    }
}
