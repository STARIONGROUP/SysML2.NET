// -------------------------------------------------------------------------------------------------
// <copyright file="VerificationCaseDefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IVerificationCaseDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="IVerificationCaseDefinition"/> instances
    ...
    public sealed class VerificationCaseDefinitionComparer : IEqualityComparer<IVerificationCaseDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IVerificationCaseDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IVerificationCaseDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IVerificationCaseDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IVerificationCaseDefinition"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IVerificationCaseDefinition x, IVerificationCaseDefinition y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IVerificationCaseDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IVerificationCaseDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IVerificationCaseDefinition obj)
        {
            return HashCode.Combine(typeof(IVerificationCaseDefinition), obj.Id);
        }
    }
}
