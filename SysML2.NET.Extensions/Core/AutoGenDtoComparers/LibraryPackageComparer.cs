// -------------------------------------------------------------------------------------------------
// <copyright file="LibraryPackageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ILibraryPackage"/> instances
    ...
    /// validation scenarios where two <see cref="ILibraryPackage"/> instances
    ...
    public sealed class LibraryPackageComparer : IEqualityComparer<ILibraryPackage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ILibraryPackage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ILibraryPackage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ILibraryPackage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ILibraryPackage"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(ILibraryPackage x, ILibraryPackage y)
        {
            ...
            if (x.IsStandard != y.IsStandard) return false;
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ILibraryPackage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ILibraryPackage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(ILibraryPackage obj)
        {
            return HashCode.Combine(typeof(ILibraryPackage), obj.Id);
        }
    }
}
