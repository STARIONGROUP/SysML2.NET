// -------------------------------------------------------------------------------------------------
// <copyright file="ExpressionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IExpression"/> instances
    ...
    /// validation scenarios where two <see cref="IExpression"/> instances
    ...
    public sealed class ExpressionComparer : IEqualityComparer<IExpression>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IExpression"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IExpression"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IExpression"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IExpression"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IExpression"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IExpression"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        {
            return HashCode.Combine(typeof(IExpression), obj.Id);
        }
    }
}
