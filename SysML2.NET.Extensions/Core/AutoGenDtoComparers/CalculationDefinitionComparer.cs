// -------------------------------------------------------------------------------------------------
// <copyright file="CalculationDefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ICalculationDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="ICalculationDefinition"/> instances
    ...
    public sealed class CalculationDefinitionComparer : IEqualityComparer<ICalculationDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ICalculationDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ICalculationDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ICalculationDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ICalculationDefinition"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ICalculationDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ICalculationDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
