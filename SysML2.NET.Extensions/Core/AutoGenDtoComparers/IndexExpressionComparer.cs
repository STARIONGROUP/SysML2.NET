// -------------------------------------------------------------------------------------------------
// <copyright file="IndexExpressionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IIndexExpression"/> instances
    ...
    /// validation scenarios where two <see cref="IIndexExpression"/> instances
    ...
    public sealed class IndexExpressionComparer : IEqualityComparer<IIndexExpression>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IIndexExpression"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IIndexExpression"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IIndexExpression"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IIndexExpression"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IIndexExpression x, IIndexExpression y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IIndexExpression"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IIndexExpression"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IIndexExpression obj)
        {
            return HashCode.Combine(typeof(IIndexExpression), obj.Id);
        }
    }
}
