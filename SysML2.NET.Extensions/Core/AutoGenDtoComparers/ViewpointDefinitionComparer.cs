// -------------------------------------------------------------------------------------------------
// <copyright file="ViewpointDefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IViewpointDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="IViewpointDefinition"/> instances
    ...
    public sealed class ViewpointDefinitionComparer : IEqualityComparer<IViewpointDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IViewpointDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IViewpointDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IViewpointDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IViewpointDefinition"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IViewpointDefinition x, IViewpointDefinition y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IViewpointDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IViewpointDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IViewpointDefinition obj)
        {
            return HashCode.Combine(typeof(IViewpointDefinition), obj.Id);
        }
    }
}
