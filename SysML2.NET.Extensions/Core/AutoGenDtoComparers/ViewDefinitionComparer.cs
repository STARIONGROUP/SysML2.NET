// -------------------------------------------------------------------------------------------------
// <copyright file="ViewDefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IViewDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="IViewDefinition"/> instances
    ...
    public sealed class ViewDefinitionComparer : IEqualityComparer<IViewDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IViewDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IViewDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IViewDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IViewDefinition"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IViewDefinition x, IViewDefinition y)
        {
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IViewDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IViewDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IViewDefinition obj)
        {
            return HashCode.Combine(typeof(IViewDefinition), obj.Id);
        }
    }
}
