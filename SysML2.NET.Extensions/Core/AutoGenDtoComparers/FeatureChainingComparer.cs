// -------------------------------------------------------------------------------------------------
// <copyright file="FeatureChainingComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IFeatureChaining"/> instances
    ...
    /// validation scenarios where two <see cref="IFeatureChaining"/> instances
    ...
    public sealed class FeatureChainingComparer : IEqualityComparer<IFeatureChaining>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IFeatureChaining"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IFeatureChaining"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IFeatureChaining"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IFeatureChaining"/>
        ...
        /// derived state.
        /// </remarks>
        public bool Equals(IFeatureChaining x, IFeatureChaining y)
        {
            ...
            if (x.ChainingFeature != y.ChainingFeature) return false;
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IFeatureChaining"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IFeatureChaining"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
        ...
        /// checks
        /// </remarks>
        public int GetHashCode(IFeatureChaining obj)
        {
            return HashCode.Combine(typeof(IFeatureChaining), obj.Id);
        }
    }
}
