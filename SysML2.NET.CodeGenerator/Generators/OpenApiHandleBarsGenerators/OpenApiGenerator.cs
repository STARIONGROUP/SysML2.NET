// -------------------------------------------------------------------------------------------------
// <copyright file="OpenApiGenerator.cs" company="Starion Group S.A.">
// 
...
namespace SysML2.NET.CodeGenerator.Generators.HandleBarsGenerators
{
    ...
    /// </summary>
    public abstract class OpenApiGenerator  : HandleBarsGenerator  
    {
        /// <summary>
        /// Generates code specific to the concrete implementation
        /// </summary>
        /// <param name="document">
        /// the <see cref="Document"/> that contains the specification to generate from
        /// </param>
        ...
        /// </returns>
        public abstract Task Generate(Document document, DirectoryInfo outputDirectory);
    }
}
