// -------------------------------------------------------------------------------------------------
// <copyright file="PimEnumGenerator.cs" company="Starion Group S.A.">
// 
...
namespace SysML2.NET.CodeGenerator.Generators.UmlHandleBarsGenerators
{
    ...
    /// <summary>
    /// A Handlebars based PIM Enumeration code generator
    /// </summary>
    public class PimEnumGenerator : UmlHandleBarsGenerator
    {
        /// <summary>
        ...
        {
            var template = this.Templates["pim-enumeration-template"];
        ...
        {
            this.RegisterTemplate("pim-enumeration-template");
        }
    }
}