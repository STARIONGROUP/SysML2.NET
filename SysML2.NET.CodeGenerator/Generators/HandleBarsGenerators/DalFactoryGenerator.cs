...
namespace SysML2.NET.CodeGenerator.Generators.HandleBarsGenerators
{
	...
	public class DalFactoryGenerator : EcoreHandleBarsGenerator
    {
		...
		{
			var template = this.Templates["element-dal-factory"];
		...
		{
			var template = this.Templates["poco-dal-factory"];
		...
		{
			this.RegisterTemplate("element-dal-factory");
			this.RegisterTemplate("poco-dal-factory");
		}
	}
}
