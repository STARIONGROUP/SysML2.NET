// -------------------------------------------------------------------------------------------------
// <copyright file="BaseGenerator.cs" company="RHEA System S.A.">
//
...
namespace SysML2.NET.CodeGenerator.Generators
{
    ...
    public abstract class BaseGenerator
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BaseGenerator"/>
        /// </summary>
        protected BaseGenerator()
        {
            ...
            this.Engine = new RazorLightEngineBuilder()
                .UseFileSystemProject(Path.Combine(assemblyFolder, "Templates"))
        ...
        /// cleaned up code
        /// </returns>
        protected string CodeCleanup(string generatedCode)
        {
