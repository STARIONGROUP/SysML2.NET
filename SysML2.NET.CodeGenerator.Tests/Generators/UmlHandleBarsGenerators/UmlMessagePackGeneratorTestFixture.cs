...
namespace SysML2.NET.CodeGenerator.Tests.Generators.UmlHandleBarsGenerators
{
    ...
    public class UmlMessagePackGeneratorTestFixture
    {
        ...
        public void SetUp()
        {
            ...
            var path = Path.Combine("UML", "_SysML2.NET.Serializer.MessagePack.Core.AutoGenMessagePackPayload");

            this.umlMessagePackPayloadDirectoryInfo = directoryInfo.CreateSubdirectory(path);
