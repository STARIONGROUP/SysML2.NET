// -------------------------------------------------------------------------------------------------
// <copyright file="DalFactoryGeneratorTestFixture.cs" company="RHEA System S.A.">
// 
...
namespace SysML2.NET.CodeGenerator.Tests.Generators.HandleBarsGenerators
{
	...
	/// <summary>
	/// Suite of tests for the <see cref="DalFactoryGenerator"/> class
	/// </summary>
	[TestFixture]
	public class DalFactoryGeneratorTestFixture
	{
		private DirectoryInfo dalFactoryDirectoryInfo;

		private DalFactoryGenerator dalFactoryGenerator;
		...
		public void SetUp()
		{
			...
			dalFactoryDirectoryInfo = directoryInfo.CreateSubdirectory("AutoGenElementFactory");

			rootPackage = DataModelLoader.Load();

			dalFactoryGenerator = new DalFactoryGenerator();
		}
