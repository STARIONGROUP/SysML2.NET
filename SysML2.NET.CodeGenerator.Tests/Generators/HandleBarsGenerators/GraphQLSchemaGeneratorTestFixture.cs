// -------------------------------------------------------------------------------------------------
// <copyright file="GraphQLSchemaGeneratorTestFixture.cs" company="RHEA System S.A.">
// 
...
namespace SysML2.NET.CodeGenerator.Tests.Generators.HandleBarsGenerators
{
	...
	[TestFixture]
	public class GraphQLSchemaGeneratorTestFixture
	{
		...
		public void SetUp()
		{
			...
			dtoDirectoryInfo = directoryInfo.CreateSubdirectory("AutoGenGraphQLSchema");

			rootPackage = DataModelLoader.Load();

			this.graphQlSchemaGenerator = new GraphQLSchemaGenerator();
		}
