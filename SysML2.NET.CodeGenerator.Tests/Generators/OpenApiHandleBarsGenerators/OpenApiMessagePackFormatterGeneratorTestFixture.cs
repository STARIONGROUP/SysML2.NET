// -------------------------------------------------------------------------------------------------
// <copyright file="OpenApiMessagePackFormatterGeneratorTestFixture.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.CodeGenerator.Tests.Generators.OpenApiHandleBarsGenerators
{
    ...
    public class OpenApiMessagePackFormatterGeneratorTestFixture
    {
        ...
        {
            await Assert.ThatAsync(() => this.openApiMessagePackFormatterGenerator.GenerateAsync(null, this.outputDirectory), Throws.TypeOf<ArgumentNullException>());
            await Assert.ThatAsync(() => this.openApiMessagePackFormatterGenerator.GenerateAsync(this.openApiDocument, null), Throws.TypeOf<ArgumentNullException>());
            Assert.That(() => OpenApiMessagePackFormatterGenerator.QueryFormattableSchemas(null), Throws.TypeOf<ArgumentNullException>());
