...
namespace SysML2.NET.Serializer.Dictionary.Core.DTO
{
    ...
    public static class UsageDictionaryReader
    {
        ...
        private static IUsage ReadSimplified(Dictionary<string, object> dictionary)
        {
            ...
            {
                throw new ArgumentException("The isConstant property is missing from the dictionary, the dictionary cannot be converted into a Usage");
            }
            ...
            {
                throw new ArgumentException("The isVariable property is missing from the dictionary, the dictionary cannot be converted into a Usage");
            }
            ...
            usageInstance.IsVariable = isVariableFeature;
