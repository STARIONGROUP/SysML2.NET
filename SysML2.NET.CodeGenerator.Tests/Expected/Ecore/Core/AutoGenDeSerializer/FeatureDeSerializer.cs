...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class FeatureDeSerializer
    {
        ...
        internal static IFeature DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.Feature();
            ...
            {
                logger.LogDebug($"the isConstant Json property was not found in the Feature: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isVariable Json property was not found in the Feature: {dtoInstance.Id}");
            }
