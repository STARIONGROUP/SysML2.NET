...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class LiteralIntegerDeSerializer
    {
        ...
        internal static ILiteralInteger DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            var dtoInstance = new SysML2.NET.Core.DTO.LiteralInteger();
            ...
            {
                logger.LogDebug($"the isConstant Json property was not found in the LiteralInteger: {dtoInstance.Id}");
            }
            ...
            {
                logger.LogDebug($"the isVariable Json property was not found in the LiteralInteger: {dtoInstance.Id}");
            }
