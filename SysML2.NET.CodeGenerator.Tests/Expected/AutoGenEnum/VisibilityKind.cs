...
namespace SysML2.NET.AutoGenEnum
{
    ...
    /// otherwise restricts access to an Element as provided by specific constraints in the
    /// abstract syntax (e.g., preventing the import or inheritance of private Elements).
    /// </summary>
    public enum VisibilityKind
    {
        ...
        /// <summary>
        /// An intermediate level of visibility between public and private.
        /// By default, it is equivalent to private for the purposes of normal access to and import of Elements from a Namespace.
        /// However, other Relationships may be specified to include Memberships with protected visibility in the list of memberships
        /// for a Namespace (e.g., Generalization).
        /// </summary>
        Protected = 1,
