// -------------------------------------------------------------------------------------------------
// <copyright file="CompositeConstraintOperatorProvider.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.PSM
{
    ...
    /// <summary>
    /// The purpose of the <see cref="CompositeConstraintOperatorProvider"/> is to convert a <see cref="CompositeConstraintOperator"/>
    ...
    public static class CompositeConstraintOperatorProvider
    {
        ...
        /// <summary>
        /// Parses the <see cref="ReadOnlySpan{Char}"/> to a <see cref="CompositeConstraintOperator"/>
        /// </summary>
        /// <param name="value">The <see cref="ReadOnlySpan{Char}"/> that is to be parsed.</param>
        /// <returns>A <see cref="CompositeConstraintOperator"/> enumeration literal.</returns>
        /// <exception cref="ArgumentException">Thrown when the value denotes no literal.</exception>
        public static CompositeConstraintOperator Parse(ReadOnlySpan<char> value)
        {
        ...
        /// <summary>
        /// Tries to parse the <see cref="ReadOnlySpan{Char}"/> to a <see cref="CompositeConstraintOperator"/>
        /// </summary>
        /// <param name="value">The <see cref="ReadOnlySpan{Char}"/> that is to be parsed.</param>
        ...
        public static bool TryParse(ReadOnlySpan<char> value, out CompositeConstraintOperator result)
        {
        ...
        /// <summary>
        /// Parses the UTF-8 encoded <see cref="ReadOnlySpan{Byte}"/> to a <see cref="CompositeConstraintOperator"/>
        /// </summary>
        /// <param name="value">The <see cref="ReadOnlySpan{Byte}"/> that is to be parsed.</param>
        /// <returns>A <see cref="CompositeConstraintOperator"/> enumeration literal.</returns>
        /// <exception cref="ArgumentException">Thrown when the value denotes no literal.</exception>
        public static CompositeConstraintOperator Parse(ReadOnlySpan<byte> value)
        {
        ...
        /// <summary>
        /// Parses the UTF-8 encoded <see cref="ReadOnlySequence{Byte}"/> to a <see cref="CompositeConstraintOperator"/>
        /// </summary>
        /// <param name="value">The <see cref="ReadOnlySequence{Byte}"/> that is to be parsed.</param>
        /// <returns>A <see cref="CompositeConstraintOperator"/> enumeration literal.</returns>
        /// <exception cref="ArgumentException">Thrown when the value denotes no literal.</exception>
        public static CompositeConstraintOperator Parse(in ReadOnlySequence<byte> value)
        {
        ...
        /// <summary>
        /// Converts a <see cref="CompositeConstraintOperator"/> to its UTF-8 encoded representation on the wire
        /// </summary>
        /// <param name="value">The <see cref="CompositeConstraintOperator"/> that is to be converted.</param>
        ...
        public static ReadOnlySpan<byte> ToUtf8Bytes(CompositeConstraintOperator value)
        {
            return value switch
            {
