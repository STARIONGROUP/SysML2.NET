...
namespace SysML2.NET.Serializer.Json.PSM
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="DataVersion"/> from the provided <see cref="Utf8JsonReader"/>
        /// </summary>
        /// <param name="reader">
        /// The <see cref="Utf8JsonReader"/> positioned on the <see cref="JsonTokenType.StartObject"/> of the
        /// <see cref="DataVersion"/> json object. On return the reader is positioned on the matching
        ...
        internal static DataVersion DeSerialize(ref Utf8JsonReader reader, SerializationModeKind serializationModeKind, bool deserializeDerivedProperties, ILoggerFactory loggerFactory = null)
        {
            ...
            while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
            {
                ...
                if (reader.ValueTextEquals("alias"u8))
                {
                    ...
                    dataVersion.Alias = new List<string>();
