// -------------------------------------------------------------------------------------------------
// <copyright file="CompositeConstraintDeSerializer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Serializer.Json.PSM
{
    ...
    /// <summary>
    /// The purpose of the <see cref="CompositeConstraintDeSerializer"/> is to provide deserialization capabilities
    /// for the <see cref="CompositeConstraint"/> class
    /// </summary>
    internal static class CompositeConstraintDeSerializer
    {
        /// <summary>
        /// Deserializes an instance of <see cref="CompositeConstraint"/> from the provided <see cref="Utf8JsonReader"/>
        /// </summary>
        /// <param name="reader">
        /// The <see cref="Utf8JsonReader"/> positioned on the <see cref="JsonTokenType.StartObject"/> of the
        /// <see cref="CompositeConstraint"/> json object. On return the reader is positioned on the matching
        ...
        /// </param>
        /// <returns>
        /// an instance of <see cref="CompositeConstraint"/>
        /// </returns>
        ...
        internal static CompositeConstraint DeSerialize(ref Utf8JsonReader reader, SerializationModeKind serializationModeKind, bool deserializeDerivedProperties, ILoggerFactory loggerFactory = null)
        {
            ...
            while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
            {
                ...
                if (reader.ValueTextEquals("constraint"u8))
                {
                    ...
                    compositeConstraint.Constraint = new List<IConstraint>();
