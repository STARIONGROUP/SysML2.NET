...
namespace SysML2.NET.Core.POCO.Root.Annotations
{
    ...
    /// representation.                        If the named language of a TextualRepresentation is
    /// machine-parsable, then the body text should be legal input text as defined for that language. The
    /// interpretation of the named language string shall be case insensitive. The following language names
    /// are defined to correspond to the given standard languages:                        <table border="1"
    /// cellpadding="1" cellspacing="1" width="498">                        <thead>                       
    /// </thead>                        <tbody>                        <tr>                        <td
    /// style="text-align: center; width: 154px;">kerml</td>                        <td style="width:
    /// 332px;">Kernel Modeling Language</td>                        </tr>                        <tr>      
    ///                  <td style="text-align: center; width: 154px;">ocl</td>                        <td
    /// style="width: 332px;">Object Constraint Language</td>                        </tr>                  
    ///      <tr>                        <td style="text-align: center; width: 154px;">alf</td>             
    ///           <td style="width: 332px;">Action Language for fUML</td>                        </tr>      
    ///                  </tbody>                        </table>                        Other
    /// specifications may define specific language strings, other than those shown above, to be used to
    /// indicate the use of languages from those specifications in KerML TextualRepresentation.             
    ///           If the language of a TextualRepresentation is &quot;kerml&quot;, then the body text shall
    /// be a legal representation of the representedElement in the KerML textual concrete syntax. A
    /// conforming tool can use such a TextualRepresentation Annotation to record the original KerML
    /// concrete syntax text from which an Element was parsed. In this case, it is a tool responsibility to
    /// ensure that the body of the TextualRepresentation remains correct (or the Annotation is removed) if
    /// the annotated Element changes other than by re-parsing the body text.                        An
    ...
    {
        /// <summary>
        /// Initialize a new instance of <see cref="TextualRepresentation" />
        /// </summary>
