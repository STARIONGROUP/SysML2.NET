...
namespace SysML2.NET.Core.POCO.Systems.Requirements
{
    ...
    public partial class FramedConcernMembership : IFramedConcernMembership
    {
        ...
        [RedefinedByProperty("IFramedConcernMembership.Kind")] RequirementConstraintKind IRequirementConstraintMembership.Kind { get; set; }
        ...
        public IConcernUsage QueryOwnedConcern()
        {
        ...
        public IConcernUsage QueryReferencedConcern()
        {
