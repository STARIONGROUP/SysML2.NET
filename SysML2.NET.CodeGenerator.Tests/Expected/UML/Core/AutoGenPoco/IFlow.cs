...
namespace SysML2.NET.Core.POCO.Kernel.Interactions
{
    ...
    public partial interface IFlow : IConnector, IStep
    {
        ...
        List<IInteraction> interaction { get; }
        ...
        IPayloadFeature payloadFeature { get; }
        ...
        List<IClassifier> payloadType { get; }
        ...
        IFeature sourceOutputFeature { get; }
        ...
        IFeature targetInputFeature { get; }
