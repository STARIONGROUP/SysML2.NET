...
namespace SysML2.NET.Core.POCO.Root.Dependencies
{
    ...
    public partial class Dependency : IDependency
    {
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IDependency.Client");
            set => throw new InvalidOperationException("Redefined by property IDependency.Client");
        }
        ...
        {
            get => throw new InvalidOperationException("Redefined by property IDependency.Supplier");
            set => throw new InvalidOperationException("Redefined by property IDependency.Supplier");
        }
