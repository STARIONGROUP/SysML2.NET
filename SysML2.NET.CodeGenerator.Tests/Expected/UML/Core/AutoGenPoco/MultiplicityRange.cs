...
namespace SysML2.NET.Core.POCO.Kernel.Multiplicities
{
    ...
    {
        /// <summary>
        /// Initialize a new instance of <see cref="MultiplicityRange" />
        /// </summary>
        ...
        public List<IExpression> bound => this.ComputeBound();
        ...
        public IExpression lowerBound => this.ComputeLowerBound();
