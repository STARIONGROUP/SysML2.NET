...
namespace SysML2.NET.Core.POCO.Core.Features
{
    ...
    public partial class ReferenceSubsetting : IReferenceSubsetting
    {
        ...
        [RedefinedByProperty("ISubsetting.SubsettedFeature")] public IType General { get; set; }
        ...
        public IFeature QueryOwningFeature()
        {
        ...
        public IFeature QueryReferencingFeature()
        {
            throw new NotImplementedException("Derived property ReferencingFeature not yet supported");
        }
        ...
        [SubsettedProperty(propertyName: "_18_5_3_12e503d9_1533160674961_132339_43177")]
        [RedefinedByProperty("ISpecialization.Specific")] public List<IElement> Source { get; set; }
        ...
        [RedefinedByProperty("ISubsetting.SubsettingFeature")] public IType Specific { get; set; }
        ...
        [RedefinedByProperty("IReferenceSubsetting.ReferencedFeature")] public IFeature SubsettedFeature { get; set; }
        ...
        [RedefinedByProperty("IReferenceSubsetting.ReferencingFeature")] public IFeature SubsettingFeature { get; set; }
        ...
        [SubsettedProperty(propertyName: "_18_5_3_12e503d9_1533160674961_132339_43177")]
        [RedefinedByProperty("ISpecialization.General")] public List<IElement> Target { get; set; }
