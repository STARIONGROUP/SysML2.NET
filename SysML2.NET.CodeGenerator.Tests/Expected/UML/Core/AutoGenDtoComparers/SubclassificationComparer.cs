// -------------------------------------------------------------------------------------------------
// <copyright file="SubclassificationComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ISubclassification"/> instances
    ...
    /// validation scenarios where two <see cref="ISubclassification"/> instances
    ...
    public sealed class SubclassificationComparer : IEqualityComparer<ISubclassification>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ISubclassification"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ISubclassification"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ISubclassification"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ISubclassification"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ISubclassification"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ISubclassification"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
