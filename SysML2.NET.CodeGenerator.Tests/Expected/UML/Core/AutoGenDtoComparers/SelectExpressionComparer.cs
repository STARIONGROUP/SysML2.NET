// -------------------------------------------------------------------------------------------------
// <copyright file="SelectExpressionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="ISelectExpression"/> instances
    ...
    /// validation scenarios where two <see cref="ISelectExpression"/> instances
    ...
    public sealed class SelectExpressionComparer : IEqualityComparer<ISelectExpression>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="ISelectExpression"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="ISelectExpression"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="ISelectExpression"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="ISelectExpression"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="ISelectExpression"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="ISelectExpression"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
