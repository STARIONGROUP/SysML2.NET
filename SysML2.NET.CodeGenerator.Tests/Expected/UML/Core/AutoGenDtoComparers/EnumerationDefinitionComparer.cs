// -------------------------------------------------------------------------------------------------
// <copyright file="EnumerationDefinitionComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IEnumerationDefinition"/> instances
    ...
    /// validation scenarios where two <see cref="IEnumerationDefinition"/> instances
    ...
    public sealed class EnumerationDefinitionComparer : IEqualityComparer<IEnumerationDefinition>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IEnumerationDefinition"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IEnumerationDefinition"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IEnumerationDefinition"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IEnumerationDefinition"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IEnumerationDefinition"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IEnumerationDefinition"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
