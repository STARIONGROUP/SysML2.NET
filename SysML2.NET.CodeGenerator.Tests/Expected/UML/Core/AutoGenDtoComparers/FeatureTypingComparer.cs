// -------------------------------------------------------------------------------------------------
// <copyright file="FeatureTypingComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IFeatureTyping"/> instances
    ...
    /// validation scenarios where two <see cref="IFeatureTyping"/> instances
    ...
    public sealed class FeatureTypingComparer : IEqualityComparer<IFeatureTyping>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IFeatureTyping"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IFeatureTyping"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IFeatureTyping"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IFeatureTyping"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IFeatureTyping"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IFeatureTyping"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
