// -------------------------------------------------------------------------------------------------
// <copyright file="RequirementUsageComparer.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Extensions.Core.DTO.Comparers
{
    ...
    /// <summary>
    /// Provides an equality comparison for <see cref="IRequirementUsage"/> instances
    ...
    /// validation scenarios where two <see cref="IRequirementUsage"/> instances
    ...
    public sealed class RequirementUsageComparer : IEqualityComparer<IRequirementUsage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Determines whether two <see cref="IRequirementUsage"/> instances are equal.
        /// </summary>
        /// <param name="x">
        /// The first <see cref="IRequirementUsage"/> to compare.
        /// </param>
        /// <param name="y">
        /// The second <see cref="IRequirementUsage"/> to compare.
        /// </param>
        /// <returns>
        /// <c>true</c> if both instances represent the same <see cref="IRequirementUsage"/>
        ...
        /// <summary>
        /// Returns a hash code for the specified <see cref="IRequirementUsage"/>.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="IRequirementUsage"/> for which a hash code is to be returned.
        /// </param>
        /// <returns>
