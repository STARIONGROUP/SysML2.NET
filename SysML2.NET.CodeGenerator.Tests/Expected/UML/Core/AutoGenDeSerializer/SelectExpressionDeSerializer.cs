...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    internal static class SelectExpressionDeSerializer
    {
        ...
        internal static ISelectExpression DeSerialize(JsonElement jsonElement, SerializationModeKind serializationModeKind, ILoggerFactory loggerFactory = null)
        {
            ...
            {
                logger.LogDebug("the behavior Json property was not found in the SelectExpression: { Id }", dtoInstance.Id);
            }
            ...
            {
                logger.LogDebug("the directedFeature Json property was not found in the SelectExpression: { Id }", dtoInstance.Id);
            }
