...
namespace SysML2.NET.Serializer.Json.Core.DTO
{
    ...
    {
        /// <summary>
        /// Deserializes an instance of <see cref="ISubclassification"/> from the provided <see cref="Utf8JsonReader"/>
        /// </summary>
        /// <param name="reader">
        /// The <see cref="Utf8JsonReader"/> positioned on the <see cref="JsonTokenType.StartObject"/> of the
        /// <see cref="ISubclassification"/> json object. On return the reader is positioned on the matching
        ...
        /// </remarks>
        internal static ISubclassification DeSerialize(ref Utf8JsonReader reader, SerializationModeKind serializationModeKind, bool deserializeDerivedProperties, ILoggerFactory loggerFactory = null)
        {
        ...
        /// <summary>
        /// Deserializes properties of a <see cref="SysML2.NET.Core.DTO.Core.Classifiers.Subclassification" />
        /// from a <see cref="Utf8JsonReader" />, including derived properties
        /// </summary>
        /// <param name="dtoInstance">
        /// The <see cref="SysML2.NET.Core.DTO.Core.Classifiers.Subclassification"/> instance holding deserialized values
        /// </param>
        /// <param name="reader">
        /// The <see cref="Utf8JsonReader"/> positioned on the <see cref="JsonTokenType.StartObject"/> of the
        /// <see cref="ISubclassification"/> json object
        /// </param>
        /// <param name="logger">
        /// The <see cref="ILogger"/> to produce logging statement
        /// </param>
        private static void DeserializeDtoIncludingDerivedProperties(SysML2.NET.Core.DTO.Core.Classifiers.Subclassification dtoInstance, ref Utf8JsonReader reader, ILogger logger)
        {
            ...
            var ownerSeen = false;
            var owningClassifierSeen = false;
            ...
            var subclassifierSeen = false;
            var superclassifierSeen = false;
            ...
            while (reader.Read() && reader.TokenType != JsonTokenType.EndObject)
            {
                ...
                {
                    throw new JsonException("Expected a property name in the Subclassification json object.");
                }
                ...
                if (reader.ValueTextEquals("owningClassifier"u8))
                {
                    owningClassifierSeen = true;
                    reader.Read();
                    ...
                    else if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var owningClassifierValue))
                    {
                        dtoInstance.owningClassifier = owningClassifierValue;
                    }
                ...
                if (reader.ValueTextEquals("subclassifier"u8))
                {
                    subclassifierSeen = true;
                    reader.Read();
                    ...
                    else if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var subclassifierValue))
                    {
                        dtoInstance.Subclassifier = subclassifierValue;
                    }

                    continue;
                }

                if (reader.ValueTextEquals("superclassifier"u8))
                {
                    superclassifierSeen = true;
                    reader.Read();
                    ...
                    else if (Utf8JsonReaderHelper.TryReadReferenceIdentifier(ref reader, out var superclassifierValue))
                    {
                        dtoInstance.Superclassifier = superclassifierValue;
                    }
        ...
        /// The <see cref="ILogger"/> to produce logging statement
        /// </param>
        private static void DeserializeDtoExcludingDerivedProperties(SysML2.NET.Core.DTO.Core.Classifiers.Subclassification dtoInstance, ref Utf8JsonReader reader, ILogger logger)
        {
            var aliasIdsSeen = false;
            var declaredNameSeen = false;
            var declaredShortNameSeen = false;
