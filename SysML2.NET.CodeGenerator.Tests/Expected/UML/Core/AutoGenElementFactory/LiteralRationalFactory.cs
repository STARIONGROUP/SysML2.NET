...
namespace SysML2.NET.Dal
{
    ...
    public static class LiteralRationalFactory
    {
        ...
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Core.DTO.Kernel.Expressions.LiteralRational"/>
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static Core.POCO.Kernel.Expressions.LiteralRational Create(Core.DTO.Kernel.Expressions.LiteralRational dto)
        {
            if (dto == null)
            {
            ...
            var poco = new Core.POCO.Kernel.Expressions.LiteralRational();
