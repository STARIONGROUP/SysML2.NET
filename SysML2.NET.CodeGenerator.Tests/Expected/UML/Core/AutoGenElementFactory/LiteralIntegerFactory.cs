// -------------------------------------------------------------------------------------------------
// <copyright file="LiteralIntegerFactory.cs" company="Starion Group S.A.">
//
...
namespace SysML2.NET.Dal
{
    ...
    public static class LiteralIntegerFactory
    {
        ...
        /// </summary>
        /// <param name="dto">
        /// The instance of the <see cref="Core.DTO.Kernel.Expressions.LiteralInteger"/>
        /// </param>
        /// <returns>
        ...
        /// </exception>
        public static Core.POCO.Kernel.Expressions.LiteralInteger Create(Core.DTO.Kernel.Expressions.LiteralInteger dto)
        {
            if (dto == null)
            {
            ...
            var poco = new Core.POCO.Kernel.Expressions.LiteralInteger();
