...
namespace SysML2.NET.Core.DTO.Kernel.Expressions
{
    ...
    public partial class SelectExpression : ISelectExpression
    {
        ...
        {
            get => throw new InvalidOperationException("Redefined by property ISelectExpression.Operator");
            set => throw new InvalidOperationException("Redefined by property ISelectExpression.Operator");
        }
