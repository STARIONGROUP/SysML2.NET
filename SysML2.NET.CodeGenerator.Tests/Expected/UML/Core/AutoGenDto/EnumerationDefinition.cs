...
namespace SysML2.NET.Core.DTO.Systems.Enumerations
{
    ...
    public partial class EnumerationDefinition : IEnumerationDefinition
    {
        ...
        List<Guid> Systems.DefinitionAndUsage.IDefinition.variant => throw new InvalidOperationException("Redefined by property IEnumerationDefinition.EnumeratedValue");
