...
namespace SysML2.NET.Core.DTO.Core.Classifiers
{
    ...
    public partial class Subclassification : ISubclassification
    {
        ...
        Guid? Core.Types.ISpecialization.owningType => this.owningClassifier.HasValue ? this.owningClassifier.Value : Guid.Empty;
